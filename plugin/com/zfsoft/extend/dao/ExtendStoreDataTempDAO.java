...
public class ExtendStoreDataTempDAO extends SuperDAOImpl<ExtendStoreData> {
	...
	public boolean deleteData(String dataid , String mid) throws Exception{
		String del = "delete from ZFXG_EXTEND_DATA_Temp where id = ? and mid = ?";
	...
	public boolean saveData(List<ExtendStoreData> data , String id , String mid) throws Exception{
		String del = "delete from ZFXG_EXTEND_DATA_Temp where id = ? and mid = ?";
		String sql = "insert into ZFXG_EXTEND_DATA_Temp(id,mid,meid,gid,zjz,zd,zdz,rn) values (?,?,?,?,?,?,?,?)";
	...
	public List<ExtendStoreData> getExtendStoreDataList(String id, String mid) throws Exception{
		String sql = "select * from ZFXG_EXTEND_DATA_Temp where id = ? and mid = ? ";
	...
	protected void setTableInfo() {
		...
		super.setKey("ID");
		super.setTableName("ZFXG_EXTEND_DATA_TEMP");
	}
