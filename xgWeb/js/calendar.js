...
// $Id: calendar.js,v 1.5 2010/11/06 06:40:27 administrator Exp $
...
Calendar.prototype.callHandler = function () {
	if (this.onSelected) {
		...
		if(calendar.wk!=null){//week text is inputed
			calendar.wk.value = this.date.print1();
		}
	}
};
...
Calendar.prototype.hideShowCovered = function () {
	...
	if($("showSelect")){
		if($("showSelect").value == "yes"){
			tags = new Array("applet", "iframe");
		}
	}
	var el = this.element;
...
Date.prototype.print1 = function () {
	var str1 = new String("D, M d");
	var m = this.getMonth();
	var d = this.getDate();
	var y = this.getFullYear();
	var wn = this.getWeekNumber();
	...
	var re = /(.*)(\W|^)(d|dd|m|mm|y|yy|MM|M|DD|D|w|ww)(\W|$)(.*)/;	
	while (re.exec(str1)!=null){
		str1 = RegExp.$1 + RegExp.$2+ s[RegExp.$3] ; 
	}	
	str1 = "ÐÇÆÚ"+str1;
	//alert(str1);
	return str1;
