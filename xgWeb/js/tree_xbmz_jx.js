...
function item_init () {
	...
	return '<table cellpadding="0" cellspacing="0" style="border:0px"><tr><td nowrap style="border:0px">' + 
			...
			'<a title="' + this.a_config[0] + '" href="#" target="' + this.o_root.a_tpl['target'] + '" onclick="jzOn(\'' + this.a_config[1] +'\');return trees[' + this.o_root.n_id + '].select(' + this.n_id + ')" onmousedown="trees[' + this.o_root.n_id + '].toggle(' + this.n_id + ')" class="t' + this.o_root.n_id + 'i" id="i_txt' + this.o_root.n_id + '_' + this.n_id + '"><img src="' + this.get_icon() + '" border="0" align="absbottom" name="i_img' + this.o_root.n_id + '_' + this.n_id + '" class="t' + this.o_root.n_id + 'im">' + this.a_config[0] + '</a>' +
			'</td></tr></table>' + 
			(
				this.a_children.length 
...
//      jxjzdj.innerText=data[2];
       	...
       	if (data[2] == 2){
    	document.getElementById("islj").value=data[0];
   		}
       }
    });
}