		...
		defaultConfig : {
			...
			var initThead = function(){
				...
				var pagerHtml = "";
					...
					pagerHtml +="<p class=\"pagenum\">第";
					pagerHtml +="<input type='text' id='pageNum' value='1' style='text-align:center;width:20px;'/>";
					pagerHtml +="/<span class='red' id='pageCount'></span>页，每页显示";
