...
<head>
	...
	<script type="text/javascript">
		function modidata(url,w,h){
				...
				showTopWin(url+pkValue,'600','400');
			}
	...
	<body onload="xyDisabled('xy')">		
		<html:form action="/qgzxZgdzdx.do?method=gwsqsh" method="post">
				          ...
				          <td colspan="6">
				            <div class="btn">
								...
								<button type="button" id="search_go"
									onclick="allNotEmpThenGo('qgzxZgdzdx.do?method=gwsqsh')">
									查询
								</button>
				            </div>
				          </td>
				...
				<tbody>
			      <logic:iterate name="rs" id="s">
					<tr onclick="rowOnClick(this)"
						...
						ondblclick="modidata('qgzxZgdzdx.do?method=showGwsqsh&pkValue=')">
						<td>
							<input type="hidden" value="<logic:iterate id="v" name="s" offset="1" length="1"><bean:write name="v"/></logic:iterate>"/>
							<input type="checkbox" id="cbv" name="cbv" value="<logic:iterate id="v" name="s" offset="2" length="1"><bean:write name="v"/></logic:iterate>" />
						</td>							
