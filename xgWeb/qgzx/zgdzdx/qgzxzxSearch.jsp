...
<head>
	...
	<body onload="xyDisabled('xy')">		
		<html:form action="/qgzxZgdzdx.do?method=qgzxzxSearch" method="post">
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>勤工助学 - 勤工助学之星 - 申请结果查询</a>
				</p>
			</div>
			<div class="toolbox">
				<!-- 按钮 -->				  
				  <div class="buttonbox">
				    <ul>
					  ...
					  <logic:equal value="yes" name="writeAble" scope="request">
							<li> <a href="#" onclick="refreshForm('qgzxZgdzdx.do?method=qgzxzx');" class="btn_zj">增加</a> </li>
					        <li> <a href="#" onclick="modidata('qgzxZgdzdx.do?method=modiQgzxzx&pkValue=','500','400');" class="btn_xg">修改</a> </li>
							<li> <a href="#" onclick="del('qgzxZgdzdx.do?method=delQgzxzx');" class="btn_sc">删除</a> </li>
							<li> <a href="#" onclick="impAndChkData();" class="btn_dr">导入数据</a> </li>
						</logic:equal>
							<li> <a href="#" onclick="dataExport('/xgxt/expData.do?tableName=view_qgzxzx');" class="btn_dc">导出数据</a> </li>
						</logic:notEqual>
					</ul>					
				  </div>
				  <div class="searchtab">
				          ...
				          <td colspan="6">
				            <div class="btn">
								...
								<button type="button" id="search_go"
									onclick="allNotEmpThenGo('qgzxZgdzdx.do?method=qgzxzxSearch')">
									查询
								</button>
				            </div>
				          </td>
				...
				<tbody>
			      <logic:iterate name="rs" id="s">
					<tr onclick="rowOnClick(this)"
						style="cursor:hand;" align="center" bgcolor="" ondblclick="modidata('qgzxZgdzdx.do?method=modiQgzxzx&pkValue=','500','400')">
						<td>
