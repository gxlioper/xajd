...
%>
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		<script type="text/javascript">
			function dataSave(url,elements){
				var eles = elements.split('-');	
				var value = "";
				var xyrs = document.getElementById('sqsyrs').value;
				var xyknsrs = document.getElementById('sqsyknss').value;
				var knsbl = document.getElementById('knsbl').value;
				
				for(var i=0; i<eles.length; i++){
					value = document.getElementById(eles[i]).value;
					if(value == ""){
						alert('请将带\*号的项目填写完整！');
						return false;
					}
		...
		<html:form action="/data_search" method="post">
			...
			<table width="100%" align="center" class="tbstyle">
				...
				<tr style="height:22px">
					<td align="right">
						<font color="red">*</font>审批报酬标准：
					</td>
					<td align="left">
						<html:text name="rs" property="spbcbz" style="width:130px" styleId="spbcbz"></html:text>
						元/小时
					</td>
					<td align="right">
					...
					<td align="left">
						<html:text name="rs" property="sqsyrs" style="width:130px" styleId="sqsyrs"></html:text>人
					</td>
				</tr>
				<tr style="height:22px">
					<td align="right">
						<font color="red">*</font>审批困难生数：
					</td>
					<td align="left">
						<html:text name="rs" property="sqsyknss" style="width:130px" styleId="sqsyknss"></html:text>人
					</td>
					<td align="right">
						审核
					</td>
			...
			<div class="buttontool" align="center">
				<button type="button" class="button2"
					onclick="dataSave('/xgxt/postChkOne.do?act=save','spbcbz-sqsyrs-sqsyknss')"
