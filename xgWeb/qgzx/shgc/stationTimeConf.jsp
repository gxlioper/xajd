...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function chec(){
      for(i=0;i<document.getElementsByName("pk").length;i++){
      	document.getElementsByName("pk")[i].checked=document.getElementsByName("dwdm")[0].checked;
      }
    }
			...
			<input type="hidden" id="doType"  name="doType" value="single"/>
				<div class="title">
					<div class="title_img" id="title_m">
						当前位置：勤工助学 - 参数设置 - 用人单位申请岗位时间设置
					</div>
				</div>
				<table class="tbstyle" width="100%">
				<thead>
					<tr><td width="100%">
					<center><b>用人单位申请岗位时间设置</b></center>
					</td></tr>
				</thead>
				</table>			
				<logic:empty name="rs">
						...
						<table width="100%" id="rsTable" class="tbstyle">
							<thead>
								<tr align="center" style="cursor:hand">
									<td>
										<input type="checkbox" name="dwdm" value="all"
											onclick="chec()">
									</td>
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowMoreClick(this,'',event);" style="cursor:hand" ondblclick="single('qgzxLogic.do?method=showModifyOfStation')">		
									<td>
					...
					<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2"
								onclick="batch('qgzxLogic.do?method=showModifyOfStation')"
								style="width:80px">
								批量设置
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="single('qgzxLogic.do?method=showModifyOfStation')"
								style="width:80px">
								单个设置
							</button>
						</div>
