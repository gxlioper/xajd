					...
					<fieldset>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowMoreClick(this,'',event);" style="cursor:hand" ondblclick="single('qgzxLogic.do?method=showModify')">		
									<td>
					...
					<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2"
								onclick="batch('qgzxLogic.do?method=showModify')"
								style="width:80px">
								批量设置
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
