		...
		<html:form action="/gzdxQgzx.do" method="post">
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">
				<logic:equal value="yes" name="writeAble" scope="request">		
					<button type="button" class="button2" onclick="dataBatch('gzdxQgzx.do?method=jjfzSh&shjg=通过&type=save')"
						style="width:80px">
						通 过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('gzdxQgzx.do?method=jjfzSh&shjg=不通过&type=save')"
						style="width:80px">
						不通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
