...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	<head>
		...
		function getDw(){
			...
			getOtherData.getDwmc(pk,function(data){
				document.getElementById("sqdw").innerText = data[0];
			});
			}		
		}
		function getFzr(){
				...
				if(type == 'add'){
					zzsfQgzx.checkXsgwExists(xh,gwdm,function(data){
						if(data){
							...
							refreshForm('qgzxXcxy.do?method=saveXsgwxx');
						}
					});
				}else{
					refreshForm('qgzxXcxy.do?method=saveXsgwxx');
	...
	<body>
		<html:form action="/qgzxXcxy.do" method="post">
			...
			<input type="hidden" id="url" name="url" value="/qgzxXcxy.do?method=xssqgw" />			
				...
				<table width="100%" id="rsT" class="tbstyle">
					...
					<tr style="height:22px">
						...
						<logic:equal value="modi" name="doType">
							<td align="left">
								...
								<input type="hidden" name="xmdm" id="xmdm" value="<bean:write name='rs' property='xmdm'/>">
								<html:select name="rs" property="xmdm" styleId="xmdm" style="width:150px" disabled="true" onchange="getDw()">
					...
					<input type="hidden" name="sfwh" value="sfwh" />
						...
						<tr>	
							...
							<td align="left">
								<html:text name='rs' property="lxdh" styleId="lxdh" onkeyup="value=value.replace(/[^(\d|\-)]/g,'') " maxlength="20" style="width:100%"/>
							</td>
						</tr>
						<tr>
							<td align="right">
