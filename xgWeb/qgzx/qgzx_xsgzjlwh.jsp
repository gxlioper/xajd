			  ...
			  <div class="buttonbox">
			    <ul>
					...
					<logic:notEqual value="stu" name="userType">
						<li> <a href="#" onclick="showTopWin('qgzxkh.do?method=xsgzjlAddBatch',800,600)" class="btn_zj">批量增加</a> </li>
						<li> <a href="#" onclick="showTopWin('qgzxkh.do?method=xsgzjlAdd',800,600)" class="btn_zj">增 加</a> </li>
						<li> <a href="#" onclick="modi('modi')" class="btn_xg">修改</a> </li>
