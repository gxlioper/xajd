...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function sendZgh(){
				if(window.dialogArguments.document.getElementById('save_xh')){
					window.dialogArguments.document.getElementById('save_xh').value = curr_row.getElementsByTagName('input')[0].value;
					Close();
	...
	<body onload="xyDisabled('xy');">
		<center>
			...
			<html:form action="/qgzx_gwsqwh.do?method=getStuInfo" method="post">
						...
						<tfoot>
			        		<tr>
			            		...
			            		<div class="btn">
			              		...
			              		onclick="document.forms[0].go.value='go';refreshForm('/xgxt/qgzx_gwsqwh.do?method=getStuInfo');this.disabled=true;">
			              		查 询
			              		</button>
