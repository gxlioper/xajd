		...
		<html:form action="/data_search" method="post">
			...
			<table width="100%" align="center" class="tbstyle">
				...
				<tr style="height:22px">
				    ...
				    <td align="left"><div align="right">负责老师：</div></td>
				    <td align="left"><bean:write name="rs" property="fzr" /></td>
				</tr>
				<tr style="height:22px">
				  <td align="right">面试地点：</td>
				...
				<tr style="height:22px">
				  <td height="17" align="right">信用度：</td>
				...
				<tr style="height:22px">
				    ...
				    <td align="left"><div align="right">性别：</div></td>
				...
				<tr>
                  ...
                  <td align="left"><div align="right">外语要求：</div></td>
