...
<body>
	<html:form action="/jygl" method="post">
		...
		<input type="hidden" name="url" id="url" value="/xgxt/jygl.do?method=jygpUpdate">
		<div class="title">
		...
		<table class="tbstyle" width="100%">
			...
			<tr>
				<td align="right">
					<font color="red">*</font>改派单位：
				</td>
				<td>
					<html:select property="gpdw" value="${rs.gpdw }">
						<html:options collection="yrdwList" property="dm" labelProperty="mc"/>
					</html:select>
				</td>
				<td align="right"><font color="red">*</font>单位所在地：</td>
				<td>
					<html:select property="dwszd" value="${rs.dwszd }">
						<html:options collection="dwdzList" property="dm" labelProperty="mc"/>
					</html:select>
				</td>
			</tr>
			<tr>
				<td align="right">
					<font color="red">*</font>改派时间：
				</td>
				<td>
					<html:text property="gpsj" styleId="gpsj" value="${rs.gpsj }" onblur='dateFormatChg(this)' onclick="showCalendar(this.id,'y-mm-dd')"></html:text>
				</td>
				<td align="right">改派人：</td>
				<td>
			...
			<tr>
				...
				<td colspan="3">
					<html:textarea property="gpyy" value="${rs.gpyy }" style="width:85%" rows="5" onblur="checkLen(this,500);"></html:textarea>
				</td>
			</tr>
		...
		<div class="buttontool" id="btn" style="position: absolute;width:100%">
			<logic:notEqual value="view" name="doType">
				<logic:notEqual value="update" name="doType">
					...
					onClick="saveUpdate('/xgxt/jygl.do?method=jygpUpdate&doType=save','xh-gpsj-gpdw-dwszd');">
						保&nbsp;&nbsp;&nbsp;&nbsp;存
					</button>
				</logic:notEqual>
			</logic:notEqual>
			...
			<logic:equal value="update" name="doType">
				<button class="button2" id="buttonSave" 
				onClick="saveUpdate('/xgxt/jygl.do?method=jygpUpdate&doType=modify','xh-gpsj-gpdw-dwszd');">
						保&nbsp;&nbsp;&nbsp;&nbsp;存
				</button>
			</logic:equal>
		</div>
