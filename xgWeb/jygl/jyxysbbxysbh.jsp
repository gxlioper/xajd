...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function savejyxy(){
		document.forms[0].action = "/xgxt/jyxysbbsq.do?act=xxsh&acttype=add&doType=save";
			...
			<logic:empty name="errMsg">
				<table width="100%" id="rsT" class="tbstyle">
					<tr>
						...
						<td colspan="3">
						<html:text property="xysbh" style="width:100%" maxlength="50"></html:text>
						</td>
					</tr>
					<tr>
						<td align="right" nowrap="nowrap">
