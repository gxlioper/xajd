...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script type="text/javascript">
		function modi(){
			...
			var url = "bdzbl.do?method=bdzblsqModi&pkValue=";
		...
		function batch(){
			var url = "bdzbl.do?method=delBdzblsq";
			var RowsStr="!!";	
			var mes = "确定要操作所选记录？";
		...
		function dataExport(){
			var url = "bdzbl.do?method=exportBdzblsq";
			var filedArr = ["xh","xm","sjhm","nd","bdzlx","nj","bdzkwdwmc","fdysh","xysh"];
			url += "&xydm=" + val('xy');
			url += "&zydm=" + val('zy');
			url += "&bjdm=" + val('bj');
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('bdzbl.do?method=bdzblsqSearch');">
											查询
										</button>
									</td>
								</tr>
						...
						<div class="buttontool" id="btn"
							...
							<logic:equal value="yes" name="writeAble" scope="request">			
								<button class="button2"
									onclick="showTopWin('bdzbl.do?method=bdzblsq')"
									style="width:80px">
									增加
								</button>	
								&nbsp;&nbsp;		
