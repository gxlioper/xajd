...
function imp(url){
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/ahgc_jyglBysxxSb.do" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：就业管理 - 学生信息 - 学生信息批量上报
				</div>
			</div>
					...
					<thead>
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/ahgc_jyglBysxxSb.do?go=go')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left" nowrap>
								...
								<html:select name="rs1" property="xydm" onchange="initZyList();initBjList()" style="width:160px" styleId="xy">
									<html:option value=""></html:option>
									<html:options collection="xyList" property="xydm"
										labelProperty="xymc" />
								</html:select>
								专业：
								<html:select name="rs1" property="zydm" onchange="initBjList()" style="width:170px" styleId="zy">
									<html:option value=""></html:option>
			...
			<div id="result">
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								<thead>
									<tr align="center" style="cursor:hand">
										...
										<logic:iterate id="tit" name="topTr" offset="1" length="6" scope="request">
											<td id="${tit.en}"
	                ...
	                <div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
						<button class="button2" onclick="imp('/xgxt/ahgc_jyglBysxxSb.do?go=imp');"
							style="width:80px">
							上  报
						</button>
					</div>
