			...
			<div class="toolbox">
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" onclick="refreshForm('/xgxt/jygl_xysbb.do');"
									class="btn_zj"> 增加 </a>
							</li>
							<li>
								<a href="#"
									onclick="showInfo('/xgxt/jygl.do?method=xysbbsq','update','900','600');"
									class="btn_xg"> 修改 </a>
							</li>
							<li>
								<a href="#"
									onclick="deletedata('/xgxt/jygl.do?method=xysbbjg&doType=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
							...
							<li>
								<a href="#"
									onclick="expData('/xgxt/jygl.do?method=xysbbjg&doType=expData')"
									class="btn_dc"> 导出 </a>
							</li>
						</ul>
					</div>
					...
					<table width="100%" border="0">
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=xysbbjg&doType=query')">
											查 询
										</button>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<html:text property="queryequals_xysbh" maxlength="20"
										style="width:80px"></html:text>
								</td>
								<th>
									新协议书编号
								...
								<td>
									<html:text property="queryequals_xxysbh" maxlength="20"
										style="width:80px"></html:text>
								</td>
								<th>
									<bean:message key="lable.xsgzyxpzxy" />
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="showInfo('/xgxt/jygl.do?method=xysbbsq','view','900','600')"
