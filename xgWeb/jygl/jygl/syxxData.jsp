	...
	<head>
		...
		<script type="text/javascript">
			function sendData() {
				...
				window.dialogArguments.document.forms[0].action = '/xgxt/jygl.do?method=syxxData&xh='+xh+'&url='+url;
			...
			<div class="toolbox">
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=syxxData&doType=query')">
											查 询
										</button>
				...
				<div class="formbox">
					<h3 class="datetitle_01">
						<span> 查询结果&nbsp;&nbsp;
							<font color="blue">提示：双击选择一个学生</font>
						</span>
					</h3>
						...
						<thead>
							<tr align="center" style="cursor:hand">
								<logic:iterate id="tit" name="topTr" offset="0" scope="request">
									<td id="${tit}" onclick="tableSort(this)" nowrap>
										${tit}
									</td>
								</logic:iterate>
							</tr>
