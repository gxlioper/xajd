...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function dataSave(){
		 var url = "/xgxt/nbtybysy.do?method=nbtybysyUpdate&act=update";
		 var yzdz = "";
		 var yzcd = "";
		 var mustFill = "xh-xm";// 2010.11.30 by lr 页面显示的只有学号和姓名为必填项 "xh-zqsj-yzyh-yzzh-sfzh";
...
<%--							<html:text name="rs" property="xn" readonly="true" styleId="xn"></html:text>--%>
					...
					<tr style="height:22px">
						...
						<td align="left">
							<html:text name="rs" name="rs" property="lxdz" maxlength="150" styleId="lxdz"></html:text>
						</td>
					</tr>
					<tr style="height:22px">
						<td align="right">
					...
					<tr style="height:22px">
						...
						<td align="left">
						<html:text name="rs" property="sjhm" maxlength="15"></html:text>
						</td>
						<td align="right">
							email邮箱：
						</td>
					...
					<tr style="height:22px">
						...
						<td>
							<html:text name="rs" property="rxnf" maxlength="30"></html:text>
						</td>
					</tr>
					<tr style="height:22px">
						<td align="right">
