							...
							<div class="tabcon">
								<div class="type_search">
									...
									<div class="hdm">
										...
										<p>
											<html:text property="querylike_zpzt" maxlength="25"
												value="请输入招聘会主题"
												onfocus="if(value==defaultValue){value='';this.style.color='#000'}"
												onblur="if(!value){value=defaultValue;this.style.color='#999'}"
												style="color:#999999" />
											<button
												onclick="if(document.getElementById('querylike_zpzt').value==document.getElementById('querylike_zpzt').defaultValue){document.getElementById('querylike_zpzt').value=''} 
												allNotEmpThenGo('/xgxt/jyweb.do?method=ztzpMore&doType=query')"
												id="search_go"></button>
										</p>
									</div>
								</div>
									...
									<tbody>
										<logic:present name="rs">
											<logic:notEmpty name="rs">
												...
												%>
												<tr>
													<logic:iterate id="t" name="topTr" offset="1"
														scope="request">
														<td>
															&nbsp;
														</td>
