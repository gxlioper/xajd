	...
	<body onload="loadchange()">
		<html:form action="/bysjbxxb_input.do" method="post">
			...
			<logic:notEmpty name="rs">
				...
				<table class="tbstyle" id="rsTable" width="100%" style="cursor:hand">
					...
					<tr align="center" style="cursor:hand">
						...
						<td align="left">
							<html:text name='rs' property="bjdm" 
								readonly="true" />
						</td>
						<td width="20%" align="right">
							<font color="red">*</font>
				...
				<tr align="center" style="cursor:hand">
					...
					<tr align="center" style="cursor:hand">
						...
						<td align="left">
							<html:text name="rs" property="lxdzxx" />
						</td>
						<td width="20%" align="right">
							QQ：
						</td>
					...
					<tr align="center" style="cursor:hand">
						...
						<td align="left">
							<html:text name="rs" property="xysbh" />
						</td>
					</tr>
					...
					<tr align="center" style="cursor:hand">
						...
						<td colspan="2">
								<html:textarea name='rs' property='memo' style="width:99%" rows='5' />
							</td>
					</tr>
				</table>
			...
			<logic:notEmpty name="inserted">
				...
				<logic:equal name="inserted" value="isexist">
					<script>
                      alert("该学号学生已存在！");
                    </script>
				</logic:equal>
