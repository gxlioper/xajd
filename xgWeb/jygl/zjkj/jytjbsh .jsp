				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#"
									onclick="showInfo('/xgxt/jygl.do?method=jytjbdj','sh','1200','700')"
									class="btn_sh"> 单个审核</a>
							</li>
							<li>
								<a href="#"
									onclick="shformdata('/xgxt/jygl.do?method=jytjbsh&shjg=通过&doType=sh');"
									class="btn_shtg"> 批量通过</a>
							</li>
							<li>
								<a href="#"
									onclick="shformdata('/xgxt/jygl.do?method=jytjbsh&shjg=不通过&doType=sh');"
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=jytjbsh&doType=query')">
											查 询
										</button>
