	...
	<head>
		...
		<script type="text/javascript">
			function printFcl(){
				...
				var url = "/xgxt/jygl.do?method=printFcl&pkValue="+pkValue;
				window.open(url);
			}
		</script>
	</head>
			...
			<div class="toolbox">
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" onclick="refreshForm('/xgxt/jygl_fclr.do')"
									class="btn_zj"> 增加 </a>
							</li>
							<li>
								<a href="#"
									onclick="showInfo('/xgxt/jygl.do?method=fclr','update','800','600')"
									class="btn_xg"> 修改 </a>
							</li>
							<li>
								<a href="#"
									onclick="deletedata('/xgxt/jygl.do?method=fccx&doType=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
							...
							<li>
								<a href="#"
									onclick="expData('/xgxt/jygl.do?method=fccx&doType=expData')"
									class="btn_dc"> 导出 </a>
							</li>
							<li>
								<a href="#" onclick="printFcl();" class="btn_dy"> 打印报表 </a>
							</li>
						</ul>
					</div>
				</logic:equal>
					...
					<table width="100%" border="0">
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=fccx&doType=query')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<html:select property="queryequals_fclx">
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="showInfo('/xgxt/jygl.do?method=fclr','view','800','600')"
