	...
	<head>
		...
		<script type="text/javascript">
			function printTjb(){
				...
				var url = "/xgxt/jygl.do?method=pritnJytjb&pkValue="+pkValue;
				window.open(url);
			}
		</script>
	</head>
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#"
									onclick="refreshForm('/xgxt/jygl_jytjbdj.do')"
									class="btn_zj"> 增加 </a>
							</li>
							<li>
								<a href="#"
									onclick="showInfo('/xgxt/jygl.do?method=jytjbdj','update','1200','700')"
									class="btn_xg"> 修改 </a>
							</li>
							<li>
								<a href="#"
									onclick="deletedata('/xgxt/jygl.do?method=jytjbjg&doType=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
							...
							<li>
								<a href="#"
									onclick="expData('/xgxt/jygl.do?method=jytjbjg&doType=expData')"
									class="btn_dc"> 导出 </a>
							</li>
							<li>
								<a href="#"
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=jytjbjg&doType=query')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tbody>
							<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="showInfo('/xgxt/jygl.do?method=jytjbdj','view','1200','700')"
