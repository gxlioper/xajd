			...
			<div class="toolbox">
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" onclick="showTopWin('/xgxt/jygl_qyxxsb.do','800','600')"
									class="btn_zj"> 增加 </a>
							</li>
							<li>
								<a href="#"
									onclick="update('/xgxt/jygl.do?method=qyxxsb','800','600')"
									class="btn_xg"> 修改 </a>
							</li>
							<li>
								<a href="#"
									onclick="deletedata('/xgxt/jygl.do?method=qyxxcx&doType=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
							...
							<li>
								<a href="#"
									onclick="expData('/xgxt/jygl.do?method=qyxxcx&doType=expData')"
									class="btn_dc"> 导出 </a>
							</li>
						</ul>
					</div>
					...
					<table width="100%" border="0">
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=qyxxcx&doType=query')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tbody>
							<tr>
								...
								<th>单位名称</th>
								<td>
									<html:text property="querylike_dwmc" style="width:160px"></html:text>
								</td>
								<th>需求专业</th>
								<td>
									<html:text property="querylike_xqzy" style="width:160px"></html:text>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="showInfo('/xgxt/jygl.do?method=qyxxsb','view','800','600')"
