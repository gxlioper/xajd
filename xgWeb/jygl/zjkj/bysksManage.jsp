				...
				<div class="toolbox">
					<div class="buttonbox">
						...
						<logic:equal value="cx" name="doType">
							<li><a href="#" class="btn_zj" onclick="location='jygl_kykgsq.do'">增加</a></li>
							<li><a href="#" class="btn_xg" onclick="isSh();">修改</a></li>
							<li><a href="#" class="btn_sc" onclick="dataBatch('jygl.do?method=bysksdel&go=go')">删除</a></li>
							<li><a href="#" class="btn_dr" onclick="impAndChkData()">导入</a></li>
							<li><a href="#" class="btn_dc" onclick="expData('jygl.do?method=bysksexp&go=go')">导出</a></li>
						</logic:equal>

						<logic:equal value="sh" name="doType">
							<li><a href="#" class="btn_sh" onclick="modi('jygl.do?method=bysksmodi&doType=shone');">单个审核</a></li>
							<li><a href="#" class="btn_shtg" onclick="batchData('primarykey_cbv','jygl.do?method=byskssh&shjg=tg&go=go','sh')">审核通过</a></li>
							<li><a href="#" class="btn_shbtg" onclick="batchData('primarykey_cbv','jygl.do?method=byskssh&shjg=btg&go=go','sh')">审核不通过</a></li>
						</logic:equal>
						</ul>
					</div>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td><html:select property="queryequals_mk">
								...
								<html:option value="ky">报考研究生</html:option>
								<html:option value="kg">报考公务员</html:option>
							</html:select></td>
							<th>审核</th>
							<td>
