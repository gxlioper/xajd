			...
			<div class="toolbox">
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" onclick="showTopWin('/xgxt/jygl_jyzdjzsb.do','700','500')"
									class="btn_zj"> 增加 </a>
							</li>
							<li>
								<a href="#"
									onclick="update('/xgxt/jygl.do?method=jyzdjzsb','700','500')"
									class="btn_xg"> 修改 </a>
							</li>
							<li>
								<a href="#"
									onclick="deletedata('/xgxt/jygl.do?method=jyzdjzcx&doType=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
							...
							<li>
								<a href="#"
									onclick="expData('/xgxt/jygl.do?method=jyzdjzcx&doType=expData')"
									class="btn_dc"> 导出 </a>
							</li>
						</ul>
					</div>
								...
								<td colspan="6">
									<div class="btn">
										<button class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/jygl.do?method=jyzdjzcx&doType=query')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="showInfo('/xgxt/jygl.do?method=jyzdjzsb','view','800','600')"
