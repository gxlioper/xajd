...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	refreshForm('xmlg_bysdalx.do?method=xmlgsh&doType=add&act=add');
	}
</script>
	<%
			...
			<fieldset>
				<table class="tbstyle" border=1 cellspacing=0 cellpadding=0
					...
					<tr>
						...
						<html:text name="rs1" property="sysheng" readonly="true"></html:text>
				 </span>
							</p>
						</td>
						...
						<td width=116 class="Normal">
							<html:text name="rs1" property="yzbm" maxlength="10" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						...
						<td width=445 colspan=8 class="Normal">
								<html:text name="rs1" property="jtdz" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						...
						<td width=386 colspan=6 class="Normal">
							<html:text name="rs1" property="lxfs" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						...
						<td width=445 colspan=8 class="Normal">
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><html:checkbox name="rs1" property="sqly1" value="1" disabled="true"></html:checkbox><span
									lang=EN-US>&nbsp; </span>单位不能接收档案</span>
							</p>
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><html:checkbox name="rs1" property="sqly2" value="1" disabled="true"></html:checkbox><span
									lang=EN-US>&nbsp; </span>暂不就业</span>
							</p>
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><html:checkbox name="rs1" property="sqly3" value="1" disabled="true"></html:checkbox><span
									lang=EN-US>&nbsp; </span>正在办理出国手续</span>
							</p>
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><html:checkbox name="rs1" property="sqly4" value="1" disabled="true"></html:checkbox><span
									lang=EN-US>&nbsp; </span>欲留在厦门找工作</span><span style='font-family: 宋体'>（针对非厦门生源）</span>
							</p>
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><html:checkbox name="rs1" property="sqly5" value="1" disabled="true"></html:checkbox><span
									lang=EN-US>&nbsp; </span>可能升入其他院校</span><span style='font-family: 宋体'>（专升本或考研）</span>
							</p>
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><html:checkbox name="rs1" property="sqly" value="1" disabled="true"></html:checkbox><span
									lang=EN-US>&nbsp; </span>其他情况请注明<span lang=EN-US>
									<html:text name="rs1" property="sqly6" maxlength="40" style="width: 280px" readonly="true"></html:text>
									</span>
								</span>
							</p>
						</td>
					...
					<tr>
						...
						<td width=445 colspan=8 class="Normal">
							<html:text name="rs1" property="lxqx" style="width: 100%" maxlength="45"  readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<td width=152 colspan=3 class="Normal">
						...
						<td width=445 colspan=8 class="Normal">
							<html:text name="rs1" property="brqm" style="width: 100%" maxlength="45"  readonly="true"></html:text>
						</td>
					</tr>
					...
					<tr>
						<td width=152 colspan=3 class="Normal">
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'><bean:message key="lable.xsgzyxpzxy" />审核:</span>
							</p>
					...
					<tr>
						...
						<td width=445 colspan=8 class="Normal">
							<html:text name="rs1" property="xysh" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<td width=152 colspan=3 class="Normal">
					...
					<tr>
						<td width=152 colspan=3 class="Normal">
							<p style='line-height: 16.0pt;'>
								<span style='font-size: 12.0pt; font-family: 宋体'>学校审核:</span>
							</p>
							<p style='line-height: 16.0pt;'></p>
						</td>
						<td width=445 colspan=8 class="Normal">
