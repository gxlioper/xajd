...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置:</em><a>就业管理 - 下载管理 - 学生文件下载</a>
			</p>
		</div>
		...
		<html:form action="jyglteafiledown.do" method="post"
			...
			<div class="formbox">
				<h3 class="datetitle_01">
						<span> 查询结果&nbsp;&nbsp; <logic:empty name="fjList2">
							...
							<logic:present name="fjList2">
								<logic:iterate id="s" name="fjList2">
									<tr>
										...
										<td align="center">
											<a
												href="jyglstufiledown.do?dir=<bean:write name="s" property="wjpath"/>&act=down&filename=<bean:write name="s" property="wjname"/>">下载</a>
										</td>
									</tr>
								</logic:iterate>
							</logic:present>
