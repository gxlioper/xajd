			...
			<logic:notEmpty name="rs">
				...
				<table width="100%" id="rsT" class="tbstyle">
					...
					<tr style="height:22px">
						...
						<td align="left">
							<html:text name="rs" property="dayjdz" style="width:210px"
								maxlength="40" />
						</td>
						<td align="right">
							档案机要单号：
						...
						<td align="left">
							<html:text name="rs" property="dajydh" style="width:210px"
								maxlength="20" />
						</td>
					</tr>
					<tr style="height:22px">
						...
						<td align="left">
							<html:text name="rs" property="ydjycrq" style="width:210px"
								maxlength="11" />
						</td>
						<td align="right">
							报到证号：
						...
						<td align="left">
							<html:text name="rs" property="bdzh" style="width:210px"
								maxlength="20" />
						</td>
					</tr>
					<tr style="height:22px">
						...
						<td align="left">
							<html:text name="rs" property="xysbh" style="width:210px"
								maxlength="11" />
						</td>
						<td align="right">	
						</td>
				...
				<div class="buttontool" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2" type="reset" onclick="returntobegin()" style="width:80px">
						重 置
					</button>
				</div>
			</logic:notEmpty>
