...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function add(){
		...
		var zxjshf = document.getElementById("zxjshf").value;
		if(zxjshf.length>600){
			alert("咨询教师回复不能超过600个汉字");
			return false;
		}
		
		 var pk = document.getElementById("rid").value;
		 document.forms[0].action = "/xgxt/jyglxszxcx.do?act=answer&rid="+pk;
	...
	<body>
		...
		<logic:notEmpty name="answer">
			...
			<logic:notEmpty name="notea">
			<logic:equal name="notea" value="notea">
				<script>
                      alert("你不是咨询教师，不能回复！");
                      window.Close();
                    </script>
		...
		<logic:notEmpty name="ishf">
			<logic:equal name="ishf" value="ishf">
				<script>
                      alert("已经有咨询教师回复，不能再次回复！");
                    </script>
			</logic:equal>
		</logic:notEmpty>
	</body>
