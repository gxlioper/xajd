...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
			...
			var url = "zjgyzyXxhz_ajax.do?method=wjcfManage";
			var ie = 'ie';
		...
		function printWjcf(){
	  		...
	  		var url = "zjgyzyXxhz.do?method=printWjcfExcel";
		...
		<html:form action="/zjgyzyXxhz" method="post">
			...
			<div class="toolbox" id="dgncz">
				...
				<div class="buttonbox">
					<ul>
						<li>
							<a href="#" onclick="printWjcf();return false;"
								class="btn_tj">违纪情况一览</a>
						</li>
					</ul>
				</div>
				...
				<div class="searchtab">
					<table width="100%" border="0">
						...
						<tr>
							...
							<td>
								<html:select property="xn" styleId="xn" value="${currXn}" style="width:150px">
							...
							<td>
								<html:select property="xq" styleId="xq" value="${currXq}" style="width:150px">
