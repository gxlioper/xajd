...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function sendInfo(){
				if(window.dialogArguments.document.getElementById('xymc')){
					window.dialogArguments.document.getElementById('xymc').value = curr_row.getElementsByTagName('input')[1].value;
					window.dialogArguments.document.getElementById('xydm').value = curr_row.getElementsByTagName('input')[0].value;

					window.dialogArguments.document.getElementById('zymc').value = "";
					window.dialogArguments.document.getElementById('zydm').value = "";
...
<%--			}--%>
	...
	<body>
		<center>
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a><bean:message key="lable.xb" />选择</a>
				</p>
			</div>
...
<%--								</td>--%>
								...
								<td>
									<html:text property="xydm" styleId="xydm"></html:text>
								</td>
						...
						<tfoot>
			        		<tr>
			            		...
			            		<div class="btn">
			              		...
			              		onclick="document.forms[0].go.value='go';refreshForm('/xgxt/commXgInfo.do?method=choiceXy');this.disabled=true;">
			              			查询
			              		</button>
