...
<logic:equal value="11626" name="xxdm">
	<tr>
		...
		<td>
			<html:text property="rxqdw" name="rs" styleId="rxqdw" maxlength="127" disabled="true"/>
		</td>
		<th>原毕业<bean:message key="lable.xb" />邮编</th>
		<td>
			<html:text property="rxqdwyb" name="rs" styleId="rxqdwyb" maxlength="6" onkeyup="value=value.replace(/[^\d]/g,'') " disabled="true"/>
		</td>		
	</tr>
	<tr>
		<th>原毕业<bean:message key="lable.xb" />通信地址</th>
		<td colspan="3">
			<html:text property="rxqdwdz" name="rs" styleId="rxqdwdz" maxlength="100" style="width:600px" disabled="true"/>
		</td>
	</tr>
	<tr>
		<th>宿舍编号</th>
		<td>
			<html:text property="ssbh" name="rs" styleId="ssbh" maxlength="10" disabled="true"/>
		</td>
		<th>宿舍电话</th>
		<td>
			<html:text property="qsdh" name="rs" styleId="qsdh" maxlength="20" onkeyup="value=value.replace(/[^\d|-]/g,'') " disabled="true"/>
		</td>		
	</tr>
	<tr>
		<th>高中阶段表现情况</th>
		<td colspan="3">
			<html:textarea property="gzbx" name="rs" styleId="gzbx" cols="60" rows="4" onblur="chLeng(this,500)" disabled="true"></html:textarea>
		</td>
	</tr>
	<tr>
		<td colspan="4">
