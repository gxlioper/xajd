...
<body>
	<html:form action="/xsbd" method="post">
		...
		<table class="formlist" width="100%">
			<thead>
		    	<tr>
		        	<th colspan="2"><span>未报到原因填写</span></th>
		        </tr>
		    </thead>
			<tbody>
			<tr>
				<th>
					<span class="red">*</span>未报到原因
					<br/>
			...
			<tfoot>
		      <tr>
		        <td colspan="2"><div class="bz">"<span class="red">*</span>"为必填项</div>
		          <div class="btn">
					<button type="button" class="button2" id="buttonSave" onclick="saveUpdate('xsbd.do?method=wbdyydetail&doType=save&zt=未报到','wbdyy-wbdyy');">
						保&nbsp;&nbsp;存
					</button>
