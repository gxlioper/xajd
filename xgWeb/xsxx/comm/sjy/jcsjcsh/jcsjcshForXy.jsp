					...
					<table width="100%" border="0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<html:text property="bmdm" styleId="bmdm" style="width: 150px"
								...
								<td>
									<html:text property="bmmc" styleId="bmmc" style="width: 150px"
										onkeypress="if(pressEnter(event)){searchRs();return false;}" maxlength="20"/>
								</td>
								<th>
									部门类别
								...
								<td>
									<html:select property="bmlb" styleId="bmlb" style="width: 150px">
										<html:option value=""></html:option>
										<html:option value="1">校级</html:option>
										<html:option value="5">院级</html:option>
									</html:select>
								</td>
							</tr>
							<!-- 第二行 -->
							<tr>
								...
								<td>
									<html:text property="bmfdm" styleId="bmfdm" style="width: 150px"
										onkeypress="if(pressEnter(event)){searchRs();return false;}" maxlength="20"/>
								</td>
								<th>
									上级部门名称
								...
								<td>
									<html:text property="fbmmc" styleId="fbmmc" style="width: 150px"
										onkeypress="if(pressEnter(event)){searchRs();return false;}" maxlength="20"/>
								</td>
								<th>
