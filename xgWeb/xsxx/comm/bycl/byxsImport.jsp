...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form action="/bycl" method="post" styleId="byclForm">
				...
				<table width="100%" border="0" class="formlist">
					<tbody>
						<tr>
							...
							<td colspan="3">
								<a href="javascript:void(0);" onclick="mbDownload();" class="name"  style="margin-left:3px;font-weigth:bold;font-size:14px">下载</a>
							</td>
						</tr>
						<tr>
							<th width="30%">
						...
						<tr>
							<th>导入说明</th>
							<td colspan="3">
								<span class="red" style="font-weight:bold">请使用本页面提供的下载模板进行导入！</span>
							</td>
						</tr>
