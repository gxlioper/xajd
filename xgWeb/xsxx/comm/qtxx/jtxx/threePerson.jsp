...
<table border="0" class="formlist" align="center" style="width: 100%">
	<thead>
		<tr onclick="showHiddenNr('tb_jtcy2')" style="cursor: hand">
			<th colspan="4">
				<span>家庭成员2</span>				
			</th>
		</tr>
	...
	<tbody id="tb_jtcy2">
		...
		<tr>
			<th width="16%">工作单位电话</th>
			<td>
				<p id="p_jtcy2_lxdh1"></p>
			</td>
			<th width="16%">个人电话</th>
			<td>
				<p id="p_jtcy2_lxdh2"></p>
			</td>
		</tr>
		<tr>
			<th width="16%">工作地址</th>
...
<table border="0" class="formlist" align="center" style="width: 100%">
	<thead>
		<tr onclick="showHiddenNr('tb_jtcy3')" style="cursor: hand">
			<th colspan="4">
				<span>家庭成员3</span>				
			</th>
		</tr>
	...
	<tbody id="tb_jtcy3">
		...
		<tr>
			<th width="16%">工作单位电话</th>
			<td>
				<p id="p_jtcy3_lxdh1"></p>
			</td>
			<th width="16%">个人电话</th>
			<td>
				<p id="p_jtcy3_lxdh2"></p>
			</td>
		</tr>
		<tr>
			<th width="16%">工作地址</th>
