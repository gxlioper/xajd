...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	
			if(!check("shlcid")){
		     ...
		     var url = "xjyd.do?method=xjydlbShpzUpd&type=update";
			...
			jQuery(function() {
				var checked=jQuery("[name=sfksq]")[1].checked;
				if(checked){
					jQuery("#sqsj").hide();
				}
	...
	<body>
		<html:form action="/xjyd" method="post" styleId="xjydForm" onsubmit="return false;">
			<html:hidden property="xjlbdm"  styleId="xjlbdm"/>
			<div class="tab">
				<table class="formlist">
					...
					<tbody>
						...
						<tr id="sqsj">
							...
							<td colspan="3">
								<html:text property="sqkssj" style="width:80px" styleId="sqkssj" onfocus="return showCalendar(this.id,'yyyy-MM-dd',true,'sqjssj',190,20);" />
								~
								<html:text property="sqjssj" style="width:80px" styleId="sqjssj" onfocus="return showCalendar(this.id,'yyyy-MM-dd',false,'sqkssj',270,20);" />
							</td>
						</tr>
					</tbody>
				</table>
