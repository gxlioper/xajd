...
<thead>
	<tr>
		<th colspan="6" onclick="document.getElementById('hi_jtxx').style.display=(document.getElementById('hi_jtxx').style.display==''?'none':'')"><span>学生家庭信息</span>
		</th></tr>
</thead>
<tbody id="hi_jtxx">
	<tr>
...
<tbody id="jt2" style="display:none">
	<tr>
		<th>姓名</th>
		<td colspan="2">
...
<tbody id="jt3" style="display:none">
	<tr>
		<th>姓名</th>
		<td colspan="2">
