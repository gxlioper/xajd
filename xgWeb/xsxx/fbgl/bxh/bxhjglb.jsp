	...
	<head>
	 ...
	 var gridSetting2 = {
				...
				colList:[
				   ...
				   {label:'专业',name:'zymc1', index: 'zymc1'},
		...
		<html:form action="/fbglbxh.do?method=list&type=query">
			...
			<div class="toolbox">
				...
				<div class="comp_title" id="comp_title">
				      <ul style="width:90%">
				        <li ><a href="javascript:void(0);" onclick="selectTab(this,'wbxh');"><span>编学号</span></a></li>
				        <li class="ha"><a href="javascript:void(0);" onclick="selectTab(this,'ybxh');"><span>学号生成结果</span></a></li>
				        <span id="tsxx" style="text-align: right;color: red;margin-left: 360px;font-size: 12px;">编学号规则未设定或未启用！</span>
				      </ul>
				</div>
			</div>
		</html:form>
