	...
	<body>
		...
		<html:form action="/fbglbbgl.do?method=list&type=query" styleId="myform">
			...
			<div class="comp_title" id="comp_title">
			      <ul style="width:90%">
			        <li ><a href="javascript:void(0);" onclick="selectTab(this,'wfb');"><span>自动分班</span></a></li>
			        <li class="ha"><a href="javascript:void(0);" onclick="selectTab(this,'yfb');"><span>分班结果</span></a></li>
