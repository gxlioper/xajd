			  ...
			  <div class="buttonbox">
			    <ul>
					...
					<logic:equal value="yes" name="writeAble">
						<li> <a href="#" onclick="showInfo('/xgxt/bdzcgl.do?method=hzcOne','sh','800','600');" class="btn_sh">单个审核</a> </li>
						<li> <a href="#" onclick="shformdata('/xgxt/bdzcgl.do?method=hzcsh&shjg=通过&doType=sh');" class="btn_shtg">审核通过</a> </li>
						<li> <a href="#" onclick="shformdata('/xgxt/bdzcgl.do?method=hzcsh&shjg=不通过&doType=sh');" class="btn_shbtg">审核不通过</a> </li>
					</logic:equal>
					<!--end读写权-->
			    </ul>
			  </div>			 
