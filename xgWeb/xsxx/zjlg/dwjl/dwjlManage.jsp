...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function delDwjl(){
		...
		if(flag){
			if (confirm("确定要删除所勾选的数据?")) {
				showTips('处理数据中，请等待......');
				var url = "/xgxt/zjlgXsxxDwjl.do?method=dwjlManage&doType=del";
				refreshForm(url);
			}
		}else{
			alert("请勾选要处理的数据");
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/zjlgXsxxDwjl" method="post">
			...
			<logic:empty name="msg">
				<logic:equal value="yes" name="writeAble">
					...
					<div class="buttonbox">	
						<ul>
							<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/zjlgXsxxDwjl.do?method=dwjlUpdate&doType=add',800,600);">增加</a></li>
							<li><a href="#" class="btn_xg" onclick="if(curr_row == null){alert('请选择要修改的数据！');return false;}showTopWin('/xgxt/zjlgXsxxDwjl.do?method=dwjlUpdate&doType=update&pk='+curr_row.getElementsByTagName('input')[0].value,800,600);">修改</a></li>
...
<!--					<div style="float:right;width:630px;">-->
					<div class="searchtab">		
						<table width="110%" class="" border="0">
							<tbody>
								<tr>
									<th>年级</th>
									...
									<th>姓名</th>
									<td><html:text property="xm" style="width:100px" maxlength="20"></html:text></td>
									<!--  <th>交流项目</th>
									<td><html:select property="jlxm" style="width:100px">
											<html:option value=""></html:option>
								...
								<tr>
									...
									<th>班级</th>
									<td colspan="2"><html:select property="bjdm" style="width:100px" styleId="bj">
											<html:option value=""></html:option>
							...
							<tfoot>
								<tr>
									...
									<button type="button" id="search_go" onclick="allNotEmpThenGo('/xgxt/zjlgXsxxDwjl.do?method=dwjlManage');">
										查询
									</button>
...
<!--											<input type="checkbox" />-->
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);"
										ondblclick="showTopWin('/xgxt/zjlgXsxxDwjl.do?method=dwjlUpdate&doType=view&pk='+curr_row.getElementsByTagName('input')[0].value,800,600);"
										style="cursor:hand">
										<td align="center">
...
<!--<script>-->
<!--	url = "/xgxt/zjlgXsxxDwjl.do?method=dwjlManage";-->
<!--</script>-->
	</body>
</html>
