...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save(){
			...
			refreshForm("/xgxt/guizdxDagl.do?method=byzdwhManage&doType=save");
		...
		function changeByOne(pk){
			...
			showTopWin("/xgxt/guizdxDagl.do?method=byzdwhUpdate&doType=add&xh="+pk,600,450);
		}
			
		// -------显示------------
		function showView(pk){

			showTopWin("/xgxt/guizdxDagl.do?method=byzdwhUpdate&doType=view&xh="+pk,600,450);
		}
		</script>
	</head>
	<body>
		...
		<html:form action="/guizdxDagl" method="post">
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						<li>
							<a href="#" onclick="changeXsdaInfo()" class="btn_zj">毕业转档管理</a>
						</li>
					</ul>
				</div>
				<div class="searchtab">
								...
								<td colspan="6">
									<div class="btn">
										<button type="button" class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/guizdx_dagl_byzd.do')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tbody>
							<logic:notEmpty name="rsArrList">
								<logic:iterate name="rsArrList" id="s">
									<tr onclick="rowMoreClick(this,'',event);" ondblclick="showView('<logic:iterate id="v" name="s" offset="0" length="1">${v}</logic:iterate>')"
										style="cursor:hand">
										<td width="15px">
