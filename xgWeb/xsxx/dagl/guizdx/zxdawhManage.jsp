...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function showView(pk){
			...
			showTopWin("/xgxt/guizdxDagl.do?method=zxdawhUpdate&doType=view&xh="+pk,600,450);
		}
		...
		<html:form action="/guizdxDagl" method="post">
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						<li>
							<a href="#" onclick="changeXsdaInfo()" class="btn_zj"> 在校档案管理 </a>
						</li>
					</ul>
				</div>
				<div class="searchtab">
								...
								<td colspan="6">
									<div class="btn">
										<button type="button" class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/guizdx_dagl_zxda.do')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
