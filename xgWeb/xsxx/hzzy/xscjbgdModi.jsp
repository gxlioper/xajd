			...
			<div class="title">
				...
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<td>
							<html:text name="rs" property="bingjia" maxlength="4" onkeyup="value=value.replace(/[^\d|.]/g,'')" ></html:text>次
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<html:text name="rs" property="shijia" maxlength="4" onkeyup="value=value.replace(/[^\d|.]/g,'')" ></html:text>次
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<html:text name="rs" property="chidao" maxlength="4" onkeyup="value=value.replace(/[^\d|.]/g,'')" ></html:text>次
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<html:text name="rs" property="kuangke" maxlength="4" onkeyup="value=value.replace(/[^\d|.]/g,'')" ></html:text>次
						</td>
						<td align="right">
							其它：
						</td>
