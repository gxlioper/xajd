...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsxx/cxdd/sh/js/cxddsh.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"班级列表",
				pager:"pager",
				url:"cxdd_pysh.do?method=getPyshList&type=query",
				colList:[
					{
					label : 'key',
					name : 'bjid',
