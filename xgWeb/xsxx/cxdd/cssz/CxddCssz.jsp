...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){
			  var checkradio = jQuery("input[name='sqkg']:checked").val();
			  if(checkradio == '1'){
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "cxdd_cssz.do?method=save" : "cxdd_cssz.do?method=update";
	...
	<body>
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				操行等第评语上报需要开启申请开关以及申请的起止时间，申请操作需在相应的起止时间内完成，操行等第<br/>
		...
		<html:form action="/cxdd_cssz" method="post" styleId="CsszForm">
