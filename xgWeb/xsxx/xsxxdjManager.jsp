						...
						<tr>
							...
							<td width="10" align="center" valign="middle" rowspan="3">
								...
								<button type="button" class="button2" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/xsxxdj.do?method=xsxxdj')">
									查 询
								</button>
							</td>
						</tr>
					...
					<table width="99%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('xsxxdj.do?method=xsxxdjModi&type=view')" style="cursor:hand">
								<td>
					...
					<TR>
						<TD>
							<jsp:include flush="true"
								page="/sjcz/turnpage.jsp?form=xsxxdjForm"></jsp:include>
						</TD>
					</TR>
					<TR>
						<TD height=3></TD>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">
				<logic:equal value="yes" name="writeAble" scope="request">		
					<button type="button" class="button2"
						onclick="showTopWin('xsxxdj.do?method=xsxxdjAdd',800,600)"
						style="width:80px">
						增 加
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="modi('xsxxdj.do?method=xsxxdjModi&type=modi')" style="width:80px">
						修 改
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('xsxxdj.do?method=xsxxdj&type=del')"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" onclick="wjcfDataExport('xsxxdj.do?method=xsxxdjExp',600,400)" style="width:80px">
					导出数据
				</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" onclick="printXsdjb('xsxxdj.do?method=printXsdjb')" style="width:80px">
					学生登记表
				</button>
				</div>
