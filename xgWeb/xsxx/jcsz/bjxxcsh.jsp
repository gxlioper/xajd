					...
					<ul id="ul1">
						<logic:notEmpty name="mkList">
							<logic:iterate id="card" name="mkList" scope="request" indexId="s">	
								<logic:equal value="班级信息" name="card" property="cn" >
								...
								<logic:notEqual value="班级信息" name="card" property="cn">
									<li id="${card.en}li">
										<a href="#" onclick="refreshForm('${card.en}')" id="${card.en}">
											<span>${card.cn}</span>
										</a>
				    ...
				    <ul>
					  ...
					  <logic:equal value="yes" name="writeAble">
						...
						<logic:equal value="true" name="cshFlag">
						 <li> <a href="#" onclick="showUpdateWindow('primarykey_cbv','xxcshgl.do?method=bjxxUpdate',600,400)" class="btn_xg">修&nbsp;&nbsp;改</a> </li>
						 <li> <a href="#" onclick="bachAction('xxcshgl.do?method=bjxxcsh&doType=del','primarykey_cbv','您确定删除所选记录吗？')" class="btn_sc">删&nbsp;&nbsp;除</a> </li>
						 <li> <a href="#" onclick="impAndChkData();" class="btn_dr">数据导入</a> </li>
						 <li> <a href="#" onclick="confirmAction('xxcshgl.do?method=bjxxcsh&doType=ljje','该操作将从外部接口接入数据，您确认继续操作吗？')" class="btn_csh">连接接口</a> </li>
						 <li> <a href="#" onclick="bachAction('xxcshgl.do?method=bjxxcsh&doType=bjwzqsj','primarykey_cbv','您确定将所选择的数据标记为正式数据吗？')" class="btn_sz">数据确认</a> </li>
						 <li> <a href="#" onclick="confirmAction('xxcshgl.do?method=bjxxcsh&doType=qbbjwzqsj','该操作将所有数据标记为正式数据，您确认继续操作吗？')"" class="btn_sz">全部数据确认</a> </li>
						</logic:equal>
					  </logic:equal>	
					</ul>					
				  </div>
