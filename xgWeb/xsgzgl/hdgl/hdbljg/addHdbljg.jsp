				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<html:text property="hdsj" styleId="hdsj" readonly="true" onfocus="showCalendar('hdsj','y-mm-dd');"/>
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td colspan="3">
								<html:textarea property='bz' styleId="bz" rows='8' onblur="checkLen(this,500);" style="width:98%"/>
							</td>
			      		</tr>						
					</tbody>
				 </table>			
