	...
	<body>
		<div class="container" style="width:100%;">
			<html:form action="/hdgl_hdjdsh" method="post" styleId="hdxxForm" onsubmit="return false;">
				...
				<input type="hidden" id="jdid" value="${hdjdInfo.jdid}" />
				<input type="hidden" name="sflx" value="${data.sflx}" />
				<logic:equal value="1" name="data" property="bmlx">
					<input type="hidden" name="sqid" id="sqid" value="${grbmxx.sqid}" />
				</logic:equal>
							...
							<div class=" table-responsive">
								<table class="table table-bordered text-center">
									...
									<logic:iterate id="dw" name="dwList" indexId="n">
										<logic:equal value="队长" name="dw" property="dwzwmc">
					...
					<div style="border: 1px solid #DEDEDE;padding: 10px;margin-bottom: 20px">
							...
							<logic:notEqual value="是" name="data" property="sflx">
								<div class="row">
									...
									<div class="col-sm-10 col-md-10">
										<textarea name="xdth" rows="8" cols="" class="active-textarea" style="border:1px solid #DEDEDE" readonly="readonly">
                                    ${ywcjd.xdth}
                            </textarea>
									</div>
								</div>
						...
						<logic:notEqual value="1" name="ywcjd" property="jdlx">
							...
							<logic:notEqual value="1" name="ywcjd" property="sfsldf">
								...
								<div class="row">
									<div class="col-sm-2 col-md-2">
										<div style="padding-top: 15px;"><label>附件上传</label></div>
									</div>
									<div class="col-sm-10 col-md-10">
										<div class="upload" style="padding-top: 10px;">
											<logic:equal value="1" name="ywcjd" property="jdlx">
					...
					<div style="margin-bottom: 20px">
						<select id="jxid">
							...
							<logic:iterate id="jx" name="jxList">
								<option value="${jx.jxdm}">${jx.jxmc}</option>
							</logic:iterate>
						</select>
					</div>
				</logic:equal>
				<logic:equal value="1" name="hdjdInfo" property="sfsldf">
					<p class="active-title">打分</p>
					<div style="margin-bottom: 20px">
						<input id="df" type="text" maxlength="3" />
					</div>
				</logic:equal>
				<logic:equal value="1" name="hdjdInfo" property="sfslxf">
					<p class="active-title">学分</p>
					<div style="margin-bottom: 20px">
						<input id="xf" type="text" />
					</div>
				</logic:equal>
				<logic:equal value="1" name="hdjdInfo" property="sfsldf">
					<div class="active-btn">
						<button type="button" class="green-bg-btn" onclick="saveDf();return false;">保存</button>
					</div>
				</logic:equal>

				<logic:notEqual value="1" name="hdjdInfo" property="sfsldf">
					<%--是否需要跳转阶段--%>
					<logic:equal value="1" name="hdjdInfo" property="sftj">
						<p class="active-title">阶段</p>
						<div style="margin-bottom: 20px">
							<html:select property="nextjdid" styleId="nextjdid">
								<html:options collection="nextJdList" property="jdid" labelProperty="jdmc"></html:options>
							</html:select>
						</div>
					</logic:equal>
					<p class="active-title">审核意见</p>
					<div>
						<textarea id="shyj" name="shyj" rows="8" cols="" class="active-textarea" style="border:1px solid #DEDEDE"></textarea>
					</div>

					<div class="active-btn">
						<button type="button" class="green-bg-btn" onclick="jdshtg()">通过</button>
						<logic:equal value="1" name="hdjdInfo" property="prejdlx">
							<button type="button" class="red-bg-btn" onclick="jdshth(3)">退回</button>
						</logic:equal>
						<button type="button" class="red-bg-btn" onclick="jdshth(2)">不通过</button>
