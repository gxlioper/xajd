            ...
            <div style="border: 1px solid #DEDEDE;padding: 10px;margin-bottom: 20px">
                <div class="row">
                    <div class="col-sm-2 col-md-2">
                        <p>
                            <%--${ywcjd.jdlx == 1?"心得体会":"审核意见"}--%>
                                <logic:equal value="1" name="ywcjd" property="jdlx">心得体会</logic:equal>
                                <logic:notEqual value="1" name="ywcjd" property="jdlx">审核意见</logic:notEqual>
                        </p>
                    </div>
                    <div class="col-sm-10 col-md-10">
                    <textarea name="xdth" rows="8" cols="" class="active-textarea" style="border:1px solid #DEDEDE" readonly="readonly">
                            <%--${ywcjd.jdlx == 1?ywcjd.xdth:ywcjd.shyj}--%>
                        <logic:equal value="1" name="ywcjd" property="jdlx">${ywcjd.xdth}</logic:equal>
                        <logic:notEqual value="1" name="ywcjd" property="jdlx">${ywcjd.shyj}</logic:notEqual>
                    </textarea>
                    </div>
                </div>
                <div class="row">
