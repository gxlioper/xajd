...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  if(jQuery.trim(splc)==""){
				...
				var url = id == "" ? "jcftz_cssz.do?method=save" : "jcftz_cssz.do?method=update";
		      	ajaxSubFormWithFun("jcftzCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/jcftz_cssz" method="post" styleId="jcftzCsszForm">
