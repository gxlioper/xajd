	...
	<head>
		...
		jQuery(function(){
			var gridSetting = {
				caption:"参评学生列表 ",
				pager:"pager",
				url:"jcftz_sq.do?method=renDing&type=query&xmdm=${xmdm}"
			};
			...
			var colList=[
				   ...
				   {label:'项目基础分',name:'jcxf', index: 'jcxf',width:'10%'},
...
<%--								html+=rowObject["xh"];--%>
			...
			jsonbz1["formatter"] = function (cell,rowObject){					
				...
				if(rowObject["xfrdsqzt"] == '1'){
					...
					html+= "<input onblur=\"savebz(this,'"+rowObject["jgid"]+"','bz1')\" type='text' ";
			...
			jsonbz2["formatter"] = function (cell,rowObject){					
				...
				if(rowObject["xfrdsqzt"] == '1'){
					...
					html+= "<input onblur=\"savebz(this,'"+rowObject["jgid"]+"','bz2')\" type='text' ";
					html+=" style='width:50px;' maxlength='20' value='";
					html+=cell==null?"":cell;
					html+="' />";
					return html;
			...
			jsonbz3["formatter"] =function (cell,rowObject){					
				...
				if(rowObject["xfrdsqzt"] == '1'){
					...
					html+= "<input onblur=\"savebz(this,'"+rowObject["jgid"]+"','bz3')\" type='text' ";
					html+=" style='width:50px;' maxlength='20' value='";
					html+=cell==null?"":cell;
					html+="' />";
					return html;
			...
			jsonbz4["formatter"] = function (cell,rowObject){					
				...
				if(rowObject["xfrdsqzt"] == '1'){
					...
					html+= "<input onblur=\"savebz(this,'"+rowObject["jgid"]+"','bz4')\" type='text' ";
					html+=" style='width:50px;' maxlength='20' value='";
					html+=cell==null?"":cell;
					html+="' />";
					return html;
			...
			jsonbz5["formatter"] = function (cell,rowObject){					
				...
				if(rowObject["xfrdsqzt"] == '1'){
					...
					html+= "<input onblur=\"savebz(this,'"+rowObject["jgid"]+"','bz5')\" type='text' ";
					html+=" style='width:50px;' maxlength='20' value='";
					html+=cell==null?"":cell;
					html+="' />";
					return html;
