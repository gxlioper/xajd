					...
					<tbody>
						...
						<tr>
							...
							<td width="30%">
								...
								<html:text style="width:50px;" property="kcyrs" styleId="kcyrs" value="0"  maxlength="5"
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="saveXmsb('save');">
										保存草稿
									</button>
									<button type="button" onclick="saveXmsb('submit');">
										提交申请
									</button>
