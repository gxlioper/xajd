			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							<th width="20%">
								<font color="red">*</font>可参与人数
							</th>
							<td width="30%">
								<label>
									<html:radio  property="csms" value="1"/>个人
								</label>
								<logic:equal value="1" name="csms">
									<html:text style="width:50px;"  property="kcyrs" styleId="kcyrs"  maxlength="5"
										onkeyup="checkNumNotZero(this)"></html:text>
								</logic:equal>
								<logic:equal value="2" name="csms">
									<html:text style="width:50px;display:none" disabled="true" property="kcyrs" styleId="kcyrss"  maxlength="5"
										onkeyup="checkNumNotZero(this)"></html:text>
								</logic:equal>
								<label>
								    <html:radio property="csms" value="2"/>团体
								</label>
								<logic:equal value="2" name="csms">
									<html:text style="width:50px;" property="kcyrs" styleId="kcyrs"  maxlength="5"
										onkeyup="checkNumNotZero(this)"></html:text>
						...
						<tr>
							...
							<td width="30%" >
								<html:text property="sbr" styleId="sbr" />
				...
				<table width="100%" border="0" class="formlist">
					...
					<tr>
						...
						<td>
						<html:text property="jxmc" styleId="jxmc" maxlength="20" value="${i.jxmc}"></html:text>
						<td>
						<html:text property="fjxf" styleId="fjxf" maxlength="2" onkeyup="value=value.replace(/[^\d]/g,'');" value="${i.fjxf}"></html:text>
						</td>
						<td width="30%">
								<html:text property="xssx" styleId="xssx" maxlength="2" onkeyup="value=value.replace(/[^\d]/g,'');" value="${i.xssx}"></html:text>
							</td>
						</tr>
						</logic:iterate>
					</tbody>
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="editXmsb('save');">
										保存草稿
									</button>
									<button type="button" onclick="editXmsb('submit');">
										提交申请
									</button>
