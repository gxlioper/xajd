			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td width="30%">
								<html:select  property="xn" disabled="true" styleId="xn" style="width:100px" >
							...
							<td>
								<html:select  property="xq" disabled="true" styleId="xq" >
						...
						<tr>
							...
							<td width="30%">
								<label>
									<html:radio disabled="true"  property="csms" value="1"/>个人
								</label>
								...
								<label>
								    <html:radio disabled="true"  property="csms" value="2"/>团体
								</label>
				...
				<table width="100%" border="0" class="formlist">
					...
					<tr>
						...
						<td>
						<html:text property="fjxf" styleId="fjxf" maxlength="5" onkeyup="value=value.replace(/(?:\D*)?(\d*)?(\.)?(\d*)?(?:\d*)?/ig,'$1$2$3')" value="${i.fjxf}"></html:text>
						</td>
						<td width="30%">
