		...
		jQuery(function(){
			var gridSetting = {
				...
				colList : [
							...
							{ label : '已颁奖人数', name : 'ybjrs', index : 'ybjrs', width : '5%' }]
					 }
		...
		<input type="hidden" name="currDate" id="currDate" value="${currDate}"/>
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						<li>
							<a href="javascript:void(0);" class="btn_dy" onclick="jxbf();return false;"  >奖项颁发</a>
						</li>
						<logic:equal value="11032" name='xxdm'>
						<li>
							<a href="javascript:void(0);" onclick="jxdr();return false;" class="btn_dr">奖项导入</a>
						</li>
						</logic:equal>
					</ul>
				</div>
