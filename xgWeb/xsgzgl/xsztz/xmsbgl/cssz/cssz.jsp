...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "xmsbJcsz.do?method=save" : "xmsbJcsz.do?method=update";
		      ajaxSubFormWithFun("sztzCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/xmsbJcsz" method="post" styleId="sztzCsszForm">
