...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form action="/grttxm_jdsz" method="post" styleId="JdwhSzForm" onsubmit="return false;">
				...
				<table width="100%" border="0" class="formlist">
					<tbody>
						<tr>
							...
							<td colspan="3">
								<html:select property="xmdm" styleId="xmdm" style="width:200px">
									...
									<html:options collection="xmmclist" property="xmdm" labelProperty="xmmc" />
								</html:select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3">
								<input type="file" onchange="attachfilename(this)" id="drmb" name="file"/>
							</td>
						</tr>
						<tr>
						<th>导入说明</th>
						...
						<tr id="errortr" style="display: none">
						     <th>错误数据下载</th>
							<td colspan="3">
								<a href="javascript:void(0);" data_file="" onclick="downloaderror();" id = "errora" class="name" style="margin-left:3px;font-weigth:bold;font-size:14px">error.xls下载</a>
							</td>
						</tr>
					</tbody>
				</table>
