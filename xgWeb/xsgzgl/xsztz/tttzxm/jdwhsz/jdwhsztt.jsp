		...
		<html:form action="/cxdd_pysb" onsubmit="return false;" >
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						<li>
                             <a href="javascript:void(0);" onclick="document.location.href='sztz_grttxm_jdsz.do';" class="btn_fh">返回</a>
                        </li>
						<li>
                             <a href="javascript:void(0);" onclick="addTtcy();" class="btn_zj">增加</a>
                        </li>
                        <li>
