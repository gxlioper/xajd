...
<html xmlns="http://www.w3.org/1999/xhtml">
			...
			jQuery(function(){
				...
				jQuery("#selhd").unbind('click').bind('click', function(){
					if(jQuery("#xh").val() == ''){
					  ...
					  var url = "jxgl_xnjxjg.do?method=getXmSelectList&xh="+jQuery("#xh1").val()+"&xmdm="+jQuery("#xmdm").val();
	...
	<body>
		<html:form action="/jxgl_xnjxjg" method="post" styleId="XnjxjgForm">
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<input id="oldxmdm" name="oldxmdm" value="${oldxmdm}" type="hidden"/>
								<input id="oldjgid" name="oldjgid" value="${oldjgid}" type="hidden"/>
								<html:hidden property="jgid"  styleId="jgid"/>
								<html:hidden property="xmdm"  styleId="xmdm"/>
								<input type="text" name="xmmc" value="${rs.xmmc}" id="xmmc" style="width:120px;"  readonly="readonly"/>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" id="bc" onclick="saveUpdate();return false;">
										保存
									</button>
