...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form method="post" styleId="JxqjjgForm" action="/jxqjjg"  enctype="multipart/form-data">
		 <html:hidden property="qjid" styleId="qjid"/>
			...
			<table width="100%" border="0" class="formlist" style="position: fixed; _position: absolute; bottom: 0;">
					...
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button"  onclick="save('jxqjjg.do?method=update&type=save','qjts-qjlx-qjkssj-qjjssj-qjsy','false');return false;" id="buttonSave">
									保 存
								</button>
