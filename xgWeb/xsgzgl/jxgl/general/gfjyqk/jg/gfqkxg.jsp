						...
						<tr>
							...
							<td align="left" colspan="3">
								<select name="gfqkfl" id="gfqkfl" style="width:150px;" onchange="change(this)">
									<option></option>
									<option value="1" <logic:equal value="1" name="gfqkfl">selected = "selected" </logic:equal>>兵役登记情况</option>
									<option value="2" <logic:equal value="2" name="gfqkfl">selected = "selected" </logic:equal>>参军入伍情况</option>
									<option value="3" <logic:equal value="3" name="gfqkfl">selected = "selected" </logic:equal>>退伍复学情况</option>
									<option value="4" <logic:equal value="4" name="gfqkfl">selected = "selected" </logic:equal>>评奖评优</option>
									<option value="5" <logic:equal value="5" name="gfqkfl">selected = "selected" </logic:equal>>奖惩情况</option>
									<option value="6" <logic:equal value="6" name="gfqkfl">selected = "selected" </logic:equal>>活动参加情况</option>
								</select>
							</td>
						</tr>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button"
										onclick="saveJg('gfjyqk_jg.do?method=update&type=update');return false;"
										id="buttonSave">
										保存
									</button>
