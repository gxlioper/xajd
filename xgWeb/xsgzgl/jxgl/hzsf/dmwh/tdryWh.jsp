	...
	<body >
		...
		<html:form action="/jxgl_dmwh" method="post">
			...
			<div class="toolbox" id="dgncz">
				...
				<div class="buttonbox">
					<ul>
						...
						<li><a href="#" onclick="tdryDiv('add','增加团队荣誉');return false;" class="btn_zj">增加</a></li>
						<li><a href="#" onclick="tdryDiv('update','修改团队荣誉');return false;" class="btn_xg">修改</a></li>
			...
			<div class="comp_title">
		      <ul>
		      	<li><a href="jxgl_dmwh.do?method=grryWh"><span>个人荣誉代码</span></a></li>
		        <li class="ha"><a href="#"><span>团队荣誉代码</span></a></li>
		      </ul>
		    </div>
