...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/dagl/qdcl/updateDaqdcl.js"></script>
	...
	<body >
		...
		<html:hidden property="daqdcl_id" styleId="daqdcl_id"  />
					...
					<tbody id="tbody_jbxx">
						<tr>
							...
							<td width="34%" colspan="3" >
								<html:text property="daqdcl_mc" styleId="daqdcl_mc"  style="width:80%"  maxlength="200" readonly="fasle" />
							</td>
						</tr>
					</tbody>
				</table>
