				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td colspan="3">
								<input type="radio" name="zcfs" value="1" onchange="changeZcfs()"/>邮寄
								<input type="radio" name="zcfs" value="2" onchange="changeZcfs()"/>自带
							</td>
						</tr>
						<tr id="mailedOne">
							<th>
						...
						<tr id="mailedFour">
							...
							<td colspan="3">
								<html:radio property="yjzt" styleId="yjzt" value="1" onchange="changeYjzt()">已邮寄</html:radio>
								<html:radio property="yjzt" styleId="yjzt" value="2" onchange="changeYjzt()">未邮寄</html:radio>
							</td>
						</tr>
						<tr id="mailedFive">
							<th>
