...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		jQuery(function(){
			var gridSetting = {
				caption : "学生列表",
				pager : "pager",
				url : "cqxxDaxxgl.do?method=cqxxdaxxwh&type=query",
				colList : [ {
					label : 'key',
					name : 'xsid',
					index : 'xsid',
	...
	<body>
		...
		<html:form action="/cqxxDaxxgl" onsubmit="return false;" >
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						<li>
                             <a href="javascript:void(0);" onclick="document.location.href='cqxxdaxxgl.do';" class="btn_fh">返回</a>	</li>
					</ul>
