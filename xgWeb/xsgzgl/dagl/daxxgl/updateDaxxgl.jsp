...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/dagl/daxxgl/updateDaxxgl.js"></script>
	...
	<body >
		<html:form action="/daxxgl" method="post"  onsubmit="return false;" styleId="form">
			...
			<html:hidden  property="dazrsj"  styleId="dazrsj" />
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody id="tbody_jbxx">
						...
						<tr>
							...
							<td width="32%">
								${daxxglForm.dazrsj }（归档日期）
							</td>
							<th width="18%">
								档案转入方式
							</th>
							<td width="32%">
								<html:text property="dazrfs" styleId="dazrfs"  style="width:50%"  maxlength="15" readonly="false" />
							</td>
						</tr>
						<tr>
							<th >
						...
						<tr>
							...
							<td >
								<html:text property="dwyb" styleId="dwyb"  style="width:50%"  maxlength="6" readonly="fasle" onblur="checkInputData(this);"/>
							</td>
						</tr>
						<tr>
							<th >
						...
						<tr>
							...
							<td  >
								<html:text property="dazjdw" styleId="dazjdw"  style="width:50%"  maxlength="50" readonly="fasle" />
							</td>
							<th >
								档案投递邮编
							</th>
							<td   >
								<html:text property="dazjyb" styleId="dazjyb"  style="width:50%"  maxlength="6" readonly="fasle" onblur="checkInputData(this);"/>
							</td>
						</tr>
						<tr>
							<th >
