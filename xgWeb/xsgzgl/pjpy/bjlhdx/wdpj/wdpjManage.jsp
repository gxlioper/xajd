...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//显示我的审核Div
		function showWdshDiv(xmdm,gwid){
		
			//路徑
			var url = "general_pjpy_wdpj_ajax.do?method=createWdshDiv";
			//參數
		 	var parameter = {
				"str_xmdm":xmdm,
				"str_gwid":gwid
		 	...
		 	jQuery("#div_wdsh").load(
				url,
				parameter,
				function(){
					tipsWindown(" ","id:div_wdsh","700","360","true","","true","id");
				}
			);
		}
...
<%--			<input type="hidden" name="xmdm" id="xmdm" value="" />--%>
			...
			<!-- 我的审核 Div begin -->
			<div id="div_wdsh" style="display:none">
