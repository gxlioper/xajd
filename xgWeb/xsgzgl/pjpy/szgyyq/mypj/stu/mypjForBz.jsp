	...
	<body onload="searchRs()" >
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				...
				5.点击<font color="blue">5S分录入</font>，可以维护学生的5S分。</br>
				6.点击<font color="blue">分数审核</font>，可以审核学生的申请。</br>
				7.点击<font color="blue">结果查询</font>，可以查看您所在班级的所有项目的情况。</br>
				8.<font color="blue">我的申诉</font>用来管理您已经申诉过的记录。
				</span>
			</p>
