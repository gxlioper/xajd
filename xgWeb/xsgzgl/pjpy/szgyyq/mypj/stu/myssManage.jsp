...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="searchRs()" >
		...
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置：</em><a>综合素质养成课 - 我的工作 - 我的申诉</a>
			</p>
			<p class="help">
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				...
				2.申诉状态为<font color="blue">已处理</font>的，可点击申诉状态查询出来结果。
				</span>
			</p>
							...
							<tbody>
								<tr>
									<td style="padding-left:68px;">
										...
										全部
										<!-- 模糊循环 -->
										<html:radio property="searchModel.mhcx_lx" value="ssnr" onclick="$('mhcx_lx').value = this.value"/>申诉内容
										<html:radio property="searchModel.mhcx_lx" value="clrxm" onclick="$('mhcx_lx').value = this.value"/>处理人
							...
							<dd>
								<ul>
									<logic:iterate name="lxTjList" id="lxMap">
										<li>
											<a href="#" class=""
												onclick="clickTj('lx','${lxMap.en }');creatGxhClickedTj('lx','申诉状态','${lxMap.en }','${lxMap.cn }',this);return false;" 
							...
							<dd>
								<ul>
									<logic:iterate name="xmdmTjList" id="xmdmMap">
										<li>
											<a href="#" class=""
												onclick="clickTj('xmdm','${xmdmMap.en }');creatGxhClickedTj('xmdm','申诉项目','${xmdmMap.en }','${xmdmMap.cn }',this);return false;" 
