...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
			var url = "pjpy_bjrygl_ajax.do?method=getBjmc";
			var ie = "ie";
			var otherValue = [ie];
		...
		function sendBjdm(){
			...
			if(len==1){	
				...
				window.dialogArguments.document.getElementById('bjdm').value = pkValue;
				Close();
	...
	<body >
		...
		<html:form action="/gyglnew_qszf_ajax" method="post">
			...
			<div class="toolbox" id="dgncz">
				<div class="buttonbox">
					<ul>
						<li><a href="#" class="btn_sr" onclick="sendBjdm();return false;">确定</a></li>
					</ul>
				</div>
				<!-- 过滤条件 -->
