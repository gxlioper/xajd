...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form action="/khglKhnrgl" method="post"
			...
			<html:hidden property="zbmxid" styleId="zbmxid"/>
			...
			<table align="center" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td>
							<logic:equal value="0" name="sfypf">
							...
							<logic:equal value="1" name="sfypf">
							<input type="hidden" value="${KhnrglForm.fzlx}" id="fzlx"/>
							${rs.fzlxmc }
							</logic:equal>
							</td>
							<th>
							...
							<td>
							   ...
							   <logic:equal value="1" name="sfypf">
							   <input type="hidden" value="${KhnrglForm.fzzdf}" id="fzzdf"/>
							   ${rs.fzqj }
							 </logic:equal>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
							<logic:equal value="0" name="sfypf">
								<html:select property="pflx" styleId="pflx" style="width:100px" value="${KhnrglForm.pflx}">
									<option value='1'>加分</option>
									<option value='2'>减分</option>
								</html:select>
							</logic:equal>
							<logic:equal value="1" name="sfypf">
							<input type="hidden" value="${KhnrglForm.pflx}" id="pflx"/>
							${rs.pflxmc }
							 </logic:equal>
							</td>
						</tr>
