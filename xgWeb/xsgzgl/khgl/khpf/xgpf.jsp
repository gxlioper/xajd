...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" >
			var gridSetting = {
					caption : "考核对象列表",
					pager : "pager",
					url : "khglKhpf.do?method=xgpf&type=query",
					multiselect:false,
					radioselect:true
				}
			...
			jQuery(function() {
				var map = {pflx:jQuery("#pflx").val(),xmid:jQuery("#xmid").val(),khbid:jQuery("#khbid").val(),khdxr:jQuery("#khdxr").val(),xmszid:jQuery("#xmszid").val(),fs:jQuery("#fs").val()};
	...
	<input type="hidden" name="bztjzt" id="bztjzt" value="${pfxxMap.bztjzt}" />
	<input type="hidden" name="bzrtjzt" id="bzrtjzt" value="${pfxxMap.bzrtjzt}" />
	<input type="hidden" name="fs" id="fs" value="${model.fs}" />
	</html:form>
	<div class="main_box">
