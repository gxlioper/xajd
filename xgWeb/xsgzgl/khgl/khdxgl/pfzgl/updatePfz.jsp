...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
		     ...
		     var url = "khglPfzgl.do?method=savePfz&type=update";
	...
	<body>
		<html:form action="/khglPfzgl" method="post"
			...
			<html:hidden property="pfzid" styleId="pfzid"/>
