...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
			...
			var url = "qgzx_cxtj_ajax.do?method=gwcjffTj";
		...
		//导出
		function Dc(){
			var url = "qgzx_cxtj_ajax.do?method=gwcjffDc";
		...
		<html:form action="/qgzx_cxtj" method="post">
			...
			<div class="comp_title">
				<ul>
		      	 	...
		      	 	<li class="ha"><a href="#"><span>岗位酬金发放统计</span></a></li>
		      	 	<li><a href="javascript:refreshForm('qgzx_cxtj.do?method=grcjffTj');"><span>个人酬金发放统计</span></a></li>
		     	</ul>
	     	</div>
			<div class="searchtab">
				<table>
