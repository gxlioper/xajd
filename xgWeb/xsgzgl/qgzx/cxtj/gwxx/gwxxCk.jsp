					...
					<div class="con_overlfow">
						<table id="shlccx_table" width="100%" class="formlist" >
							<logic:notEmpty name="zgrylist">
								...
								<logic:iterate id="i" name="zgrylist">
									<tr>
										<td>${i.r}</td>
										<td>${i.xh}</td>
										<td>${i.xm}</td>
			...
			<tr>
				<td colspan="4">
					<style>
						...
						#shlccx_table1 th{text-align: center;}
						#shlccx_table1 tr{text-align: center;}
					</style>
					<div class="con_overlfow">
						<table id="shlccx_table1" width="100%" class="formlist" >
							<logic:notEmpty name="lzrylist">
								<tr>
									<th>序号</th>
									<th>学号</th>
									<th>姓名</th>
								...
								<logic:iterate id="i" name="lzrylist">
									<tr>
										<td>${i.r}</td>
										<td>${i.xh}</td>
										<td>${i.xm}</td>
