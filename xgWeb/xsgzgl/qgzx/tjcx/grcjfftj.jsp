...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="toolbox" id="dgncz">
			<div class="buttonbox">
				<ul>
					<li><a href="#" class="btn_dc" onclick="expGrcjfftj();return false;">导出</a></li>
				</ul>
			</div>
		</div>
		<html:form action="/qgzx_cjtjcx" method="post">
	      ...
	      <ul>
	        ...
	        <li class="ha"><a href="javascript:$('go').value='';refreshForm('qgzx_cjtjcx.do?method=grcjfftjCx');"><span>个人酬金发放统计</span></a></li>
	      </ul>
	    </div>
			<!-- 内容显示区开始 -->
			<div class="main_box">
