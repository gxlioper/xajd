...
<html:form styleId="qgzxGwglNewForm" action="/qgzx_gwglnew" method="post" onsubmit="return false;">
    ...
    <table align="center" class="formlist">
        ...
        <tr>
            ...
            <th>工作性质</th>
            <td>
                <input type="radio" name="gwxzdm" value="0" <logic:equal name="model" property="gwxzdm" value="0">checked="checked"</logic:equal> >临时
                <input type="radio" name="gwxzdm" value="1" <logic:equal name="model" property="gwxzdm" value="1">checked="checked"</logic:equal>>正式
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="radio" name="gwlx" value="0" <logic:equal name="model" property="gwlx" value="0">checked="checked"</logic:equal>>临时
                <input type="radio" name="gwlx" value="1" <logic:equal name="model" property="gwlx" value="1">checked="checked"</logic:equal>>长期
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="gwcjsx" id="gwcjsx" value="${model.gwcjsx}" onblur="checkGz()"  maxlength="7" placeholder="不得大于工资上限（${gsgz.cjsx}）">
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td colspan="3">
                <input type="text" name="gssx" id="gssx" value="${model.gssx}" onblur="checkGs()" maxlength="4" placeholder="不得大于工时上限（${gsgz.gzscsx}）">&nbsp;&nbsp;
                <span id="label"></span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" name="cq" value="1" <logic:equal name="model" property="cq" value="1">checked="checked"</logic:equal>/>长期
            </td>
        </tr>
        <%--<tr>
            <th>
        ...
        <tr>
            <td colspan="4">
                ...
                <div class="btn">
                    <button type="button" name="保存" onclick="yrdwDivSave('save');return false;">
                        保存
                    </button>
