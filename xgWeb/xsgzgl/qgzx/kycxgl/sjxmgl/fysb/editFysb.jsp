...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="width: 100%">
		...
		<html:hidden property="sbid" styleId="sbid"/>
			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;' id="xmDiv">
				...
				<tr>
					...
					<tbody id="tbody_sbxx">
						...
						<td>
						<input type='text' name='gs' id='gs' value='${i.gs}' maxlength='10'onkeyup="value=value.replace(/(?:\D*)?(\d*)?(\.)?(\d)?(?:\d{2})?/ig,'$1$2$3');getCjje(this)"/>
						</td>
						<td>
						<input type='text' style="border:0px;" name='cjje' id='cjje' value='${i.cjje}' maxlength='10' readonly="readonly"/>
						</td>
						</tr>
						</logic:iterate>
						</tbody>
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="saveEditFysb('save');">
										保存草稿
									</button>
									<button type="button" onclick="saveEditFysb('submit');">
										提交申请
									</button>
