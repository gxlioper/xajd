			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td width="30%" >
								<html:text property="jfys" styleId="jfys" value="${rs.jfys}" onkeyup="value=value.replace(/[^\d]/g,'');"></html:text>
							</td>
						</tr>
					</tbody>
					<thead>
				...
				<tr>
					...
					<tbody id="tbody_xsxx">
						...
						<td>${i.bjmc}</td>
						<td>
						<html:text property="xmfg" styleId="xmfg_${index01}" maxlength='20' value="${i.xmfg}" style="width:100px"></html:text>
						</td>
						<td>
						${i.lxdh}
						</td>
				...
				<table width="100%" border="0" class="datelist" style="margin:2px auto;">
					...
					<tbody id="tbody_jsxx">
						...
						<td>${i.xymc}</td>
						<td>
						<html:text property="zc" styleId="zc_${index01}" maxlength='20' value="${i.zc}"></html:text>
						</td>
						<td>
						<html:text property="yjfx" styleId="yjfx_${index01}" maxlength='20' value="${i.yjfx}"></html:text>
						</td>
						<td>
						${i.lxdh}
						</td>
