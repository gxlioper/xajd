			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto'>
				...
				<table width="100%" border="0" class="datelist" style="margin:2px auto;">
					...
					<tbody id="tbody_jsxx">
						...
						<td>${i.xymc}</td>
						<td>
						<html:text property="zc" styleId="zc_${index01}" value="${i.zc}" maxlength='20'></html:text>
						</td>
						<td>
						<html:text property="yjfx" styleId="yjfx_${index01}" value="${i.yjfx}" maxlength='20'></html:text>
						</td>
						<td>
						${i.lxdh}
						</td>
