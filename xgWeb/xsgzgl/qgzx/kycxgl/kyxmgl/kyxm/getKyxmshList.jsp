...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/qgzx/kycxgl/kyxmgl/kyxm/js/kyxmsh.js"></script>
		...
		<script type="text/javascript">
			...
			var gridSetting = {
				caption : "科研项目列表",
				pager : "pager",
				url : "qgzx_kycxkyxmsh.do?method=getKyxmshList&type=query",
				colList : [
	...
	<body>
		...
		<html:form action="/qgzx_kycxkyxmsh">
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					...
					<logic:equal name="writeAble" value="yes">
						<li id="li_sh">
							<a href="javascript:void(0);" onclick="kysh();return false;" 
