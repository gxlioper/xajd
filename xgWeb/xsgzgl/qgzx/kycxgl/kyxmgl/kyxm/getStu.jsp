...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		jQuery(function(){
			var gridSetting = {
				...
				pager:"pager",
				rowNum:10,
				url:"qgzx_kycxkyxmsq.do?method=getStu&type=query&xmid="+jQuery("#xmid").val()+"&xhs="+jQuery("#xhs").val(),
				...
				colList:[
				   ...
				   {label:'联系电话',name:'lxdh', index: 'lxdh',width:'7%'}
				],
				sortname: "xh",
			 	sortorder: "desc"
			}
	...
	<body>
		<html:form method="post" styleId="form" action="/qgzx_kycxkyxmsq">
