...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function queryXmXh(){
			var url ="qgzx_cjffjg.do?method=cjxxCkByxhxm";
			var parameter={
				"xh":	jQuery("#xh").val(),
		...
		function exportExcel(){
			window.top.location.href = "qgzx_cjffjg.do?method=cjxxExportExcel&pkValue="+'${pkValue}';
		}
				...
				<table width="100%" border="0" class="formlist">
					...
					<td colspan="6">
						...
						<button type="button" onclick="queryXmXh();return false;" class="btn_01">查询</button>
							<button type = "button" onclick="exportExcel();return false;" class="btn_01">导出</button>
						</font>
					</td>
				</tr>
					</thead>
