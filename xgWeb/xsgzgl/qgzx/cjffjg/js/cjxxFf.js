...
function getGwdm(){
	...
	jQuery.getJSON('qgzx_cjffjg_ajax.do?method=getGwdm',parameter,function(data){
		jQuery('#gwdm').empty();
...
function getFFny(){
	...
	parameter["xn"]=escape(jQuery("#xn").val());	
    parameter["yrbm"]=escape(jQuery("#yrbm").val());
	jQuery.getJSON('qgzx_cjffjg_ajax.do?method=getFFny',parameter,function(data){
		jQuery('#ffny').empty();
		if(data != null && data.length != 0){
...
//查询
function searchRs(){
	var url = "qgzx_cjffjg_ajax.do?method=getGwryList";
...
function scCjbz(ind){
    ...
    parameter["xn"]=escape(jQuery("#xn").val());
	var url = "qgzx_cjffjg_ajax.do?method=scCjbz";
...
function saveCjffForWCSY(){
	...
	var url = "qgzx_cjffjg_ajax.do?method=saveCjffxx";
...
function checkTjInfo(){
	...
	var data = "";
	var parameter={};
	var url="qgzx_cjffjg_ajax.do?method=checkTjInfo";	
	parameter["xn"]=escape(jQuery("#xn").val());
