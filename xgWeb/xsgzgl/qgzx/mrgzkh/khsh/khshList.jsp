...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/calendar/calendar.js"></script>
			<script type="text/javascript" src="xsgzgl/qgzx/mrgzkh/khsh/khsh.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"每日工作考核审核",
				pager:"pager",
				url:"mrgzkhKhsh.do?method=getKhshList&type=query",
				colList:[
                    ...
                    {label:'岗位类别',name : 'gwxzmc',index : 'gwxzmc',width : '7%'},
					{label:'工作时间',name:'gzsj', index: 'gzsj',width:'21%'},
					{label:'工时(小时)',name:'gs', index: 'gs',width:'5%'},
