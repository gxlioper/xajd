...
function khshView(sqid, xh) {
	showDialog("审核查询", 750, 550, "mrgzkhKhsq.do?method=khsqView&sqid=" + sqid
			+ "&xh=" + xh);
}
...
function khsh() {
	...
	if (shzt == "ysh") {
		...
		showDialog("批量审核", 500, 250, "mrgzkhKhsh.do?method=khPlsh");
	}
}
// 批量审核
...
var DCCLBH = "mrgzkhKhsh.do";//dcclbh,导出功能编号
...
function khshExportData() {
	...
	var shzt = jQuery("#shzt").val();
	var url = "mrgzkhKhsh.do?method=exportData&shzt="+shzt+"&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
