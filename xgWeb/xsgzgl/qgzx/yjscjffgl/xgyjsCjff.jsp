				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody id="tbody_ffxx">
						...
						<tr >
							...
							<td width="34%">
								<html:text  name="model" property="gwmc" styleId="gwmc"  maxlength="20"  styleClass="text_nor"></html:text>
							</td>
							<th width="16%">
						...
						<tr>
							...
							<td width="34%">
								<html:text name="model" property="gs" styleId="gs" maxlength="5" styleClass="text_nor" onkeyup="value=value.replace(/(?:\D*)?(\d*)?(\.)?(\d*)?(?:\d*)?/ig,'$1$2$3')" />
							</td>
							<th width="16%">
								<font color="red">*</font>金额
							</th>
							<td width="34%">
								<html:text name="model" property="je" styleId="je" maxlength="10" styleClass="text_nor" onkeyup="value=value.replace(/(?:\D*)?(\d*)?(\.)?(\d*)?(?:\d*)?/ig,'$1$2$3')" />
							</td>
						</tr>
						<tr>
							<th width="16%">
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" type="button" id="but_save" onclick="saveForm('xgyjsCjff')">
										保 存
									</button>
