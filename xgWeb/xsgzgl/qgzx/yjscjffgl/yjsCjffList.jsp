			...
			jQuery(function(){
				...
				var gridSetting = {
						...
						colList:[
						   ...
						   {label:'发放年月',name:'ffny', index: 'ffny',width:'12%'},
						   {label:'工时',name:'gs', index: 'gs',width:'13%'},
						   {label:'金额',name:'je', index: 'je',width:'13%'}
				...
				<div class="buttonbox">
					<ul>
						<logic:equal value="yes" name="writeAble">
							...
							<li><a href="#" onclick="toImportDataNew('IMPORT_N440303_YJSCJFF');return false;" class="btn_dr">导入</a></li>	
						</logic:equal>
