				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<logic:notEmpty name="ssm" ><html:text styleId="ssm" property="ssm" readonly="true" maxlength="50"/></logic:notEmpty>
							<logic:empty name="ssm" > <html:text styleId="ssm" property="ssm"  maxlength="50"/></logic:empty>
						...
						<tr>
							...
							<td colspan="3">
								<html:textarea rows="7" onkeyup="" property="xd" styleId="xd"
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<%--<button type="button"
										onclick="save('dekt_dsglsq.do?method=add&type=save');return false;"
										id="buttonSave">
										保存草稿
									</button>--%>
									<button type="button"
										onclick="save('dekt_dsglsq.do?method=add&type=submit');return false;"
										id="buttonSave">
										提交申请
									</button>
