			...
			<meta name="viewport" content="width=device-width, initial-scale=1.0">
				<link href="assets/plugins/bootstrap/css/bootstrap.min.css"
					...
					<link href="assets/css/style.css" rel="stylesheet">
						...
						<link rel="stylesheet" href="comm/skin/zfstyle/ymPrompt.css"
							type="text/css" media="all" />
						<script type="text/javascript"
							src="<%=stylePath%>js/lhgdialog/lhgdialog.min.js?skin=iblue"></script>
						<script type="text/javascript" src="js/calendar/calendar.js"></script>

						<script type="text/javascript" src="js/jquery/jquery.form.js"></script>
						<script type="text/javascript"
							src="xsgzgl/dekt/qnzyhd/js/ycjhd.js"></script>
				...
				<div class="search-wrap">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-r0">
						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding-lr0">
							<select id="gsshzt" name="gsshzt" class="form-control">
								<option value="">
									--请选择--
								</option>
								<option value="0">
...
<%--							</p>--%>
<%--							<p>--%>
<%--								2、点击取消，则意味着退出该志愿者活动，服务工时通过审核，不能取消活动--%>
<%--							</p>--%>
<%--							<p>--%>
<%--								3、工时审核退回，填写完工时后，请再次提交工时--%>
<%--							</p>--%>
<%--					</div>--%>
						<div style="margin-top: 15px">
							<p>点击取消，则意味着退出该志愿者活动，服务工时审核状态为通过时，不能取消活动</p>
						</div>
				</div>
<%--				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 padding-lr0 hint" style="height:120px;">--%>
<%--						<div style="margin-top: 15px">--%>
<%--							<p>--%>
<%--								1、报名审核未通过之前，不能提交工时--%>
<%--							</p>--%>
					...
					<div class="activity-list">
						...
						<div class="text-center">
							<jsp:include flush="true"
								page="/xsgzgl/dekt/qnzyhd/turnpage.jsp?form=qnzyhdForm"></jsp:include>
						</div>
					</div>
				</div>
			</div>
