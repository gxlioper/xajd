...
<head>
    ...
    <script type="text/javascript">
        ...
        var colList = [
            ...
            { label : 'jjcz', name : 'jjcz', index : 'jjcz',hidden : true },
            { label : '学号', name : 'xh', index : 'xh', width : '10%', formatter : xhLink},
            { label : '姓名', name : 'xm', index : 'xn', width : '12%' },
            { label : '性别', name : 'xb', index : 'xb', width : '10%' },
            { label : '班级', name : 'bjmc', index : 'bjdm', width : '17%' },
            { label : '家教编号', name : 'xqid', index : 'xqid', width : '12%' },
            { label : '家教操作', name : 'jjczmc', index : 'jjcz', width : '16%' },
        ...
        var gridSetting = {
            caption:"${gnmkmc}列表",
            pager:"pager",
            url:"jjgl_jjxq.do?method=getJjczshListData",
            colList:colList,
            sortname: "xqid",
            sortorder: "desc",
            radioselect:false
