...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				gridSetting['params'] = {sblx : jQuery('#sblx').val()};
	...
	<body>
		...
		<input type="hidden" value="${sblx}" id="sblx"/>
