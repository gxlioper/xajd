...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var xgzgh = jQuery("#xgzgh").val();
		var gridSetting = {
								
				caption:"",
				pager:"pager",
				url:"gyjc_ccrcsz.do?method=updateCcrList&type=query&ccid="+ccid+"&xgzgh="+xgzgh,
				colList:[
	...
	<body>
		<html:form action="/gyjc_ccrcsz">
			...
			<html:hidden property="xgzgh" styleId="xgzgh"/>
			<div class="toolbox">
				<!-- 按钮 -->
				<div class="buttonbox">
					<ul>
						...
						-->
						<li id="li_fp">
							<a href="javascript:void(0);" class="btn_sz" onclick="updateFyfp();return false;"  >分配</a>
						</li>	
