...
<head>
    ...
    <script type="text/javascript" src="xsgzgl/zhdj/sgygc/dzbbjgl/js/dzbbjglList.js"></script>
        ...
        <div class="buttonbox">
            <ul>
                 <logic:equal name="writeAble" value="yes">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="btn_zj" onclick="add();return false;">新增联系班级</a>
                    </li>
                    <li>
