	...
	<head>
		...
		jQuery(function(){
			var gridSetting = {
				caption : "",
				pager : "pager",
				url : "sgygc_jjfzbfgl.do?method=getBfr&type=query",
				colList : [
                    {label : 'key', name : 'xb', index : 'xb', hidden : true},
                    {label : 'key1', name : 'sjhm', index : 'sjhm', hidden : true},
                    {label : 'key2', name : 'qqhm', index : 'qqhm', hidden : true},
					...
					{label : 'key6', name : 'bzrxm', index : 'bzrxm', hidden : true},
                    {label : 'key7', name : 'csrq', index : 'csrq', hidden : true},
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							<a href="javascript:void(0);" class="btn_sz" onclick="choseBfr();return false;">选择人员</a>
						</li>
