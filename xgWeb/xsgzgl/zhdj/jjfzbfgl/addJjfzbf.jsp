				...
				<table width="100%" border="0" class="formlist">
					...
					<tr>
						...
						<td >
							...
							<button class="btn_01" type="button" onclick="showDialog('请选择一个学生',800,500,'sgygc_jjfzbfgl.do?method=getJjfz');">选择</button>
						</td>
						<th>姓名</th>
					...
					<tr>
						...
						<td >
							...
							<button class="btn_01" type="button" onclick="showDialog('请选择一个学生',800,500,'sgygc_jjfzbfgl.do?method=getBfr');">选择</button>
						</td>
						<th>姓名</th>
