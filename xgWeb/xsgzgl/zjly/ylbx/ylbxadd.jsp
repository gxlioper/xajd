				...
				<table width="" border="0" class="formlist">
					...
					<tbody>
						<tr>
						    ...
						    <td>
								<div>
									<html:radio property="cxblb" value="新参保"  styleId="cxblb">新参保</html:radio>
									<html:radio property="cxblb" value="续保" styleId="cxblb">续保</html:radio>
								</div>
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<div>
									<html:radio property="shbz" value="审核通过" styleId="shbz">审核通过</html:radio>
									<html:radio property="shbz" value="审核不通过" styleId="shbz">审核不通过</html:radio>
								</div>
							</td>
						</tr>
						<tr>
