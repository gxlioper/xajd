	...
	<head>
		...
		jQuery(function(){
			var gridSetting = {
				caption : "",
				pager : "pager",
				url : "zjly_zhfdr.do?method=getZhfdrCx&type=query&lb=dr",
				colList : [
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							...
							<li><a href="javascript:void(0);" onclick="importJfxm();return false;" class="btn_dr">导入</a></li>
							<li><a href="javascript:void(0);" onclick="exportJfxm();return false;" class="btn_dc">导出</a></li>
					</ul>
				</div>
				<!-- 过滤条件 -->	
