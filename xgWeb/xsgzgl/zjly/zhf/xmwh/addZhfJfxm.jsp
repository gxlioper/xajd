				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="jfxmmc" id="jfxmmc" maxlength="50" />
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<input type="text" name="khyd" id="khyd" maxlength="50" />
							</td>
							<th>
								<font color="red">*</font>
								得分
							...
							<td>
								<input type="text" name="fs" id="fs" maxlength="3" />
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr style="display: none" id="xdfstr">
							<th>限定分数</th>
							<td>
								<input type="text" name="xdfs" id="xdfs" maxlength="3"/>
							</td>
						</tr>
					</tbody>
				</table>	
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button class="button2" id="btn_bc" type="button" onclick="saveJfxm('save')">
										保 存
									</button>
