...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function showZzxmShqk(obj,xmdm){
				jQuery(".ha").removeClass("ha");
				jQuery(obj).parent().addClass("ha");
				jQuery(".comp_con").load("xszz_sqsh.do?method=zzxmShqk&xmdm="+xmdm);
			}
	...
	<body>
		<html:form action="/xszz_sqsh">
			...
			<div class="comp_title" id="comp_title">
		      <ul style="width: 90%; margin-top: 0px;">
				<logic:present name="zzxmList">
					<logic:iterate id="zzxm" name="zzxmList">
						<li>
							<a href="javascript:void(0);"  onclick="showZzxmShqk(this,'${zzxm.xmdm}');">
								<span>${zzxm.xmmc}</span>
							</a>
						</li>
					</logic:iterate>
