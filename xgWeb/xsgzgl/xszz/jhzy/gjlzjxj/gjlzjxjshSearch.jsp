...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
			...
			var url = "jhzyGjlzjxj.do?method=searchGjlzjxjsh";
			var ie = "ie";
		...
		function checkLineNum(){
			...
			if(len==0){	
				...
				var url="jhzyGjlzjxj.do?method=gjlzjxjshUpdate";
					url+="&pkValue="+pkValue;
		...
		function saveKnsrdSh(shzt){
			var message = "";
			if(shzt == "tg"){
				message = "您确认审核<font color='blue'>通过</font>所勾选学生的国家励志奖学金申请吗？";
			}else if(shzt == "btg"){
				message = "您确认审核<font color='blue'>不通过</font>所勾选学生的国家励志奖学金申请吗？";
			}
			...
			confirmInfo(message,function(tag){
				if(tag=="ok"){
					...
					//路径
					var url = "jhzyGjlzjxj.do?method=saveGjlzjxjSh";
