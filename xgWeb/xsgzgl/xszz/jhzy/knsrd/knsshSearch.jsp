...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
			...
			var url = "jhzy_knsrd.do?method=searchKnssh";
			var ie = "ie";
		...
		function checkLineNum(){
			...
			if(len==0){	
				...
				var url="jhzy_knsrd.do?method=knsshUpdate";
					url+="&pkValue="+pkValue;
		...
		function saveKnsrdSh(shzt){
			var message = "";
			if(shzt == "tg"){
				message = "您确认审核<font color='blue'>通过</font>所勾选学生的困难生申请吗？";
			}else if(shzt == "btg"){
				message = "您确认审核<font color='blue'>不通过</font>所勾选学生的困难生申请吗？";
			}
					...
					<table width="100%" border="0" class="formlist">
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
									<input type="radio" name="tjdc" value="一般困难" checked="checked"/>一般困难
									<input type="radio" name="tjdc" value="特别困难"/>特别困难
