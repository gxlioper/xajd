...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveGjzxjSh(shzt){
			var message = "";
			if(shzt == "tg"){
				message = "您确认审核<font color='blue'>通过</font>该学生的国家助学金申请吗？";
			}else if(shzt == "btg"){
				message = "您确认审核<font color='blue'>不通过</font>该学生的国家助学金申请吗？";
			}
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">
								<input type="radio" name="tjdc" value="一等" <logic:equal name="tjdj" value="一等">checked="checked"</logic:equal>/>一等（￥4000）
								<input type="radio" name="tjdc" value="二等" <logic:equal name="tjdj" value="二等">checked="checked"</logic:equal>/>二等（￥2500）				
							</td>
						</tr>
						<tr>
							<th width="">
