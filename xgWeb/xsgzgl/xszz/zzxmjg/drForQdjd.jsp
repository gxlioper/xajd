				...
				<table width="100%" border="0" class="formlist">
					<tbody>
						<tr>
							...
							<td colspan="3">
								<a href="javascript:void(0);" onclick="downloadDrmb();" class="name"  style="margin-left:3px;font-weigth:bold;font-size:14px">下载</a>								
							</td>
						</tr>
						<tr>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="Dr();">
										导入
									</button>
									<button type="button" onclick="gb();">
										关闭
									</button>
								</div>
							</td>
