				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
							<tr>
								...
								<td colspan="3">
									<html:select property="ylzd5" styleId="ylzd5">
										<html:options collection="knyyList" property="yydm"
											labelProperty="yymc" />
									</html:select>
								</td>
							</tr>
					...
					<logic:equal value="10355" name="xxdm">
							...
							<td colspan="3">
								<html:textarea  property='jtrjnsr' styleId="jtrjnsr" style="word-break:break-all;width:20%" onblur="chLengs(this,450);"
					   ...
					   <logic:notEqual name="xxdm" value="10026">
			      		 ...
			      		 <logic:equal value="10355" name="xxdm">
							...
							<td colspan="3">
								<html:textarea property='ylzd5' style="width:98%" styleId="ylzd5" rows='5' onblur="checkLen(this,200);"/>
							</td>
			     				</tr>
			     		 </logic:equal>
			     <!--北京中医药大学-->
