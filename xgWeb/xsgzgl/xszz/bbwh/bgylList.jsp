	...
	<head>
		...
		<script type="text/javascript">
			function viewDjbg(bbdm,xmdm,bblx) {
				showDialog("登记表设置",765,675,"xszz_bbwh.do?method=showYlbg&bbdm="+bbdm+"&xmdm="+xmdm+"&bblx="+bblx,{
					fixed:false,
					close:function(){
						window.reload();
					}
	...
	<body>
		<div class="djb_list">
			<div class="djb_list_nav">
				<h4>
					（${xmxx.sqxn }&nbsp;学年）${xmxx.xmmc }
				</h4>
				<a href="xszz_xmwh.do?method=xmwhCx">返回</a>
			</div>
				    	...
				    	<logic:iterate id="bbxx" name="bbxxList">
				    		<li id="${bbxx.bbdm }">
								<a href="javascript:void(0);" 
								   onclick="viewDjbg('${bbxx.bbdm }','${xmxx.xmdm }','${bbxx.bblx}');">
