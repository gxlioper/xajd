...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var gridSetting = {
				...
				colList:[
				   {label:'项目类别代码',name:'xmlbdm', index: 'xmlbdm',key:true,width:'20%'},
				   {label:'项目类别名称',name:'xmlbmc', index: 'xmlbmc',width:'40%'},
				   {label:'艺术团类别名称',name:'ystlbmc', index: 'ystlbmc',width:'40%'}
				],
				sortname: "xmlbdm",
			 	sortorder: "asc"
			} 
		...
		<div class="tab_cur">
			...
			<div class="compTab" id="card">
				<div class="comp_title">
					<ul>
						<li ><a href="#" onclick="newChgCode(this);return false;" id="ystglDmwh.do?method=getYstlbList"><span>艺术团类别</span></a></li>
						<li class="ha"><a href="#" onclick="newChgCode(this);return false;" id="ystglDmwh.do?method=getXmlbList"><span>项目类别</span></a></li>
