...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			 var mc=jQuery("#ystlbmc").val();
			  if(jQuery.trim(mc)==""){
				  showAlert("请输入艺术团类别名称！");
					return false;
			  }
			  var url = "ystglDmwh.do?method=updateYstlb&type=update";
	...
	<body>
		<html:form action="/ystglDmwh" method="post" styleId="YstglDmwhForm"
			...
			<html:hidden property="ystlbdm" styleId="ystlbdm" />
				...
				<table align="center" class="formlist">
					<tbody>
						<tr>
							...
							<td>
								<html:text property="ystlbmc" styleId="ystlbmc" maxlength="10" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"
									styleClass="text_nor" />
							</td>
						</tr>
