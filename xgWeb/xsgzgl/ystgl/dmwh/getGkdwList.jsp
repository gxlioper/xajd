...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var gridSetting = {
				...
				colList:[
				   {label:'挂靠单位代码',name:'gkdwdm', index: 'gkdwdm',key:true,width:'15%'},
				   {label:'挂靠单位名称',name:'gkdwmc', index: 'gkdwmc',width:'85%'}
				],
				sortname: "gkdwdm",
			 	sortorder: "asc"
			} 
			...
			<div class="compTab" id="card">
				<div class="comp_title">
					<ul>
						...
						<li class="ha"><a href="#" onclick="newChgCode(this);return false;" id="ystglDmwh.do?method=getGkdwList"><span>挂靠单位</span></a></li>
					</ul>
				</div>
			</div>	
			<!-- 过滤条件 -->
