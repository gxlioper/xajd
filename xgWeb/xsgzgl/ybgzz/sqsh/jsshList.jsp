	...
	<head>
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				var gridSetting = {
					pager:"pager",
					url:"ybgzzSqsh.do?method=getJsshList",
					colList:[
					   ...
					   {label:'申请加入日期',name:'sqjrsj',index:'sqjrsj',width:'13%'},
			...
			function cancelAuding(){
				...
				if (ids.length != 1){
					...
					jQuery.post("ybgzzSqsh.do?method=cancelAudit",{id:ids.toString(),gwid:rows[0]["xtgwid"]},function(data){
			...
			function cksq(id){
				showDialog("查看申请表",600,400,"ybgzzSqsh.do?method=view&id="+id);
			}
		</script>
	</head>
