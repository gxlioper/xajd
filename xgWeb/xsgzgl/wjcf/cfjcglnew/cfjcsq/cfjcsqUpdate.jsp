...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="showCfqxFlag('${map.cflbdm }');">
		<html:form method="post" styleId="cfjcsqForm" action="/wjcf_cfjcsq"  >
			...
			<html:hidden property="sqjg" styleId="sqjg"/>
					...
					<tbody>
						...
						<logic:equal name="xxdm" value="12865">
							<tr>
								...
								<td colspan="3">
									<html:text property="jdxx" styleId="jdxx"  maxlength="30"></html:text>
								</td>
							</tr>
							<tr>
								<th align="right">
									<font color="red">*</font>处分鉴定申请
									<br />
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="updateSave('wjcf_cfjcsq.do?method=cfjcsqUpdateSave&type=save')" id="buttonSave">
										保存草稿
									</button>
									&nbsp;&nbsp;
									<button type="button" onclick="updateSave('wjcf_cfjcsq.do?method=cfjcsqUpdateSave&type=submit')" id="buttonSave">
										提交申请
									</button>
									&nbsp;&nbsp;
