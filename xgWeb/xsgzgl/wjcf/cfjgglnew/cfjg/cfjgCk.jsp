...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function fjxz(type){
			if(type=="sbfj"){
				var sbfj = jQuery("#sbfj").val();
				jQuery("#fjmc").val(sbfj);
				}
			if(type=="ssfj"){
				var ssfj = jQuery("#ssfj").val();
				jQuery("#fjmc").val(ssfj);
				}
			var url="wjcf_cfjg.do?method=fjxz";
	...
	<body >
		<html:form action="/wjcf_cfjg" method="post" enctype='multipart/form-data'>	
					...
					<tr>
						...
						<td align="left">
							...
							<logic:notEqual name="xxdm" value="13011">
								&nbsp;&nbsp;&nbsp;&nbsp;<span id="showCfqx" style="color: red">${cfqx }</span>
							</logic:notEqual>
						</td>
					</tr>
