...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save(){
			...
			if(""==xh||""==cfyymc||""==cflbdm||""==wjsj||cfwh==""||cfsj==""||filepath==""||filepath4==""){
			...
			jQuery.post("wjcf_cfsbgl.do?method=checkExistCfjg", {
				...
				if(data ==null || data){
					...
					return false;
				     ...
				     var url = "wjcf_cfjg.do?method=saveCfjgXg";
		...
		<html:form action="/wjcf_cfjg" method="post" enctype='multipart/form-data' styleId="cfjgForm">
				...
				<div  style="width:100%;overflow-x:hidden;overflow-y:auto;">
					...
					<tr>
						...
						<td align="left">
							<html:select property="cflbdm" styleId="cflbdm" style="width:140px" value="${rs.cflbdm }" onchange="showCfqxFlag(this.value);">
								<html:option value=""></html:option>
					...
					<tr>
						...
						<td align="left">
							<html:text property="wjsj" styleId="wjsj"
								style="cursor:hand;"
								onclick="return showCalendar('wjsj','y-mm-dd',true,'cfsj');" value="${rs.wjsj }"/>
						</td>
						<th align="right">
							上报人
						</th>
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:select property="nd" styleId="nd" style="width:140px" value="${rs.nd }" onchange="initCfwh(this.value)">
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:select property="sdlx" styleId="sdlx" value="${rs.sdlx}">
								<html:option  value=""> </html:option >
								<html:option  value="直接送达">直接送达</html:option >
								<html:option  value="留置送达">留置送达</html:option >
								<html:option  value="邮寄送达">邮寄送达</html:option >
								<html:option  value="公告送达">公告送达</html:option >
							</html:select>
						</td>
					</tr>
					</logic:equal>
					...
					<tr>
						...
						<td align="left" colspan="3" >
								<html:textarea styleId="cfyj" property='cfyj' style="width:600px"
								rows='4' onblur="checkLen(this,1000)" value="${rs.cfyj}"></html:textarea>
						</td>
					</tr>
					<tr>
						<th align="right">
					...
					<tr>
						...
						<td colspan="3">
							<html:hidden name="rs" property="filepath2" styleId="filepath2" />
					...
					<tr>
						...
						<td colspan="3">
							<html:hidden name="rs" property="filepath3" styleId="filepath3" />
					...
					<tr>
						...
						<td colspan="3">
							<html:hidden name="rs" property="filepath4" styleId="filepath4" />
