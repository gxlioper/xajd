...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save(){
			...
			if(ycflbdm==cflbdm){
				...
				refreshForm('general_wjcf_cfsb_ajax.do?method=updateCfsb&flag='+flag);
			}
		</script>
	...
	<body >
		<html:form action="/general_wjcf_cfsb_ajax" method="post" enctype='multipart/form-data'>
					...
					<input type="hidden" id="ycflbdm" value="${wjsb.cflbdm}" />	
					...
					<tr>
						...
						<td align="left">
							<html:select property="cfyydm" styleId="cfyydm" value="${wjsb.cfyydm}" style="width:140px">
						...
						<td align="left">
							<html:select property="cflbdm" styleId="cflbdm" value="${wjsb.cflbdm}" style="width:140px">
								<html:option value=""></html:option>
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:text property="wjsj" styleId="wjsj"
								...
								onclick="return showCalendar('wjsj','y-mm-dd');" value="${wjsb.wjsj}"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left" colspan="3" >
								...
								rows='5' value="${wjsb.wjssjg}" onblur="checkLen(this,1000)"/>
						</td>
					</tr>
						<tr>
						<td align="right">
						...
						<td align="left" colspan="3" >
								...
								rows='5' value="${wjsb.bz}" onblur="checkLen(this,1000)"/>
						</td>
					</tr>
					</tbody>
