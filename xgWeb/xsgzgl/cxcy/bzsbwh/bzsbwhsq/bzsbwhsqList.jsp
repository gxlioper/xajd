...
<head>
    ...
    <script type="text/javascript" src="xsgzgl/cxcy/bzsbwh/bzsbwhsq/js/bzsbwhsqList.js"></script>
...
<body>
    ...
    <html:form action="/cxcy_bzsbwhsq">
        <input type="hidden" name="isopen" id="isopen" value="${ccszModel.isopen }"/>
