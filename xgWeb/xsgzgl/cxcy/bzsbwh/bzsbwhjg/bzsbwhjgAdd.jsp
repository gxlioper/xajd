    ...
    <div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;height: 500px' >
        <table width="100%" border="0" class="formlist">
            ...
            <tr>
                ...
                <td>
                    <html:text property="bzje" styleId="bzje" style="width:100px;" onblur="checkMoney(this);"/>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td colspan="3">
                    <html:textarea property='sqly' style="width:98%" styleId="sqly" rows='4' onblur="checkLen(this,500);"/>
                </td>
            </tr>
            </tbody>
        </table>
