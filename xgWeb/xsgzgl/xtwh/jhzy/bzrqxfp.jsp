			...
			function save(type) {
				if("group"==type){
					...
					if(userGroup == ""){
						...
						document.forms[0].action = "jhzy_xtwh.do?method=bzrqxfp&doType=save&yhm="+yhm;
					...
					var yhm=getStr(document.forms[0].topGroup.options[document.forms[0].topGroup.selectedIndex].text, 0)
					...
					document.forms[0].action = 'jhzy_xtwh.do?method=bzrqxfp&doType=qx&yhm='+yhm;
					document.forms[0].submit();
	...
	<body>
		<html:form action="/jhzy_xtwh" method="post">
				...
				<div class="tab_cur" id="title">
					<p class="location">
							<em>您的当前位置:</em><a>系统维护 - 权限维护 - 班主任权限维护</a>
					</p>
				</div>
				...
				<div class="tab">
				  <table width="100%" border="0" class="permissionlist">
				    <thead>
				    	<tr>
				        	<td colspan="3"><span>班主任权限维护</span></td>
				        </tr>
				    </thead>
				      <tr>
				          ...
				          <table width="100%">
				              ...
				              <tr>
				                <td>
				                  ...
				                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                  <button type="button" onclick="showTopWin('jhzy_xtwh.do?method=userQuery&doType=bzr','350','350');">
										用户查询
									</button>
