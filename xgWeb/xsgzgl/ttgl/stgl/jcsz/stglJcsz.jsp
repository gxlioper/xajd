...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/jxgl/general/gfjyqk/jcsz/js/gfjyJcsz.js"></script>
...
function saveJcsz(){
	...
	var url = "ttgl_stgljcsz.do?method=saveStglJcsz";
	ajaxSubFormWithFun("stjcszForm",url,function(data){
	...
	<body >
		<html:form action="/ttgl_stgljcsz" method="post" styleId="stjcszForm" >
			<div class="tab_cur">
				<p class="location">
