...
function tocheck(sqid,shid,gwid){
	...
	showDialog("Ω±œÓ…Û∫À",700,500,"bzjl_sqsh.do?method=viewJxsh&sqid="+sqid+"&shid="+shid+"&gwid="+gwid);
}
...
function plshtg(){
	...
	showDialog("≈˙¡ø…Û∫À",700,300,"bzjl_sqsh.do?method=toPlshy&xn="+xn+"&xq="+xq+"&bjdms="+bjdms);
}