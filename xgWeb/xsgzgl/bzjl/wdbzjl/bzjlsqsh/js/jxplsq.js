...
function getDclGird(){
	...
	return {
		caption:"申请学生列表 ",
		pager:"pager",
		url:"bzjl_sqsh.do?method=viewJxsqList_new&type=query",
		colList:colList,
		sortname:"nj",
		sortorder:"asc",
		radioselect:false
...
function viewJxsq(){
	...
	if (ids.length ==0){
		...
		//showDialog("奖项审核",700,500,"bzjl_sqsh.do?method=toCheckPjpy&xn="+xn+"&xq="+xq+"&bjdms="+bjdms);
 ...
 */
function viewShqk(){
	showDialog("评奖评优审核情况统计",500,400,"bzjl_sqsh.do?method=pjxmShtj");
}
