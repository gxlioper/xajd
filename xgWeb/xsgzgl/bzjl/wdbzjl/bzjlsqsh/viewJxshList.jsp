		...
		function getDclGird(){
			...
			var colList = [
			   ...
			   {label:'学号',name:'xh', index: 'xh',width:'12%',formatter:function(cell,rowObject){
				   return "<a href='javascript:void(0);' onclick=\"showDialog('查看申请表',800,500,'bzjl_sqsh.do?method=viewSqb&sqid="+rowObject["sqid"]+"');\" class='name'>"+cell+"</a>";
			   }},
		 ...
		 function getYclGrid(){
	 	  ...
	 	  if(jQuery('#xxdm').val() == '13627'){//重庆邮电大学 个性化添加辅导员列
			...
			function zjdxPlsh(){
				...
				showDialog("奖项审核",750,570,"bzjl_sqsh.do?method=zjdxPlsh&id="+ids.toString()+"&jsonStr="+jsonStr);
			}
