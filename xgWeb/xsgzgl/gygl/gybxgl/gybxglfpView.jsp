...
<body>
	<html:form action="/gyglnew_gybxgl" method="post">
		...
		<div class="tab" style="width:100%;height:458px;overflow-x:hidden;overflow-y:auto;">
...
<%--							readonly="true" style="width: 95%"></html:textarea>--%>
			...
			<tbody>
				<tr>
					...
					<td >
						${rs.fpztmc}
						<input type="hidden" id="fpzt" value="${rs.fpzt }"/>
					</td>
					<logic:notEmpty name="rs" property="fpbm">
					<th>分配部门</th>
					<td>
						${rs.fpbmmc}
						<input type="hidden" id="fbbm" value="${rs.fpbm }"/>
					</td>
					</logic:notEmpty>
				</tr>
				<!-- 苏州卫生职业技术学院个性化 -->
				<logic:equal value="12688" name="xxdm">
					<logic:notEmpty name="rs" property="fpxq">
					<tr>
						<th>分配校区</th>
						<td colspan="3">
							${rs.fpxqmc}
			...
			<logic:notEmpty name="rs" property="clzt">
			<thead>
				<tr>
					<th colspan="4">
						<span>处理信息</span>
...
<%--							readonly="true"	value="${rs.zbclyy}"></html:textarea>--%>
			...
			<logic:notEmpty name="rs" property="mycd">
			<thead>
				<tr>
					<th colspan="4">
						<span>服务评价</span>
