			...
			<div class="formbox">		
				...
				<table summary="" class="dateline" width="100%">
					...
					<logic:iterate name="rsArrList" id="s" indexId="index">
						<tr onclick="rowOnClick(this);" ondblclick="update('gyglnew_gybxgl.do?method=gybxglView','view')" 
							...
							<!-- 显示信息 -->
							<logic:iterate id="v" name="s" offset="8" length="4">
								<td align="left" nowrap="nowrap">
									${v }
								</td>
							</logic:iterate>
							...
							<logic:iterate id="v" name="s" offset="13" length="2">
								<td align="left" nowrap="nowrap">
										${v }
								</td>
							</logic:iterate>
