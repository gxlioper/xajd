...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveQscwfpxx_submit(){
			...
			jQuery("#bj").val(jQuery("#hidden_bjdm").val());
		...
		function loadLdlist(){
			...
			jQuery.get(url, { xb:(xb=="男"?"1":"2"),bjdm:bjdm,bz:"bjloadldlist"},
					  function(data){
				...
				<div class="searchtab">
					...
					<table id="ldtj" class="dateline" width="98%" style="display: ">
						...
						<tr>
							...
							<td align="left">当前班级床位数</td>
							<td align="left">当前班级已入住床位数</td>
							<td align="left">当前班级未入住床位数</td>
						</tr>
						</thead>
