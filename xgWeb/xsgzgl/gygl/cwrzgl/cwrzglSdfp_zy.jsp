	...
	<head>
		...
		function saveQscwfpxx(doType){
			...
			if(doType=="qxfp"){
				...
				$("th_span_lable").innerHTML="请选择退宿时间";
				$("th_rzsj").innerHTML="退宿时间";
				...
				tipsWindownNew("保存提示","id:tempDiv",350,200);
				...
				$("th_span_lable").innerHTML="请选择入住时间";
				$("th_rzsj").innerHTML="入住时间";
				...
				"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				//tipsWindown("保存提示","id:tempDiv","400","200","true","","true","id");
		...
		function loadLdlist(){
			...
			jQuery.get(url, { xb:(xb=="男"?"1":"2"),bjdm:bjdm,bz:"zyloadldlist"},
					  function(data){
	...
	<body onload="">
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				...
				<font color="black"><B>未入住床位</B></font>。<br>
...
<%--				<%@ include file="/comm/search/superSearchArea.jsp"%>--%>
				...
				<div class="searchtab">
					...
					<table id="ldtj" class="dateline" width="98%" style="display: ">
						...
						<tr>
							<td align="left">楼栋</td>
							<td align="left">当前<bean:message key="lable.xsgzyxpzxy" />总床位数</td>
							<td align="left">当前<bean:message key="lable.xsgzyxpzxy" />已分配床位数</td>
							<td align="left">当前<bean:message key="lable.xsgzyxpzxy" />未分配床位数</td>
							<td align="left">当前专业床位数</td>
							<td align="left">当前专业已入住床位数</td>
							<td align="left">当前专业未入住床位数</td>
						</tr>
						</thead>
						...
						<tfoot>
							<tr>
								<td colspan="2" nowrap="nowrap">
									...
									<div class="btn">
										<button type="button" name="保存"  onclick="saveQscwfpxx_submit_browser()">
											确 定 
										</button>
