    ...
    <script type="text/javascript">
        jQuery(function(){
            var gridSetting = {
                caption : "楼栋信息列表",
                pager : "pager",
                url : "gygl_sfqscj_wh.do?method=sqList&type=query",
                colList : [
        ...
        function add(){
            showDialog("增加",700,550,"gygl_sfqscj_wh.do?method=add");
        }
        function update(){
            ...
            showDialog("修改",700,550,"gygl_sfqscj_wh.do?method=update&sqid="+rows[0]["sqid"]);
        }
        function view(sqid){
        ...
        function del() {
            ...
            confirmInfo("您确定要删除"+ids.length +"条记录吗?",function(ty){
                if(ty=="ok"){
                    jQuery.post("gygl_sfqscj_wh.do?method=del",{values:ids.toString(),keys:arr.toString()},function(data){
        ...
        function submit(){
            ...
            if (ids.length != 1){
                ...
                var rows = jQuery("#dataTable").getSeletRow();
                var url = "gygl_sfqscj_wh.do?method=submit";
        ...
        function cancel(){
            ...
            if (ids.length == 0) {
                ...
                showConfirmDivLayer("您确定要撤销选择的记录吗？",{"okFun":function(){
                    jQuery.post("gygl_sfqscj_wh.do?method=cancel",
                        {
                            values:ids.toString(),
                            splc : rows[0]['splc']
                        },function(data){
