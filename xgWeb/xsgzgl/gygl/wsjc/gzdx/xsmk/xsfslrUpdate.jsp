			        ...
			        <td colspan="6">
			          <div class="btn">
			          	<logic:notEqual value="view" name="doType">
			          		<button type="button" name="保存" onclick="save('/xgxt/commWsjc.do?method=xsfslrUpdate&doType=save');">保存</button>
			          	</logic:notEqual>
			          		<button type="button" onclick="window.close();return false;">关闭</button>
			          </div></td>
			      </tr>
			    </tfoot>
			</table>
