...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//查询
		function searchRs(){
			allNotEmpThenGo('gzdx_gygl_wsjc_fscx.do');
		}
		...
		function showXxInfo(type){
			var lx = $("lx").value 
			var url = "/xgxt/gzdxWsjc.do?method=fscxUpdate";
				url+= "&lx="+lx;
		...
		function wsjcExp(){
			...
			var lx = $("lx").value 
			var url = "/xgxt/gzdxWsjc.do?method=fscxManage&doType=exp";
				url+= "&lx="+lx;
	...
	<body onload="showGdtj('Three-Four-Five-Six');">
		<!-- 标题 -->
		<div class="tab_cur">
			<p class="location">
...
<%--							<li id="scId">--%>
<%--								<a href="#"--%>
<%--									onclick="sumitInfo('/xgxt/gzdxWsjc.do?method=fscxManage','del');"--%>
<%--									class="btn_sc">删除</a>--%>
<%--							</li>--%>
<%--							<li id="dcId">--%>
<%--								<a href="#"--%>
							...
							<thead>
								<tr align="center" style="cursor:hand">
									...
									<logic:equal name="lx" value="qs">
										...
										<td onclick="tableSort(this)" nowrap>检查人员</td>
										<logic:equal name="lrxs" value="分数">
