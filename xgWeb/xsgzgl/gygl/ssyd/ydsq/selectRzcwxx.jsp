		...
		<script type="text/javascript">
			var gridSetting = {
				...
				colList:[
				   ...
				   {label:'操作',name:'rzcwxx', index: '',width:'58px',noSort:true,formatter:function(cell,rowObject){
					   return "<label class='btn_01' onclick=\"selectRzcw('"+cell+"','"+rowObject["xh"]+"');\">选择</label>";
				   }}
				],
				sortname: "sfrz",
			 	sortorder: "desc",
