...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
			var url = "gyglnew_wsjc_ajax.do?method=wsjcCx";
			var ie = "10.0";
			var otherValue = [ie];
		...
		function showModi(){
			...
			if(len==1){	
				...
				var url="gyglnew_wsjc.do?method=wsjcXg";		
				url+="&pkValue="+pkValue;
		...
		function deleteWsjc(){
			...
			if(len>=1){	
				if(blog){
					confirmInfo("该操作将会删除卫生检查信息，是否确定继续操作？",function(tag){
						if(tag=="ok"){
							...
							var parameter={}
							var url="gyglnew_wsjc.do?method=wsjcSc";	
							parameter["str"]=str;							
			...
			<div class="toolbox" id="dgncz">
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							<a href="#" onclick="showTopWin('gyglnew_wsjc.do?method=wsjcZj',800,600);return false;" class="btn_zj">增加</a>
						</li>
						<li>
							<a href="#" onclick="showModi();return false;" class="btn_xg">修改</a>
						</li>
						<li>
							<a href="#" onclick="deleteWsjc();return false;" class="btn_sc">删除</a>
						</li>
						</logic:equal>
						<logic:equal name="writeAble" value="yes">
						<li>
