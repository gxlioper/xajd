...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div style='tab'>
			...
			<tbody>
				<tr>
					<th width="20%" align="right"><font color="red">*</font>职工号：</th>
					<td width="30%">
					...
					<html:hidden property="gldm" styleId="gldm" />
						<button class="btn_01" type="button"  
										onclick="showDialog('请选择一个辅导员',680,480,'szdw_fdyjtff.do?method=showFdys&goto=${path}');return false;">选择</button>
					</td>
					<th width="20%">姓名：</th>
					<td width="30%">
				...
				<tfoot>
			      <tr>
			        <td colspan="4"><div class="bz">"<span class="red">*</span>"为必填项</div>
			          <div class="btn">
			          	<button type="button" name="提交" id="buttonSave"  onclick="save('gypy.do?method=add&type=save','gldm-xn-xqdm-pyly');">保存</button>
