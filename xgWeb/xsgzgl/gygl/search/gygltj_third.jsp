		...
		<dd>
			<ul>
				<logic:iterate name="gyglXqList" id="xqdm">
					<li>
						<a href="#" class=""
							onclick="clickXq(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${xqdm.dm }','${xqdm.mc }',this);return false;" 
		...
		<dd>
			<ul id="${tjMap.tj }_ul">
				<logic:iterate name="gyglYqList" id="yqdm">
					<li>
						<a href="#" class=""
							onclick="clickYq(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${yqdm.dm }','${yqdm.mc }',this);return false;" 
			...
			<ul id="${tjMap.tj }_ul">
				...
				<logic:iterate name="gyglLdList" id="lddm">
					<li>
						<%if (lddm_count<8) {%>
							<a href="#" class=""
								onclick="clickLd_Third(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${lddm.dm }','${lddm.mc }',this);return false;" 
...
<!-- 层号 -->
<logic:equal name="tjMap" property="tj" value="ch">
	<dl>
		<dt>${tjMap.mc }：</dt>
		<dd>
			<ul id="${tjMap.tj }_ul">
				<logic:iterate name="gyglChList" id="ch">
					<li>
						<a href="#" class=""
							onclick="clickCh_Third(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${ch.dm }','${ch.mc }',this);return false;" 
							id="tj_${tjMap.tj }_${ch.dm }" name="tj_${tjMap.tj }">
							${ch.mc }
						</a>
					</li>
				</logic:iterate>	
		...
		<dd>
			<ul id="${tjMap.tj }_ul">
				<logic:iterate name="gyglCsList" id="cs">
					<li>
						<a href="#" class=""
							onclick="clickCs(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${cs.dm }','${cs.mc }',this);return false;" 
								...
								<logic:iterate name="qs" property="qsList" id="newQs">
									...
									<%if (qsh_count<12) {%>
										...
										<logic:notEqual name="newQs" property="qshmc" value="其他">
											<a href="#" class="" name="a_qsh_mc" id="qsh_mc_xs_${newQs.qshdm }" onclick="clickQsh(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${newQs.qshdm }','${newQs.qshmc }',this);return false;" title="${newQs.qshmc }">${newQs.qshmc }</a>
										</logic:notEqual>
										<!-- 其他 -->
									...
									<%}else{%>
										<!-- 寝室 -->
										<logic:notEqual name="newQs" property="qshmc" value="其他">
											<a href="#" class="" name="a_qsh_mc" id="qsh_mc_yc_${newQs.qshdm }" style="display: none;" onclick="clickQsh(this);creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${newQs.qshdm }','${newQs.qshmc }',this);return false;" title="${newQs.qshmc }">${newQs.qshmc }</a>
		...
		<dd>
			<ul>
				<logic:iterate name="gyglKfhzList" id="kfhz">
					<li>
						<a href="#" class=""
							onclick="clickTj('kfhz','${kfhz.en }');creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${kfhz.en }','${kfhz.cn }',this);return false;" 
		...
		<dd>
			<ul>
				<logic:iterate name="gyglRzztList" id="rzzt">
					<li>
						<a href="#" class=""
							onclick="clickTj('rzzt','${rzzt.en }');creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${rzzt.en }','${rzzt.cn }',this);return false;" 
		...
		<dd>
			<ul>
				<logic:iterate name="gyglCwfpList" id="cwfp">
					<li>
						<a href="#" class=""
							onclick="clickTj('cwfp','${cwfp.en }');creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${cwfp.en }','${cwfp.cn }',this);return false;" 
		...
		<dd>
			<ul>
				<logic:iterate name="gyglXbxdList" id="xbxd">
					<li>
						<a href="#" class=""
							onclick="clickTj('xbxd','${xbxd.en }');creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${xbxd.en }','${xbxd.cn }',this);return false;" 
		...
		<dd>
			<ul>
				<logic:iterate name="gyglRzqkList" id="rzqk">
					<li>
						<a href="#" class=""
							onclick="clickTj('rzqk','${rzqk.en }');creatClickedTj_Third('${tjMap.tj }','${tjMap.mc }','${rzqk.en }','${rzqk.cn }',this);return false;" 
...
<!-- 退宿原因 -->
<logic:equal name="tjMap" property="tj" value="tsyy">
	<dl>
		<dt>${tjMap.mc }：</dt>
		<dd>
			<ul>
				<logic:iterate name="gyglTsyyList" id="tsyy">
					<li>
						<a href="#" class=""
							onclick="clickTj('tsyy','${tsyy.dm }');creatClickedTj('${tjMap.tj }','${tjMap.mc }','${tsyy.dm }','${tsyy.mc }',this);return false;" 
							id="tj_${tjMap.tj }_${tsyy.dm }" name="tj_${tjMap.tj }">
							${tsyy.mc }
						</a>
					</li>
				</logic:iterate>	
