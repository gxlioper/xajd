...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/gygl/ldgl/js/ldfpNew.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"",
				pager:"pager",
				url:"gyglnew_ldgl.do?method=ldfpUpdateNew&type=query",
				colList:[
					{label:'用户名',name:'yhm', index: 'yhm',width:'35%'},
	...
	<body>
		...
		<html:form action="/gyglnew_ldgl">
			...
			<div style="display:none">
				<logic:iterate id="ld" name="ldArry">
					<input name="checkVal" value="${ld}" type="hidden"/>
				</logic:iterate>
			</div>
