...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<input type="hidden" name="lddmN" id="lddmN" value="${qsxx.lddm}" />
		<input type="hidden" name="qshN" id="qshN" value="${qsxx.qsh}"/>
		<input type="hidden" name="qshN" id="chN" value="${qsxx.ch}"/>
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<th>申请时间</th>
							<td><html:text property="sqsj" styleId="sqsj" readonly="true" style="width:150px" /> </td>
						</tr>
						<tr>
							<th>申请理由</th>
							<td colspan="3">
