...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function yanzheng(){
				var ny = jQuery("#ny").val();
				var khxs = jQuery("#khxs").val();
				var dysskhfz = jQuery("#dysskhfz").val();
				var regny=/^\d{4}([0][1-9]|1[0-2])$/;
				if(ny!=null && ny!=""){

					if(!regny.test(ny)){
						alertInfo("请输入有效年月！",function(tag){
							if(tag == "ok"){
								jQuery("#ny").focus();
								}
							});
			...
			jQuery(function(){
				//为button注册事件
				jQuery("#but_save").click(function(){save("nykhxsAdd")});
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody id="tbody_jbxx">
						<tr>							
							...
							<td >
								<html:text property="ny" styleId="ny" name="model" maxlength="6" ></html:text>&nbsp;(如：201310)
							</td>
						</tr>
						<tr>
							<th>
