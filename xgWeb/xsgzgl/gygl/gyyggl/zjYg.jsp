...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function saveForm(){
					var str = "ygbh-xm-xb-sfzh-nl-lxdh";
				...
				if(checkYgbh()){
					var url = "gyglnew_gyygxxgl.do?method=zjYg&type=save";
			...
			function checkYgbh(){
				var ygbh =jQuery("#ygbh").val();
				 var url = "gyglnew_gyygxxgl.do?method=checkYgbh";
				 var result = false;
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody id="tbody_jbxx">
						<tr>
							...
							<td width="30%">
								<html:text property="ygbh" styleId="ygbh" maxlength="10" onkeyup="isNotChar(this);" onblur="checkYgbh(this)" styleClass="text_nor" />
							</td>
							<th width="20%">
