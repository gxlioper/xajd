			...
			function saveUpdate(){
				var zwmc=jQuery("#zwmc").val();
				  if(zwmc==""){
				     ...
				     var url = "gyglnew_gyygzwdmgl.do?method=updateZwdm&type=update";
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody id="tbody_jbxx">
						<tr>
							...
							<td width="34%" >
								<html:text property="zwdm" styleId="zwdm" maxlength="5"  style="width:98%" styleClass="text_nor" readonly="true"/>
							</td>
						</tr>
						<tr>
							<th width="16%">
