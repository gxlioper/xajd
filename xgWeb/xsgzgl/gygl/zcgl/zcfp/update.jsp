    ...
    <div style='width:100%;overflow-x:hidden;overflow-y:auto;'>
        <table width="100%" border="0" class="formlist">
            ...
            <tr>
                ...
                <td>
                    <html:select name="rs" property="xqdm" styleId="xqdm" onchange="xqChange()">
                ...
                <td>
                    <html:select name="rs" property="lddm" styleId="lddm" onchange="ldChange();">
            ...
            <tr>
                ...
                <td>
                    <html:select name="rs" property="ch" styleId="ch" onchange="lcChange();">
                        <logic:iterate id="i" name="lcList">
                            <option value="${i}" <logic:equal value="${i}" name="rs" property="ch">selected</logic:equal>>${i}</option>
                        </logic:iterate>
                    </html:select>
                </td>
                <th>寝室号</th>
