...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//查询
		function searchRs(){
			var url = "gyjl_gyjlglnew_ajax.do?method=xsjlxxcx";
			var ie = "ie";
			var otherValue = [ie];
		...
		function ckxsjl(val){
			var pk_value=val;
			var xh=pk_value.split("!@")[0];
			var jlsj=pk_value.split("!@")[2];
			var gyjllbdm=pk_value.split("!@")[1];
			var url="gyglnew_gyjlgl_xsjlxxck.do";
