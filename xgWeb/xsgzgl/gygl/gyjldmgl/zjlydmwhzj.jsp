				...
				<table align="center" class="formlist">
					<tbody>
						<tr>
							...
							<td>
								<html:text property="gyjllbdldm" styleId="gyjllbdldm" maxlength="10"
									styleClass="text_nor" onkeyup="checkInput(this)" />
							</td>
						</tr>
						<tr>
							<th>
								<span class="red">*</span>奖惩类别名称
							</th>
							<td>
						...
						<tr>
							...
							<td>
								<html:select property="lb" styleId="lb">
									<html:option value="jf">加分项</html:option>
									<html:option value="kf">扣分项</html:option>
								</html:select>
							</td>
						</tr>
						<tr>
