...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "qmlxcssz.do?method=save" : "qmlxcssz.do?method=update";
		      ajaxSubFormWithFun("CsszForm",url,function(data){
		    	  showAlertDivLayer(data["message"],{},{"clkFun":function(){
		    		  document.location.href = "rcsw_qmlxcssz.do";
					}});
				});
		  }
		</script>
	...
	<body>
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				期末离校趋向登记申请需要开启申请开关以及申请开放时间，申请操作需在相应的开放时间内完成，<br/>
		...
		<html:form action="/qmlxcssz" method="post" styleId="CsszForm">
