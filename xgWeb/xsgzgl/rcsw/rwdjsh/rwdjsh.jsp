...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function saveSh(){
				...
				var url = "rwdjsh.do?method=dgsh&type=save";
	...
	<body>
			<html:form method="post" action="/rwdjsh.do" styleId="form" >
		...
		<html:hidden name="data" property="shid" styleId="shid"/>
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
						<jsp:include page="/xsgzgl/comm/shlc/cyyj.jsp?gnid=rwdjsh&id=shyj" />
