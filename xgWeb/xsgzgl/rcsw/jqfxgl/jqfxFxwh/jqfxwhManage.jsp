	...
	<head>
		...
		function addfxgl() {
			...
			if(rows.length > 1){
				...
				showDialog("批量返校处理",420,300,"rcsw_jqfxFxwh.do?method=pldgxsJqfx&countNum="+countNum);
				return false;										
			}
				...
				<div class="buttonbox">
					<ul>
						...
						<logic:equal name="writeAble" value="yes">					
							...
							<li><a href="javascript:void(0);" onclick="bdqktj();return false;" class="btn_dy">报到情况统计</a></li>
						</logic:equal>		
