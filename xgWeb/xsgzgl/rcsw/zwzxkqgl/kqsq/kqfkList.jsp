		...
		jQuery(function(){
			var gridSetting = {
				...
				colList : [
							...
							{ label : '抽查类型', name : 'cclxmc', index : 'cclxmc', width : '5%' },
							{ label : '抽查日期', name : 'ccrq', index : 'ccrq', width : '5%' },
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							<a href="javascript:void(0);" onclick="fdyfk();return false;" class="btn_xg" >反馈</a>
						</li>
						<li>
