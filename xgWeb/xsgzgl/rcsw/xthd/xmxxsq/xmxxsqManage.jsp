...
//			}
		...
		var DCCLBH = "rcsw_xthd_xmxxsq.do";//dcclbh,导出功能编号
		...
		function xmxxsqExportData() {
			...
			var url = "rcsw_txhd_xmxxsqgl.do?method=exportData&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							<a href="javascript:void(0);" onclick="xthdLcinfo();return false;" title="选中一条记录，点击该按钮可以查看审核流程。" class="btn_cs">流程跟踪</a>
						</li>	
						<!-- 读写权 -->
						<logic:equal name="writeAble" value="yes">					
