...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	//				return false;
	//			}
				var url = "rcsw_txhd_jcszgl.do?method=saveXmxxJcsz";
				ajaxSubFormWithFun("xmxxJcszForm",url,function(data){
	...
	<body >
		<html:form action="/rcsw_txhd_jcszgl" method="post" styleId="xmxxJcszForm" >
			<div class="tab_cur">
				<p class="location">
