		...
		<script type="text/javascript">
			...
			function update(){
				...
				if (rows.length != 1){
					...
					showDialog('修改',700,450,'hsd_sybx.do?method=sybxEdit&id='+rows[0]["id"]);
				}
			}
			...
			function addDjjd(){
				showDialog('增加商业保险',700,450,'hsd_sybx.do?method=sybxAdd');;
			}
			...
			function exportData(){
				...
				var url = "hsd_sybx.do?method=export&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
