...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(obj){
			...
			jQuery.post("rcsw_rcxwwhnew_rcxwjggl.do?method=rcxwxxSfcf",{xh:xh,xn:xn,xq:xq,xwxlStr:xwxlStr.toString(),fssjStr:fssjStr.toString()},function(data){
					if(data["message"]!=null  && data["message"]!="无"){
						showAlert(data["message"]);
						return false;
					}else{
						var url = "rcsw_rcxwwhnew_rcxwjggl.do?method=addXwjg&type=save&xh="+xh;
		  ...
		  function showXwlbxx(){
			  if(jQuery("#xxdm").val() == '10704'){
				  showDialog("选择综合测评类别",800,400,"rcsw_rcxwwhnew_rcxwdmwhgl.do?method=getXwlbList");
			  }else{
