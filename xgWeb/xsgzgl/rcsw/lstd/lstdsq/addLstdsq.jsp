...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(obj){
			...
			var url = "";
			if(obj == 'save'){
				 url = "rcsw_lstd_sqgl.do?method=addLstdsq&type=save";
			}
			if(obj == 'submit'){
				 url = "rcsw_lstd_sqgl.do?method=addLstdsq&type=submit";
			}
	...
	<body>
		...
		<html:form action="/rcsw_lstd_sqgl" method="post" styleId="lstdsqForm" onsubmit="return false">
