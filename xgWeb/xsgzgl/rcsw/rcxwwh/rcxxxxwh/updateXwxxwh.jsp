...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(obj){
			...
			var temp = "行为";
			if("13431" == jQuery("#xxdm").val()) temp="加分";
					    ...
					    <tr>
					    	...
					    	<td colspan="3" id="fileTd">
					    		<logic:notEmpty name="rcxwxxwhForm" property="fjlj">
					    			<a href="javascript:delFile('${rcxwxxwhForm.id }');" class="name">删除</a>
					    			<a href="javascript:void(0);" onclick="window.open('rcsw_rcxwwh_rcxwxxwhgl.do?method=downloadFile&id=${rcxwxxwhForm.id }');return false;" class="name">下载</a>&nbsp;${rcxwxxwhForm.fjmc }
					    		</logic:notEmpty>
