...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function saveForm() {
				...
				var url = "rcsw_rcxwwh_rcxwdmwhgl.do?method=rcxwlbdldmSjkg&type=update";
	...
	<body>
		<html:form action="/rcsw_rcxwwh_rcxwdmwhgl" method="post" styleId="form1">
