...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){
			...
			if(!sfcf){
				showAlert(temp+"记录信息有重复记录，请确认！");
				return false;
			}

			if(xwlbStr==null || xwlbStr.length<=0){
				showAlert("请增加至少一条"+temp+"类别信息！");
				return false;
			}
		...
		function showXwlbxx(){
            var temp = "行为";
            if(jQuery("#xxdm").val() == "13431") temp="加分";
			  showDialog("选择"+temp+"类别",800,400,"rcsw_rcxwwh_rcxwdmwhgl.do?method=getXwlbList");
		  }
	...
	<body>
		...
		<html:form action="/rcsw_rcxwwh_rcxwjggl" method="post" styleId="rcxwjgForm" enctype="multipart/form-data">
			...
			<input type="hidden" id="rcxwjlsj" name="rcxwjlsj" value="${rcxwjgForm.rcxwjlsj }"/><!-- 记录时间 -->
									...
									<table class="dateline" width="100%">
										<thead>
											<tr>
												...
												<td style="width: 7%">评分说明 </td>
												<td style="width: 7%"><font color="red">*</font><font color="blue">评定分值</font></td>
												<td style="width: 15%"><logic:equal value="10956" name="xxdm"><font color="red">*</font></logic:equal><logic:equal value="13011" name="xxdm"><font color="red">*</font></logic:equal><font color="blue">给分理由</font></td>
