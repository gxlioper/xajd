...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function savePddj(){
		...
		var url = "xsxwkhDjpd.do?method=pddjSingle&type=save";
		ajaxSubFormWithFun("pddjForm",url,function(data){
			...
			<thead>
					...
					<tbody>
						<tr>
							...
							<td>
								<html:select  property="pddj" styleId="pddj"  style="width:130px" value="${rs.pddj}">
		...
		<table width="100%" border="0" class="formlist" style="position: fixed; _position: absolute; bottom: 0;">	
			<tfoot>
					<tr>
						<td colspan="4">
							<div class="btn">
								<button type="button" name="保存"  onclick="savePddj();return false;">
									保 存
								</button>
