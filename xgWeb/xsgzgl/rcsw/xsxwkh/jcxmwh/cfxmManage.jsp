		...
		<script type="text/javascript">
		  var gridSetting = {
				...
				colList:[
				   ...
				   {label:'分值（分/次）',name:'fz', index: 'fz',width:'30%'},
		...
		<div class="tab_cur">
			...
			<div class="compTab" id="card">
				<div class="comp_title">
					<ul>
						<li><a href="#" onclick="newChgCode(this);return false;" id="xsxwkhJcxmwh.do?method=jlxmManage"><span>奖励分</span></a></li>
						<li  class="ha"><a href="#" onclick="newChgCode(this);return false;" id="xsxwkhJcxmwh.do?method=cfxmManage"><span>处罚分</span></a></li>
					</ul>
				</div>
			</div>	
			<!-- 过滤条件 -->
