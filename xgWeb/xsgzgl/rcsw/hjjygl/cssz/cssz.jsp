...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "hjjyCssz.do?method=save" : "hjjyCssz.do?method=update";
		      ajaxSubFormWithFun("HjjyCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/hjjyCssz" method="post" styleId="HjjyCsszForm">
