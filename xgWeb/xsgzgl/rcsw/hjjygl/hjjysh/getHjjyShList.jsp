...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/rcsw/hjjygl/hjjysh/js/hjjysh.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"户籍借用审核",
				pager:"pager",
				url:"hjjyJysh.do?method=getHjjyShList&type=query",
				colList : [
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					...
					<logic:equal name="writeAble" value="yes">
						<li id="li_sh">
							<a href="javascript:void(0);" onclick="hjjysh();return false;" 
