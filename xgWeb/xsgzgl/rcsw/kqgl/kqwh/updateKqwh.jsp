...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>	
		<html:form action="/zjsy_kqwh" method="post" styleId="KqwhForm" onsubmit="return false;">
			...
			<table width="100%" border="0" class="formlist">
				...
				<tbody>
					    <tr>
							<th width="20%">学年学期</th>
							<td>
								<span>${KqwhForm.xn}</span><span>${KqwhForm.xqmc}</span>
							</td>
						  <th>月份</th>
							<td>
								<span>${KqwhForm.toyf}</span>
							</td>
					    </tr>
					    <tr>
					        <th>周次</th>
							<td>
								<span>${KqwhForm.tozc}</span>
							</td>
					        <th>
								班级
							</th>
							<td>
								<span>${KqwhForm.bjmc}</span>
							</td>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="saveKqInfo('save');">
										保存草稿
									</button>
									<button type="button" onclick="saveKqInfo('submit');">
										提交申请
									</button>
