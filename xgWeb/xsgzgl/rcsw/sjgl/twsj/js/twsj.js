var DCCLBH = "rcswx_sjgl_twsj.do";//dcclbh,导出功能编号
function searchRs() {
...
function twsjExportData() {	
	...
	var url = "twsj.do?method=exportData&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
...
function twsjView(id,xh){
	showDialog('团委数据查看',800,400,'twsj.do?method=viewTwsj&id='+id + "&xh=" + xh);
}
