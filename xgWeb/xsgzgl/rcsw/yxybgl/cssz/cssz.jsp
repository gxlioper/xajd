...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  if(jQuery.trim(splc)==""){
				...
				var url = id == "" ? "yxybgl_cssz.do?method=save" : "yxybgl_cssz.do?method=update";
		      	ajaxSubFormWithFun("yxybCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/yxybgl_cssz" method="post" styleId="yxybCsszForm">
