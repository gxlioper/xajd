					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button"
										onclick="save('rwdjsq.do?method=add&type=save','xh-rwsj-xyqk-bjgms-hyzk-cylb-hjlb-bdlxfs-fybd');return false;"
										id="buttonSave">
										保存草稿
									</button>
									<button type="button"
										onclick="save('rwdjsq.do?method=add&type=savesubmit','xh-rwsj-xyqk-bjgms-hyzk-cylb-hjlb-bdlxfs-fybd');return false;"
										id="buttonSave">
										提交申请
									</button>
