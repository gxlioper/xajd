...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form method="post" styleId="form"
			action="/rwdjsq.do?method=add&type=save">
							...
							<tfoot>
								<tr>
									<td colspan="4">
										...
										<div class="btn">
											<button type="button"
												onclick="save('rwdjsq.do?method=update&type=save','xh-rwsj-xyqk-bjgms-hyzk-cylb-hjlb-bdlxfs-fybd');return false;"
												id="buttonSave">
												保存草稿
											</button>
											<button type="button"
												onclick="save('rwdjsq.do?method=update&type=savesubmit','xh-rwsj-xyqk-bjgms-hyzk-cylb-hjlb-bdlxfs-fybd');return false;"
												id="buttonSave">
												提交申请
											</button>
