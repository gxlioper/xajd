...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(obj){
			...
			var url = "";
			if(obj == 'save'){
				 url = "rcsw_xszbb_bbsqgl.do?method=addXszbbsq&type=save";
			}
			if(obj == 'submit'){
				 url = "rcsw_xszbb_bbsqgl.do?method=addXszbbsq&type=submit";
			}
...
<%--				}	      		--%>
	...
	<body>
		...
		<html:form action="/rcsw_xszbb_bbsqgl" method="post" styleId="xszbbsqForm" onsubmit="return false">
