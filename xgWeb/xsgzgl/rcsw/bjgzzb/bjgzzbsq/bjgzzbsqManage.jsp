...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		jQuery(function(){
			var gridSetting = {
					...
					colList:[      
					   ...
					   {label:'周次',name:'zcmc', index: 'zcmc',width:'8%'},
		...
		var DCCLBH = "rcsw_bjgzzb_bjgzzbsq.do";//dcclbh,导出功能编号
		...
		function xsgzzbsqExportData() {
			...
			var url = "rcsw_xsgzzb_xsgzzbsqgl.do?method=exportData&gzzblx=bj&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
