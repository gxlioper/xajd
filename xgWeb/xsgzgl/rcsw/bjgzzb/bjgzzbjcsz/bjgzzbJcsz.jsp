...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	//				return false;
	//			}
				var url = "rcsw_xsgzzb_jcszgl.do?method=saveXsgzzbJcsz&gzzblx=bj";
				ajaxSubFormWithFun("xsgzzbJcszForm",url,function(data){
	...
	<body >
		<html:form action="/rcsw_xsgzzb_jcszgl" method="post" styleId="xsgzzbJcszForm" >
			<div class="tab_cur">
				<p class="location">
