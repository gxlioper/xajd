...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<html:form action="/rcsw_cdgl_cdsq" method="post" styleId="rcswCdsqForm" onsubmit="return false">
					...
					<tbody>
						<tr>
							...
							<td colspan="3">
								...
								<input type="hidden" name="qxfw" value="${cdxx.qxfw }" id="qxfw" />
								<button class="btn_01" type="button"  
										onclick="showDialog('请选择一个场地',700,500,'rcsw_cdgl_cdxxwh.do?method=showCdxx&search_sfkfsq=1&goto=${pathForCd}');">选择</button>
							</td>
						</tr>
						<tr>
							<th width="16%">
						...
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									...
									<button id="save_button" type="button"  onclick="addCqsqAction();">
										保存草稿
									</button>
									<button  id="submit_button" type="button" onclick="addSubmitCdsqAction();">
										提交申请
									</button>
