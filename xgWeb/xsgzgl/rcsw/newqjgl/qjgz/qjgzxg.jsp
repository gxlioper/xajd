				...
				<table width="100%" border="0" class="formlist">
					<tbody>
						<tr>
							...
							<td>
								<bean:write name="ssxymc"/>
								<html:hidden property="ssxydm" styleId = "ssxydm" />
							</td>
						</tr>
						<tr>
							<th width="100%">
								<span class="red">*</span>请假区间
							</th>
							<td>
								<html:hidden property="qjgzid" styleId="qjgzid"/>
								<html:text property="kssj" styleId="kssj" style="width:35%" maxlength="4" onchange="autoShowLable();"></html:text>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button"
										onclick="save('qjgz.do?method=update&type=save','kssj-jssj-splcid','qjgzid');return false;"
										id="buttonSave">
										保 存
									</button>
