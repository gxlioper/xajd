		...
		<div class="tab_cur">
			...
			<div class="buttonbox">
				<ul>
					...
					<li><a href="javascript:void(0);" onclick="delCbzklx();" class="btn_sc">删除</a></li>						
				</ul>
			</div>
			</logic:equal>
			<div class="compTab" id="card">
				<div class="comp_title"><ul>
					<li ><a href="#" onclick="newChgCode(this);return false;" id="rcsw_dxsylbx_ylbxwhgl.do?method=czqebzlxListManage"><span>补助类型</span> </a>
					<li class="ha"><a href="#" onclick="newChgCode(this);return false;" id="rcsw_dxsylbx_ylbxwhgl.do?method=cbzklxListManage"><span>参保状况类型</span> </a>
				</div>
			</div>	
			<!-- 过滤条件 -->
			<div class="searchtab">
