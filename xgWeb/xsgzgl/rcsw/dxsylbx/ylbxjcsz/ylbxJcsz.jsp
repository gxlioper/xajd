...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/rcsw/dxsylbx/ylbxjcsz/js/ylbxJcsz.js"></script>
	...
	<body >
		<html:form action="/rcsw_dxsylbx_jcszgl" method="post" styleId="ylbxJcszForm" >
			<div class="tab_cur">
				<p class="location">
