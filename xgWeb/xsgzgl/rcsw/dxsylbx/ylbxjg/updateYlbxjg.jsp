...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(obj){
			...
			var url = "";
			if(obj == 'update'){
				 url = "rcsw_dxsylbx_ylbxjggl.do?method=updateYlbxjg&type=update&czqebzdm="+czqebzIds+"&cbzkdm="+cbzkIds+"&qtcbzkval="+qtcbzkval;
			}
	...
	<body>
		...
		<html:form action="/rcsw_dxsylbx_ylbxjggl" method="post" styleId="ylbxjgForm">
			<html:hidden property="yljgid"  styleId="yljgid" />
