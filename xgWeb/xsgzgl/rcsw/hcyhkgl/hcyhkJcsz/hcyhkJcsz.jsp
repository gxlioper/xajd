...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/rcsw/hcyhkgl/hcyhkJcsz/js/hcyhkJcsz.js"></script>
	...
	<body >
		<html:form action="/rcsw_hcyhk_jcszgl" method="post" styleId="hcyhkJcszForm" >
			<div class="tab_cur">
				<p class="location">
			...
			<table width="100%" border="0" class="formlist">
				...
				<tbody>
					...
					<tr>
						<th>乘车起点站</th>
						<td>
							<html:text  property="ccqdz" styleId="ccqdz"   size="23" maxlength="15"></html:text>
