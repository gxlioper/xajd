...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(obj){
          ...
          //浙江中医药
			...
			if("submit"==obj&&"3"!=sqzt&&"true"!=isopen){
				showAlert("当前未开放学生假期留校申请，请联系管理员！");
				return false;
			}
			
			var url = "";
			if(obj == 'save'){
				 url = "rcsw_jqlx.do?method=updateJqlx&type=update";
			}
			if(obj == 'submit'){
				 url = "rcsw_jqlx.do?method=updateJqlx&type=submit";
			}
			...
			if ("false" == isopen&&'3'!=sqzt && obj == 'submit'){
				showAlertDivLayer("当前未开放学生假期留校申请，请联系管理员！");
				return false;
			}
	...
	<body>
		...
		<html:form action="/rcsw_jqlx" method="post" styleId="jqlxModel">
			...
			<html:hidden property="sqzt" styleId="sqzt"/>
...
<%--								</html:select>--%>
						...
						<%--
							<tr>
								...
								<td>
									<html:text property="lddm" styleId="lddm" style="width:155px">
						...
						--%>
							<tr>
								...
								<td>
									<html:text property="dwlxdh" styleId="dwlxdh" maxlength="20"></html:text>
								</td>
							</tr>
							<tr>
								<th width="20%">
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<logic:notEmpty name="jcszModel" property="uploadid">
						    			<input type="checkbox" id="lxxy_checkbox" checked="checked"/>我已阅读并接受<a href="javascript:void(0);" onclick="window.open('common_upload.do?method=asyncDownload&fid=${jcszModel.uploadid}');return false;" class="name" style="margin-left: 0px;">《留校协议》</a>
						    		</logic:notEmpty>
						    		&nbsp;&nbsp;&nbsp;
