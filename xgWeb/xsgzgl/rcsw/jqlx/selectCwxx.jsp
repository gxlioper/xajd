	...
	<head>
		...
		<script type="text/javascript">
			var gridSetting = {
				...
				multiselect:false,
				rowNum:10,
				url:"rcsw_jqlx.do?method=selectCwxx&type=query&sqid=${sqid}",
				colList:[
			...
			function selectCw(cwxx,xh){
				...
				if (api){
					if (api.get('childDialog')){
						...
						var W = api.opener;
						W.showCwxx(cwxx,'${sqid}');
						W.location="javascript:showCwxx('"+cwxx+"','${sqid}')";
					}
				} else if (parent.window){
					parent.window.document.location="javascript:showCwxx('"+cwxx+"','${sqid}')";
				}
				iFClose();
			}
