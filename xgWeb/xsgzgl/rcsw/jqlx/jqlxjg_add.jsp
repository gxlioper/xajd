	...
	<head>
		...
		function saveForm(obj){
          ...
          //浙江中医药
			...
			var url = "rcsw_jqlx.do?method=addJqlxJg&type=save";
					...
					<tbody>
						...
						<% if("12861".equals(xxdm) || "10351".equals(xxdm)){ %>
							<tr>
								...
								<td>
									<html:text property="jzlxdh" styleId="jzlxdh" maxlength="15" onkeyup="checkInput(this)" style=" ime-mode: disabled;"></html:text>
								</td>
				      		</tr>
						<% } %>
					...
					<logic:notEqual name="xxdm" value="10344">
						<tr>
							...
							<td align="left" width="10%" colspan="3">
								<button class="btn_01" type="button"  onclick="selectCw('${path}','');return false;" >选择床位</button>
							</td>
						</tr>
						<tr id="yxzcwxx">
							<th>
