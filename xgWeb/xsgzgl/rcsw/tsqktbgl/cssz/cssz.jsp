...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "tsqktbgl_cssz.do?method=save" : "tsqktbgl_cssz.do?method=update";
		      ajaxSubFormWithFun("xqflCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/tsqktbgl_cssz" method="post" styleId="xqflCsszForm">
