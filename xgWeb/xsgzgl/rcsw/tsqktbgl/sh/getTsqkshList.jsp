...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/rcsw/tsqktbgl/sh/js/tsqksh.js"></script>
		<script type="text/javascript">
		var gridSetting = {
					caption:"特殊情况通报审核列表",
					pager:"pager",
					url:"tsqktbgl_sh.do?method=getTsqkshList&type=query",
					colList : [
