...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/rcsw/xqybgl/bjxqybgl/bjxqybcssz/js/xqybbjybcssz.js"></script>
		<script type="text/javascript" src="js/calendar/calendar.js"></script>
		<script type="text/javascript">				
		</script>
	</head>
	<body >
		<html:form action="/rcsw_xqybgl_bjxqybgl_bjxqybcsszgl" method="post" styleId="bjxqybcsszForm" >
			<div class="tab_cur">
				<p class="location">
