				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td width="30%">
								<html:select property="fzrlb" styleId="fzrlb" style="width:152px;" onchange="xsbjfj();">
							...
							<td width="30%">
								<input type="text" name="stfzrxm" style="width:100px;" id="stfzrxm" value="${stfzrxm}" readonly="true" maxlength="10"/>
					...
					<tr colspan="4">
						...
						<tr>
							...
							<td width="30%" >
								<html:text property="lxdh" styleId="lxdh" style="width:148px;" maxlength="20"></html:text>
							</td>
							<th width="20%">
								建团人
							</th>
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="editStsq('save');">
										保存草稿
									</button>
									<button type="button" onclick="editStsq('submit');">
										提交申请
									</button>
