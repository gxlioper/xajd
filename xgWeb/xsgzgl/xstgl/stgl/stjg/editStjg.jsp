...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type='text/javascript'>
			jQuery(function(){
				...
				jQuery("#fzrlb").val('${fzrlb}');
				xsbjfj();
				if('${sjly}' == 1){
					jQuery("input:not(:button,:hidden)").attr("readonly",true);
					jQuery("textarea").attr("readonly",true);
					jQuery("select:not(:'#splc')").attr("disabled",true);
					jQuery("#sqsj").removeAttr("onclick");
					jQuery("#stclsj").removeAttr("onclick");
					jQuery("#selfzr").removeAttr("onclick");
					jQuery("#selzdls").removeAttr("onclick");
				}
	...
	<body style="width: 100%">
		<html:hidden property="sjly" styleId="sjly" value="${sjly}"/>
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td width="30%">
								<html:select property="fzrlb" style="width:152px;"  styleId="fzrlb" >
							...
							<td width="30%">
								<input type="text" name="stfzrxm" style="width:100px;" value="${stfzrxm}" id="stfzrxm" readonly="true" maxlength="10"/>
					...
					<tr colspan="4">
						...
						<tr>
							...
							<td width="30%" >
								<html:text property="lxdh" styleId="lxdh" style="width:152px;" maxlength="20"></html:text>
							</td>
							<th width="20%">
								建团人
							</th>
					...
					<logic:equal value="12872" name = "xxdm">
						...
						<tr>
							<th width="20%">
								社团简介  </br><font color="red">(限500字)</font></th>
							</th>
							<td colspan="3">
						...
						<tr>
							<th width="20%">
								社团获奖情况  </br><font color="red">(限500字)</font></th>
							</th>
							<td colspan="3">
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="saveStjg('update');">
										保存
									</button>
