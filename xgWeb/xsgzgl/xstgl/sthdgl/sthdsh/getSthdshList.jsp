...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/xstgl/sthdgl/sthdsh/js/sthdsh.js"></script>
		<script type="text/javascript" src="xsgzgl/xstgl/comm/js/comm.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"${gnmkmc}",
				pager:"pager",
				url:"sthdglSthdsh.do?method=getSthdshList&type=query",
				colList:[
                    ...
                    { label : '时间', name : 'fwsj', index : 'fwsj', width : '10%' },
                    { label : '服务地点', name : 'fwddxxdz', index : 'fwddxxdz', width : '10%' },
                    { label : '服务时长', name : 'fwsc', index : 'fwsc', width : '5%' },
		...
		var gridSetting2 = {
				...
				colList:[
					...
					{ label : 'splc', name : 'splc', index : 'splc',hidden : true },
					{ label : '学号', name : 'xh', index : 'xh', width : '12%', formatter : xhLink},
                    { label : '姓名', name : 'xm', index : 'xn', width : '8%' },
                    { label : '活动名称', name : 'hdmc', index : 'hdmc', width : '12%'},
                    { label : '时间', name : 'fwsj', index : 'fwsj', width : '10%' },
                    { label : '服务地点', name : 'fwddxxdz', index : 'fwddxxdz', width : '10%' },
                    { label : '服务时长', name : 'fwsc', index : 'fwsc', width : '5%' },
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					...
					<logic:equal name="writeAble" value="yes">
						<li id="li_sh">
							<a href="javascript:void(0);" onclick="hdsh();return false;" 
