	...
	<logic:present name="jbxxList">
		<tr>
			<logic:iterate id="j" name="jbxxList" indexId="i">
				...
				<td width="34%" class="${j.zddm }" ajaxEle="true">
			...
			var showXsxxAjax = function(xh){
				jQuery.ajax({
					...
					success: function(data){
						...
						//更新页面数据
						jQuery("td[ajaxEle=true]").each(function(i){
							var td = jQuery(this);
					...
					<button class="btn_01" type="button"  
									onclick="showDialog('请选择一个学生',800,480,'xsxx_xsgl.do?method=showStudentsAjax&isAll=true');return false;">选择</button>
						</logic:notEqual>
