jQuery.extend( {
			MultiUploader_13431 : function(options) {
				var _default = {
				...
				if (commonFileuploadOptions['accept']) {
					...
					jQuery('#tips').text('提示：1.需要上传已盖章的《家庭情况调查表》！');
					
					jQuery('#tips').append('</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp2.请选择 ' + accepts.toString() + ' 格式的文件！');
					
					var maxsize = commonFileuploadOptions['maxsize'];
					maxsize = (maxsize == null || maxsize == '') ? "20" : maxsize;
					jQuery('#tips').append('</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp3.请上传不超过 ' + maxsize + ' M的文件！');
					
					var maxcount = commonFileuploadOptions['maxcount'];
					maxcount = (maxcount == null || maxcount == '') ? "3" : maxcount;
					jQuery('#tips').append('</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp4.上传文件数不超过 ' + maxcount + ' 个！')
				}
				if (commonFileuploadOptions['gid']) {
					jQuery
							.getJSON(
