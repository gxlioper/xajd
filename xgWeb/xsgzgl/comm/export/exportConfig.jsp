...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/comm/export/js/exportConfig.js"></script>
	...
	<body>
		<html:form action="/comm_export" method="post" >
			<html:hidden property="dcclbh" styleId="dcclbh" value="${dcclbh}"/>
						...
						<td width="48%" >
							<div class="tab_box">
								...
								<div class="demo_college" style="height: 400px; width: 100%;overflow-y:scroll;position:relative;z-index:1">
									<ul id="unselectUl" >
										<logic:iterate id="o" name="configList" >
											<logic:equal  name="o" property="zt" value="0">
												<li style="position:relative">
													<label class="college_li college_checkbox" style="height:20px;line-height:20px!important;font-size:12px!important;*height:28px;width:120px;">
														${o.zdmc}
