...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" src="xsgzgl/xlzx/yysqnew/js/yysqDetail.js"></script>
	</head>
	<body onload="init();">
		<html:form action="/xlzx_yysqnew" method="post">
		<!--  <input type="hidden" id="url" name="url" value="xlzx_yysqnew.do?method=yysqDetail" /> -->
							...
							<tr style="height:10px">
								...
								<td colspan="2">
									...
									<logic:notEqual name="zxsList" property="kjdrs" value="">
										<span class="blue">该咨询师当日已成功预约</span><span class="red">${zxsList.yjdrs}</span><span class="blue">人,上限</span><span class="red">${zxsList.kjdrs}</span><span class="blue">人</span>
									</logic:notEqual>
								</td>
							</tr>
							<tr style="height:10px">
