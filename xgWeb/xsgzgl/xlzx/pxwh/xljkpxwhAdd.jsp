				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td colspan="3">
								<html:text property="pxzt" maxlength="30" styleId="pxzt" style="width:96%" ></html:text>
							</td>
						</tr>
						<tr>
						<tr>
						...
						<tr>
							...
							<td width="30%">
								<html:text property="sxrs" maxlength="5" styleId="sxrs" onblur="checkInt(this);" value="200"></html:text>
							</td>
							<th  width="20%">
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="save('xlzx_pxwh.do?method=pxwhAdd&type=save','pxzt-pxdd-pxsj-js-sxrs-bmkg-kssj-jssj');" id="buttonSave">
										保 存
									</button>
