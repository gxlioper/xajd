		...
		jQuery(function(){
			var gridSetting = {
				...
				colList : [
							...
							{ label : '咨询次数', name : 'cs', index : 'cs', width : '15%' }
						 ],							
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							<a href="javascript:void(0);" onclick="wh();return false;" class="btn_sz">咨询记录维护</a>
						</li>
<%--						<li>--%>
...
<%--						</li>--%>
						...
						<li>
							<a href="javascript:void(0);" onclick="printExportDjb();" class="btn_dy">打印登记表</a>
						</li>
						<li>
							<a href="javascript:void(0);" onclick="printExportZxjlDjb();" class="btn_dy">打印咨询记录</a>
						</li>															
