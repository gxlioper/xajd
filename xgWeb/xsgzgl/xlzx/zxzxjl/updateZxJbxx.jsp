				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<html:text property="djrq" styleId="djrq" onfocus="showCalendar('djrq','y-mm-dd');" maxlength="10"></html:text>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td colspan="3">
								<logic:iterate name="zxwtList" id="wt">
									<html:multibox property="yzxwts" value="${wt.dm}"></html:multibox>${wt.mc}							
								</logic:iterate>
							</td>
			      		</tr>
			      		<tr>
