...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="init();">
		...
		<input type="hidden" name="sclydm" id="sclydm" value="${zxsInfoList.sclydm}" />
						...
						<logic:equal name="xxdm" value="11527"> 
							 <tr>
								...
								<logic:equal name="doType" value="view">
									...
									<logic:notEqual name="doType" value="view">
										<logic:notEmpty name="sclyList">
											<logic:iterate id="s" name="sclyList">
												<div class='demo_data2'>
													<input type="checkbox" name="sclyBoxList" id="scly<bean:write name="s" 
														property="sclydm"/>" value="${s.sclydm}"/>
													<label style="cursor:pointer;" for="scly<bean:write name="s" property="sclydm"/>">${s.sclymc}</label>
												</div>
											</logic:iterate>
										</logic:notEmpty>
									</logic:notEqual>
