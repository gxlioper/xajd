                ...
                <td   colspan="3">
                    <logic:equal name="sjly" value="1">
                        <table id="bxnmbTable">
                            ...
                            <tr>
                                <th>不及格人次</th>
                                <td>${jgmap.bjgrc}人次</td>
                                <th>班干部学习成绩前五名</th>
                                <td>${jgmap.bgbqwrs}人</td>

                            </tr>
                            <tr>
                                <th>班干部学习成绩前十名</th>
                                <td>${jgmap.bgbqsrs}人</td>
                                <th>获奖学生</th>
                                <td>${jgmap.hjxsrs}人</td>
                            </tr>
                            <tr>
                                <th>获集体奖</th>
                                <td>${jgmap.hjtjgs}个</td>
                                <th>社会实践获奖</th>
                                <td>${jgmap.shsjhjrc}人次</td>
                            </tr>
                            <tr>
                                <th>宿舍获奖</th>
                                <td>${jgmap.sshjcs}次</td>
                                <th>组织全班集体活动</th>
                                <td>${jgmap.qbjthdcs}次</td>
                            </tr>
                            <tr>
                                <th>科技学术获奖</th>
                                <td>${jgmap.kjxshjrc}人次</td>
                                <th>组织班级同学参加校院活动</th>
                                <td>${jgmap.cjxyhdcs}次</td>
                            </tr>
                            <tr>
                                <th>降级同学</th>
                                <td>${jgmap.jjtxrs}名</td>
                                <th>试读学生</th>
                                <td>${jgmap.sdxsrs}名</td>
                            </tr>
                            <tr>
                                <th>退学</th>
                                <td colspan="3">${jgmap.txrs}人</td>
                            </tr>
                        </table>
                    </logic:equal>
                    <logic:equal name="sjly" value="0">
