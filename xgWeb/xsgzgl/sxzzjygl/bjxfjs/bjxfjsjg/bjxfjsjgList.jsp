...
<head>
    ...
    <script type="text/javascript" src="xsgzgl/sxzzjygl/bjxfjs/bjxfjsjg/js/bjxfjsjgList.js"></script>
...
<body>
<html:form action="/sxzzjy_bjxfjsjg" method="post">
    ...
    <div class="toolbox">
        ...
        <div class="buttonbox">
            <ul>
                ...
                <li>
                    <a href="javascript:void(0);" class="btn_dc" onclick="exportConfig();return false;" >导出</a>
                </li>
                <li>
                    <a href="#" class="btn_down" onclick="printWord('sq');return false;">申报表下载</a>
                </li>
                <li>
