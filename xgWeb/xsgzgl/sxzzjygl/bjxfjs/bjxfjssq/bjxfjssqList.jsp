...
<head>
    ...
    <script type="text/javascript" src="xsgzgl/sxzzjygl/bjxfjs/bjxfjssq/js/bjxfjssqList.js"></script>
    <script type="text/javascript">
        var gridSetting = {
            caption: "活动列表",
            pager: "pager",
            url: "sxzzjy_bjxfjssq.do?method=getList&type=query",
            colList: [
...
<body>
<html:form action="/sxzzjy_bjxfjssq" method="post">
