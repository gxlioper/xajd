...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="width: 100%">
		<html:form action="/ztbhgl_bzrztbhjg" method="post" styleId="ZtbhJgForm" onsubmit="return false;">
			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;margin-bottom:0px;'>
				<table width="100%" border="0" class="formlist">
					...
					<tr>
						...
						<td width="30%">
								${xn}
							<html:hidden property="xn" styleId="xn"></html:hidden>
						</td>
						<th width="20%">
							<font color="red">*</font>填报日期
						</th>
						<td width="30%">
							<html:text property="hdrq" onclick="return showCalendar('hdrq','yyyy-MM-dd HH:mm');" styleId="hdrq" readonly="true"></html:text>
						</td>
					</tr>
					<tr>
						<th width="20%">
						...
						<td width="30%">
								${xqmc}
								<html:hidden property="xq" styleId="xq"></html:hidden>
						</td>
					...
					<tbody>
						...
						<tr><th width="20%"><span class="red">*</span>班会总结
							</br><font color="red">(限200字)</font></th>
							<td colspan="3">
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="ztbhJgSaveForEdit();">
										保存
									</button>
