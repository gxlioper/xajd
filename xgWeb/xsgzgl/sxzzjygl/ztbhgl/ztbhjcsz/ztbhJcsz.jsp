...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "ztbhgl_ztbhjcsz.do?method=save" : "ztbhgl_ztbhjcsz.do?method=update";
		      	ajaxSubFormWithFun("ZtbhjcszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/ztbhgl_ztbhjcsz" method="post" styleId="ZtbhjcszForm">
