...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type='text/javascript'>
            ...
            function selectOption() {
                var sfsfx = jQuery('#sfsfxSelect').val();
                jQuery("#sfsfx option").each(function () {
                    if (sfsfx == (jQuery(this).val())) {
	...
	<body style="width: 100%">
		<html:form action="/ztbhgl_ztbhjg" method="post" styleId="ZtbhJgForm" onsubmit="return false;">
			...
			<input type="hidden" id="sfsfxSelect" value="${sfsfxSelect}"/>
			  ...
			  <div>
				...
				<tfoot>
					<tr>
						<td colspan="4">
							<div class="btn">
								<button type="button" onclick="saveSfsfx();">
										保存
									</button>
