...
function rdsfxztbh() {
    ...
    if (rows.length == 1) {
        ...
        showDialog("批量认定", 500, 250, "ztbhgl_ztbhjg.do?method=ztbhJgPlrd");
    }
...
function exprotData() {
    ...
    var url = "ztbhgl_ztbhjg.do?method=exportData&dcglbh=" + DCGLBH;//dcglbh,导出功能编号
...
function butClick(tar){
    ...
    showDialog('请选择一个班级',800,500,'ztbhgl_ztbhjg.do?method=getBj');
}
