				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							...
							<td width="30%">
								<input type="text" name="bjmc" value="${bjmc}" id="bjmc" style="width:159px;" readonly="readonly"
									   class="text_nor"  >
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="ztbhSqSaveForEdit('save');">
										保存草稿
									</button>
									<button type="button" onclick="ztbhSqSaveForEdit('submit');">
										提交申请
									</button>
