...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "bjhdgl_jcsz.do?method=save" : "bjhdgl_jcsz.do?method=update";
		      	ajaxSubFormWithFun("BjhdjcszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/bjhdgl_jcsz" method="post" styleId="BjhdjcszForm">
