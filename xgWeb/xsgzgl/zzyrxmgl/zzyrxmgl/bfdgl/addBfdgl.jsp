...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveFdgl(type) {
			...
			var url = "zzyrxmglbfdgl.do?method=addBfdgl&type="+type;
	...
	<body style="width: 100%">
		<html:form action="/zzyrxmglbfdgl" method="post" styleId="bfdglForm" onsubmit="return false;">
			...
			<input type="hidden" name="fblx" value="1"/>
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td width="30%">
								<html:text property="fdkm" styleId="fdkm" value = "${fdkm}" maxlength="10"></html:text>
							</td>
							</td>
							<th>
