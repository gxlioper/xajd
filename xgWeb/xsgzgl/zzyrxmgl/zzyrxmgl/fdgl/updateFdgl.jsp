...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveFdgl(type) {
			...
			var url = "zzyrxmglfdgl.do?method=updateFdgl&type="+type;
		...
		//勾选已选中的项目
		function initSet(){	
			var url = "zzyrxmglfdgl.do?method=kfxydmCx";
			jQuery.post(url, {
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<th>
								<span class="red">*</span>限定人数
							</th>
							<td>
								<html:text property="xdrs" styleId="xdrs" onkeyup="checkInput(this)"  maxlength="2"></html:text>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td colspan="3">
								<div style="position:relative;">							
									...
									<div id="note" class="note">
            							<font color="#777">1、个人优势学科、优势环节</font></br>
