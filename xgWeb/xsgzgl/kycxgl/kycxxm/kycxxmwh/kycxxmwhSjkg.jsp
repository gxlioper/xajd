...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function saveForm() {
				...
				var url = "kycxgl_kycxxm_kycxxmwhgl.do?method=kycxxmwhSjkg&type=update";
	...
	<body>
		<html:form action="/kycxgl_kycxxm_kycxxmwhgl" method="post" styleId="form1">
		...
		<div class="prompt">
				...
				<p>
					当前设置的科研类别为：<font color="red">${lbmc} &nbsp;	
				</font>
				</p>
