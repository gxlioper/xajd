	...
	<%@ include file="/syscommon/head.ini"%>
		...
		<script language="javascript">
			function saveForm(){	  
		      ...
		      var url = "kycxgl_kycxxm_kycxxmwhgl.do?method=addKycxxmwh&type=save";
			...
			<div class="open_win01">
				<table align="center" class="formlist">
					...
					<tbody>
						<tr>
							<th>
								<span class="red">*</span>科研类别代码
							</th>
							<td>
								<html:text property="lbdm" styleId="lbdm" maxlength="20" styleClass="text_nor" onkeyup="value=value.replace(/[\u4e00-\u9fa5]/g,'');"/>
							</td>
						</tr>
						<tr>
							<th>
