...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script	type="text/javascript">		
		function save(){
			...
			systemFunction.checkExists("xg_dtjs_dxpxb","pxqc",jQuery("#pxqc").val(),function(data){
				if(data){//数据已存在
					alertInfo("该培训期次已存在！");
				}else{
					lock();
				 	jQuery("#form").ajaxSubmit({
						url:'dtjs_dxbmgl_dxpxglZj.do',
						type:"post",
						dataType:"json",
						data:{"type":"save"},
		...
		<table class="formlist" width="95%">			
			<tbody>
				<tr >
					...
					<td width="34%">
						<html:text property="pxqc" styleId="pxqc" value="" />
					</td>
					<th width="16%">发布人</th>
				...
				<tr>
					...
					<td>
						<input name="bmkssj" id="bmkssj" onclick="return showCalendar(this.id,'yyyy-MM-dd')"/>
					</td>
					<th width="16%"><font color="red">*</font>报名结束时间</th>
					<td>
						<input name="bmjssj" id="bmjssj" onclick="return showCalendar(this.id,'yyyy-MM-dd')"/>
					</td>
				</tr>
				<tr>
					<th width="16%"><font color="red">*</font>培训时间</th>
					<td colspan="3">
						<input name="pxsj" id="pxsj" onclick="return showCalendar(this.id,'yyyy-MM-dd')"/>
					</td>
				</tr>
				<tr>
					<th width="16%">培训内容</th>
					<td colspan="3">						
						<html:textarea property="pxnr" styleId="pxnr" rows="5" cols="75" />
					</td>
				</tr>
			</tbody>						
			<tfoot>
