				...
				<table width="100%" border="1" class="formlist">
					...
					<tbody>
					    <tr>
							...
							<th><span class="red">*</span>上交时间</th>
							<td>
								<input type="text" id="sjsj" name="sjsj" onfocus="return showCalendar(this.id,'yyyy-MM-dd',true);"
								readonly="true"/>
							</td>
					    </tr>
					</tbody>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" type="button" onclick="saveForm('addSxhb','save');">
										保 存
									</button>
