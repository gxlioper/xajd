...
<head>
    ...
    <script type="text/javascript" src="xsgzgl/dtjs/shsjjl/sq/js/shsjjlSq.js"></script>
...
<html:form action="/shsjjl_sq" method="post" styleId="form" onsubmit="return false;">
        ...
        <table width="100%" border="0" class="formlist" style="position: fixed; _position: absolute; bottom: 0;">
            ...
            <tr>
                <td colspan="4">
                    ...
                    <div class="btn">
                        <button type="button" onclick="saveUpdate('save');">
                            保存草稿
                        </button>
                        <button type="button" onclick="saveUpdate('submit');">
                            提交申请
                        </button>
                        <button type="button" onclick="iFClose();aaa()">
                            关闭
                        </button>
                    </div>
                </td>
