...
function view(sqid) {
    showDialog(jQuery("#gnmkmc").val()+"查看", 800, 500, "shsjjl_sq.do?method=shsjjlView&sqid="+sqid);
}
...
var DCCLBH = "dtjs_shsjjl_sq.do";//dcclbh,导出功能编号
...
function hdsqExportData() {
    ...
    var url = "shsjjl_sq.do?method=exportData&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
