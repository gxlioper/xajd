...
function save(type) {
    ...
    var url = "shsjjl_jg.do?method=save&type=" + type;
...
//增加
function add() {
    var url = "shsjjl_jg.do?method=shsjjlJgAdd";
...
function del() {
    ...
    if (ids.length == 0){
        ...
        showConfirmDivLayer("您确定要删除选择的记录吗？",{"okFun":function(){
            jQuery.post("shsjjl_jg.do?method=del",{values:ids.toString()},function(data){
...
var DCCLBH = "dtjs_shsjjl_jg.do";//dcclbh,导出功能编号
...
function exportData() {
    ...
    var url = "shsjjl_jg.do?method=exportData&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
