		...
		<table class="formlist" width="95%">			
			...
			<tbody>
				<tr >
					...
					<td width="34%">
						<logic:equal value="null" name="other" property="zd1">&nbsp;</logic:equal>
						<logic:notEqual value="null" name="other" property="zd1">${other.zd1}</logic:notEqual>
					</td>
					<th width="16%">
						列入年度发展计划				
					</th>
					<td width="34%">
						<logic:equal value="null" name="other" property="zd3">&nbsp;</logic:equal>
						<logic:notEqual value="null" name="other" property="zd3">${other.zd3}</logic:notEqual>
					</td>
				</tr>
				<tr>
					<th width="16%">
					...
					<td>
						<logic:equal value="null" name="other" property="zd4">&nbsp;</logic:equal>
						<logic:notEqual value="null" name="other" property="zd4">${other.zd4}</logic:notEqual>
					</td>
					<th width="16%">
						党内联系人2
					</th>
					<td>
						<logic:equal value="null" name="other" property="zd5">&nbsp;</logic:equal>
						<logic:notEqual value="null" name="other" property="zd5">${other.zd5}</logic:notEqual>
					</td>
				</tr>
				<tr>
					<th width="16%">
					...
					<td colspan="3">
						<logic:equal value="null" name="other" property="zd2">&nbsp;</logic:equal>
						<logic:notEqual value="null" name="other" property="zd2">${other.zd2}</logic:notEqual>
					</td>
				</tr>
