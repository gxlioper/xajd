...
function view(sqid) {
    showDialog("审核查询", 750, 550, "llxxjl_sq.do?method=llxxjlView&sqid="+sqid);
}
...
function sh() {
    ...
    if (shzt == "ysh") {
        ...
        showDialog("批量审核", 500, 250, "llxxjl_sh.do?method=llxxjlPlsh");
    }
}
// 批量审核
...
var DCCLBH = "dtjs_llxxjl_sh.do";//dcclbh,导出功能编号
...
function hdshExportData() {
    ...
    var shzt = jQuery("#shzt").val();
    var url = "llxxjl_sh.do?method=exportData&shzt="+shzt+"&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
