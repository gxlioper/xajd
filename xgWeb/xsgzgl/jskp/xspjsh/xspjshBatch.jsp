	...
	<head>
		...
		<script type="text/javascript">
			...
			function xspjshBatchSave(shzt){
				...
				W.xspjshBatchSave(shzt,shyj,fs,ffgz);
				closeDialog();
			}
		</script>
	</head>
	<body>
		<html:form action="/xspj_xspjsh" method="post" onsubmit="return false;">
				...
				<table class="formlist">
					...
					<tbody>
						<tr>
							...
							<td>
								<html:text style="width:100px" property="fs" styleId="fs"  maxlength="10" onkeyup="checkInputNum(this)"></html:text>
							</td>
						</tr>
						<tr>
							<th>赋分规则</th>
			...
			<table width="100%" border="0" class="formlist" style="position: fixed; _position: absolute; bottom: 0;">	
				<tfoot>
					<tr>
						<td colspan="2">
							<div class="btn">
								<button type="button" onclick="xspjshBatchSave('1');">
									通过
								</button>
								<button type="button" onclick="xspjshBatchSave('2');">
									不通过
								</button>
