...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/jskp/xspjsh/js/xspjsh.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"项目审核",
				pager:"pager",
				url:"xspj_xspjsh.do?method=getXspjshList&type=query",
				colList:[
					...
					{label:'参与时间时间',name:'cysj', index: 'cysj',width:'10%'},
		...
		var gridSetting2 = {
				...
				colList:[
					...
					{label:'参与时间时间',name:'cysj', index: 'cysj',width:'8%'},
					{label:'审核状态',name:'shztmc', index: 'shztmc',width:'10%'}
				],
				params:{shzt:"ysh"},
				sortname: "sjlrsj",
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					...
					<logic:equal name="writeAble" value="yes">
						<li id="li_sh">
							<a href="javascript:void(0);" onclick="xspjsh();return false;" 
							   title="选中您要审核的记录，点击该按钮可以打开审核页面。"
							   class="btn_sh">审核</a>
						</li>						
						<li id="li_qx" style="display: none;">
							<a href="javascript:void(0);" onclick="xspjshRevoke();return false;" 
							   title="选中一条记录，点击该按钮您可以撤消失误的审核操作。"
							   class="btn_qxsh">撤消</a>
						</li>	
					</logic:equal>					
						<li><a href="javascript:void(0);" onclick="xspjshTrack();return false;" 
