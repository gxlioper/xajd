...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<input type="hidden" id="guid" name="guid" value="${xspjjgForm.guid }"/>
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td style="width:35%">
								<input type="text" name="xmmc" id="xmmc" maxlength="64" value="${xspjjgForm.xmmc}"/>
							</td>
							<th style="width:15%">
							...
							<td style="width:35%">
								...
								<input type="hidden" id="zdbmdm" name="zdbmdm" value="${xspjjgForm.zdbmdm}" />
							</td>
						</tr>
						<tr>
							<th>
