	...
	<head>
		...
		<script type="text/javascript">
			var gridSetting = {
					caption:"学生评价自主申请",
					pager:"pager",
					url:"xspj_xspjsq.do?method=seachForXspjsq",
					colList:[
				...
				<div class="buttonbox">
					<ul>
						<logic:equal name="writeAble" value="yes">
							<li>
								<a href="javascript:void(0);" class="btn_zj" onclick="xspjsqApply();return false;"
								   title="点击该按钮，打开申请表填写页面">申请</a>
							</li>
							<li>
								<a href="javascript:void(0);" class="btn_sc" onclick="xspjsqDelete();return false;">删除</a>
							</li>
							<li>
								<a href="javascript:void(0);" class="btn_xg" onclick="xspjsqUpdate();return false;">修改</a>
							</li>
							<li>
								<a href="javascript:void(0);" class="btn_shuc" onclick="xspjsqSubmit();return false;">提交</a>
							</li>
							<li>
								<a href="javascript:void(0);" class="btn_sr" onclick="xspjsqRevoke();return false;">撤销</a>
							</li>
							<logic:notEqual name="userType" value="stu">
								<li>
									<a href="javascript:void(0);" class="btn_dr" onclick="xspjsqImport();return false;">导入</a>
								</li>
							</logic:notEqual>
						</logic:equal>
						<li>
							<a href="javascript:void(0);" class="btn_cs" onclick="xspjsqTrack();return false;">流程跟踪</a>
						</li>
						<li>
							<a href="javascript:void(0);" class="btn_dc" onclick="xspjsqExport();return false;">导出</a>
						</li>
					</ul>
				</div>
				<!-- 过滤条件 -->	
