				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td style="width:35%">
								<input type="text" name="xmmc" id="xmmc" maxlength="25" value="${LxjgxForm.xmmc}"/>
							</td>
							<th style="width:15%"><font color="red">*</font>指导部门</th>
							<td style="width:35%">
								<input type="text" name="bmmc" id="bmmc" value="${bmmc}" />
								<input type="hidden" id="zdbm" name="zdbm" value="${LxjgxForm.zdbm}" />
							</td>
						</tr>	
						<tr>
							<th><font color="red">*</font>项目类别</th>
							<td>
								<html:select   property="xmlb" styleId="xmlb" value="${LxjgxForm.xmlb}" style="width:150px;">
						...
						<tr>
							...
							<td>
								...
								<html:text property="fzrlxfs" styleId="fzrlxfs" value="${LxjgxForm.fzrlxfs}" maxlength="15" onkeyup="checkInputLxfx(this)"></html:text>
						...
						<tr>
							...
							<td>
								...
								<html:text property="zdls" styleId="zdls" value="${LxjgxForm.zdls}" maxlength="10" ></html:text>
								
							</td>
							<th><font color="red">*</font>指导老师联系方式</th>
							<td>
								
								<html:text property="zdlslxfs" styleId="zdlslxfs" value="${LxjgxForm.zdlslxfs}"  maxlength="15" onkeyup="checkInputLxfx(this)"></html:text>
						...
						<tr>
							...
							<td colspan="3">
								<input name="zxf" style="width:80px" type="text" maxlength="8" id="zxf" value="${LxjgxForm.zxf}"  onkeyup="checkInput(this)" onblur="replaceAboveZero(this)" /> - <input name="zdf" style="width:80px" value="${LxjgxForm.zdf}" maxlength="8"  type="text" id="zdf" onkeyup="checkInput(this)" onblur="replaceAboveZero(this)" />
							</td>
						</tr>
						<tr>
							<th>
