	...
	<head>
		...
		jQuery(function(){
			var gridSetting = {
					caption:"学生列表",
					pager:"pager",
					url:"xpjpy_pjpybjpy_xzszgl.do?method=addXzsz&type=query&bjdm=${rs.bjdm}",
					colList:[      
		...
		function addXzszBc() {
			...
			if (ids.length == 0) {
				...
				jQuery.post("xpjpy_pjpybjpy_xzszgl.do?method=addXzszBc", { values : ids.toString(), bjdm: "${rs.bjdm}" },
						function(data) {
