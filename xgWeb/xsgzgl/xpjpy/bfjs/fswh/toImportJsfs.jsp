...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form action="/xpjpyBfjsFswh" method="post" styleId="BfjsFswhModel" enctype="multipart/form-data" >
				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							<th width="12%">说明</th>
							<td>
								①  竞赛分导入请使用系统提供的模版;<br/><br/>
								②  请严格按照模版提供的格式填写竞赛分;<br/><br/>
								③ 各项竞赛<u><font color="red">分数不能为空</font></u>;<br/><br/>
						...
						<tr>
							...
							<td>
								...
								<label class="btn_01" onclick="uploadJsfs();">导入</label>
							</td>
						</tr>
					</tbody>
				</table>
