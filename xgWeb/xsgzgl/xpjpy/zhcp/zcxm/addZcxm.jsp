				...
				<table width="100%" border="0" class="formlist">
					<tfoot>
						<tr>
							<td colspan="2">
								...
								<div class="btn">
									<button type="button" type="button" onclick="saveZcxm();">
										保 存
									</button>
					...
					<tbody>
						...
						<tr id="zdfTr">
							...
							<td>
								<html:text property="zdfs" styleId="zdfs" maxlength="5" onkeyup='checkInputNum(this)' onblur='checkInputNum(this)' value="100"></html:text>
							</td>
						</tr>
						<tr id="zxfTr">
							<th>
