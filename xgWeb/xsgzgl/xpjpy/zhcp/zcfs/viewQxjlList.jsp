...
//				   {label:'专业',name:'zymc', index: 'zydm',width:'20%'},
                    {label:'书院',name:'symc', index: 'sydm',width:'23%'},
				   {label:'行政班级',name:'bjdm', index: 'bjdm',hidden:true},
				   {label:'行政班级',name:'bjmc', index: 'bjdm',width:'23%'},
				   {label:'提交人',name:'qxr', index: 'qxr',width:'10',hidden:true},
				   {label:'操作人',name:'qxrxm', index: 'qxrxm',width:'12%'},
				   {label:'操作时间',name:'qxsj', index: 'qxsj',width:'18%'},
				   <logic:equal value="1" name="szyf">
				   {label:'综测年月',name:'yf', index: 'yf',width:'10%'},
				   </logic:equal>
			...
			function qxjlView(){
				...
				var id = rows[0]["id"];
				showDialog("查看综测分",510,295,"xpj_zcfs.do?method=qxjlView&id="+id);
			}
			...
			function exportData(){
				...
				var url = "xpj_zcfs.do?method=exportData&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
