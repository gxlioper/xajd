	...
	<head>
		...
		<script type="text/javascript">
			...
			function cleanCurrPage(){
				jQuery("#dataTable td input[type='text']").val("");
			}
			...
			function tbf(type){
				...
				map['type'] = type;
				jQuery.post("xpj_zcfs.do?method=getIntefaceData_tbf",map,function(data){
...
<%--						>提交</a></li>--%>
					...
					<logic:notEqual value="13022" name="xxdm">
						<logic:notEqual value="13779" name="xxdm">
							<logic:notEqual value="10279" name="xxdm">
								<logic:notEqual value="10868" name="xxdm">		
									<logic:present name="zcxmList">
										<logic:iterate id="z" name="zcxmList">
					...
					<logic:equal value="12688" name="xxdm">
						<li><a href="javascript:void(0);" onclick="tbf('zy')" class="btn_sx">同步智育分</a></li>
						<li><a href="javascript:void(0);" onclick="tbf('ty')" class="btn_sx">同步体育分</a></li>
						<li><a href="javascript:void(0);" onclick="tbf('dy')" class="btn_sx">同步德育分</a></li>
					</logic:equal>

					<logic:equal value="13431" name="xxdm">
						<li><a href="javascript:void(0);" onclick="getIntefaceData_13431()" class="btn_sx">同步</a></li>
					</logic:equal>
					...
					<logic:equal value="12673" name="xxdm">
						<li><a href="javascript:void(0);" onclick="getIntefaceDataNmgdz()" class="btn_sx">同步德育分</a></li>
					</logic:equal>	
					<logic:equal value="12942" name="xxdm">
						<li><a href="javascript:void(0);" onclick="getIntefaceDataNmgzc()" class="btn_sx">同步综测分</a></li>
					</logic:equal>		
					<logic:equal value="13022" name="xxdm">
						<li><a href="javascript:void(0);" onclick="getIntefaceDataXysp()" class="btn_sx">同步学业水平评价</a></li>
						<li><a href="javascript:void(0);" onclick="getIntefaceDataSxdd()" class="btn_sx">同步思想道德/综合能力评价</a></li>
					</logic:equal>
					<%--
					<logic:equal value="13011" name="xxdm">
						<li><a href="javascript:void(0);" onclick="getIntefaceDataS()" class="btn_sx">同步日常行为加减分</a></li>
					</logic:equal>
					--%>
					...
					<li><a href="javascript:void(0);" onclick="cleanCurrPage();" class="btn_fh">清空当前页面</a></li>	
				</ul>
			</div>
			</logic:equal>
			<!-- 过滤条件 -->	
