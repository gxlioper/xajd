...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function saveQxtj(){
			...
			var url = "";
			    url = "xpjpy_zcwh.do?method=cancelTj&doType=update";
			ajaxSubFormWithFun("zcwForm",url,function(data){
	...
	<body>
		<html:form action="/xpjpy_zcwh" method="post" styleId="zcwForm" onsubmit="return false;">
