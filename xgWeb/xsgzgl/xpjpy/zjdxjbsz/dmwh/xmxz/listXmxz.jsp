	...
	<head>
		...
		<script type="text/javascript">
			jQuery(function(){
				...
				jQuery("#xzmc").bind("keypress",function(event){
		...
		<div class="toolbox">
			...
			<div class="comp_title" id="comp_title">
		      <ul style="width:90%" id="tabUl">
				...
				<li class="ha" ><a href="javascript:void(0);"><span>评奖项目性质</span></a></li>
		      </ul>
		    </div>
			<!-- 过滤条件 -->
			<div class="searchtab">
				<table width="100%" border="0">
					<tr>
						<th width="15%">项目性质名称</th>
						<td>
							<input type="text" id="xzmc" name="xzmc" maxleng="20" />
						</td>
						<td>
							<div class="btn">
