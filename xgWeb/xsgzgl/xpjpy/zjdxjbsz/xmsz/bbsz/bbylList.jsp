	...
	<head>
		...
		<script type="text/javascript">
			function viewDjbg(bbdm,xmdm,bblx) {
				showDialog("登记表设置",765,675,"xpjpy_xmwh_bbsz.do?method=showYlbb&bbdm="+bbdm+"&xmdm="+xmdm+"&bblx="+bblx,{
					fixed:false,
					close:function(){
						window.reload();
					}
	...
	<body>
		<div class="djb_list">
			<div class="djb_list_nav">
				<h4>
					（${xmxx.xn }&nbsp;学年）&nbsp;&nbsp;${xmxx.xmmc }
				</h4>
				<a href="xpjpy_xmwh.do?method=getXmwhList">返回</a>
			</div>
