...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/xpjpy/xwhj/sh/js/hjsh.js"></script>
		<script type="text/javascript">
			gridSetting = {
					caption:"获奖信息审核列表",
					pager:"pager",
					url:"xpj_hjsh.do?method=hjshList&type=query",
					colList : [
								...
								{ label : '奖项类别', name : 'jxlbmc', index : 'jxlbmc', width : '10%' },					
								{ label : '竞赛方式', name : 'jsfsmc', index : 'jsfsmc', width : '10%' },
								{ label : '奖项等级', name : 'jxdjmc', index : 'jxdjmc', width : '10%' },
								{ label : '奖项名次', name : 'jxmcmc', index : 'jxmcmc', width : '10%' },
