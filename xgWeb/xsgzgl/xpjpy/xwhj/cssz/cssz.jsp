...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "xwhj_cssz.do?method=save" : "xwhj_cssz.do?method=update";
		      ajaxSubFormWithFun("xwhjCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/xwhj_cssz" method="post" styleId="xwhjCsszForm">
