...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript">
			jQuery(function(){
				...
				var gridSetting = {
					...
					pager:"pager",
					rowNum:10,
					url:"xpjpy_xmsh.do?method=xmshShmx",
					colList:[
			...
			function saveZdPlsh(shzt){
				var api = frameElement.api,W = api.opener;
				var jsonStr = W.getSuperSearch();;
				
				var shyj = jQuery("#shyj").val().trim();
				...
				W.savePlsh(shzt,shyj,xyXmdm.toString(),jsonStr,id);
				closeDialog();
			}
	...
	<body>
		<html:form action="/xpjpy_xmsh" method="post" onsubmit="return false;">
