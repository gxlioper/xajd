				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							...
							<td colspan="4">
								<html:select property="xn" styleId="xn" style="width:160px" onchange="changeXmmc();">
						...
						<tr>
							...
							<td>
								 <html:text property="ssdh"  styleId="ssdh" maxlength="12" style="width:150px" onkeyup="checkInputLxfx(this)" value="${latestSqxx.ssdh}"></html:text>
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td colspan="3" style="word-break:break-all;">
								<html:textarea property="grxxjl" styleId="grxxjl" style="width:100%;" rows="3" onblur="checkLen(this,200);" value="${latestSqxx.grxxjl}"></html:textarea>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td colspan="3" style="word-break:break-all;">
								<html:textarea property="cjkyqk" styleId="cjkyqk" style="width:100%;" rows="3" onblur="checkLen(this,200);" value="${latestSqxx.cjkyqk}"></html:textarea>
							</td>
						</tr>
						<tr>
							<th>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" type="button" onclick="saveFormAdd();">
										保 存
									</button>
