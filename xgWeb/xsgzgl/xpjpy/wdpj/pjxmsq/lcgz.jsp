		...
		<html:form action="/xpj_sqsh">
			<div class="splc1" style="height: auto;">
				...
				<div class="step">
					...
					<div class="text">
						<logic:equal value="0" property="shzt" name="xpjxmsqModel">
							未开始
						</logic:equal>
						<logic:equal value="1" property="shzt" name="xpjxmsqModel">
							已结束（通过）
						</logic:equal>
						<logic:equal value="2" property="shzt" name="xpjxmsqModel">
							已结束（不通过）
						</logic:equal>
						<logic:equal value="5" property="shzt" name="xpjxmsqModel">
							审核中
						</logic:equal>
					</div>
				</div>
