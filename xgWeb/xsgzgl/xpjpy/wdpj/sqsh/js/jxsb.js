...
function getGridSetting(){
	...
	var gridSetting = {
		caption:"参评学生列表 ",
		pager:"pager",
		url:"xpj_sqsh.do?method=viewJxsbList&type=query",
		multiselect:false
	};
...
function toJxsb(xh){
	...
	showDialog("上报奖项",600,450,"xpj_sqsh.do?method=toJxsb&xh="+xh+"&xmdm="+xmdm);
}
 ...
 */
function resetPjxm(){
	showDialog("选择上报奖项",300,150,"xpj_sqsh.do?method=selectSbjx",{max:false,min:false});
}
...
function saveJxsb(){
	...
	var url = "xpj_sqsh.do?method=saveJxsb";
