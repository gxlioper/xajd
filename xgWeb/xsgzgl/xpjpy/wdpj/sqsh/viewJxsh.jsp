	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveAuding(){
				...
				var url = "xpj_sqsh.do?method=runAuding";
			...
			function checkResult(xmdm){
				...
				jQuery.post("xpj_sqsh.do?method=checkCondition",{xh:xh,xmdm:xmdm},function(data){
			...
			function getXmxx(xmdm){
				if(jQuery("#xxdm").val() == "11488"){
					jQuery.post("xpj_sqsh.do?method=getXmje",{xmdm:xmdm},function(data){					
						...
						<td colspan="4">
							<table width="99%" style="text-align: center;">
								<tr>
									...
									<th style="text-align: center;">异动类别</th>
									<th style="text-align: center;">原年级</th>
									<th style="text-align: center;">原学院</th>
									<th style="text-align: center;">原专业</th>
									<th style="text-align: center;">原班级</th>
									<th style="text-align: center;">原学制</th>
									<th style="text-align: center;">异动时间</th>
								</tr>
								<logic:present name="xjydList">
									<logic:iterate id="x" name="xjydList">
										<tr>
											<td>${x.xn }</td>
											<td>${x.xqmc }</td>
											<td>${x.ydlbmc }</td>
