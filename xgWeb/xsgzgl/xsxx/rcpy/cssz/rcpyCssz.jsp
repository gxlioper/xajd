...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function bcCssz() {
				...
				var url = "rcpy_cssz.do?method=bcCssz";
	...
	<body >
		<html:form action="/rcpy_cssz" method="post" styleId="csszForm" >
			<div class="tab_cur">
				<p class="location">
			      ...
			      <tr>
			        <td colspan="4"><div class="bz">"<span class="red">*</span>"为必填项</div>
			          ...
			          <logic:equal name="writeAble" value="yes">		            
						<button type="button" class="button2" onclick="bcCssz();return false;" id="btn_save">
							保 存
						</button>
						</logic:equal>
