...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save(){
			...
			var url = "general_xsxx_xgzdpzgl.do?method=bcXgzdsz&lb=stu";
		...
		<input type="hidden" name="btzds" id="btzds" value="${btzds}">
			...
			<div class="compTab">
				<div class="comp_title">
			      <ul>
			         <li class="ha"><a><span>学生</span></a></li>
			         <li ><a href="general_xsxx_xgzdpzgl.do?method=cxXgzdpz&lb=tea"><span>教师</span></a></li>
			      </ul>
			    </div>
			</div>	
