		...
		<script type="text/javascript">
			jQuery(function(){
				...
				jQuery("#btn_fh").bind("click",function(){
					document.location.href="general_xsxx_tjcx.do?method=tjcxByXyZyBj&xydm="+xyid+"&zydm="+zyid;
				});
			...
			function cxXs(){
				...
				allNotEmpThenGo("general_xsxx_tjcx.do?method=tjxsByBjdm&bjdm="+bjid+"&xydm="+xyid+"&zydm="+zyid);
				}
