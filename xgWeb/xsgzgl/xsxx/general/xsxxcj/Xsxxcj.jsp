			...
			function change(id,cs){
				...
				if(obj.val()=='否'){
					...
					for(i=0;i<temp.length;i++){
						...
						jqTemp.children("td").children().each(function(obj){
							this.value="";
						});
					}
				}
		...
		<html:form action="/xsxx_gygl_xsxxcj" method="post" styleId="xsxxcjForm">
			...
			<html:hidden property="xh" styleId="xh" value="${jbxx.xh }"/>
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							<th ><font color="red">*</font>户口是否迁入学校</th>
							<td >
							...
							<th ><font color="red">*</font>是否住校</th>
							<td >
						...
						<tr>
							<th ><font color="red">*</font>是否申请入党</th>
							<td >
						...
						<tr id="sfsqrdcs" <logic:notEqual value="是" name="xsxxcjForm" property="sfsqrd"> style="display: none;" </logic:notEqual>bgcolor="#f1f1f1">
						...
						<tr id="sfsqrdcs2" <logic:notEqual value="是" name="xsxxcjForm" property="sfsqrd"> style="display: none;" </logic:notEqual> bgcolor="#f1f1f1">
						...
						<tr>
							<th ><font color="red">*</font>是否少数民族</th>
							<td >
						...
						<tr id="sfssmzcs" <logic:notEqual value="是" name="xsxxcjForm" property="sfssmz">style="display: none;"</logic:notEqual> >
							<th><font color="red">*</font>少数民族名称</th>
							<td colspan="3" bgcolor="#f1f1f1">
								<html:select style="width:33%" styleId="ssmz" property="ssmz">
						...
						<tr id="sflspxcs" <logic:notEqual value="是" name="xsxxcjForm" property="sflspx">style="display: none;"</logic:notEqual>>
						...
						<tr>
							<th ><font color="red">*</font>是否宗教信仰</th>
							<td >
						...
						<tr id="sfzjxycs" <logic:notEqual value="是" name="xsxxcjForm" property="sfzjxy">style="display: none;"</logic:notEqual>>
						...
						<tr>
							<th ><font color="red">*</font>是否经济困难</th>
							<td >
						...
						<tr id="sfjjkncs" <logic:notEqual value="是" name="xsxxcjForm" property="sfjjkn">style="display: none;"</logic:notEqual> bgcolor="#f1f1f1">
							<th><font color="red">*</font>经济困难原因</th>
							<td colspan="3">
								<html:text styleId="jjknyy" property="jjknyy" style="width:80%" maxlength="200"></html:text>
							</td>
						</tr>
						<tr>
							<th ><font color="red">*</font>身体是否疾病</th>
							<td >
						...
						<tr id="stsfcjcs" <logic:notEqual value="是" name="xsxxcjForm" property="stsfcj">style="display: none;"</logic:notEqual> bgcolor="#f1f1f1">
						...
						<tr>
							<th ><font color="red">*</font>是否学习困难</th>
							<td >
						...
						<tr id="sfxxkncs" <logic:notEqual value="是" name="xsxxcjForm" property="sfxxkn">style="display: none;"</logic:notEqual> bgcolor="#f1f1f1">
						...
						<tr>
							<th ><font color="red">*</font>是否心理困难</th>
							<td >
						...
						<tr id="sfxlkrcs" <logic:notEqual value="是" name="xsxxcjForm" property="sfxlkr">style="display: none;"</logic:notEqual> bgcolor="#f1f1f1">
						...
						<tr>
							<th ><font color="red">*</font>是否家庭困扰</th>
							<td >
						...
						<tr id="sfjtkrcs" <logic:notEqual value="是" name="xsxxcjForm" property="sfjtkr">style="display: none;"</logic:notEqual> bgcolor="#f1f1f1">
						...
						<tr>
							<th ><font color="red">*</font>是否有其他困扰</th>
							<td >
						...
						<tr id="sfyqtkrcs" <logic:notEqual value="是" name="xsxxcjForm" property="sfyqtkr">style="display: none;"</logic:notEqual> bgcolor="#f1f1f1">
				...
				<table border="0" class="formlist">
					<tfoot>
						<tr>
							<td colspan="4">
								<div class="btn">
									<button type="button" onclick="saveXscj();">
										保存
									</button>
								</div>
							</td>
