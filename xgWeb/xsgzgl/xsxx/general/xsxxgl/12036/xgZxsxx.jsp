...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function format(){
			...
			//jQuery("#yhdmkz option[value="+yhdm+"]").remove();
		}
		jQuery(function(){
			format();
			//tbxlk("yhdm","yhdmkz");
				...
				<table style="margin-bottom: 2px" width="100%" border="0" class="formlist" id="tab_qtxx">
					...
					<tbody id="hi_qtxx">
						<tr>
							...
							<td align="left">
								<html:select name="rs" property="yhdm" styleId="yhdm">
									<html:option value=""></html:option>
									<html:option value="1">中国工商银行</html:option>
						...
						<tr>
							...
							<td align="left">
								<html:select name="rs" property="zd4" styleId="yhdmkz">
									<html:option value=""></html:option>
									<html:option value="2">中国农业银行</html:option>
									<%--<html:options collection="yhmcList" labelProperty="yhmc" property="yhdm"/>--%>
								</html:select>
							</td>
							<th>
							...
							<td colspan="2">
								<html:text name="rs" property="zd5" maxlength="20" 
										   styleClass="text_nor" styleId="yhkhkz"
								onkeyup="value=value.replace(/[^0-9]/g,'') "></html:text>
							</td>
						</tr>
