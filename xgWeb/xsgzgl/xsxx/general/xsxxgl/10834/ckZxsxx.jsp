    ...
    <ul class="list_xxxx">
    	<li><a href="#tab_jbxx" class="smooth">学生信息</a>
    		<div class="list_xxxx_downmenu" style="display:none">
    			<dl>
    				<dd id="tab_jbxx_a" style="text-align: left; text-indent:1em;"><a href="#tab_jbxx" class="smooth">基本信息</a></dd>
    				<dd id="tab_lxfs_a" style="text-align: left; text-indent:1em;"><a href="#tab_lxfs" class="smooth">联系方式</a></dd>
    				<dd id="tab_jtcyxx_a" style="text-align: left; text-indent:1em;"><a href="#tab_jtcyxx" class="smooth">家庭成员信息</a></dd>
    				<dd id="tab_qtxx_a" style="text-align: left; text-indent:1em;"><a href="#tab_qtxx" class="smooth">其他信息</a></dd>
    				<dd id="tab_szxx_a" style="text-align: left; text-indent:1em;"><a href="#tab_szxx" class="smooth">思政信息</a></dd>
    			</dl>
    	</li>
        <!-- 业务模块名称 -->
							...
							<td rowspan="5" class="nohover"
								style="vertical-align:middle; text-align:left;width:115px;">
									<div id="stuImg" class="open_img" style="margin-left:0px;margin-top: 0px;height: 130px">
										<img style="width:100px;height:130px;" src="xsxx_xsgl.do?method=showPhoto&xh=${rs.xh}" border="0"/>
									</div>
							</td>
						</tr>
						<tr>
				...
				<table width="100%" border="0" class="formlist" style="position:fixed;_position:absolute; bottom:0;">
					<tfoot>
						<tr>
							<td colspan="5">
								<div class="btn">
									<button name="关闭" onclick="Close();" id="buttonClose">关 闭</button>	
									<button type="button" name="学生登记表打印" onclick="printZxsxx();return false;" id="btn_dy">学生登记表打印</button>					           
								</div>
							</td>
						</tr>
					</tfoot>
