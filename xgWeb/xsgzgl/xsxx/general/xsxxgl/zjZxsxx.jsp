				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody id="hi_jbxx">
						<tr>
							...
							<td>
								<html:text property="xm" styleId="xm" maxlength="30"
									styleClass="text_nor" />
							</td>
						...
						<tr>
							...
							<td>
								<html:radio  property="xb" styleId="xbn" value="1">男</html:radio>
								<html:radio property="xb" styleId="xbnv" value="2">女</html:radio>
							</td>
							<th>
								出生日期
							</th>
						...
						<tr>
							...
							<td colspan="2">
								<html:text  property="sfzh" styleId="sfzh" styleClass="text_nor" maxlength="18"
