...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
					...
					for (var i=0;i<zdpzArr.length;i++) {
						...
						if ('y'==sfzd) {//只读的处理
							...
							if (zdid == 'jg'){
								...
								jQuery('input[name=xb]:checked').parent().html(xb);
								...
								jQuery('#'+zdid).parent().html("<div style='word-break:break-all;width:97%'>" + tagValue +"</div>");
								jQuery('#'+zdid).parent().append(hiddenInput);
							}
		...
		function saveZxsSq(btzdId){
			var str = "xh-xm-nj-xydm-zydm-bjdm-"+btzdId;
				...
				<table style="margin-bottom: 2px" width="100%" border="0" class="formlist" id="tab_qtxx">
					...
					<tr>
						...
						<td colspan="2">
							...
							&nbsp<font color='red'> * 必须是本人开户行</font>
						</td>
					</tr>
					<tr>
							<th width="13%">
						...
						<th>
							...
							<tr>
							<th>
								备注<br /><font color="red">(限制500字以内)</font>
							</th>
							<td colspan="4">
							...
							<tr>
							<th>
								在校期间获奖情况<br /><font color="red">(限制500字以内)</font>
							</th>
							<td colspan="4">
