					...
					<tbody id="hi_jbxx">
						...
						<tr>
							...
							<td align="left" colspan="2">
								<html:select name='rs' property="zd2" style="width:120px"
									styleId="zd2">
									<html:option value=""></html:option>
						...
						<tr>
							...
							<td colspan="2">
							<html:text name='rs'  property="bysj" styleId="bysj"
									maxlength="10" styleClass="text_nor"
				...
				<table width="100%" border="0" style="margin-bottom: 2px" class="formlist" id="tab_lxfs">
					...
					<tr>
						...
						<th>
							...
							<td>
								<html:text name='rs' property="zd1" maxlength="6" styleId="zd1"
								onkeyup="value=value.replace(/[^\d]/g,'') "/>
							</td>
							<th>
							现住址
							...
							<td align="left" colspan="2">
							<html:text name="rs" property="xwzsxxdz" maxlength="25" styleId="xwzsxxdz" style="width:90%"/>
							</td>
							</tr>
					</tbody>
				</table>
				...
				<table style="margin-bottom: 2px" width="100%" border="0" class="formlist" id="tab_qtxx">
					...
					<tr>
						...
						<th>
							...
							<td>
							<html:select name='rs' property="sfjh" style="width:120px"
									styleId="sfjh">
									<html:option value=""></html:option>
							...
							<td colspan="2">
								<html:text name="rs" property="zjdm" styleId="zjdm"
									styleClass="text_nor" maxlength="20" />
							</td>
							</tr>
							...
							<td>
							<html:text name="rs" property="xx" styleId="xx"
									styleClass="text_nor" maxlength="4" />
									</td>
									<th>
								家庭结构
							...
							<td colspan="2">
								<html:text name="rs" property="jtcygc" styleId="jtcygc"
									styleClass="text_nor" maxlength="10" />
							</td>
							</tr>
							...
							<td>
							<html:text name="rs" property="ccqj" styleId="ccqj"
									styleClass="text_nor" maxlength="20" />
									</td>
									<th>
								担任班干部
					...
					<tfoot>
						<tr>
							<td colspan="5">
								...
								<div class="btn">									
									<button type="button" name="学生登记表打印" onclick="printZxsxx();return false;" id="btn_dy">学生信息打印</button>	
