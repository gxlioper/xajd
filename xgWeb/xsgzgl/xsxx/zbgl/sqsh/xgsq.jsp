	...
	<head>
		...
		<script type="text/javascript">
			function saveForm(url){
				var checkStr = "dszn-hyzk-sl-sg-tz-yzd-yzly-cjyy";
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="saveForm('zbglSqsh.do?method=update');">
										保存草稿
									</button>
									<button type="button" onclick="saveForm('zbglSqsh.do?method=updateAndSubmit');">
										提交申请
									</button>
