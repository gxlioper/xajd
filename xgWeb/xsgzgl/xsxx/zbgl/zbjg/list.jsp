...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function cksq(id){
				showDialog("查看",700,460,"zbglZbjg.do?method=view&id="+id);
			}
			...
			function update(){
				...
				if (rows.length != 1){
					...
					showDialog('修改',700,500,'zbglZbjg.do?method=edit&id='+rows[0]["id"]);
				}
			}
			...
			function add(){
				showDialog('增加',700,500,'zbglZbjg.do?method=add');;
			}
			...
			function exportData(){
				...
				var url = "zbglZbjg.do?method=export&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
