	...
	<head>
		...
		<script type="text/javascript">
			function saveForm(url){
				...
				if("13943" == xxdm) {
					if (jQuery("#xn").val() == "" || jQuery("#sqsj").val() == "" 
				...
				jQuery.post("cxpdSqsh.do?method=getExistsCount",{xh:xh,xn:xn,xq:xq,id:jQuery("#id").val()},function(data){
					if (Number(data) == 0){
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="saveForm('cxpdSqsh.do?method=update');">
										保存草稿
									</button>
