	...
	<head>
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				var gridSetting = {
					pager:"pager",
					url:"cxpdSqsh.do?method=getPdsbList",
					colList:[
					   ...
					   {label:'评定级别',name:'cxdjmc',index:'cxdjmc'},
					   {label:'申请时间',name:'sqsj',index:'sqsj'},
					   {label:'shzt',name:'shzt',index:'shzt',hidden:true},
					   {label:'shzt',name:'splcid',index:'splcid',hidden:true},
