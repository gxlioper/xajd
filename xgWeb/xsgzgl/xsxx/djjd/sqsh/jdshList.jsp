	...
	<head>
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				var gridSetting = {
					pager:"pager",
					url:"jddj_sqsh.do?method=getJdshList",
					colList:[
					   ...
					   {label:'项目',name:'xmmc',index:'xmmc',width:'13%'},
					   {label:'级别',name:'jbmc',index:'jbmc',width:'13%'},
					   {label:'证书编号',name:'zsbh',index:'zsbh',width:'13%'},
			...
			function cancelAuding(){
				...
				if (ids.length != 1){
					...
					jQuery.post("jddj_sqsh.do?method=cancelAudit",{id:ids.toString(),gwid:rows[0]["xtgwid"]},function(data){
