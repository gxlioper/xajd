	...
	<head>
		...
		jQuery(function(){
			var gridSetting = {
				...
				pager:"pager",
				rowNum:10,
				url:"xsxx_bysxx_xxgl.do?method=showStudents&type=query",
				...
				colList:[
				   ...
				   {label:'学制',name:'xz', index: 'xz',width:'10%'}
				],
				sortname: "xh",
			 	sortorder: "asc",
			}
	...
	<body>
		<html:form method="post" styleId="form" action="/xsxx_bysxx_xxgl.do?method=showStudents&type=query">
			...
			<div class="toolbox">
				...
				<ul>
						<li>
							<a href="javascript:void(0);" onclick="bysXxSave();return false;" class="btn_zj">添加</a>
						</li>
				</ul>
			</div>
				<!-- 过滤条件 -->	
