...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/xsxx/bysxxgl/xxxgsq/js/xgsq.js"></script>
					...
					<tfoot>
						<tr>
							<td colspan="5">
								...
								<div class="btn">
									<button type="button" type="button" id = "but_save" onclick="xxXgSq('save');return false;">
										保存草稿
									</button>
									<button type="button" id="buttonSave"  onclick="xxXgSq('submit');return false;">
										提交申请
									</button>
