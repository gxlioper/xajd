	...
	<body onload="showXgInfo()" >
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				...
				3.如果您认可该学生的申请情况，请点击<font color="blue">通过</font>按钮，以便下一级别进行审核。</br>
				4.如果您不认可该学生的申请情况，请点击<font color="blue">不通过</font>按钮，这样下一级别就无需再审。</br>
				5.如果您觉得该学生的申请情况有问题需要上一级别重新审核，或者学生修改后重新提交，请点击<font color="blue">退回</font>按钮。</br>
				6.如果您是最终级别岗位审核的话，那么<font color="blue">审核通过</font>的同时，将更新学生信息库。
				</span>
			</p>
			...
			<table class="formlist" style="width:95%">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<html:textarea property="shyj" styleId="shyj" rows="5" style="word-break:break-all;width:99%" onblur="chLeng(this,200)"></html:textarea>
						</td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
						<td colspan='4'>
							<div class="btn">
								...
								<button type="button" onclick="saveShzt('不通过');" style="display:none">
									不通过
								</button>
