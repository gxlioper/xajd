...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/zxdk/xyddk/xyddkhkwh/js/xyddkHkwh.js"></script>		
	</head>
	<body>
		<html:form action="/xyddk_hk" method="post" styleId="xyddkhkwhForm">		
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table width="100%" border="0" class="formlist">
					...
					<%@ include file="/xsgzgl/zxdk/xyddk/xyddkhkwh/comm/selectStudent.jsp" %>
					<thead>
						<tr>
							<th colspan="4">
								<span>申请信息</span>
