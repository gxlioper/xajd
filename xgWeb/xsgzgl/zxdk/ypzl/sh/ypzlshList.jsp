...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/zxdk/ypzl/sh/js/ypzlsh.js"></script>
		...
		if("10511"==xxdm){
			gridSetting = {
					caption:"临时困难补助审核列表",
					pager:"pager",
					url:"ypzl_sh.do?method=getYpzlshList&type=query",
					colList : [
								...
								{ label : '申请金额', name : 'sqje', index : 'sqje', width : '5%' },
