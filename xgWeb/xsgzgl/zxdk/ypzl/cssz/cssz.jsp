...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "ypzl_cssz.do?method=save" : "ypzl_cssz.do?method=update";
		      ajaxSubFormWithFun("ypzlCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/ypzl_cssz" method="post" styleId="ypzlCsszForm">
