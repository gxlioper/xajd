...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var gridSetting = {
				pager:"pager",
				url:"dkbc_dmwh.do?method=getBfqxList",
				colList:[
			...
			function update(){
				...
				if (rows.length != 1){
					...
					showDialog('修改',400,140,'dkbc_dmwh.do?method=dmwhEdit&dm='+rows[0]["dm"]);
				}
			}
			...
			function dmwhDel(){
				...
				if (ids.length == 0){
					...
					showConfirmDivLayer("您确定要删除该记录吗？",{"okFun":function(){
						jQuery.post("dkbc_dmwh.do?method=dmwhDel",{ids:ids.toString()},function(data){
			...
			function addDmwh(){
				showDialog('增加',400,140,'dkbc_dmwh.do?method=dmwhAdd');;
			}
		</script>
	</head>
