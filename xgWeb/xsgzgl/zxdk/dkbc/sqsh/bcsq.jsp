	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveForm(url){
				...
				jQuery.post("dkbc_sqsh.do?method=getCountByXhAndXn",{xh:xh},function(data){
					if (Number(data) == 0||'0'==ksqcs){
				...
				<tfoot>
					<tr>
						<td colspan="4">
							...
							<div class="btn">
								<button type="button" onclick="saveForm('dkbc_sqsh.do?method=save');">
									保存草稿
								</button>
