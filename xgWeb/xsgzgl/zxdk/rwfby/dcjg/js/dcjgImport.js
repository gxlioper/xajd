...
function downloadTemplate(drmkdm){
	...
	var url = "rwfby_dcjg.do?method=downloadTemplate";
...
function selectImport(){
	...
	var url = "rwfby_dcjg.do?method=saveImport";
...
function downloadError(filename){
	var jqFrom=jQuery("#importForm");
	var url = "rwfby_dcjg.do?method=downloadImportError&filename="+filename;
	jqFrom.attr("action",url);
	jqFrom.submit();
}
