	...
	<head>
		...
		<script type="text/javascript">
			function saveForm(){
				...
				var url = id == "" ? "rwfby_cssz.do?method=save" : "rwfby_cssz.do?method=update";
				ajaxSubFormWithFun("rwfbyCsszForm",url,function(data){
  	...
  	<body >
	<html:form action="/rwfby_cssz" method="post" styleId="rwfbyCsszForm">
