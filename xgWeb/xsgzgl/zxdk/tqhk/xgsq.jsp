...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<html:form action="/zxdkTqhk" method="post" styleId="hksqForm">
			...
			<input type="hidden" name="xh" value="${zxdkTqhkForm.xh }"/>
			<div>
				...
				<table class="formlist">
					...
					<tbody>
						<tr>
							...
							<td>
								<html:text property="hkzh" styleId="hkzh" maxlength="20"
						...
						<tr>
							...
							<td>
								<html:text property="hkje" styleId="hkje" maxlength="10"
									onkeyup="value=value.replace(/[^\d]/g,'')"
								></html:text>
							</td>
						</tr>
				...
				<tfoot>
					<tr>
						<td colspan="2">
							...
							<div class="btn">
								<button type="button" onclick="saveHksq('zxdkTqhk.do?method=update');">
									保存草稿
								</button>
