...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/zxdk/xnwxdk/sq/js/xnwxdksq.js"></script>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" onclick="saveDksq('update');">
										保存草稿
									</button>
									<button type="button" onclick="saveDksq('updatesubmit');">
										提交申请
									</button>
