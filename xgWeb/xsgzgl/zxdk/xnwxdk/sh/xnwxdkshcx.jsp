...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/zxdk/xnwxdk/sh/js/xnwxdksh.js"></script>
		<script type="text/javascript">
		var gridSetting = {
				caption:"无息借款审核列表",
				pager:"pager",
				url:"xnwxdk_sh.do?method=getXnwxdkshCx&type=query",
				colList:[
					...
					{label:'申请金额(元)',name:'sqje', index: 'sqje',width:'6%'},
