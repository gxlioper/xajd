					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">
							    ...
							    <br/>
							    <input id="checkboxvlaue" type="hidden" value="${checkboxvlaue}"/>
							    <div id="jmyjdiv">
							    	<table  border="0" cellspacing="0" cellpadding="0">
								    <logic:iterate id="jm"  name="jmyjlist">
								      <tr>
								        <td>
								    	<html:checkbox name="jm" property="jmyj" value="${jm.xssx}"></html:checkbox>
								        </td>
								        <td>
								        	${jm.jmyj}
								        </td>
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" id="bccg" onclick="saveDksq('update');">
										保存草稿
									</button>
									<button type="button" id="tjsq" onclick="saveDksq('updatesubmit');">
										提交申请
									</button>
