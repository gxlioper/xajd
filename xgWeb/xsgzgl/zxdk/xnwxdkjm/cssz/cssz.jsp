...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "xnwxdkjm_cssz.do?method=save" : "xnwxdkjm_cssz.do?method=update";
		        ajaxSubFormWithFun("XnwxdkjmCsszModel",url,function(data){
	...
	<body>
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				校内无息借款减免申请需要开启申请开关以及申请的起止时间，申请操作需在相应的起止时间内完成，无息借款<br/>
		...
		<html:form action="/xnwxdkjm_cssz" method="post" styleId="XnwxdkjmCsszModel">
