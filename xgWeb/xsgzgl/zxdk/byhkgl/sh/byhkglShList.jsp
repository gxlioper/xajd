...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="xsgzgl/zxdk/byhkgl/sh/js/byhkglSh.js"></script>
		<script type="text/javascript">
			gridSetting = {
					caption:"毕业还款审核列表",
					pager:"pager",
					url:"byhkgl_sh.do?method=getByhkglShList&type=query",
					colList : [
								{ label : 'key', name : 'sqid', index : 'sqid',key : true, hidden : true },
								{ label : 'splc', name : 'splc', index : 'splc',hidden : true },
								{ label : '学号', name : 'xh', index : 'xh', width : '12%',formatter:xhLink },
								{ label : '借用人', name : 'xm', index : 'xm', width : '10%' },
								{ label : '学院', name : 'xymc', index : 'xymc', width : '15%' },
								{ label : '班级', name : 'bjmc', index : 'bjmc', width : '15%' },					
								{ label : '还款金额(元)', name : 'hkje', index : 'hkje', width : '8%' },
