...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "byhkgl_cssz.do?method=save" : "byhkgl_cssz.do?method=update";
		      ajaxSubFormWithFun("byhkglCsszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/byhkgl_cssz" method="post" styleId="byhkglCsszForm">
