    	...
    	<table width="100%" border="0" class="formlist">
			...
			<tbody>
				<tr>
					...
					<td>
						<html:text property="lxdm" styleId="lxdm" styleClass="text_nor" maxlength="8"/>
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						<textarea name="wttg" id="wttg" style="width:98%"></textarea>
					</td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
					<td colspan="2">
						...
						<div class="btn">
							<button id="submit_button" type="button"  onclick="addThlxAction();">
								保 存
							</button>
