...
<head>
    ...
    <script language="javascript">
        function saveForm(){
            ...
            var url = id == "" ? "szdw_thjl_jcszwh.do?method=save" : "szdw_thjl_jcszwh.do?method=update";
...
<html:form action="/szdw_thjl_jcszwh" method="post" styleId="jcszForm">
            ...
            <tr>
                ...
                <td width="60%">
                    <html:text property="sqkssj" styleId="sqkssj"
                               onfocus="showCalendar('sqkssj','y-mm-dd',true,'sqjssj');" readonly="true"/>
                    &nbsp;至
                    <html:text property="sqjssj" styleId="sqjssj"
                               onfocus="showCalendar('sqjssj','y-mm-dd',false,'sqkssj');" readonly="true"/>
                </td>
            </tr>
            <tr>
                <th width="35%">
                    <font color="red">*</font>申请审核流
                </th>
                <td width="60%">
