				...
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
						<tr>
							<th>岗位</th>
							<td >
								<html:text property="gw" styleId="gw" style="border:none"></html:text>
								<html:hidden property="id" styleId="id"/>
							</td>
							<th><font color="red">*</font>固定津贴</th>
							<td >
								<html:text property="gdffje" styleId="gdffje" onkeyup="checkMoneyBykeyUp(this)" maxlength="10"></html:text>元
							</td>
						</tr>
						<tr>
							<th>备注
					...
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<button type="button" id="savegdjt" onclick="savegdjts('update');">
										保    存
									</button>
