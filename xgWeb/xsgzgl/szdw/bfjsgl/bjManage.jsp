...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		jQuery(function(){
			var gridSetting = {
					caption:"班级列表",
					pager:"pager",
					url:"bfjsgl_bfjsglwh.do?method=bjManage&type=query&jcrq="+jQuery("#jcrq").val(),
					colList:[      
		...
		function addBjBc() {
			...
			if (ids.length != 1) {
				...
				jQuery("#tbody_zcryxx",parentD).empty();
				jQuery("#tbody_zdryxx",parentD).empty();
				jQuery("#tbody_skryxx",parentD).empty();
				jQuery("#tbody_wzxryxx",parentD).empty();
				iFClose();
			}
		}
	...
	<body>
		<html:form action="/bfjsgl_bfjsglwh">
			...
			<input type="hidden" id="jcrq" value="${jcrq}" />
