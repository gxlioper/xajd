		...
		<script type="text/javascript">
			...
			var gridSetting = {
				...
				colList:[
				   ...
				   {label:'性别',name:'xbmc', index: 'xbmc',width:'7%'},
				   ...
				   {label:'zcmc',name:'zcmc', index: 'zcmc',width:'10%',hidden:true},
                    {label:'名族',name:'mzmc', index: 'mzmc',width:'10%',hidden:true},
                    {label:'政治面貌',name:'zzmmmc', index: 'zzmmmc',width:'10%',hidden:true},
                    {label:'到校工作时间',name:'rxgzsj', index: 'rxgzsj',width:'10%',hidden:true},
