...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function savePxsq(obj){
				var oldxmdm = jQuery("#oldxmdm").val();
				var xmdm = jQuery("#xmdm").val()
					if(yanzheng()){
						if(oldxmdm == xmdm){
							...
							//验证成功后才能进行保存
							if(obj == "submit"){
								url = "szdw_fdypxxmsq.do?method=fdypxxmsqXg&type=submit";
							}else{
								url = "szdw_fdypxxmsq.do?method=fdypxxmsqXg&type=update";
							}
	...
	<body style="width:100%">
		...
		<input type="hidden" id="oldxmdm" value="${oldxmdm}"/>
		...
		<html:hidden property="xmdm" name="model" styleId="xmdm"/>
