    ...
    <script type="text/javascript">
        jQuery(function(){
            var gridSetting = {
                caption:"",
                pager:"pager",
                url:"szdw_fdy_lwwh.do?method=lwList&type=query",
                colList:[
                    ...
                    {label:'题目',name:'tm', index: 'tm',width:'10%'},
                    {label:'发表时间',name:'fbsj', index: 'fbsj',width:'10%'},
                    {label:'刊物名称',name:'kwmc', index: 'kwmc',width:'10%'},
                    {label:'刊号',name:'kh', index: 'kh',width:'10%'},
                    {label:'期刊类别',name:'qklbmc', index: 'qklbmc',width:'10%'},
                    {label:'本人角色',name:'cdjsmc', index: 'cdjsmc',width:'10%'}
                ],
                sortname: "zgh",
                sortorder: "asc"
            }
        ...
        function add(){
            showDialog("增加论文信息",700,550,"szdw_fdy_lwwh.do?method=add");
        }
        function update(){
            ...
            showDialog("修改论文信息",700,550,"szdw_fdy_lwwh.do?method=update&id="+rows[0]["id"]);
        }
        function view(val){
            showDialog("论文信息查看",700,550,"szdw_fdy_lwwh.do?method=view&id="+val);
        }
        function del() {
            ...
            confirmInfo("您确定要删除"+ids.length +"条记录吗?",function(ty){
                if(ty=="ok"){
                    jQuery.post("szdw_fdy_lwwh.do?method=del",{values:ids.toString()},function(data){
        ...
        function importConfig(){
            toImportDataNew("IMPORT_FDYLW");
            return false;
        }

        //dcglbh,导出功能编号
        var DCGLBH = "szdw_fdy_lwwh.do";
        ...
        function exprotData() {
            ...
            var url = "szdw_fdy_lwwh.do?method=exportData&dcglbh=" + DCGLBH;//dcglbh,导出功能编号
