...
<head>
    ...
    <script type="text/javascript">
        jQuery(function(){
            var gridSetting = {
                ...
                colList:[
                    ...
                    {label:'研究方向',name:'yjfx', index: 'yjfx',width:'10%'},
                    {label:'级别',name:'jbmc', index: 'jbmc',width:'10%'},
                    {label:'成立时间',name:'clsj', index: 'clsj',width:'10%'},
                    {label:'经费总额',name:'jfze', index: 'jfze',width:'10%'},
                    {label:'本人承担角色',name:'cdjsmc', index: 'cdjsmc',width:'10%'},
                    {label:'是否考核通过',name:'sfkhtgmc', index: 'sfkhtgmc',width:'10%'}
                ],
                sortname: "zgh",
                sortorder: "asc"
            }
        ...
        function add(){
            showDialog("增加工作坊/工作室信息",700,550,"szdw_fdy_gzfwh.do?method=add");
        }
        function update(){
            ...
            showDialog("修改工作坊/工作室信息",700,550,"szdw_fdy_gzfwh.do?method=update&id="+rows[0]["id"]);
        }
        function view(val){
            showDialog("工作坊/工作室信息查看",700,550,"szdw_fdy_gzfwh.do?method=view&id="+val);
        }
        function del() {
        ...
        function exprotData() {
            ...
            var url = "szdw_fdy_gzfwh.do?method=exportData&dcglbh=" + DCGLBH;//dcglbh,导出功能编号
