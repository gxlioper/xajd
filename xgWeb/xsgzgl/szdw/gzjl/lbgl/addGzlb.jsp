...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
		     ...
		     var url = "gzjllb.do?method=addGzlb&type=save";
	...
	<body>
		<html:form action="/gzjllb" method="post"
			styleId="GzjlLbglForm" onsubmit="return false;">
			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table align="center" class="formlist">
					<tbody>
						<tr>
							<th>
								<span class="red">*</span>工作类别代码
							</th>
							<td>
								<html:text property="lbdm" styleId="lbdm" maxlength="20"
									styleClass="text_nor" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<html:textarea property="lbsm" styleId="lbsm" style="width:95%;" rows="5" onkeypress="checkLen(this,200);"></html:textarea>
							</td>
						</tr>
