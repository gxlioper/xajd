...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function saveForm(){	  
			  ...
			  var id = jQuery("#id").val();
				var url = id == "" ? "gzjljcsz.do?method=save" : "gzjljcsz.do?method=update";
		      ajaxSubFormWithFun("GzjlJcszForm",url,function(data){
	...
	<body>
		...
		<html:form action="/gzjljcsz" method="post" styleId="GzjlJcszForm">
