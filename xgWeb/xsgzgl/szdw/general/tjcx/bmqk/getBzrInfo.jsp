...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function expBzrInfo(){
			var url="general_szdw.do?method=exportBzrInfo&rand=<%=System.currentTimeMillis() %>";
	...
	<body>
		<html:form action="/general_szdw" method="post">
			...
			<button type="button" style="display:none;" id="search_go" 
					onclick="allNotEmpThenGo('general_szdw.do?method=getBzrInfo')">
			</button>
			...
			<div class="formbox" style="overflow-x:hidden;overflow-y:auto;"> 
				...
				<table class="dateline tablenowrap" width="100%">
					...
					<tbody>
						<logic:iterate id="b" name="bzrList">
							<tr>
								<td>${b.nj }</td>
								<td>${b.bjmc }</td>
								<td>${b.bzr }</td>
			...
			<table class="dateline tablenowrap" width="100%">
				<tfoot>
					...
					<td colspan="4" align="right">
						<button type="button"  onclick="expBzrInfo();">导出</button>
