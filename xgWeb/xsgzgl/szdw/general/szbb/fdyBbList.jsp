...
<head>
    ...
    <script type="text/javascript">
        jQuery(function () {
            var gridSetting = {
                ...
                colList: [
                    ...
                    {label: '行政班级人数', name: 'rs', index: 'rs', width: '10%',formatter:function(cellVal,row){
        ...
        function xsxxView(n,bjdm){
            ...
            showDialog("学生详细信息",900,500,"general_szdw.do?method=xsxxList&bjdm="+bjdm+"&bbType=fdy");
        }
