		...
		<html:form action="/szdw_szbb" method="post">
			...
			<div class="toolbox">
				...
				<div class="buttonbox">
					<ul>
						<li>
							<a href="#" onclick="goHome(jQuery('#hid_fplx').val());return false;" class="btn_fh">
								返回
							</a>
						</li>
					</ul>
						...
						<tbody>
							...
							<tr>
								...
								<logic:equal name="fplx" value="fdy">
									书院
									<logic:equal name="userType" value="sy">
									<html:select property="sydm" styleId="sy" disabled="true"
												 value="${userSyDep}" style="width:120px"
												 onchange="initBjListBySzbb();">
										<html:option value=""></html:option>
										<html:options collection="syList" property="sydm"
													  labelProperty="symc" />
										<html:hidden property="sydm" value="${userSyDep }" style="display:none" />
									</html:select>
									</logic:equal>
									<logic:notEqual name="userType" value="sy">
										<html:select property="sydm" styleId="sy"
													 style="width:120px"
													 onchange="initBjListBySzbb();">
											<html:option value=""></html:option>
											<html:options collection="syList" property="sydm"
