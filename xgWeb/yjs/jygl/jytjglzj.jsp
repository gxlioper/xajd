...
<head>
	...
	<script language="javascript">
		function checkForm(){
			...
			changTab('/yjsjwgl/jytjzg.do?dotype=add');
		}
		function checkModify(){
			...
			changTab('/yjsjwgl/jytjzg.do?dotype=modify');
		}
	</script>
</head>
 <%
		...
		<div>
			<table width="99%">
				...
				<tr>
					...
					<td><input type="text" name="lqjytjbsj" onclick="return showCalendar('lqjytjbsj','y-mm-dd');"/></td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						推荐表盖章时间
					</td>
					<td><input type="text" name="tjbgzsj" onclick="return showCalendar('tjbgzsj','y-mm-dd');"/></td>	
				</tr>
			</table>
			<div id="button">
		...
		<div>
			...
			<table width="99%">
				...
				<tr>
					...
					<td>
						<html:text property="lqjytjbsj" name="map" onclick="return showCalendar('lqjytjbsj','y-mm-dd');"></html:text>
					</td>	
				</tr>
				<tr>
					<td align="center" width="45%">
					...
					<td><html:text property="tjbgzsj" name="map" onclick="return showCalendar('tjbgzsj','y-mm-dd');"></html:text> </td>	
				</tr>
			</table>
			<div id="button">
			...
			<logic:equal name="result" value="view">
			    ...
			    window.dialogArguments.document.forms[0].action='/yjsjwgl/jytjgl.do?act=find';
