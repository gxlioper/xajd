...
<body>
	...
	<input type="hidden" name="form_action" value="/yjsjwgl/jyjlgl.do?act=find"/>
						...
						<tr>
							...
							<td align="center">
								<button class="button2"
									onclick="changTab('/yjsjwgl/jyjlgl.do?act=find')"
									style="width: 60px">
									查&nbsp;&nbsp;询
								</button>
							</td>
				...
				<table width="99%">
					...
					<logic:iterate id="model" name="jytjList" scope="request">
						<tr style="cursor: hand" onclick="cols(this)"
								...
								ondblclick="cz('/yjsjwgl/jyjlgl.do?act=ck','ck')">
							...
							<td align="center">
								<bean:write name="model" property="grjydw" />
							</td>
							<td align="center">
								<bean:write name="model" property="zslqr" />
							</td>
							<td align="center">
								<bean:write name="model" property="jjlqr" />
							</td>
							<td align="center">
			...
			<div id="btn" style="position: absolute; left:0px;top:0px">
				<logic:equal name="canWrite" value="1">
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/jyjlgl.do?act=add','add')">
						增加记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/jyjlgl.do?act=modify','modify')">
						修改记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="changTab('/yjsjwgl/jyjlgl.do?act=delete')">
						删除记录
					</button>
				</logic:equal>
			</div>
