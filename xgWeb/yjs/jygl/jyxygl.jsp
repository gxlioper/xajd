...
<body>
	...
	<input type="hidden" name="form_action" value="/yjsjwgl/jyxygl.do?act=find"/>
						...
						<tr>
							...
							<td align="center">
								<button class="button2"
									onclick="changTab('/yjsjwgl/jyxygl.do?act=find')"
									style="width: 60px">
									查&nbsp;&nbsp;询
								</button>
							</td>
				...
				<table width="99%">
					...
					<logic:iterate id="model" name="jytjList" scope="request">
						<tr style="cursor: hand" onclick="cols(this)"
								...
								ondblclick="cz('/yjsjwgl/jyxygl.do?act=ck','ck')">
							...
							<td align="center">
								<bean:write name="model" property="jydwmc" />
							</td>
							<td align="center">
								<bean:write name="model" property="dwlxdh" />
							</td>
							<td align="center">
								<bean:write name="model" property="yrdwjfqzsj" />
							</td>
							<td align="center">
								<bean:write name="model" property="yrdwyfqzsj" />
							</td>
					</logic:iterate>
					</logic:present>
				</table>
			...
			<div id="btn" style="position: absolute; left:0px;top:0px">
				<logic:equal name="canWrite" value="1">
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/jyxygl.do?act=add','add')">
						增加记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/jyxygl.do?act=modify','modify')">
						修改记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="changTab('/yjsjwgl/jyxygl.do?act=delete')">
						删除记录
					</button>
				</logic:equal>
			</div>
