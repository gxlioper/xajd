...
<body>
	...
	<input type="hidden" name="form_action" value="/yjsjwgl/jygpgl.do?act=find"/>
						...
						<tr>
							...
							<td align="center">
								<button class="button2"
									onclick="changTab('/yjsjwgl/jygpgl.do?act=find')"
									style="width: 60px">
									查&nbsp;&nbsp;询
								</button>
							</td>
				...
				<table width="99%">
					...
					<logic:iterate id="model" name="jytjList" scope="request">
						<tr style="cursor: hand" onclick="cols(this)"
								...
								ondblclick="cz('/yjsjwgl/jygpgl.do?act=ck','ck')">
							...
							<td align="center">
								<bean:write name="model" property="gpyy" />
							</td>
							<td align="center">
								<bean:write name="model" property="gpqdw" />
							</td>
							<td align="center">
								<bean:write name="model" property="gphdw" />
							</td>
							<td align="center">
								<bean:write name="model" property="spr" />
							</td>
					</logic:iterate>
					</logic:present>
				</table>
			...
			<div id="btn" style="position: absolute; left:0px;top:0px">
				<logic:equal name="canWrite" value="1">
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/jygpgl.do?act=add','add')">
						增加记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/jygpgl.do?act=modify','modify')">
						修改记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="changTab('/yjsjwgl/jygpgl.do?act=delete')">
						删除记录
					</button>
				</logic:equal>
			</div>
