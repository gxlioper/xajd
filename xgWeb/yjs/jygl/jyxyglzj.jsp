...
<head>
	...
	function checkForm(){
			...
			changTab('/yjsjwgl/jyxyzg.do?dotype=add');
		}
	function checkModify(){
			...
			changTab('/yjsjwgl/jyxyzg.do?dotype=modify');
		}
	</script>
</head>
 <%
		...
		<div>
			<table width="99%">
				...
				<tr>
					...
					<td><input type="text" name="jydwmc" /></td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						单位联系电话
					</td>
					<td><input type="text" name="dwlxdh" /></td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						用人单位甲方签字时间
					</td>
					<td><input type="text" name="yrdwjfqzsj" 
						onclick="return showCalendar('yrdwjfqzsj','y-mm-dd');"/></td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						用人单位乙方签字时间
					</td>
					<td><input type="text" name="yrdwyfqzsj" 
						onclick="return showCalendar('yrdwyfqzsj','y-mm-dd');"/></td>	
				</tr>
			</table>
			<div id="button">
		...
		<div>
			...
			<table width="99%">
				...
				<tr>
					...
					<td>
						<html:text property="jydwmc" name="map">
						</html:text>
					</td>	
				</tr>
				<tr>
					...
					<td><html:text property="dwlxdh" name="map"></html:text> </td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						用人单位甲方签字时间
					</td>
					<td><html:text property="yrdwjfqzsj" name="map"
						onclick="return showCalendar('yrdwjfqzsj','y-mm-dd');"></html:text> </td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						用人单位乙方签字时间
					</td>
					<td><html:text property="yrdwyfqzsj" name="map" 
						onclick="return showCalendar('yrdwyfqzsj','y-mm-dd');"></html:text> </td>	
				</tr>
			</table>
			<div id="button">
			...
			<logic:equal name="result" value="view">
			    ...
			    window.dialogArguments.document.forms[0].action='/yjsjwgl/jyxygl.do?act=find';
