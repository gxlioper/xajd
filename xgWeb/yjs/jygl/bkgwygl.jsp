...
<body>
	...
	<input type="hidden" name="form_action" value="/yjsjwgl/bkgwygl.do?act=find"/>
						...
						<tr>
							...
							<td align="center">
								<button class="button2"
									onclick="changTab('/yjsjwgl/bkgwygl.do?act=find')"
									style="width: 60px">
									查&nbsp;&nbsp;询
								</button>
							</td>
				...
				<table width="99%">
					...
					<logic:iterate id="model" name="jytjList" scope="request">
						<tr style="cursor: hand" onclick="cols(this)"
							...
							<td align="center">
								<bean:write name="model" property="grbmbgzsj" />
							</td>
							<td align="center">
								<bean:write name="model" property="nbkdw" />
							</td>
					</logic:iterate>
					</logic:present>
				</table>
			...
			<div id="btn" style="position: absolute; left:0px;top:0px">
				<logic:equal name="canWrite" value="1">
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/bkgwygl.do?act=add','add')">
						增加记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/bkgwygl.do?act=modify','modify')">
						修改记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="changTab('/yjsjwgl/bkgwygl.do?act=delete')">
						删除记录
					</button>
				</logic:equal>
			</div>
