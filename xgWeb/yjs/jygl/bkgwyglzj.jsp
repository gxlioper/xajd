...
<head>
	...
	<script language="javascript">
		function checkForm(){
			...
			changTab('/yjsjwgl/bkgwyzg.do?dotype=add');
		}
		function checkModify(){
			...
			changTab('/yjsjwgl/bkgwyzg.do?dotype=modify');
		}
	</script>
</head>
 <%
		...
		<div>
			<table width="99%">
				...
				<tr>
					...
					<td><input type="text" name="grbmbgzsj" 
						onclick="return showCalendar('grbmbgzsj','y-mm-dd');"/></td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						拟报考单位
					</td>
					<td><input type="text" name="nbkdw" /></td>	
				</tr>
			</table>
			<div id="button">
		...
		<div>
			...
			<table width="99%">
				...
				<tr>
					...
					<td>
						<html:text property="grbmbgzsj" name="map" 
								onclick="return showCalendar('grbmbgzsj','y-mm-dd');"></html:text>
					</td>	
				</tr>
				<tr>
					<td align="center" width="45%">
					...
					<td><html:text property="nbkdw" name="map"></html:text> </td>	
				</tr>
			</table>
			<div id="button">
			...
			<logic:equal name="result" value="view">
			    ...
			    window.dialogArguments.document.forms[0].action='/yjsjwgl/bkgwygl.do?act=find';
