...
<body>
	...
	<input type="hidden" name="form_action" value="/yjsjwgl/zflxgl.do?act=find"/>
						...
						<tr>
							...
							<td align="center">
								<button class="button2"
									onclick="changTab('/yjsjwgl/zflxgl.do?act=find')"
									style="width: 60px">
									查&nbsp;&nbsp;询
								</button>
							</td>
				...
				<table width="99%">
					...
					<logic:iterate id="model" name="jytjList" scope="request">
						<tr style="cursor: hand" onclick="cols(this)"
								...
								ondblclick="cz('/yjsjwgl/zflxgl.do?act=ck','ck')">
							...
							<td align="center">
								<bean:write name="model" property="blsj" />
							</td>
							<td align="center">
								<bean:write name="model" property="qwgj" />
							</td>
							<td align="center">
								<bean:write name="model" property="jdxx" />
							</td>
							<td align="center">
								<bean:write name="model" property="yjfx" />
							</td>
					</logic:iterate>
					</logic:present>
				</table>
			...
			<div id="btn" style="position: absolute; left:0px;top:0px">
				<logic:equal name="canWrite" value="1">
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/zflxgl.do?act=add','add')">
						增加记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="cz('/yjsjwgl/zflxgl.do?act=modify','modify')">
						修改记录
					</button>
					<button class="button2" style="width: 70px"
						onClick="changTab('/yjsjwgl/zflxgl.do?act=delete')">
						删除记录
					</button>
				</logic:equal>
			</div>
