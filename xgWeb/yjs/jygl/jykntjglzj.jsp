...
<head>
	...
	function checkForm(){
			...
			changTab('/yjsjwgl/jykntjzg.do?dotype=add');
		}
	function checkModify(){
			...
			changTab('/yjsjwgl/jykntjzg.do?dotype=modify');
		}
	</script>
</head>
 <%
		...
		<div>
			<table width="99%">
				...
				<tr>
					...
					<td><input type="text" name="knyy" /></td>	
				</tr>
				<tr>
					<td align="center" width="45%">
						推荐单位
					</td>
					<td><input type="text" name="tjdw" /></td>	
				</tr>
			</table>
			<div id="button">
		...
		<div>
			...
			<table width="99%">
				...
				<tr>
					...
					<td>
						<html:text property="knyy" name="map">
						</html:text>
					</td>	
				</tr>
				<tr>
					...
					<td><html:text property="tjdw" name="map"></html:text> </td>	
				</tr>
			</table>
			<div id="button">
			...
			<logic:equal name="result" value="view">
			    ...
			    window.dialogArguments.document.forms[0].action='/yjsjwgl/jykntjgl.do?act=find';
