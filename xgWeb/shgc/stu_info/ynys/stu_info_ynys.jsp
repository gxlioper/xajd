...
<!--						<html:option value="无学籍">无学籍</html:option>-->
				...
				<tr>
					<td align="right">是否需要助学贷款：</td>
					<td >
					<html:radio name="rs" property="sfdk" value="是">是</html:radio>
					<html:radio name="rs" property="sfdk" value="否">否</html:radio>
					</td>
					<td align="right">
