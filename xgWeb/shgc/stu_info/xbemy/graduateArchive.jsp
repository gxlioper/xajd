		...
		<div class="rightcontent">
			...
			<logic:equal value="yes" name="writeAble" scope="request">
				<div class="buttontool" id="btn"
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
						onclick="javascript:if(curr_row==null){alert('请选择要修改的记录!');return false;}else{showTopWin('xbemyArchive.do?method=showGraduateArchive&xh='+curr_row.cells[0].innerText)}"
						style="width:80px">
						修 改
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
						onclick="javascript:if(curr_row==null){alert('请选择要删除的记录!');return false;}else{if(confirm('您确定删除该条记录吗？'))refreshForm('xbemyArchive.do?method=graduateArchive&doType=del&xh='+curr_row.cells[0].innerText)}"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2" onclick="expTab('rsTable','毕业生档案转移情况表','')">
						打印列表
					</button>
				</div>
			</logic:equal>
