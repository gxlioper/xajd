			...
			<html:form action="/xbemyStuStatus.do" method="post">
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowMoreClick(this,'',event);" style="cursor:hand"
									ondblclick="javascript:if(curr_row==null){alert('请选择要修改的记录!');return false} else{refreshForm('xbemyStuStatus.do?method=showTransferSpecialty&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)}">
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<div class="buttontool" id="btn"
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2" onclick="javascript:if(curr_row==null){alert('请选择要修改的记录!');return false} else{refreshForm('xbemyStuStatus.do?method=showTransferSpecialty&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)}" style="width:80px">
							修 改
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2" onclick="javascript:if(curr_row==null){alert('请选择要修改的记录!');return false} else{if(confirm('您确定删除该记录吗？'))refreshForm('xbemyStuStatus.do?method=TransferSpecialtyQuery&doType=del&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)}" style="width:80px">
							删 除
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
