...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('xbemyStuStatus.do?method=stuTransferStatusAuditing')">
										查询
									</button>
								</td>
							</tr>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="showTopWin('xbemyStuStatus.do?method=stuTransferStatusAuditing&doType=view&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)"
									>
