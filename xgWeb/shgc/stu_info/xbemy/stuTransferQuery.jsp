...
<%--									<html:text property="zrzymc" style="width:120px"/>--%>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('xbemyStuStatus.do?method=stuTransferQuery')">
										查询
									</button>
								</td>
							</tr>
...
<%--									<html:text property="zrxxmc" />	--%>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowMoreClick(this,'',event);" style="cursor:hand"
									ondblclick="refreshForm('xbemyStuStatus.do?method=showTransferApp&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)">
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<div class="buttontool" id="btn"
						...
						<button class="button2" onclick="refreshForm('xbemyStuStatus.do?method=showTransferApp')"
							style="width:80px">
							增 加
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2" onclick="javascript:if(curr_row==null){alert('请选择要修改的记录!');return false} else{refreshForm('xbemyStuStatus.do?method=showTransferApp&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)}" style="width:80px">
							修 改
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2" onclick="javascript:if(curr_row==null){alert('请选择要修改的记录!');return false} else{if(confirm('您确定删除该记录吗？'))refreshForm('xbemyStuStatus.do?method=stuTransferQuery&doType=del&xh='+curr_row.cells[1].innerText+'&sqrq='+curr_row.cells[0].innerText)}" style="width:80px">
							删 除
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2" onclick="expTab('rsTable','转学申请信息','')">
							打印列表
						</button>
					</div>
					<script language="javascript">
