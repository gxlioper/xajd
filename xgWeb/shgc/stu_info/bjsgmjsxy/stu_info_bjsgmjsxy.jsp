										...
										<logic:notEqual value="12861" name="xxdm">
											<logic:notEqual value="13108" name="xxdm">
												...
												<logic:notEqual value="add" name="oper">
													<div>
														<a href="#"
															onclick="addZpsc('uploadPicture.do?method=uploadPicture&type=stu&id=${rs.xh}')">上传照片</a>
													</div>
												</logic:notEqual>
												<button style="display: none" id="reloadF"
						...
						<logic:notEqual name="xxdm" value="12752">
							...
							<logic:notEqual name="xxdm" value="11057">
								...
								<tr>
									<th>是否征兵离校</th>
									<td colspan="2">
										<html:select name="rs" property="sfzblx" style="width:150"
											styleId="sfzblx">
											<html:option value=""></html:option>
											<html:option value="征兵离校">征兵离校</html:option>
											<html:option value="征兵未离校">征兵未离校</html:option>
										</html:select>
									</td>
								</tr>
							</logic:notEqual>
						...
						<tr>
							<td colspan="6">
								...
								<div class="btn">
									...
									<!--修改操作-->
									<%--						<logic:equal value="update" name="oper">--%>
									<%--						<button class="button2" id="buttonUp" style="height:20px;width:80px"--%>
									<%--							onclick="nextOrUp()">--%>
									<%--							上一页--%>
									<%--						</button>			--%>
									<%--						<button class="button2" id="buttonNext" style="height:20px;width:80px"--%>
									<%--							onclick="nextOrUp('N')">--%>
									<%--							下一页--%>
									<%--						</button>	--%>
									<%--						</logic:equal>--%>
