			...
			<table width="100%" class="formlist">
				...
				<td colspan="4">
					<html:select property="jtjjqk" name="rs" >
							<html:option value=""></html:option>
							<html:option value="1万元以下/年">1万元以下/年</html:option>
							<html:option value="1-5万元/年">1-5万元/年</html:option>
							<html:option value="5-10万元/年">5-10万元/年</html:option>
							<html:option value="10万元以上/年">10万元以上/年</html:option>
						</html:select>	
				</td>
				</tr>
				<tr>
