...
<!--							<html:option value="无学籍">无学籍</html:option>-->
				...
				<tr>					
					...
					<html:hidden property="zzmm" name="rs"/>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td align="left">
						<input type="text" disabled="disabled" value="<bean:write name="rs" property="sfjh"/>"/>
						<html:hidden name="rs" property="sfjh"/>
					</td>
					<td align="right">
						乘车区间：
					</td>
					<td align="left" colspan="2">
						<input type="text" id="ccqj" disabled="disabled" value="<bean:write name="rs" property="ccqj"/>"/>						
						<html:hidden name="rs" property="ccqj"/>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td align="left">
						<html:text name="rs" property="lxdh" disabled="true"/>
						<html:hidden name="rs" property="lxdh"/>
					</td>
					<td align="right">
						手机号码：
					</td>
					<td align="left" colspan="2">
						<html:text name="rs" property="sjhm" disabled="true"/>
						<html:hidden name="rs" property="sjhm"/>
					</td>
				</tr>
				<tr>
					<td align="right">
