			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
			    ...
			    <logic:equal name="writeAble" value="yes">
					<li> <a href="#" onclick="showOpenWindow('/xgxt/xljkMjxyXlwj.do?method=xlwjSb&doType=add',700,500)" class="btn_zj"> 增加 </a> </li>
				    <li> <a href="#" onclick="modi('/xgxt/xljkMjxyXlwj.do?method=xlwjOne&doType=modi')" class="btn_xg"> 修改 </a> </li>
					<li> <a href="#" onclick="dataBatch('xljkMjxyXlwj.do?method=xlwjCx&doType=del')" class="btn_sc"> 删除 </a> </li>
					<li> <a href="#" onclick="impAndChkData()" class="btn_dr"> 导入 </a> </li>
				</logic:equal>
				<li> <a href="#" onclick="checkDcTime()" class="btn_dc"> 导出 </a> </li>
			    </ul>
			 </div>
			<div class="searchtab">
