...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body >
		...
		<html:form action="/xljkMjxyXlztbs" method="post">
		    ...
		    <input type="hidden" name="realTable" id="realTable" value="XLJK_MJXY_XLJKBS" />
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
				...
				<li> <a href="#" onclick="showOpenWindow('/xgxt/xljkMjxyXlztbs.do?method=xlztbsWh&doType=add',700,500)" class="btn_zj"> 增加 </a> </li>
			    <li> <a href="#" onclick="modi('/xgxt/xljkMjxyXlztbs.do?method=xlztbsOne&doType=modi')" class="btn_xg"> 修改 </a> </li>
				<li> <a href="#" onclick="dataBatch('xljkMjxyXlztbs.do?method=xlztbsCx&doType=del')" class="btn_sc"> 删除 </a> </li>
				<li> <a href="#" onclick="impAndChkData()" class="btn_dr"> 导入 </a> </li>
				</logic:equal>
				<li> <a href="#" onclick="expData('xljkMjxyXlztbs.do?method=expDate')" class="btn_dc"> 导出 </a> </li>
			    </ul>
			 </div>
			<div class="searchtab">
			          ...
			          <td colspan="6">
			            <div class="btn">
			              <button class="btn_cx" id="search_go" 
			              	onclick="allNotEmpThenGo('/xgxt/xljkMjxyXlztbs.do?method=xlztbsCx&doType=qry')">
			              	查 询
			              </button>
			              &nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table summary="" class="dateline" align="" width="100%">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('/xgxt/xljkMjxyXlztbs.do?method=xlztbsOne&doType=view')" style="cursor:hand">
								<td>
