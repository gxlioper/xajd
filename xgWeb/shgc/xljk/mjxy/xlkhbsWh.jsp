	...
	<head>
		...
		<script language="javascript">	     
	     function sqSave(){
	        ...
	        refreshForm("/xgxt/xljkMjxyXlkhbs.do?method=xlkhbsWh&doType=save");
	        if($("buttonSave")){
	     ...
	     function modi(){
	       ...
	       refreshForm('/xgxt/xljkMjxyXlkhbs.do?method=xlkhbsOne&doType=update');
	        if($("buttonSave")){
	          $("buttonSave").disabled=true;
	        }
	     }
	     ...
	     function rychSqPrint(){
	        window.open('xljkMjxyXlkhbs.do?method=xlkhbsb&pkValue=${pkValue}');
	       }	
	</script>
	</head>
	<body>
		   <html:form action="/xljkMjxyXlkhbs" method="post">
			...
			<div class="tab">
				...
				<tr >
					...
					<td colspan="3" align="left">
						<html:textarea rows="8" cols="76" style="width:98%" property="save_jtqk" value="${rs.jtqk}"  onblur="chLeng(this,500)"/>
					</td>
				</tr>
				</tbody>
				 <tfoot>
