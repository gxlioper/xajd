	...
	<body >
		...
		<html:form action="/xljkMjxyXlkhxs" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
			    <ul>
				<li> <a href="#" onclick="showOpenWindow('/xgxt/xljkMjxyXlkhxs.do?method=xlkhxsWh&doType=add',700,500)" class="btn_zj"> 增加 </a> </li>
			      <li> <a href="#" onclick="modi('/xgxt/xljkMjxyXlkhxs.do?method=xlkhxsOne&doType=modi')" class="btn_xg"> 修改 </a> </li>
				<li> <a href="#" onclick="dataBatch('/xgxt/xljkMjxyXlkhxs.do?method=xlkhxsCx&doType=del')" class="btn_sc"> 删除 </a> </li>
			          ...
			          <td colspan="6">
			            <div class="btn">
			              <button class="btn_cx" id="search_go" 
			              	onclick="allNotEmpThenGo('/xgxt/xljkMjxyXlkhxs.do?method=xlkhxsCx&doType=qry')">
			              	查 询
			              </button>
			              &nbsp;&nbsp;&nbsp;&nbsp;
			...
			<logic:notEmpty name="rs">
					<table summary="" class="dateline" align="" width="100%">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('/xgxt/xljkMjxyXlkhxs.do?method=xlkhxsOne&doType=view')" style="cursor:hand">
								<td>
					...
					<jsp:include flush="true"
						page="/sjcz/turnpage.jsp?form=xljkMjxyXlkhxsForm"></jsp:include>
			</logic:notEmpty>
		</html:form>
