					...
					<thead>
						<tr>
							<td align="left">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;性别：
								<html:select property="sex_dm" style="width:50px" styleId="sex_dm"
									onchange="">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/MemberSearch.do?act=MemberSearch&doType=Search')">
									查询
								</button>
							</td>
						</tr>
				...
				<fieldset>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)" style="cursor:hand;background-color:" ondblclick="">
