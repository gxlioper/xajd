...
%>
		...
		<html:form action="/stu_active_thing" method="post">
			<div class="title">
						...
						<tr>
							...
							<td width="10" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go" 
										onclick="allNotEmpThenGo('/xgxt/stu_active_thing.do')">
									查询
								</button>
							</td>
						</tr>
						 ...
						 <tbody id="rsTable">
    						<logic:present name="rs">
      							<logic:iterate id="s" name="rs">
									<tr onclick="rowOnClick(this)" style="cursor:hand" ondblclick="viewInfo('xshdjl','/xgxt/stu_ActiveInfo.do')">
			...
			<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
				<center>
					<div class="buttontool" id="btn"
						...
						<button class="button2" onclick="viewInfo('xshdjl','/xgxt/stu_ActiveInfo.do')"
							style="width:100px">
							活 动 记 录
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
