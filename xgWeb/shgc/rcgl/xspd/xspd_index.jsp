...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script language="JavaScript">
		function rcgl_xspd_view()
		{
			var xn_id=curr_row.cells[0].getElementsByTagName("input")[0].value;
			showTopWin("/xgxt/rcgl_xspd.do?act=xspd&doType=xspd_view&xn_id="+xn_id,525,400);
		}
		function rcgl_xspd_add()
		{
			showTopWin("/xgxt/rcgl_xspd.do?act=xspd&doType=xspd_add",550,425);
		}
		
		function rcgl_xspd_del()
		{
			if (curr_row == null) {
				alert("请选择要删除的数据！\n（单击相应的行）");
				return false;
					...
					if (confirm("确定要删除该行数据吗？")) {
						var xn_id=curr_row.cells[0].getElementsByTagName("input")[0].value;
						refreshForm("/xgxt/rcgl_xspd.do?act=xspd&doType=xspd_del&xn_id="+xn_id);
						return true;
					} 
					else {
						return false;
		...
		function rcgl_xspd_modi()
		{
			...
			if (curr_row == null) {
				...
				var xn_id=curr_row.cells[0].getElementsByTagName("input")[0].value;
				showTopWin("/xgxt/rcgl_xspd.do?act=xspd&doType=xspd_modi&xn_id="+xn_id,525,400);
				return true;
			}
		}
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							...
							<td width="10" rowspan="3" align="center" valign="middle">
								...
								<button class="button2" style="height:40px;" id="search_go" 
									onclick="allNotEmpThenGo('/xgxt/rcgl_xspd.do?act=xspd&doType=xspd_search')">
									查询
								</button>								
							</td>
						</tr>
						<tr>
							<td align="left">
							品德模块：
							<html:select property="pdmkdm" style="width:150px" styleId="pdmkdm"
									onchange="">
									<html:option value=""></html:option>
				...
				<fieldset>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)" style="cursor:hand;background-color:" ondblclick="rcgl_xspd_view()">	
									<td>
									...
									<td>
										<bean:write name="s" property="PDMKMC"/>
									</td>
									<td>
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<center>
						<div class="buttontool" id="btn"
							...
							&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="rcgl_xspd_add()"
								style="width:100px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="rcgl_xspd_modi()"
								style="width:100px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="rcgl_xspd_del()"
								style="width:100px">
								删除
							</button>
						</div>
