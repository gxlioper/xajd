...
%>
	...
	function xscx_save()
	{
			...
			var cxmkdm=document.all["cxmkdm"].value;
			if ( cxmkdm==""){
				alert ("请选择诚信模块！");
				document.all["cxmkdm"].focus();
				return false;
			}
			...
			refreshForm('/xgxt/rcgl_xscx.do?act=xscx&doType=xscx_add');
	}
	</script>
	<body >
		...
		<input type="hidden" id="add_flag" name="add_flag" value="no" />		
				<table  class="tbstyle" align="center">
					...
					<tr style="height:22px">
							...
							<td align="left">
								<html:text  property="xh" styleId="xh"
									...
									<button onclick="showTopWin('/xgxt/rcgl_xscx.do?act=xscx&doType=stu_info',750,550);"
					...
					<tr style="height:22px">
						...
						<td align="left">
							<html:select property="cxmkdm" style="width:100px" styleId="cxmkdm"
									onchange="">
									<html:option value=""></html:option>
				...
				<div class="buttontool" align="center">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"  onclick="xscx_save()">
						保 存
					</button>
				</div>
