...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script>
		function sumbitForm(){
			//提交
			refreshForm("XsgyglDispatch.do?method=modiYdwmqssq&doType=save");
				...
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea property="bz" name="rs" cols="80" rows="4" onblur="chLeng(this,300)"></html:textarea>
						</td>
					</tr>	
				</table>
