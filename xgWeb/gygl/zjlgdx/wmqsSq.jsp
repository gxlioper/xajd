...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script language="javascript">
		function Save(value){
		   ...
		   document.forms[0].action = "/xgxt/zjlg_gygl.do?method=wmqssq&doType=save&act="+value;
		   document.forms[0].submit();
		}		
		function toPrintOut(){//输出相应的打印页面 
			document.forms[0].action = "/xgxt/zjlg_gygl.do?method=viewWmqsSqxx&doType=print";
...
<body>
	...
	<logic:notEqual value="yes" name="info">
		...
		<logic:notEqual value="no" name="rzxx">
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>公寓管理 - A级寝室管理 - 申请 - 文明寝室</a>
				</p>
			</div>
