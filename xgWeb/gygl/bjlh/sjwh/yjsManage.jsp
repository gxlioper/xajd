						...
						<table width="100%" class="tbstyle">
							<thead>
								<tr>
									<td align="left">
										年级：
										<html:select property="nj" style="" onchange="setZyList('研究生');setBjList('研究生')">
								...
								<tr>
									<td align="left" nowrap>
										...
										<html:select property="xydm" style="" styleId="xydm" onchange="setZyList('研究生');setBjList('研究生')">
											<html:options collection="xyList" property="dm" labelProperty="mc" />
										</html:select>
										&nbsp;&nbsp;专业：
										<html:select property="zydm" style="" styleId="zydm" onchange="setBjList('研究生')">
