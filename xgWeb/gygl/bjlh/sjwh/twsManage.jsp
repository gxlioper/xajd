	...
	function saveTws(){
		if($("rsNum")){
			if($("rsNum").value == "0"){
				...
				if (confirm("确定该批学生的团委学生状态?")) {
					saveUpdate('/xgxt/bjlh_sjwh.do?method=twsManage&doType=save','');
				}
			}
		}
	}
				...
				<div class="rightcontent">
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/bjlh_sjwh.do?method=twsManage');">
											查询
										</button>
									</td>
								</tr>
					...
					<logic:notEmpty name="rs">
						<fieldset>
							<legend>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<font color="blue">提示：单击表头可以排序;"是否团委生"打勾者为团委学生.</font>
							</legend>
										...
										<logic:iterate id="v" name="s" offset="7" length="1" >
											<td align="center">
												<logic:equal name="v" value="是">
													<input type="checkbox" id=twsxh name="twsxh" checked="checked" value="<logic:iterate id="v" name="s" offset="0" length="1"><bean:write name="v"/></logic:iterate>"/>
												</logic:equal>
												<logic:equal name="v" value="否">
													<input type="checkbox" id=twsxh name="twsxh" value="<logic:iterate id="v" name="s" offset="0" length="1"><bean:write name="v"/></logic:iterate>"/>
												</logic:equal>
												<logic:equal name="v" value="体优生">
													<bean:write name="v" />
												</logic:equal>
											</td>
										</logic:iterate>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" onclick="saveTws()">
								保	存
							</button>
							&nbsp;&nbsp;
