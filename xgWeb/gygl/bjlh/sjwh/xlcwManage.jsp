				...
				<div class="rightcontent">
							...
							<thead>
								<tr>
									<td align="left">
										...
										&nbsp;&nbsp;检测数据异常：
										<html:checkbox property="sfyc" styleId="sfyc" onclick=""></html:checkbox>
									</td>
									<td width="10" rowspan="" align="center" valign="middle">
										<input type="hidden" name="go" value="a" />
										<button class="button2" style="" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/bjlh_sjwh.do?method=xlcwManage');">
											查询
										</button>
									</td>
								</tr>
					...
					<div id="toolTipLayer"
						...
						<div class="buttontool" align="center" id="btn" style="position:absolute;width:100%;">
							<button class="button2" onclick="sumitInfo('/xgxt/bjlh_sjwh.do?method=xlcwManage','del')">
								删	除
							</button>
							&nbsp;&nbsp;
