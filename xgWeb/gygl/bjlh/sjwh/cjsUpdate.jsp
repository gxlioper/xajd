...
<html xmlns="http://www.w3.org/1999/xhtml" lang="GBK">
	...
	function saveCjs(){
		...
		saveUpdate('/xgxt/bjlh_sjwh.do?method=cjsUpdate&doType=save','xh-xb-nj-xm-xydm-zydm-bjdm-sfzh-rxrq-xz');
	}
	</script>
	<body onload="">
		<html:form action="/bjlh_sjwh">
			...
			<table class="tbstyle" border="0" id="rsTable" align="center"
				...
				<tr style="height: 23px">
					...
					<td align="left">
						<logic:equal name="doType" value="add">
							<html:text name='rs' property="fqrzxh" styleId="fqrzxh" maxlength="20" onchange="isCz('fqrzxh||lx',this.value+'成教生')"/>
						</logic:equal>
					...
					<td align="left">
						<html:select name="rs" property="nj" style="" styleId="nj" onchange="setZyList('成教生');setBjList('成教生')">
				...
				<tr style="height: 23px">
					...
					<td align="left">
						<html:select name="rs" property="xydm" style="" styleId="xydm" onchange="setZyList('成教生');setBjList('成教生')">
				...
				<tr style="height: 23px">
					...
					<td align="left">
						<html:select name="rs" property="zydm" style="" styleId="zydm" onchange="setBjList('成教生')">
