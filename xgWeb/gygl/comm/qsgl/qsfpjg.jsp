...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//查询结果集
		function searchRs(){
			allNotEmpThenGo('/xgxt/gyglQsgl.do?method=qsfpjg');
		}
		...
		function qxfp(){
			...
			if(flag){
				if (confirm("将要取消所勾选寝室的分配情况，请确认！")) {
					saveUpdate('/xgxt/gyglQsgl.do?method=qsfpjg&doType=del','');
				}
			}else{
				alert("请勾选需要取消分配的寝室！");
			}
	...
	<body>
		...
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				结果集中展现信息为已经分配的全部寝室。勾选希望取消分配的寝室分配记录，点击“取消分配”，完成取消操作。
			</p>
