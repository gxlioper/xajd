...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//查询结果集
		function searchRs(){
			allNotEmpThenGo('/xgxt/gyglCwgl.do?method=axsfpcw');
		}
		...
		function axsfpcw(){
			...
			saveUpdate('/xgxt/gyglCwgl.do?method=xscwfp&doType=cwfp','');
		...
		function fhSdfp(){
			...
			//查询结果集
			allNotEmpThenGo('/xgxt/gyglCwgl.do?method=cwsdfp');
		}
		</script>
	</head>
	<body onload="">
		...
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置：</em><a>公寓管理 - 床位管理 - 床位手动分配</a>
			</p>
		</div>
		<!-- 标题 end-->
