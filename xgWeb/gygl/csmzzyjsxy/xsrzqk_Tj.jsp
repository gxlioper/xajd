...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function dataExport(){
			document.forms[0].action = "/xgxt/csmz_gygl.do?method=wxsyzy_xsrzqk_Tj";
	...
	<body>
		...
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置：</em><a>公寓管理 - 统计分析 - 学生入住情况统计</a>
			</p>
		</div>
		<!-- 标题 end-->
								...
								<td colspan="10">
									<div class="btn">
										...
										<button class="btn_cx" id="search_go"
											onclick="document.forms[0].go.value='go';refreshForm('/xgxt/stuHouseInfo.do');this.disabled=true">
											统计
										</button>
									</div>
								</td>
