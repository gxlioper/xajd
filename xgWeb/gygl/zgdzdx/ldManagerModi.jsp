...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="showLzRq();loadView();">
		...
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置：</em><a>公寓管理 - 园区管理 - 楼长信息</a>
			</p>
		</div>
		<!-- 标题 end-->
			...
			<table class="formlist" border="0" align="center" style="width: 100%">
				...
				<tbody>		
					<tr>
						...
						<td height="22" align="left">
							<html:select name="rs" property="yqdm" style="width:150px" styleId="yqdm" 
										onchange="refreshForm('/xgxt/zgdzdx_Gygl.do?method=ldManagerModi')">
					...
					<tr>
						...
						<td height="22" align="left">
							<html:text  name="rs" property="lz"></html:text>
						</td>
					</tr>						
					<tr>
						<th height="22" align="right">
	...
	<script type="text/javascript">
	     function ldMAddSave(mustFill){
	           ...
	           refreshForm("/xgxt/zgdzdx_Gygl.do?method=ldManagerModi&doType=Save");		           	    	 	           
	     }
	     function showLzRq(){
	          var sfzz = $("sfzz").value;
	          if(sfzz=="否"){
