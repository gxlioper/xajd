		...
		<input type="hidden" id="pkValueA" name="pkValueA" value="<bean:write name="pkValueA" scope="request"/>" />		
			<div class="title">
				<div class="title_img" id="title_m">
						当前所在位置：公寓管理 - 公寓德育考评 - 详细信息查看 - 学生惩罚信息
				</div>
			</div>
			<logic:empty name="rs">
				<br />
				...
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<logic:present name="showhzy">
								<html:select  name ="rs" property="cfnr" style="width: 120px" onchange="getGyJcXf_Modi('cf')">
								    <html:option value=""></html:option>
								    <html:options collection="xscfList" property="cfdm"
								          labelProperty="cfmc"/>
								</html:select>
						</logic:present>
						<logic:notPresent name="showhzy">
						<html:text name='rs' property="cfnr" styleId="jlnr" />
						</logic:notPresent>
						</td>
						<td align="right">
							德育扣分：
						...
						<td align="left">							
							<html:text name="rs" property="rykf" style="width: 120px" styleId="ryjf" onkeypress="return sztzNumInputValue(this,5,event)" onblur="chkInput(this,event)"/>
						</td>			
					</tr>
					<tr>
						<td align="right">
