		...
		<html:form action="/XsgyglDispatch.do" method="post">
			...
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置： 公寓管理 - 审核 - 寝室评奖申请审核 - 学年文明寝室申请审核
				</div>
			</div>			
			<fieldset>
				<legend>
			...
			<center>
				<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px">
					<button class="button2" onclick="sumitInfo('XsgyglDispatch.do?method=xnwmqssh&shjg=通过','audi')" style="width:80px">
						通 过
					</button>
					&nbsp;&nbsp;
					<button class="button2" onclick="sumitInfo('XsgyglDispatch.do?method=xnwmqssh&shjg=不通过','audi')" style="width:80px">
						不 通 过
					</button>
				</div>
			</center>
