...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script>
		...
		function modifyData(w,h){
			...
			showTopWin('XsgyglDispatch.do?method=audiYdwmqssq&pk=' + pkValue,w,h);
		}
		...
		<html:form action="/XsgyglDispatch.do" method="post">
			...
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置： 公寓管理 - 审核 - 寝室评奖申请审核 - 卫生标兵寝室申请审核
				</div>
			</div>			
			<fieldset>
				<legend>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go" 
										onclick="document.forms[0].go.value='go';refreshForm('/xgxt/XsgyglDispatch.do?method=ydwmqssh');">
									查询
								</button>
							</td>
						</tr>
			...
			<center>
				<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px">
					<button class="button2" onclick="sumitInfo('XsgyglDispatch.do?method=ydwmqssh&shjg=通过','audi')" style="width:80px">
						通 过
					</button>
					&nbsp;&nbsp;
					<button class="button2" onclick="sumitInfo('XsgyglDispatch.do?method=ydwmqssh&shjg=不通过','audi')" style="width:80px">
						不 通 过
					</button>
				</div>
			</center>
