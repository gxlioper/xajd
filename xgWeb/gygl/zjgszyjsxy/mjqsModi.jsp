...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
				...
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<td align="left" width="25%">
							<html:select name="rs" property="xn" style="width:150px" styleId="xn">
						...
						<td align="left">
							<html:select name="rs" property="xq" style="width:150px" styleId="xq">
					...
					<tr>
						...
						<td align="left">
							<html:select name="rs" property="lddm" style="width:150px"
								onchange="getSsbhLb()" styleId="lddm">
								<html:option value=""></html:option>
						...
						<td align="left">
							<html:select name="rs" property="ssbh" style="width:150px" styleId="ssbh">
					...
					<tr>
						...
						<td align="left">
							<html:text  name="rs" property="rq" onblur="dateFormatChg(this)"
								style="cursor:hand;" styleId="rq"
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea name="rs" property='bz' styleId="bz" style="width:400px"
								rows='5' />
						</td>
					</tr>
				</table>
	...
	<script type="text/javascript">
     function mjqsSave(mustFill){      
	    ...
	    refreshForm("/xgxt/zjgszy_gygl.do?method=mjqsModi&doType=save");
