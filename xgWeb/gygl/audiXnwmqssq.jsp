...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script>
		function sumbitForm(){
			...
			//提交
			refreshForm("XsgyglDispatch.do?method=audiXnwmqssq&doType=save");	
		}
	</script>
	<%
	...
	<body >	
		<html:form action="/XsgyglDispatch" method="post">		
			<input id='pk' name='pk' type='hidden' value='${rs.pk}'>	
			<input id='disabled' name='disabled' type='hidden' value='${rs.disabled}'>
			<div class="title">
				<div class="title_img" id="title_m">
						当前所在位置：公寓管理 - 申请 - 学年文明寝室申请审核
				</div>
			</div>
				...
				<!--公寓辅导员	-->
					...
					<tr>
						...
						<td align="left">
							<html:textarea property="fdyshyj" name="rs" cols="40" rows="4" onblur="chLeng(this,100)"></html:textarea>
						</td>
					</tr>
					<tr>	
						<td align="right">
					...
					<tr>
						...
						<td align="left">
							<html:textarea property="xyshyj" name="rs" cols="40" rows="4" onblur="chLeng(this,100)"></html:textarea>
						</td>
					</tr>
					<tr>	
						<td align="right">
					...
					<tr>
						...
						<td align="left">
							<html:textarea property="xxshyj" name="rs" cols="40" rows="4" onblur="chLeng(this,100)"></html:textarea>
						</td>
					</tr>
					</logic:equal>
					<!--end学校	-->
