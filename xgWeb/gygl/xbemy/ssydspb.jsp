			...
			<table width="100%" border="0" id="theTable"  class="printstyle">
				...
				<tr>
					...
					<td colspan="7">
						<p>
							1、按本表格要求填写相关内容；<br>
							2、普通宿舍之间调整不用到财务处盖章；<br>
							3、填好表格后分别到本<bean:message key="lable.xb" />、宿管科、财务处签署意见；<br>
							4、审批通过后，按要求到原宿舍楼值班室办理退宿手续后到拟调入楼办理入住手续；<br>	
							5、办理结束后 , 将此表复印四份 ( 本人、财务处、所在<bean:message key="lable.xb" />、拟调入楼楼管 ) 原件交宿管科。
						</p>
					</td>
				</tr>
