...
function chkView(){
    var url = "/xgxt/jhzy_yxlcqsz.do?method=yxlcqszChek&xmk=wjlz&pkValue=";
 ...
 function check(str){
           var userType = $("userType").value;
           var url = "/xgxt/jhzy_yxlcqsz.do?method=yxlcqszCk&xmk=wjlz&go=go&check="+str;
		   var RowsStr="";		  
		   var userType = $("userType").value;		   
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_yxlcqsz.do?method=wjlzShManage&go=go');">
										查询
									</button>
								</td>
							</tr>
