...
function chkView(){
    var url = "/xgxt/jhzy_yxlcqsz.do?method=yxlcqszChek&xmk=bjqsz&pkValue=";
 ...
 function check(str){
           var userType = $("userType").value;
           var url = "/xgxt/jhzy_yxlcqsz.do?method=yxlcqszCk&xmk=bjqsz&go=go&check="+str;
		   var RowsStr="";		  
		   var userType = $("userType").value;		   
...
<%--				<input type="hidden" id="isFdy" name="isFdy" value="<bean:write name="fdyQx" scope="session"/>"/>		--%>
				...
				<div class="title">
					<div class="title_img" id="title_m">
						当前所在位置：公寓管理 - 优秀楼层寝室长管理 - 审核 - 百佳寝室长
					</div>
				</div>
				<fieldset>
					<legend>
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_yxlcqsz.do?method=bjqszShManage&go=go');">
										查询
									</button>
								</td>
							</tr>
