...
function yxlcqszView(act){  
    ...
    var url = "/xgxt/jhzy_yxlcqsz.do?method=bjqszSq&act="+act+"&pkValue=";
...
function del(){          
           var url = "/xgxt/jhzy_yxlcqsz.do?method=yxlcqszDel&xmk=bjqsz&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
...
<%--				<input type="hidden" id="isFdy" name="isFdy" value="<bean:write name="fdyQx" scope="session"/>"/>		--%>
				...
				<div class="title">
					<div class="title_img" id="title_m">
						当前所在位置：公寓管理 - 优秀楼层寝室长管理 - 结果查询 - 百佳寝室长
					</div>
				</div>
				<fieldset>
					<legend>
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_yxlcqsz.do?method=bjqszManage&go=go');">
										查询
									</button>
								</td>
							</tr>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">													
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="showTopWin('jhzy_yxlcqsz.do?method=bjqszSq',600,480)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
