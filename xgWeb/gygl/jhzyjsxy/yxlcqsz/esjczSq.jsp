...
<head>
	...
	<script language="javascript">
		function dataSave(){
			...
			if(szlcqk.length>1000){
			  	alert("楼层情况字数过大，限1000字内!");
				return false;
			}
			...
			if(act=="modi"){
			   if(confirm("提交修改后，该申请需将重新进行审核！\n\n确定要提交吗？")){
			      refreshForm("/xgxt/jhzy_yxlcqsz.do?method=esjczSq&doType=save");			     
			   }
			}else{
			   getSztzData.getInfoEx("esjczxxb","xh||xn",pkV," (fdysh<>'未审核' or xysh<>'未审核' or xxsh<>'未审核')",function(bool){
			       if(bool){
			           alert("该生已申请本年度\"二十佳层长\"；\n\n并通过相关部门审核或正在审核中！不能再次申请！ ");
			           return false;
			       }else{
			          refreshForm("/xgxt/jhzy_yxlcqsz.do?method=esjczSq&doType=save");			          
			       }
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/jhzy_yxlcqsz.do?method=sqbPrint&xmk=esjcz";
...
<body>
	<div class="title">
		<div class="title_img" id="title_m">
			当前所在位置：公寓管理 - 优秀楼层寝室长管理 - 申请 - 二十佳层长
		</div>
	</div>
...
<logic:present name="noPass">
	       <p align="center" style="color: red">该生未曾担任过层长，不能进行本年度“二十佳层长”申请！</p>
	    </logic:present>	
		<input type="hidden" name="qshV" id="qshV" />
		<input type="hidden" id="url" name="url"
			value="/jhzy_yxlcqsz.do?method=esjczSq" />
		...
		<table class="tbstyle" width="90%">
				...
				<logic:empty name="act">
					<td width="34%">
						<html:select property="xn" styleId="xn"
							onchange="refreshForm('/xgxt/jhzy_yxlcqsz.do?method=esjczSq')">
			...
			<tr>
				...
				<td width="34%">
					<input type="text" id="zz" name="zz"  readonly="true"
						style="width:180px;heigh:100%"
						value="<bean:write name="rsEsjCz" property="zz"/>">
				</td>
			</tr>
			<tr>
			...
			<tr>				
				...
				<td>
					<input type="text" id="lxdh" name="lxdh"  maxlength="20"
						style="width:180px;heigh:100%"
						value="<bean:write name="rsEsjCz" property="lxdh"/>">
				</td>
			</tr>					
			<tr>
				<td>
				...
				<td colspan="3">
					<html:textarea name="rsEsjCz" property="szlcqk" rows='5'
						style="width:100%" />
				</td>
			</tr>						
		</table>
