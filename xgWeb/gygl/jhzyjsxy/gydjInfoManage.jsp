...
function dataView(act){  
    ...
    var url = "/xgxt/jhzy_gygl.do?method=gydjInfoAdd&act="+act+"&pkValue=";
    var pk = curr_row.cells[0].getElementsByTagName("input")[0].value;
    url += pk;
    showOpenWindow(url,"540","460");
} 
function del(){          
           var url = "/xgxt/jhzy_gygl.do?method=gydjInfoDel&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
						...
						<thead>
							<tr>
								<td align="left">
									...
									姓名
									<html:text property="xm"  style="width:60px"/>
									年级
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_gygl.do?method=gydjInfoManage&go=go');">
										查询
									</button>
								</td>
							</tr>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">													
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="showOpenWindow('jhzy_gygl.do?method=gydjInfoAdd',540,460)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
