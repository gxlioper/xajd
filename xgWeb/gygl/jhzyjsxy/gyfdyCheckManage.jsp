...
function dataView(act){  
    ...
    var url = "/xgxt/jhzy_gygl.do?method=gyfdyCheckAdd&act="+act+"&pkValue=";
    var pk = curr_row.cells[0].getElementsByTagName("input")[0].value;
    url += pk;
    showTopWin(url,600,500);
} 
function del(){          
           var url = "/xgxt/jhzy_gygl.do?method=gyfdyCheckDel&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
						...
						<thead>
							<tr>
								<td align="left">
									...
									&nbsp;&nbsp;职工号：
									<html:text property="zgh" style="width:80px" />
									&nbsp;&nbsp;姓名：
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_gygl.do?method=gyfdyCheckManage&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">													
							...
							<button class="button2"
								onclick="showTopWin('jhzy_gygl.do?method=gyfdyCheckAdd',600,500)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
