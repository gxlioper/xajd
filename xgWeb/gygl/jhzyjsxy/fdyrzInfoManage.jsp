...
function dataView(act){  
    ...
    var url = "/xgxt/jhzy_gygl.do?method=fdyRzInfoAdd&act="+act+"&pkValue=";
    var pk = curr_row.cells[0].getElementsByTagName("input")[0].value;
    url += pk;
    showTopWin(url,"500","280");
} 
function del(){          
           var url = "/xgxt/jhzy_gygl.do?method=fdyRzInfoDel&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_gygl.do?method=fdyrzInfoManage&go=go');">
										查询
									</button>
								</td>
							</tr>							
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">													
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="showTopWin('jhzy_gygl.do?method=fdyRzInfoAdd',500,280)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
