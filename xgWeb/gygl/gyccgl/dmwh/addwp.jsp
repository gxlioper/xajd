			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table align="center" class="formlist">
					<tbody>
						<tr>
							<th>
								<span class="red">*</span>物品代码
							</th>
							<td>
								<html:text property="dm" styleId="dm" maxlength="10" onkeyup="checkInput(this)"
									styleClass="text_nor" />
							</td>
						</tr>
						<tr>
							<th>
								<span class="red">*</span>物品名称
							</th>
							<td>
							...
							<td colspan="2">
								...
								<div class="btn">
									<button type="button" type="button"
										onclick="saveWpForm('add');return false;">
										保 存
									</button>
									<button type="button" type="button"
