...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script>
		function dataExport(){
			url = "XsgyglDispatch.do?method=expXqwmqssqxx";			
		...
		function modifyData(w,h){
			...
			showTopWin('XsgyglDispatch.do?method=modiXqwmqssq&pk=' + pkValue,w,h);
		}
		...
		<html:form action="/XsgyglDispatch.do" method="post">
			...
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置： 公寓管理 - 申请 - 寝室评奖申请结果查询 - 学期文明寝室申请结果查询
				</div>
			</div>			
			<fieldset>
				<legend>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go" 
										onclick="document.forms[0].go.value='go';refreshForm('/xgxt/XsgyglDispatch.do?method=xqwmqssqSearch');">
									查询
								</button>
							</td>
						</tr>
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<button class="button2" onclick="showTopWin('XsgyglDispatch.do?method=xqwmqssq',700,400)" style="width:80px">
						增加
					</button>
					&nbsp;&nbsp;
					...
					&nbsp;&nbsp;
					<button class="button2" onclick="sumitInfo('XsgyglDispatch.do?method=xqwmqssqSearch','del')" style="width:80px">
						删除
					</button>
					&nbsp;&nbsp;
