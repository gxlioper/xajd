				...
				<fieldset>
					...
					<table width="100%" class="tbstyle">
						...
						<tr align="left">
							...
							<td colspan="3">
								<html:textarea name='rs' property='save_bz' style="width:99%" rows='5' onblur="chLeng(this,250)"/>
							</td>
						</tr>
					</table>
					<div class="buttontool" align="center">
						<logic:notEqual value="view" name="type">
							<button class="button2" onclick="saveData('bxgl.do?method=tbxxModi&type=save','xh-nd-tbxzdm-tbsj-bxnx-tbgsdm')"
