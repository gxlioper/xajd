	...
	<html:form action="/szdw_zjlg" method="post">
		...
		<table class="tbstyle" width="90%" id="theTable">
			...
			<tr>
				...
				<td colspan="3">
					<html:textarea name="rs" property="sdbjxshjqk" rows='5'
			...
			<tr >
				...
				<td colspan="3">
					<html:textarea name="rs" property="hjqk" rows='5' styleId="hjqk" 
			...
			<tr >
				...
				<td colspan="3">
					<html:textarea name="rs" property="gzzj" rows='5' style="width:100%" onblur="chLeng(this,200)"/>
				</td>
			</tr>
				<tr >
				<td>
					<div align="center">
						所在<bean:message key="lable.xsgzyxpzxy" />意见
						<br>
						<font color="red"><限200字> </font>
					</div>
				</td>
				<td colspan="3">
					<html:textarea name="rs" property="xyyj" rows='5' style="width:100%" onblur="chLeng(this,200)"/>
				</td>
			</tr>
				<tr >
				<td>
				...
				<td colspan="3">
					<html:textarea name="rs" property="xxyj" rows='5' style="width:100%" onblur="chLeng(this,200)"/>
				</td>
			</tr>
		</table>
		<%--			<logic:equal name="sfksq" value="1">--%>
