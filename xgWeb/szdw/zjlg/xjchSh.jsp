...
function chkView(){
    ...
    var url = "/xgxt/szdw_zjlg.do?method=xjchChek&xjchdm="+xjchdm+"&pkValue=";
 ...
 function check(str){
           ...
           var xjchdm = $("xjchdm").value; 	
           var url = "/xgxt/szdw_zjlg.do?method=xjchCk&xjchdm="+xjchdm+"&go=go&check="+str;
		   var RowsStr="";		  
		   var userType = $("userType").value;		   
							...
							<tr>
								...
								<td width="10" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/szdw_zjlg.do?method=xjchsh&go=go');">
										查询
									</button>
								</td>
							</tr>
