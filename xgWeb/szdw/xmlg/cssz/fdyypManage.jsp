...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function updateCssz(type){
		if(type == "add"){
			showTopWin('/xgxt/xmlgfdyyp.do?method=csszUpdate&doType='+type,300,350)
			...
			if(curr_row == null){
				...
				showTopWin('/xgxt/xmlgfdyyp.do?method=csszUpdate&doType='+type+'&pk='+pk,300,350)
			}
		}else if(type == "del"){
			if(curr_row == null){
				alert('请选择要删除的信息!');
				...
				if (confirm("确认要删除字段吗？(会导致数据丢失,请慎重!)\n点击\"确定\"，删除字段；\n点击\"取消\"，将放弃删除！")) {
					showTips('处理数据中，请等待......');
					refreshForm('/xgxt/xmlgfdyyp.do?method=csszManage&doType='+type+'&pk='+pk)
				}
			}
		}
	}
							...
							<tr>
								...
								<td width="10" rowspan="32" align="center" valign="middle">
									...
									<button type="button" class="button2" style="" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/xmlgfdyyp.do?method=csszManage')">
										查询
									</button>
								</td>
							</tr>
