...
%>
    ...
    alert("您输入的学号无效!");
				...
				<input type="hidden" id="url" name="url" value="/zjjj_xsgzdw.do?method=xshzzxxOne" />
				<fieldset>
					<legend>
						学生会组织信息
					</legend>
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td align="left">
								<html:select name = "rs" property="zwdm" style="width:90px">
							...
							<td align="left">
								<html:select name = "rs" property="jb" style="width:90px">
				...
				<div class="buttontool">
					<button type="button" class="button2"
						onclick="szsxDataDoSave('zjjj_xsgzdw.do?method=saveXshzzxxOne','xh');"
