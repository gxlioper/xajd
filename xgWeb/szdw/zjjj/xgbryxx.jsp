		...
		<center>
			...
			<input type="hidden" id="writeAble" name="writeAble"
				...
				<table width="100%" class="tbstyle"> 
	      		...
	      		职务： 
	        	<html:select property="zwdm" style="width:230px" styleId="zwdm"> 
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/zjjj_xsgzdw.do?method=xgbryxxOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2"
								onclick="showTopWin('/xgxt/zjjj_xsgzdw.do?method=xgbryxxOne',600,480)"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showTopWin('/xgxt/zjjj_xsgzdw.do?method=xgbryxxOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)}"
									style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/zjjj_xsgzdw.do?method=delXgbryxxOne&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}"
									style="width:80px">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
