...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<html:form action="/szdwfzjy" method="post">
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>发展教育-发展教育相关-英才工程</a>
				</p>
			</div>
			...
			<input type="hidden" id="xh" name="xh"
				...
				<div class="tab">
				  	<table width="100%"  border="0" class="formlist">
					    <thead>
					    	<tr>
					        	<th colspan="4"><span>英才工程</span></th>
					        </tr>
					    </thead>
						<tfoot>
					      <tr>
					        <td colspan="4"><div class="bz">"<span class="red">*</span>"为必填项</div>
					          <div class="btn">
					          		<button type="button" name="保存" onclick="szsxDataDoSave('szdwfzjy.do?method=ycjySh','xh-sbjhmc-xn-nd');">保 存</button>
					          </div></td>
					      </tr>
					    </tfoot>
