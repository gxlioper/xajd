			...
			<logic:notEmpty name="rs">
				...
				<fieldset>
					...
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td align="left">
								<html:text name = "rs" property="fwxx" />
							</td>
							<td align="right">
								访问学校联系人
							</td>
							<td align="left">
								<html:text name = "rs" property="fwxxlxr" />
							</td>
						</tr>
							<tr>
							<td align="right">
							...
							<td align="left">
								<html:text name = "rs" property="fwxxlxrlxfs" />
							</td>
							<td align="right">
								访问时间
							</td>
							<td align="left">
								<html:text name= "rs"  property="fwsj" styleId="fwsj"
						...
						<tr align="left">
							...
							<td colspan="3">
								<html:text name = "rs" property="cjr" style="width:99%" />
							</td>
						</tr>
						<tr align="left">
							<td align="right">
							...
							<td colspan="3">
								<html:textarea name = "rs" property="fwxxgzld" style="width:99%" rows='5'  />
							</td>
						</tr>
						<tr align="left">
							<td align="right">
				...
				<div class="buttontool">
					<button type="button" class="button2"
						onclick="szsxDataDoSave('szdwfzjy.do?method=saveFdyxgxxOne','fwxx');"
