...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="checkWinType();">
		...
		<html:form action="/szdwfzjy" method="post">
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>发展教育-发展教育相关-新生入学教育</a>
				</p>
			</div>
				...
				<input type="hidden" id="tableName" name="tableName"
					...
					<div class="tab">
					  <table width="100%"  border="0" class="formlist">
					    <thead>
					    	<tr>
					        	<th colspan="4"><span>新生入学教育</span></th>
					        </tr>
					    </thead>
						 <tfoot>
					      <tr>
						...
						<tr>
							...
							<th align="right">
								选择参与<bean:message key="lable.xsgzyxpzxy" />:
							</th>
							<td align="left">
						...
						<tr>
							<th align="right">
								已选择参与<bean:message key="lable.xsgzyxpzxy" />:
							</th>
