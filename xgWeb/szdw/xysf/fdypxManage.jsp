...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="isJs()">
		<html:form action="/xysf_fdypx.do?method=fdypxManage" method="post">
			...
			<div class="buttonbox">	
				<ul>
					<li><a href="#" class="btn_xg" onclick="modi('xysf_fdypx.do?method=fdypxView&doType=modi',700,500);">修改</a></li>
					<li><a href="#" class="btn_sc" onclick="dataBatch('xysf_fdypx.do?method=fdypxManage&doType=del)">删除</a></li>
					<li><a href="#" class="btn_dr" onclick="impAndChkData()">导入</a></li>
					<li><a href="#" class="btn_dc" onclick="wjcfDataExport('xysf_fdypx.do?method=fdypxExp',600,400)">导出</a></li>								
				</ul>
			</div>
			</div>
			</logic:equal>
