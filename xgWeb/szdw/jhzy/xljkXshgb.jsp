...
%>
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/show_xljkXshgb_list.do" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：思政队伍-班级情况-心理健康学生会干部
				</div>
			</div>
			<div class="rightcontent">
				<fieldset>
					...
					<input type="hidden" id="realTable" name="realTable"
							value="sxjy_xljkxshgbxxb" />
					<input type="hidden" id="tableName" name="tableName"
						value="view_xljkxshgbxx" />
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="szdwBjMust('/xgxt/show_xljkXshgb_list.do?act=xljkXshzw')">
										查询
									</button>
								</td>
							</tr>
			...
			<logic:notEmpty name="rs">
				<fieldset>
					...
					<table width="99%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)" ondblclick="sxjyReportupdata('xljkXshzw')" style="cursor:hand">
								<td>
				...
				<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">
					...
					onclick="showTopWin('xljkXshgb_updata.do?act=xljkXshzw',560,350)"
					style="width:80px">
						增 加
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" 
					onclick="sxjyReportupdata('xljkXshzw')"
					style="width:80px">
						修 改
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="sxjyReportDel('xljkXshzw')"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
