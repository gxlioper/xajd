			...
			<logic:equal value="yes" name="writeAble">
				...
				<div class="buttonbox">	
					<ul>
						...
						<li><a href="#" class="btn_sc" onclick="dataBatch('ntzy_fdyfk.do?method=fdypxcx&doType=del&go=go')">删除</a></li>
						<li><a href="#" class="btn_dr" onclick="impAndChkData()">导入</a></li>
						<li><a href="#" class="btn_dc" onclick="wjcfDataExport('ntzy_fdyfk.do?method=fdypxcx&doType=export',600,400)">导出</a></li>								
					</ul>
				</div>
				</div>
			</logic:equal>
