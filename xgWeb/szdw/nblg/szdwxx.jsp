	...
	<body onload="check_user()">
		...
		<center>
			...
			<input type="hidden" id="writeAble" name="writeAble"
	        	...
	        	&nbsp;&nbsp;专业技术等级： 
	        	<html:select property="zyjsdj" style="width:60px" styleId="zyjsdj"> 
	          	<html:option value=""></html:option> 
	          	<html:options collection="SzdwzyjsdjList" property="djdm" labelProperty="djmc" /> 
	        	</html:select> 
	        	&nbsp;&nbsp;人员类别： 
	        	<html:select property="rylb" style="width:60px" styleId="rylb"> 
	          	<html:option value=""></html:option> 
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/zjjj_xsgzdw.do?method=nblgSzdwxxOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,680,300)">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2"
								onclick="showTopWin('/xgxt/zjjj_xsgzdw.do?method=nblgSzdwxxOne',680,300)"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showTopWin('/xgxt/zjjj_xsgzdw.do?method=nblgSzdwxxOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,680,300)}"
									style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/zjjj_xsgzdw.do?method=delNblgSzdwxx&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}"
									style="width:80px">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
