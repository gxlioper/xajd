							...
							<tr>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/bjtsxm.do?method=bjtsxmYqys')">
										查询
									</button>
								</td>
							</tr>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this);" style="cursor:hand"
									ondblclick="showOpenWindow('/xgxt/bjtsxm.do?method=bjtsxmYqysSq&type=view&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,680,600)">
									<td align="center">
					...
					<div class="buttontool" id="btn"
						...
						<logic:notEqual name="userType" value="stu">
							<button type="button" class="button2"
								onclick="if(curr_row == null){alert('请选择要修改的信息!');return false;}showOpenWindow('/xgxt/bjtsxm.do?method=bjtsxmYqysSq&type=edit&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,680,600)"
								style="width:80px">
								审 核
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<logic:equal name="userType" value="stu">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="if(curr_row == null){alert('请选择要删除的信息!');return false;}refreshForm('/xgxt/bjtsxm.do?method=bjtsxmYqysSq&type=del&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
