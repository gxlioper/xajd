					...
					<div class="buttontool" id="btn"
						...
						<logic:notEqual name="userType" value="stu">
							<button type="button" class="button2"
								onclick="if(curr_row == null){alert('请选择要修改的信息!');return false;}showOpenWindow('/xgxt/bjtsxm.do?method=bjtsxmSb&type=edit&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,680,600)"
								style="width:80px">
								审 核
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<logic:equal name="userType" value="stu">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="if(curr_row == null){alert('请选择要删除的信息!');return false;}refreshForm('/xgxt/bjtsxm.do?method=bjtsxmSb&type=del&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
