...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script type="text/javascript">
	    ...
	    function tzInfoAddSave(){	          
           ...
           refreshForm("/xgxt/nbzy_sztz.do?method=tzInfoAdd&doType=Save");
	...
	<body onload=" hiddenKm()">
		...
		<html:form action="/nbzy_sztz.do?method=tzInfoAdd" method="post">
			<input type="hidden" id="url" name="url"
				value="/nbzy_sztz.do?method=tzInfoAdd" />
			...
			<table width="100%" class="tbstyle">
				...
				<tr>
					...
					<td height="22" align="left" style="width: 30%">
						<html:text property="xh" styleId="xh" maxlength="15"
							onblur="dctStuXh()"
					...
					<td height="22" align="left">
						<html:select styleId="sfjlxm" property="sfjlxm"
				...
				<tr>
					...
					<td height="22" align="left">
						<html:select styleId="kmdm" property="kmdm"
				...
				<tr>
					...
					<td height="22" align="left">
						<html:text property="xmmc" styleId="xmmc" style="width:250px;"
							maxlength="50" />
					</td>
				</tr>
				<tr>
					...
					<td height="22" align="left">
						<html:text property="cj" styleId="cj" style="width:250px;"
							maxlength="50" />
					</td>
				</tr>
				<tr>
					...
					<td height="22" align="left">
						<html:text property="sj" styleId="sj" onblur="dateFormatChg(this)"
				...
				<tr align="left">
					...
					<td colspan="4">
						<html:textarea property="bz" style="width:570px" rows="4" />
					</td>
				</tr>
			</table>
