...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="bjDisabled('nj-xy-zy-bj');myxyDisabled('xy');removeXnXq();checkType()">
		...
		function showJx(){
			...
			if(len>0){ 
				tipsWindown("系统提示","id:div_jx","350","150","true","","true","id");
			}else{
				alert("请选择需要审核的记录！");
				return false;
			}
...
<%--			<input type="hidden" id="kcxf"	name="kcxf" value="">--%>
			...
			<div class="toolbox">
				 ...
				 <div class="buttonbox">
				    <ul>
					  <li> <a href="#"  onclick="showJx();return false;" id="checkpass" class="btn_shtg"> 审核 </a> </li>
						...
						<tfoot>
							<tr>
								<td colspan="2">
									...
									<div class="btn">
										<button name="通过" onclick="xmsh('yes')">
											通  过
										</button>
										<button name="不通过" onclick="xmsh('no')">
											不通过
										</button>
