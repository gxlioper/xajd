			...
			<div class="rightcontent">
				...
				<logic:empty name="rs">
						<p align="center">
						    ...
						    <li>
						    2、已分配权限的<bean:message key="lable.xsgzyxpzxy" />(或部门)用户只能查看及审核本<bean:message key="lable.xsgzyxpzxy" />(或部门)内，已"通过"班级审核的<font color="blue" style="font-family: sans-serif">"班级级别"</font>的项目申报，
						    查看及审核本<bean:message key="lable.xsgzyxpzxy" />(或部门)内的<font color="blue" style="font-family: sans-serif">"<bean:message key="lable.xsgzyxpzxy" />级别"以上</font>的项目申报。
						    </li>
						    <li>
						    3、已分配权限的学校用户能查看及审核已"通过"<bean:message key="lable.xsgzyxpzxy" />审核的所有项目申报。
						    </li>
						    						    <li>
						    4、审核流程：<font color="blue" style="font-family: sans-serif">"班级级别"</font>项目需&nbsp;&nbsp;'班干部'->'<bean:message key="lable.xsgzyxpzxy" />'->'学校'&nbsp;&nbsp;三级审核，
						    <font color="blue" style="font-family: sans-serif">"<bean:message key="lable.xsgzyxpzxy" />(部门)级别"</font>以上项目需&nbsp;&nbsp;'<bean:message key="lable.xsgzyxpzxy" />(或部门)'->'学校'&nbsp;&nbsp;两级审核，
						    </li>						    
						    </ul>
				</logic:empty>		    											
