	...
	<body>
		...
		<html:form action="/comm_pub" method="post">
			...
			<logic:present name="isEXIST">
         	<logic:match value="is" name="isEXIST">
         		<script language="javascript">
	         		alert("该年度、学年、学期的拓展项目信息已经存在，不能再发布！");
	         	</script>
	         </logic:match>
           </logic:present>
			<logic:empty name="rs">
				...
				<fieldset>
					...
					<table width="100%" class="tbstyle">
						<tr valign="middle">
							...
							<td width="35%" align="left">
								<html:select name="rs" styleId="xn" property="xn" style="background-color:#FFFFFF;" >								
							...
							<td width="35%" align="left">
								<html:select name="rs" styleId="xq" property="xq" style="background-color:#FFFFFF;" >
									<option value=""></option>
						...
						<tr valign="middle">
							...
							<td align="left">
								<html:select name="rs" styleId="nd" property="nd" style="background-color:#FFFFFF;" >
							...
							<td align="left">
								<html:select name="rs" property="xmdm" styleId="xmdm"
									onchange="refreshForm('/xgxt/tzhd_pub.do')" style="background-color:#FFFFFF;">
									<option value=""></option>
						...
						<tr valign="middle">
							...
							<td align="left">
								<html:text name="rs" property="sztzkmmc" readonly="true"
									style="cursor:hand" />
							</td>
							<td align="right" nowrap>
					...
					<div class="buttontool" id="btn" align="center">
						<button class="button2"
							onclick="if(sztzCheckXnNdXq('xn','nd','xq'))sztzDataDoSavePub('/xgxt/tzhd_pub.do?doType=save&pkValue=','xn-nd-xq-xmdm');"
