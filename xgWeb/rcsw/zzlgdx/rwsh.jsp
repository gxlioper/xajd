...
function dataExport2() {
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/zzlgdx_rcsw.do?method=rwsh" method="post">
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#"
									onclick="tg('/xgxt/zzlgdx_rcsw.do?method=rwsh&go=tg');"
									class="btn_shtg">通过</a>
							</li>
							<li>
								<a href="#"
									onclick="btg('/xgxt/zzlgdx_rcsw.do?method=rwsh&go=btg');"
									class="btn_shbtg"> 不通过 </a>
							</li>
							<li>
								<a href="#"
									onclick="del('/xgxt/zzlgdx_rcsw.do?method=rwsh&go=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
								...
								<td colspan="6">
									<div class="btn">
										<button type="button" class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/zzlgdx_rcsw.do?method=rwsh&go=go')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zzlgdx_rcsw.do?method=rwshOne')"
										style="cursor:hand;">
										<td align=center>
