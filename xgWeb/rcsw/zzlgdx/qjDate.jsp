			...
			<div class="toolbox">
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" onclick="add('/xgxt/zzlgdx_rcsw.do?method=qjsq')"
									class="btn_zj"> 增加 </a>
							</li>
							<li>
								<a href="#"
									onclick="modi('/xgxt/zzlgdx_rcsw.do?method=qjsq&type=modi')"
									class="btn_xg"> 修改 </a>
							</li>
							<li>
								<a href="#"
									onclick="del('/xgxt/zzlgdx_rcsw.do?method=qjDate&go=del');"
									class="btn_sc"> 删除 </a>
							</li>
							<li>
								...
								<td colspan="6">
									<div class="btn">
										<button type="button" class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/zzlgdx_rcsw.do?method=qjDate&go=go')">
											查 询
										</button>
										&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zzlgdx_rcsw.do?method=qjQuery')"
										style="cursor:hand;">
										<td align=center>
