...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function querygo(){
		 	document.forms[0].action = "csmz_rckh_query.do?act=go&doType=query";
		 	document.forms[0].submit();
    }
   
   	function viewmore(){
		var url ="/xgxt/viewmorerckh.do?pkValue=";
    ...
    function updaterckh(){
     ...
     //   }
    	...
    	function rckhdel(doType){
		var url = "csmz_rckh_query.do?act=go&doType=del&pkValue=";
		var pkValue = "";
	...
	<base target="_self">
	<body>
		<html:form action="/csmz_rckh_query" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：日常事务 - 日常考核及工作周报 - 日常考核
				</div>
			</div>
			<fieldset>
				<legend>
			...
			<div class="buttontool" id="btn"
				...
				<button type="button" class="button2" onclick="addrckh()" style="width:100px">
					增加日常考核
				</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" onclick="updaterckh()" style="width:100px">
					修改日常考核
				</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" onclick="rckhdel('del');" style="width:100px">
					删除
				</button>
			</div>
			</logic:equal>
