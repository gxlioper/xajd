...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script type="text/javascript">
		function modi(){
			...
			var url = "bylfgl.do?method=bylfsqModi&pkValue=";
			var pkValue = curr_row.getElementsByTagName("input")[0].value;
			url += pkValue;
			showTopWin(url,600,4600);
		}
		
		function batch(){
			var url = "bylfgl.do?method=delBylfxx";
			var RowsStr="!!";	
			var mes = "确定要操作所选记录？";
		...
		function expData(){
			url = "bylfgl.do?method=expBylfxx";
			url += "&nd=";
			url += val('nd');
			url += "&xydm=";
			url += val('xy');
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('bylfgl.do?method=bylfcx');">
											查询
										</button>
									</td>
								</tr>
						...
						<div class="buttontool" id="btn"
							style="position: absolute;left:1%;top:100px" width="100%">								
								<button type="button" class="button2"
									onclick="showTopWin('bylfgl.do?method=bylfsqAdd',600,400)"
									style="width:80px">
									增加
								</button>	
								&nbsp;	
