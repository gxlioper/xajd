...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script type="text/javascript">
		function modi(){
			var url = "bylfgl.do?method=bylfsqAudi&pkValue=";
		...
		function batch(shjg){
			var url = "bylfgl.do?method=saveBylfsqshBatch&xxsh="+shjg;
			var RowsStr="!!";	
			var mes = "确定要操作所选记录？";
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('bylfgl.do?method=bylfshcx');">
											查询
										</button>
									</td>
								</tr>
						...
						<fieldset>
							...
							<table width="100%" id="rsTable" class="tbstyle">
								<thead>
									...
									<tr onclick="rowMoreClick(this,'',event);" style="cursor:hand" ondblclick="modi()" bgcolor="<logic:iterate id="v" name="s" offset="1" length="1"><bean:write name="v"/></logic:iterate>">
										<td>
