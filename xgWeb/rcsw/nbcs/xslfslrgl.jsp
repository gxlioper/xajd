...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script type="text/javascript">
		function modi(){
			...
			var url = "xsfwzdzx.do?method=xslfslrxxModi&pkValue=";
		...
		function batch(){
			var url = "xsfwzdzx.do?method=delXslfslrxx";
			var RowsStr="!!";	
			var mes = "确定要操作所选记录？";
		...
		function expData(){
			url = "xsfwzdzx.do?method=expXslfslrxx";
			url += "&slbmdm=";
			url += val('slbmdm');
			url += "&slryhm=";
			url += val('slryhm');
							...
							<thead>
								<tr>
									<td align="left">
										...
										&nbsp;&nbsp;受理人用户名：
										<html:text property="slryhm"></html:text>
										&nbsp;&nbsp;受理人姓名：
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('xsfwzdzx.do?method=xslfslrxxcx');">
											查询
										</button>
									</td>
								</tr>
						...
						<div class="buttontool" id="btn"
							style="position: absolute;left:1%;top:100px" width="100%">
								...
								<button type="button" class="button2"
									onclick="showTopWin('xsfwzdzx.do?method=xslfslrxxAdd',400,300)"
									style="width:80px">
									增加
								</button>	
								&nbsp;&nbsp;		
