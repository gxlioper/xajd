...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script type="text/javascript">
		function modi(){
			...
			var url = "xsfwzdzx.do?method=cqxxModi&pkValue=";
		...
		function batch(){
			var url = "xsfwzdzx.do?method=delCqxx";
			var RowsStr="!!";	
			var mes = "确定要操作所选记录？";
		...
		function expData(){
			url = "xsfwzdzx.do?method=expCqxx";
			url += "&slbmdm=";
			url += val('slbmdm');
			url += "&nd=";
			url += val('nd');
		...
		function print(){
			var url = "xsfwzdzx.do?method=printCqb";
			url += "&nd=";
			url += val('nd');
			url += "&yf=";
			url += val('yf');
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('xsfwzdzx.do?method=cqxxcx');">
											查询
										</button>
									</td>
								</tr>
						...
						<div class="buttontool" id="btn"
							style="position: absolute;left:1%;top:100px" width="100%">								
								<button type="button" class="button2"
									onclick="showTopWin('xsfwzdzx.do?method=cqxxAdd',600,400)"
									style="width:80px">
									增加
								</button>	
								&nbsp;	
