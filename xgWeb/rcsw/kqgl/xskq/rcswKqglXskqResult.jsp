	...
	<script language="javascript">
		function modi(url){
		 ...
		 function doQuery(){
	    	...
	    	allNotEmpThenGo('rcswKqglXskq.do?method=rcswKqglXskqResult&doType=qry');
	    }
	</script>
	<body>
		<html:form action="rcswKqglXskq" method="post">
						...
						<tr>
							<td align="left">
								...
								<logic:equal name="userOnLine" value="student">
									<html:text property="xh" disabled="true" size="15" styleId="xh"/>
						...
						&nbsp;请假时间：
						 ...
						 <html:text property="querylessequal_qjjssj" styleId="qjjssj" 
							...
							<logic:equal name="userType" value="xy">
								...
								<html:select property="queryequals_xysh" style="width:180px" styleId="xysh"
							...
							<logic:equal name="userType" value="xx">
								&nbsp;最终审核：
								<html:select property="queryequals_shzt" style="width:180px" styleId="shzt"
								 onchange="initZyList();initBjList();">
								<html:option value=""></html:option>
								<html:option value="不通过" >不通过</html:option>
								<html:option value="通过" >通过</html:option>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
					...
					<button type="button" class="button2"
						onclick="showTopWin('rcswKqglXskq.do?method=rcswKqglXskqSq&doType=view',700,500)"
						style="width:80px">
						增 加
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="modi('rcswKqglXskq.do?method=rcswKqglXskqOne&doType=save')" style="width:80px">
						修 改
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('rcswKqglXskq.do?method=rcswKqglXskqResult&doType=del')"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="wjcfDataExport('rcswKqglXskq.do?method=expDate')" style="width:80px">
						导出数据
					</button>
					</div>
