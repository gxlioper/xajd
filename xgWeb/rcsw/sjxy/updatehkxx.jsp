...
<head>
	...
	<script language="javascript">
		function SaveAdd(){
		   document.forms[0].action = "/xgxt/xshkgl.do?method=updatehkxx&doType=save";
	...
	<html:form action="/xshkgl" method="post">
		<table class="tbstyle" width="100%">
			...
			<tr>
				...
				<td align="left">
					<html:select name="rs" property="hkzt" styleId="hkzt" style="width:150px" onchange="changeView(this);">
				...
				<td align="left">
					<html:text name="rs" property="hkdm" maxlength="40"></html:text>
				</td>
			</tr>
			
		</table>
		<div id="sfxs" style="display: 
			<logic:notEqual value="已迁出" name="rs" property="hkzt">
				none
			</logic:notEqual>
			<logic:equal value="已迁出" name="rs" property="hkzt">
				block
			</logic:equal>
		">
