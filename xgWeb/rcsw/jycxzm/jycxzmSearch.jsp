...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function add(){
		var url = "/xgxt/jycxzmgl.do?method=addJycczm";
	...
	function update(){
	  if(curr_row==null){
	   ...
	   var tableName = document.getElementById("tableName").value;
	  var url = "/xgxt/jycxzmgl.do?method=jycczmUpdate&titleType=update&pk=";
	...
	//全部选中
	 ...
	 function xljkdel(){          
          var url = "/xgxt/jycxzmgl.do?method=jycczmDel&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
		   for (i=0; i<document.getElementsByName("pkV").length; i++){
		...
		function expDataJycxzmgl() {
			document.forms[0].action = "/xgxt/jycxzmgl.do?method=expData";
							...
							<tr>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jycxzmgl.do?method=searchJycczm&go=go');">
										查询
									</button>
								</td>
							</tr>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble" scope="request">
							...
							&nbsp;	
							<button type="button" class="button2" onclick="update();return false;"
								style="width:80px">
								修 改
							</button>
							&nbsp;
...
<%--							</button>--%>
							&nbsp;
							<button type="button" class="button2" onclick="expDataJycxzmgl()"
								style="width:80px">
								导出数据
							</button>
						</logic:equal>
