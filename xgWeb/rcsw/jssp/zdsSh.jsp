		...
		<html:form action="jsspZds" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
				...
				<li> <a href="#" onclick="modi('/xgxt/jsspZds.do?method=zdsOne&doType=audi',700,500)" class="btn_sh"> 单个审核 </a> </li>
			    <li> <a href="#" onclick="dataBatch('/xgxt/jsspZds.do?method=zdsSh&doType=sh&shjg=通过')" class="btn_shtg"> 通过 </a> </li>
				<li> <a href="#" onclick="dataBatch('/xgxt/jsspZds.do?method=zdsSh&doType=sh&shjg=不通过')" class="btn_shbtg"> 不通过 </a> </li>
				</logic:equal>
			    </ul>
			 </div>
			<div class="searchtab">
