				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" id="btn_shtg"
									onclick="dataBatch('rcsw_xszgl.do?method=xszdjsh&type=save&shzd=xxsh&shjg=通过')"
									class="btn_shtg"> 审核通过 </a>
							</li>
							<li>
								<a href="#" id="btn_shbtg"
									onclick="dataBatch('rcsw_xszgl.do?method=xszdjsh&type=save&shzd=xxsh&shjg=不通过')"
					...
					<table width="100%" border="0" id="searchTab">
								...
								<td colspan="6">
									...
									<div class="btn">
										...
										<button type="button" class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/rcsw_xszgl.do?method=xszdjsh')">
											查 询
										</button>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									<html:text property="querygreaterequal_djsj" style="width:80px"
										onblur="dateFormatChg(this)"
										onclick="return showCalendar('querygreaterequal_djsj','y-mm-dd');"></html:text>
									-
									<html:text property="querylessequal_djsj" style="width:80px"
										onblur="dateFormatChg(this)"
							...
							<tbody>
								<logic:iterate name="rs" id="s">
									<tr onclick="rowMoreClick(this,'',event);"
										ondblclick="modi('rcsw_xszgl.do?method=xszdjshOne',700,500)"
										style="cursor:hand">
										<td>
