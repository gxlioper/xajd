		...
		<center>
			...
			<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<logic:equal name = "ksb" value="yes">
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="if(curr_row == null){alert('请选择要审核的行!');return false;}else{showTopWin('/xgxt/xsgbForNblg.do?method=xshzzxxOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,680,300)}"
									style="width:80px">
									修 改
								</button>
							</logic:equal>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/xsgbForNblg.do?method=delXshzzxxOne&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}"
									style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
