					...
					<table width="100%" class="tbstyle">
						<thead>
							...
							<tr>
								...
								<td align="left" nowrap>
									&nbsp;&nbsp;学生组织所在部门
									<html:select property="bmdm" style="width:150px" styleId="bmdm" onchange="refreshForm('/xgxt/xsgbForNblg.do')"> 
	          						<html:option value=""></html:option> 
	          						<html:options collection="bmList" property="bmdm" labelProperty="bmmc" /> 
	          						</html:select> 
									&nbsp;&nbsp;学生组织
									<html:select property="zzdm" style="width:180px" styleId="zzdm" onchange="refreshForm('/xgxt/xsgbForNblg.do')"> 
	          						<html:option value=""></html:option> 
	          						<html:options collection="xszzList" property="zzdm" labelProperty="zzmc" /> 
	          						</html:select> 
	          						&nbsp;&nbsp;审核状态
									<html:select property="shzt" style="width:90px" styleId="shzt"> 
									<html:option value=""></html:option>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/xsgbForNblg.do?method=xsgbsqOne&writeAble=<bean:write name = "writeAble"/>&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button class="button2"
								onclick="showTopWin('/xgxt/xsgbForNblg.do?method=xsgbsqOne',600,480)"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showTopWin('/xgxt/xsgbForNblg.do?method=xsgbsqOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)}"
									style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/xsgbForNblg.do?method=delXsgbOne&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}"
									style="width:80px">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
