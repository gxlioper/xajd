					...
					<table width="100%" class="tbstyle">
						<thead>
							<tr>
							    <td>
								&nbsp;&nbsp;申请社团：
								<html:select property="stdm" style="width:90px"
									styleId="stdm">
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/stcygl.do');">
										查询
									</button>
								</td>
							</tr>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/stcygl.do?method=rssq&gb=no&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button class="button2"
								onclick="showTopWin('/xgxt/stcygl.do?method=rssq&gb=no',600,480)"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showTopWin('/xgxt/stcygl.do?method=rssq&gb=no&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)}"
									style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/jxglxxwh.do?method=delJxglxstjOne&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}"
									style="width:80px">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
