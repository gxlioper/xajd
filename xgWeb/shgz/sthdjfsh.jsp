			...
			<input type="hidden" id="tableName" name="tableName"
				...
				<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showOpenWindow('/xgxt/stgl.do?method=hdjfsq&act=sh&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)}"
									style="width:80px">
								单个审核
							</button>					
							&nbsp;&nbsp;&nbsp;&nbsp;
