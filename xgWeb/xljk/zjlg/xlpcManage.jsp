...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script language="javascript">
		function add(){
			 var url = "/xgxt/zjlg_xljk.do?method=xlpcbAdd&titleType=add";
		...
		function update(){
		  if(curr_row==null){
		   ...
		   var tableName = document.getElementById("tableName").value;
		  var url = "/xgxt/zjlg_xljk.do?method=xlpcbAdd&titleType=update&pk=";
		...
		function viewxljk(){
			  ...
			  var tableName = document.getElementById("tableName").value;
			  var url = "/xgxt/zjlg_xljk.do?method=xlpcbAdd&titleType=view&pk=";
			  var pk = curr_row.cells[0].getElementsByTagName("input")[0].value;
			  url += pk;
			  url += "&tableName="+tableName;
			  //showOpenWindow(url, 800, 600);
		...
		<html:form action="/zjlg_xljk" method="post">
			...
			<logic:equal value="yes" name="writeAble">
				...
				<div class="searchtab">
						...
						<input type="hidden" id="realTable" name="realTable" value="zjlg_xlcb" />
						...
						<table width="100%" class="tbstyle">
							<tbody>
								<tr>
									...
									<td><logic:equal value="stu" name="userType" scope="session">
										<input name="xh" readonly="readonly" value="<bean:write name="userName" scope="session"/>" style="width:85px"/>
										</logic:equal>
										<logic:notEqual value="stu" name="userType" scope="session">
								...
								<tr>
									...
									<td><logic:notEqual value="stu" name="userType" scope="session">
										...
										<html:select property="xy" onchange="initZyList();initBjList();"
									...
									<th>班级</th>
									<td><logic:equal value="stu" name="userType" scope="session"> 
										<html:select property="bjdm" style="width:;display: none" 
								...
								<tr>
									<th>是否独生子女</th>
									<td><html:select property="sfdszn">	
											<html:option value=""></html:option>
											<html:option value="是">是</html:option>
											<html:option value="否">否</html:option>
										</html:select></td>
									<th>是否困难生</th>
									<td><html:select property="sfkns">	
											<html:option value=""></html:option>
											<html:option value="是">是</html:option>
											<html:option value="否">否</html:option>
										</html:select></td>
									<th>是否单亲</th>
									<td><html:select property="sfdq">	
											<html:option value=""></html:option>
											<html:option value="是">是</html:option>
											<html:option value="否">否</html:option>
										</html:select></td>
							...
							<tfoot>
								<tr>
									<td colspan="6">
									<div class="btn">
									<button id="search_go" onclick="refreshForm('/xgxt/zjlg_xljk.do?method=xlpcbManage&go=go');">
										查询
									</button>
