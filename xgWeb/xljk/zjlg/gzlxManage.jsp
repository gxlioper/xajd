...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript">
			function add(){
				 var url = "/xgxt/zjlg_xljk.do?method=gzlxAdd&titleType=add";
			...
			function update(){
			  ...
			  var tableName = document.getElementById("tableName").value;
			  var url = "/xgxt/zjlg_xljk.do?method=gzlxAdd&titleType=update&pk=";
			...
			function viewxljk(){
				  ...
				  var tableName = document.getElementById("tableName").value;
				  var url = "/xgxt/zjlg_xljk.do?method=gzlxAdd&titleType=view&pk=";
				  var pk = curr_row.cells[0].getElementsByTagName("input")[0].value;
				  url += pk;
				  url += "&tableName="+tableName;
				  //showOpenWindow(url, 800, 600);
	...
	<body onload="">
		<html:form action="/zjlg_xljk.do" method="post">
			...
			<input type="hidden" id="tableName" name="tableName" value="zjlg_gzlxb" />
			<input type="hidden" id="realTable" name="realTable" value="zjlg_gzlxb" />
				...
				<table width="100%" class="tbstyle">
					<tbody>
						<tr>
							...
							<td><logic:equal value="admin" name="userType" scope="session">
								<html:select property="xy" onchange="initBjList();initZyList();"
									styleClass="select" style="width:180px" styleId="zyV">
								...
								<logic:notEqual value="admin" name="userType" scope="session">
								<html:select property="xy" onchange="initBjList();initZyList();" 
									styleClass="select" style="width:180px;display: none" styleId="zyV">
									<html:option value=""></html:option>
									<html:options collection="xyList" property="xydm"
										labelProperty="xymc" />
								</html:select>
						...
						<tr>
							...
							<th>班级</th> 
							<td><logic:equal value="admin" name="userType" scope="session">
								<html:select property="bjdm" onchange=""
									styleClass="select" style="width:180px" styleId="bj">
									<html:option value=""></html:option>
								...
								<logic:equal value="xy" name="userType" scope="session">
								<html:select property="bjdm" onchange="" 
									styleClass="select" style="width:180px;display: " styleId="bj">
									<html:option value=""></html:option>
									<html:options collection="bjList" property="bjdm"
										labelProperty="bjmc" />
								</html:select>
								...
								<logic:notEqual value="xy" name="userType" scope="session">
								<html:select property="bjdm" onchange="" 
									styleClass="select" style="width:180px;display: none" styleId="bj">
									<html:option value=""></html:option>
									<html:options collection="bjList" property="bjdm"
										labelProperty="bjmc" />
								</html:select>
					...
					<tfoot>
						<tr>
							<td colspan="4">
							<div class="btn">
							<button id="search_go" onclick="refreshForm('/xgxt/zjlg_xljk.do?method=gzlxManage&go=go');">
								查询
							</button>
					...
					<table width="100%" id="rsTable" class="dateline tablenowrap">
						<thead>
							<tr align="center" style="cursor:hand">
								...
								<logic:iterate id="tit" name="topTr" offset="2" length="4">
									<td id="<bean:write name="tit" property="en"/>"
										onclick="tableSort(this)" nowrap="nowrap">
										<bean:write name="tit" property="cn" />
									</td>
