...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="">
		<html:form action="/zjlg_xljk.do" method="post">
			...
			<input type="hidden" id="realTable" name="realTable" value="zjlg_xlzxs" />
			<input type="hidden" id="pkVStr" name="pkVStr"  value="" />
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>心里健康 - 心里健康工作队伍 - 心里咨询师</a>
				</p>
			</div>
					...
					<thead>
						<tr>
							...
							<td><html:text property="nl" style="width:85px" onkeyup="value=value.replace(/[^\d]/g,'') "></html:text></td>
						  	<th>单位</th> 
							<td><html:text property="dw" style="width:85px" ></html:text></td>
						</tr>
					</thead>
					<tfoot>
					<tr>
