...
<body onload="xyDisabled('xy');">
	<html:form action="/xljkXlcyjg.do" method="post">
		...
		<div class="toolbox">
		 ...
		 <div class="buttonbox">
		    <ul>
			<li> <a href="#" id="btn_add"  onclick="showTopWin('xljk_tyb_addKtewjwh.do',730,620)" class="btn_zj"> 增加 </a> </li>
		      <li> <a href="#" id="btn_xg" onclick="modiAndDel('xljk_tyb_updateKtewjwh.do?pkValue=','modi',730,620)"class="btn_xg"> 修改 </a> </li>
			<li> <a href="#" id="btn_sc" onclick="deldata('xljk_tyb_ktewjwh.do?act=del')" class="btn_sc"> 删除 </a> </li>
