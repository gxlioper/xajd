	...
	<head>
		...
		function deleteYbbx(){
			...
			if(n>0){
				...
				if(blog){
					confirmInfo("该操作将会删心理咨询记录，是否确定继续操作？",function(tag){
					...
					<ul>
						<logic:equal name="writeAble" value="yes">
							<logic:equal name="userType" value="stu">
								<li>
									<a href="#" onclick="showTopWin('xljk_hzny.do?method=zxzxDetail',800,460);return false;" class="btn_zj">咨询</a>
								</li>
								<li>
							...
							<logic:equal name="zxs" value="true">
								<li>
									<a href="#" onclick="showModi();return false;" class="btn_xg">回复</a>
								</li>
							</logic:equal>	
						</logic:equal>
						<li>
