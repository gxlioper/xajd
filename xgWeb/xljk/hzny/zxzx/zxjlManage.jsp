...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
				...
				//按钮控制
				var url = "xljk_hzny_ajax.do?method=zxjlSearch";
				...
				zxjlSearch(url,parameter);
			
		
		}
		
		function zxjlSearch(url,parameter){
		...
		function save(tag){
			if(tag=="ok"){
				...
				var url = "xljk_hzny_ajax.do?method=zxjlModi";
		...
		function showModi(){
			...
			if(len==1){	
				...
				var url="xljk_hzny.do?method=zxjlDetail&doType=modi";
		...
		function showView(){
			...
			if(len==1){	
				...
				var url="xljk_hzny.do?method=zxjlDetail&&doType=view";
		...
		function deleteYbbx(){
			...
			if(n>0){
				...
				if(blog){
					confirmInfo("该操作将会删除咨询记录信息，是否确定继续操作？",function(tag){
						...
						if(tag=="ok"){
							...
							var url= "xljk_hzny_ajax.do?method=deleteZxjl";
				...
				<div class="buttonbox">
					<ul>
						<logic:equal name="writeAble" value="yes">
							...
							<li>
								<a href="#" onclick="showTopWin('xljk_hzny.do?method=zxjlDetail',800,600);return false;" class="btn_zj">增加</a>
							</li>
							<li>
