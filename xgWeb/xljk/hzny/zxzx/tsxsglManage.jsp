...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function searchRs(){
				...
				//按钮控制
				var url = "xljk_hzny_ajax.do?method=tsxsglSearch";
		...
		function showModi(){
			...
			if(len==1){	
				...
				var url="xljk_hzny.do?method=tsxsglDetail&doType=modi";
		...
		function showView(){
			...
			if(len==1){	
				...
				var url="xljk_hzny.do?method=tsxsglDetail&&doType=view";
		...
		function deleteYbbx(){
			...
			if(n>0){
				...
				if(blog){
					confirmInfo("该操作将会删除心理特殊学生，是否确定继续操作？",function(tag){
						...
						if(tag=="ok"){
							...
							var url= "xljk_hzny_ajax.do?method=deleteTsxs";
		...
		<html:form action="/xljk_hzny" method="post">
			...
			<div class="toolbox" id="dgncz">
				...
				<div class="buttonbox">
					<ul>
						...
						<li>
							<a href="#" onclick="showTopWin('xljk_hzny.do?method=tsxsglDetail&doType=add',800,600);return false;" class="btn_zj">增加</a>
						</li>
						<li>
			...
			<div class="main_box">
				...
				<jsp:include flush="true"
					page="/sjcz/turnpage.jsp?form=hznyXljkZxzxForm"></jsp:include>
