...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save(){
			var url="/xgxt/xtwhSplc.do?method=splcManage&doType=save";
			refreshForm(url);
		}
		function modi(){
			var url="/xgxt/xtwhSplc.do?method=splcManage&doType=modi";
			refreshForm(url);
		}
		</script>
	</head>
				...
				<div class="tab">
					<table width="100%" border="0" class="formlist">
                        ...
                        <tbody>
							...
							<tr>
							<th>
								<font color="red">*</font>单据类型
							</th>
							<td coalpsn="3">
								<html:text name="rs" property="djlx" styleId="djlx" />
							</td>
							</tr>
							<tr>
							<th>
								<font color="red">*</font>是否默认
							</th>
							<td coalpsn="3">
								<html:multibox name="rs" property="sfmr" styleId="sfmr" value="1">默认</html:multibox> 
							</td>
							</tr>
                            <tr>
							<th>
