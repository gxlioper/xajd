...
%>
    ...
    alert("您输入的学号无效!");
				...
				<input type="hidden" id="getStuInfo" name="getStuInfo"
					value="xydm-nj" />
				<input type="hidden" id="url" name="url" value="/sjcz/yxjxhjb.jsp" />
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<td align="left">
							<html:select name="rs" property="nj" styleId="nj" style="width:90px" onchange="">
					...
					<tr>
						...
						<td align="left">
							<html:select name="rs" property="xydm" styleId="xy" style="width:150px" onchange="">
				...
				<div class="buttontool" align="center">
					<button type="button" class="button2"
						onclick="if(checkXnNd('xn','nd'))dataDoSave('xn-xq-xydm-hjsj-jxdm');"
