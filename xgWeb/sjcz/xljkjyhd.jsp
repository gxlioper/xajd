							...
							<thead>
								<tr>
									<td align="left">
										...
										&nbsp;&nbsp;主题：
										<html:text property="zt" style="width:85px"></html:text>
										...
										&nbsp;&nbsp;活动地点：
										<html:text property="dd" style="width:85px"></html:text>
										&nbsp;&nbsp;活动时间：
										<html:text property="hdrq" style="width:85px" onclick="return showCalendar('hdrq','y-mm-dd');"></html:text>
									</td>
