						...
						<tr>
							...
							<td width="10" align="center" valign="middle">
								...
								<button type="button" class="button2" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/test_question_search.do?act=testQuestion')">
									查 询
								</button>
							</td>
						</tr>
			...
			<div class="searchcontent">
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<div class="buttontool" id="btn"
						style="position: absolute;left:1%;top:475px" width="100%">
						...
						<button type="button" class="button2"
							onclick="showTopWinTest('/xgxt/test_option_search.do?act=testOption',650,500)"
							style="width:80px">
							选 项 维 护
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
