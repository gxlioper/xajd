	...
	<script>
	   ...
	   function printXsxxk(){
	   		...
	   		if(len!=1){
		  		...
		  		var url = "xsxx_xsxxhzk.do?method=printXsxxExcel&xh="+xh;
			   	document.forms[0].action = url;
			   	document.forms[0].target = "_blank";
			   	document.forms[0].submit();
		  	 	document.forms[0].target = "_self";
				  ...
				  <div class="buttonbox">
				    <ul>
					  ...
					  <logic:present name="isXY">
						...
						<!--南京技师-->
						<logic:equal value="8001" name="xxdm">
						<li>
						    <a href="#" onclick="showTopWin('stu_info_add.do?method=showStuInfo&oper=add',800,600,false);return false;" class="btn_zj">增 加</a>							
						</li>
						</logic:equal>
						<!--end南京技师-->	
						</logic:notEqual>
						<!--end非在校库页面-->
						<li>
							<a href="#" onclick="ljsdaUpdate('stu_info_add.do?method=showStuInfo&oper=update&xh=',800,600);return false;" class="btn_xg">修 改</a>
						</li>
						<!--南京技师-->
						<logic:equal value="8001" name="xxdm">
						<li>
							<a href="#" onclick="batch('stu_info_add.do?method=stuInfoDelete','del');return false;" class="btn_sc">删 除</a>
						</li>		
						</logic:equal>
						<!--end南京技师-->
						...
						<logic:notEqual value="no" name="sfzxk">
						<!-- 非四川机电职业技术学院 -->
						<logic:notEqual value="12751" name="xxdm">
						<li>
					  ...
					  <logic:notPresent name="isXY">
						...
						<li>
							<!-- 湖北国土资源职业学院 -->
							<logic:equal value="13800" name="xxdm">
								<a href="#" onclick="showTopWin('xsxx_zxxs_hbktzy.do?method=xsxxAdd',900,600,false);return false;" class="btn_zj">增 加</a>
							</logic:equal>
							<!-- end湖北国土资源职业学院 -->
							<logic:notEqual value="13800" name="xxdm">
								<a href="#" onclick="showTopWin('stu_info_add.do?method=showStuInfo&oper=add',800,600,false);return false;" class="btn_zj">增 加</a>
							</logic:notEqual>
						</li>
						</logic:notEqual>
						...
						<li>
							<!-- 湖北国土资源职业学院 -->
							<logic:equal value="13800" name="xxdm">
								<a href="#" onclick="ljsdaUpdate('xsxx_zxxs_hbktzy.do?method=xsxxUpdate&xh=',800,600);return false;" class="btn_xg">修 改</a>
							</logic:equal>
							<!-- end湖北国土资源职业学院 -->
							<logic:notEqual value="13800" name="xxdm">
							<logic:notEqual value="12751" name="xxdm">
						...
						<!-- 四川机电职业技术学院  学校不可以看到"修改"按钮-->
						<logic:equal value="12751" name="xxdm">
							<logic:notEqual value="xx" name="userStatus">	
								<a href="#" onclick="ljsdaUpdate('stu_info_add.do?method=showStuInfo&oper=update&xh=',800,600);return false;" class="btn_xg">修 改</a>
							</logic:notEqual>
						</logic:equal>
						<!-- end四川机电职业技术学院  学校不可以看到"修改"按钮-->
						...
						<li>
							<a href="#" onclick="batch('stu_info_add.do?method=SaveBatchOfGraduate','del');return false;" class="btn_csh">毕 业</a>
						</li>
						</logic:equal>
						<%--end浙江大学宁波理工学院--%>
						<%--北京联合大学--%>
						...
						<li>
							<a href="#" onclick="batch('stu_info_add.do?method=showBatchPageOfStuinfo','batch');return false;" class="btn_xg">批量更新</a>
						</li>
						</logic:equal>
						<%--end北京联合大学--%>	
						<%--杭职院增加学生毕业功能--%>
						<logic:present name="isWrite">
						<li>
							<a href="#" onclick="batch('stu_info_add.do?method=SaveBatchOfGraduate','del');return false;" class="btn_csh">毕 业</a>
						</li>
						</logic:present>
						<%--end杭职院增加学生毕业功能--%>	
						<logic:notPresent name="isWrite">
<!--							<li>-->
<!--								<a href="#" onclick="showBycl();" class="btn_csh">毕业处理</a>-->
<!--							</li>-->
							<li>
								<a href="#" onclick="viewTempDiv('毕业信息设置','bycfDiv',450,350);return false;" class="btn_csh">毕业处理</a>
							</li>
							<%--广东建设学籍卡打印 --%>
							<logic:equal value="12741" name="xxdm">
							  <li>
								<a href="#" onclick="printXsxxk();return false;" class="btn_dy">学生信息卡</a>
						  	  </li>
						  	</logic:equal>
						  	<%--end广东建设学籍卡打印 --%>
						  	<%--浙江科技学院学籍卡打印 --%>
						...
						<!-- end非四川机电职业技术学院 -->
						<!-- 浙江工业职业导入 家庭信息 -->
						<logic:equal value="12871" name="xxdm">
							<li>
					  ...
					  <logic:equal value="10225" name="xxdm">
						<li>
						  <a href="#" onclick="dataExport1('/xgxt/expData.do?tableName=view_xsxxb');return false;" class="btn_dc">导出数据</a>
				  	    </li>
					  </logic:equal>
					  <%--end东北林业大学--%>
					  <%--非东北林业大学--%>
					  <logic:notEqual value="10225" name="xxdm">
							...
							<%-- <li><a href="#" onclick="writeCondition();refreshForm('xsxxgl.do?method=showExportPage');return false;" class="btn_dc">导出数据</a></li>--%>
					  </logic:notEqual>
					  <%--end非东北林业大学--%>
					  <!--非中国矿业大学-->
					  ...
					  <logic:equal value="12752" name="xxdm">
				  		<li>
						 	<a href="#" onclick="printXjqrd();" class="btn_dy">学籍确认单打印</a>
				  	    </li>
					  </logic:equal>
					  <%--浙江机电职业技术学院--%>
					  <logic:equal value="12861" name="xxdm">
						<li>
							<a href="#" onclick="zjjd_stuTable('zjjd_tableOne');return false;" class="btn_dy">表一</a>
						</li>
						<li>
							<a href="#" onclick="zjjd_stuTable('zjjd_tableTwo');return false;" class="btn_dy">表二</a>
						</li>
					  </logic:equal>
				    </ul>	
					<ul>
					  ...
					  <logic:equal value="10225" name="xxdm">
					  <li>
						<a href="#" onclick="window.open('stuinfo_print.do?xh=' + curr_row.cells[1].innerText.trim());return false;" class="btn_dy">打印列表</a>
					  </li>
					  </logic:equal>
					  <%--end东北林业大学--%>
					  <!--天津交通职业学院-->
					  ...
					  <li>
						<a href="#" onclick="printNewReport('xsxxgl.do?method=printTjjtzyXsdjb&xh=');return false;" class="btn_dj">学生登记表</a>
					  </li>
					  </logic:equal>
					  <!--end天津交通职业学院-->
					  ...
					  <logic:equal value="11641" name="xxdm">
						<li>
							<a href="#" onclick="turnSearch('${bjkbUrl}','${userName}','${time}');return false;" class="btn_xx">班级课表</a>
					  	</li>
						<li>
							<a href="#" onclick="turnSearch('${jskbUrl}','${userName}','${time}');return false;" class="btn_xx">教师课表</a>
					  	</li>
					  </logic:equal>
					  <%--end淮海工学院--%>
					  <%--杭州职业技术学院--%>
					  <logic:equal value="12872" name="xxdm">
                        <li>
							<a href="#" onclick="hzy_cjbgdprint();return false;" class="btn_dy">成绩报告单打印(单)</a>
					  	</li>
						<li>
							<a href="#" onclick="showCjbgddytj();return false;" class="btn_dy">成绩报告单打印(连)</a>
					  	</li>
					  </logic:equal>
					  <%--end杭州职业技术学院--%>
					  ...
					  <li>
						<a href="#" onclick="printCjd();return false;" class="btn_dy">成绩单打印</a>
				  	  </li>
					  </logic:equal>
					  <%--end常州信息职业技术学院--%>
					</ul>	
								...
								<tbody>
							      ...
							      <!-- 湖北国土资源职业学院 -->
									...
									<logic:notEqual value="13800" name="xxdm">
										...
										<logic:empty name="userOper">
												<td align="center">
													<input type="hidden" name="pk" value="${v}"/>
												</td>
											</logic:empty>
										<td>
											<logic:iterate id="v" name="s" offset="0" length="1">
				...
				<logic:notEmpty name="result">
					<logic:equal value="true" name="result">
						<logic:notEmpty name="mes">
							<script>
								alertInfo(document.getElementById('mes').value,function(tag){
									if(tag=="ok"){
