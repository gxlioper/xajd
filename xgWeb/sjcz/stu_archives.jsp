...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
  ...
  <body>
			...
			<html:form action="/stu_archives" method="post">
				<div class="title">
					<div class="title_img" id="title_m">
						当前位置：学生信息 - 信息查询 - 学生档案信息
					</div>
				</div>
				<fieldset>
					<legend>
							...
							<tr>
								<td align="left">
									...
									<html:select property="xydm" style="width:180px"
										onchange="refreshForm('/xgxt/stu_archives.do')">
										<html:option value=""></html:option>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px"
										onclick="document.forms[0].go.value='go';refreshForm('/xgxt/stu_archives.do');">
										查询
									</button>
								</td>
							</tr>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="stuHdJxjInfoWin(this)">
