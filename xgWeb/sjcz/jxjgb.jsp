...
%>
    ...
    alert("您输入的学号无效!");
				...
				<input type="hidden" id="url" name="url" value="/sjcz/jxjgb.jsp" />
				<fieldset>
					<legend>
						军训结果维护
					</legend>
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td align="left">
								<html:select name="rs" property="sfjjfz" style="width:90px"
									styleId="yesNo">
									<html:option value=""></html:option>
						...
						<tr>
							...
							<td align="left">
								<html:text name='rs' property="bxsfhg" styleId="zy" maxlength="3"/>
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr align="left">
							<td align="right">
								备注：<br><font color="red">（限输入60字）</font>
							</td>
							<td colspan="3">
				...
				<div class="buttontool">
					...
					<button type="button" class="button2"
						onclick="if(checkXnNd('xn','nd'))dataDoSave('xn-xq-xh-sfhg');"
