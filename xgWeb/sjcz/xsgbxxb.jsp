...
%>
    ...
    alert("您输入的学号无效!");
				...
				<input type="hidden" id="url" name="url" value="/sjcz/xsgbxxb.jsp" />
				<fieldset>
					<legend>
						学生干部信息维护
					</legend>
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td align="right">
								<font color="red">*</font>任职部门:
							</td>
							<td align="left">
								<html:select name="rs" property="rzbmdm" style="width:90px"
									styleId="rzbmdm">
									<html:option value=""></html:option>
									<html:options collection="rzbmList" property="rzbmdm"
										labelProperty="rzbmmc" />
								</html:select>
							</td>
						</tr>
						<tr>
				...
				<div class="buttontool">
					...
					<button type="button" class="button2"
						onclick="if(checkXnNd('xn','nd'))dataDoSave('xn-xq-xh-rzbmdm-drzw');"
