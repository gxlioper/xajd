...
%>
    ...
    alert("您输入的学号无效!");
				...
				<input type="hidden" id="url" name="url" value="/sjcz/hcyhkczb.jsp" />
				<fieldset>
					<legend>
						火车优惠卡充值维护
					</legend>
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td align="right">
								<font color="red">*</font>充值时间：
							</td>
							<td align="left">
								<html:text name='rs' property="czsj" styleId="czsj"
									onblur="dateFormatChg(this)" style="cursor:hand;"
									onclick="return showCalendar('czsj','y-mm-dd');" />
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td align="left">
								<html:text name='rs' property="czje" styleId="czje" />
							</td>
						</tr>
						<tr>
							<td align="right">
				...
				<div class="buttontool">
					...
					<button type="button" class="button2"
						onclick="if(checkXnNd('xn','nd'))dataDoSave('xn-xq-xh-czsj-jbr');"
