		...
		<input type="hidden" id="tableName" name="tableName" value="view_newstuyyreportinfo" >
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：
					<logic:equal value="10463" name="xxdm">迎新管理 － 户籍报到 － 学生报到</logic:equal>
							...
							<tr>
								<td align="left">
									...
									<html:select property="xydm" style="width:160px" styleId="xy"
										onchange="refreshForm('yxgl_stbd.do');getfocus('search_go')" disabled="true">
									...
									<logic:notEqual name="userType" value="xy" scope="session">
										<html:select property="xydm" style="width:160px" styleId="xy"
											onchange="refreshForm('yxgl_stbd.do');getfocus('search_go')">
											<html:option value=""></html:option>
											<html:options collection="xyList" property="xydm"
											labelProperty="xymc" />
										</html:select>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">	
									<tr onclick="rowOnClick(this);" style="cursor:hand"
										ondblclick="yxglBdModi('yxgl_stbd_one.do')">
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<center>
						<div class="buttontool" id="btn"
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="cancleBd('st');"
									style="width:80px">
								撤销报到 
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
