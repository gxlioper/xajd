		...
		<html:form action="yxgl_xybd.do">
			...
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：<bean:message bundle="yxgl" key="yxgl_xybd" />
				</div>
			</div>
				<fieldset>
					<legend>
					...
					<table width="100%" class="tbstyle">
						<thead>	
							...
							<tr>
								<td>
									&nbsp;&nbsp;考生号：
									<html:text property="ksh" styleId="ksh" style="width:120px" onkeydown="if(event.keyCode==13)report_go.click();"></html:text>
									&nbsp;&nbsp;学号：
									<html:text property="xh" style="width:120px" styleId="xh"></html:text>
									&nbsp;&nbsp;姓名：
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<center>
						<div class="buttontool" id="btn"
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="cancleBd('xy');"
									style="width:80px">
								撤销报到 
							</button>						
							&nbsp;&nbsp;&nbsp;&nbsp;
