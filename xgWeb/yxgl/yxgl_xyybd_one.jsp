...
<html:html>
  ...
  <logic:present name="dors">
    ...
    <html:form action="yxgl_xyybd_one" method="post">
    <div class="title">
		<div class="title_img" id="title_m">
			当前所在位置：<bean:message bundle="yxgl" key="yxgl_xyybd_one" />
	...
	<table width="100%" class="tbstyle">
		  ...
		  <tr>
		    <td><div align="right">
		      <html:checkbox name="rs" property="sfzsym" styleId="sfzsym"/>
		    </div></td>
		    <td>已注射疫苗</td>
		    <td><div align="right">
		      <html:checkbox name="rs" property="sftj" styleId="sftj"/>
		    </div></td>
		    <td>已体检</td>
		  </tr>
		  <logic:equal name="rs" property="sfjy" value="yes" scope="request">
		  </logic:equal>
		</table>
		<div id="tmpdiv"></div>
		<div class="buttontool">
		<logic:notPresent name="modify">
       <button class="button2" onclick="document.forms[0].action='yxgl_xyybd_one.do?doType=add';document.forms[0].submit();getParentPageSearch();">
          提交信息
       </button>
       </logic:notPresent>
       <logic:present name="modify">
         <button class="button2" id="report_go" onclick="doBD('yy')">
         <!-- onkeydown="if(event.keyCode==13)report_go.click();" 
         onclick="document.forms[0].action='xsbd_one.do?doType=yy';
