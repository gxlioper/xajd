...
%>
	...
	<body onload="document.getElementById('ksh').focus()">
		...
		<html:form action="yxgl_lstd.do">
		<input type="hidden" id="realTable" name="realTable" value="view_newstulstdexpinfo" >
		<input type="hidden" id="tableName" name="tableName" value="view_newstulstdexpinfo" >
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：<bean:message bundle="yxgl" key="yxgl_lstd" />
				</div>
			</div>
				<fieldset>
					<legend>
					...
					<table width="100%" class="tbstyle">
						<thead>	
							<tr>
								<td align="left">
									...
									<html:select property="xydm" style="width:160px" styleId="xy"
										onchange="refreshForm('yxgl_xybd.do');getfocus('search_go')" disabled="true">
									...
									<logic:notEqual name="userType" value="xy" scope="session">
										<html:select property="xydm" style="width:160px" styleId="xy"
											onchange="refreshForm('yxgl_xybd.do');getfocus('search_go')">
											<html:option value=""></html:option>
											<html:options collection="xyList" property="xydm"
												labelProperty="xymc" />
										</html:select>
									...
									<html:select property="zydm" style="width:180px" styleId="zy"
										onchange="refreshForm('yxgl_lstd.do');getfocus('search_go')">
										<html:option value=""></html:option>
							...
							<tr>
								<td>
									&nbsp;&nbsp;考生号：
									<html:text property="ksh" style="width:120px" onkeydown="if(event.keyCode==13)search_go.click();"></html:text>
									&nbsp;&nbsp;学号：
									<html:text property="xh" style="width:120px"></html:text>
									&nbsp;&nbsp;姓名：
									<html:text property="xm" style="width:120px"></html:text>
									&nbsp;&nbsp;办理情况：
									<html:select property="sfblLstd" style="width:130px" styleId="sftj">
										<html:option value=""></html:option>
										<html:options collection="sfblLstdList" property="en"
											labelProperty="cn" />
									</html:select>
								</td>
							</tr>					
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">	
									<tr onclick="rowOnClick(this);" style="cursor:hand"
										ondblclick="yxglBdModi('yxgl_lstd_one.do')">
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<center>
						<div class="buttontool" id="btn"
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="yxglBdModi('yxgl_lstd_one.do');"
									style="width:80px">
								修 改
							</button>							
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="yxglBdDelete('yxgl_lstd.do');"
								style="width:150px">
								删除该生绿色通道信息 
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
