		...
		<html:form action="sjxyDektqh" method="post">
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
				<logic:equal name="writeAbled" value="yes">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2" onclick="dataBatch('sjxyDektqh.do?method=shDektqh&doType=save&shjg=通过')"
						style="width:80px">
						审核通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2" onclick="dataBatch('sjxyDektqh.do?method=shDektqh&doType=save&shjg=不通过')"
						style="width:80px">
						审核不通过
					</button>
				</logic:equal>
