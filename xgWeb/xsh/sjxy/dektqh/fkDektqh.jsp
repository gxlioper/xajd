...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body>
		<html:form action="sjxyDektqh" method="post">
			...
			<input type="hidden" name="realTable" id="realTable" value="nbty_sjxy_dekthdqh" />
			<div class="title">
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							<td>
								&nbsp;活动名称:
								<html:text property="querylike_hdmc"/>
								&nbsp;举办部门:
								<html:text property="querylike_jbbm"/>
								&nbsp;举办时间:
							...
							<td width="10" align="center" valign="middle" rowspan="3">
								<button class="button2" id="search_go"
											onclick="allNotEmpThenGo('sjxyDektqh.do?method=fkDektqh&doType=qry')" style="height: 25px">
											查 询
										</button>
										<br>
						...
						<tr>
							<td>
								&nbsp;活动地点:
								<html:text property="querylike_hddd"/>
								&nbsp;活动负责人:
								<html:text property="querylike_hdfzr"/>
								&nbsp;指导老师:
								<html:text property="querylike_zdls"/>
							</td>
					...
					<table width="99%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('sjxyDektqh.do?method=oneFkDektqh&doType=view')" style="cursor:hand">
								<td>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
				<logic:equal name="writeAbled" value="yes">
					<button class="button2" onclick="modi('sjxyDektqh.do?method=fkOneDektqh&doType=save')" style="width:80px">
						修 改
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
