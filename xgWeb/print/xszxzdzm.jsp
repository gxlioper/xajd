...
<div class="all">
<h1>在读证明</h1>
<div class="con"><p><bean:write name="rs" property="xm"/>同学是我<bean:write name="xxmc"/><bean:write name="rs" property="xymc"/><bean:message key="lable.xsgzyxpzxy" /><bean:write name="rs" property="zymc"/>专业<bean:write name="rs" property="bjmc"/>班级学生（学号：<bean:write name="rs" property="xh"/>），现读大学<bean:write name="nj"/>年级。</p></div>
