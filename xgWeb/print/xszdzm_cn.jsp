...
<div class="all">
<h1>在读证明</h1>
<div class="con"><p><bean:write name="rs" property="xm"/>同学是我<bean:write name="xxmc"/><bean:write name="rs" property="xymc"/>学生，学号：<bean:write name="rs" property="xh"/>，现读大学<bean:write name="nj"/>年级。</p></div>
...
window.onload = function(){
	...
	if(cu_R >= window.opener.$("tabPri").rows.length){
		...
		window.location.href = "certificatePrintAll.do?xh=" + xh + "&mb="+document.getElementById('mb').value;
	}
}
</script>
</body>
