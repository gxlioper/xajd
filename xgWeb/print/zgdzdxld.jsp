...
var top= new Array();
  ...
  <tr> 
    ...
    <ul style="margin-top:10em;"> 
        ...
        <li> 
          <h4><div style="position: absolute; left: 164px; top: 287px; height: 1px;width: 300" title="民族" id="mz" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)"><bean:write name="rsMap" property="mz"/>mz</div></h4> 
        </li>
        <li> 
