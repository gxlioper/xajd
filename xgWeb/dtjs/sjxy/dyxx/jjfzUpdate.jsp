...
<html xmlns="http://www.w3.org/1999/xhtml" lang="GBK">
	...
	function saveYbdy(){
		...
		var url = "/xgxt/sjxyDtjsDyxx.do?method=jjfzUpdate&doType=zz";
		showTips('处理数据中，请等待......');
	...
	<body onload="getSszb()">
		...
		<input type="hidden" id="url" name="url" value="/sjxyDtjsDyxx.do?method=jjfzUpdate&doType=add"/>
		<html:hidden name='rs' property="zzzt" styleId="zzzt"/>
			...
			<table class="tbstyle" border="0" id="rsTable" align="center"
				...
				<tr bgcolor="EEF4F9" align="center">
					...
					<button type="button" class="button2" id="buttonSave" onclick="saveUpdate('/xgxt/sjxyDtjsDyxx.do?method=jjfzUpdate&doType=save','xh-xn-xq-nd-xsccdm')"
						style="width: 80px">
						保	存
					</button>
