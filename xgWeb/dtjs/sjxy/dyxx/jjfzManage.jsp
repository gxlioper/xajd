...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function saveYbdy() {
		...
		var url = "/xgxt/sjxyDtjsDyxx.do?method=jjfzManage&doType=zz";
		showTips('处理数据中，请等待......');
		refreshForm(url);
	}
				...
				<div class="rightcontent">
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/sjxyDtjsDyxx.do?method=jjfzManage');">
											查询
										</button>
									</td>
								</tr>
							...
							<table width="100%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);" style="cursor:hand" 
										ondblclick="showInfo('/xgxt/sjxyDtjsDyxx.do?method=jjfzUpdate','view','600','480')">
										<td align="center">
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2" onclick="showTopWin('/xgxt/sjxyDtjsDyxx.do?method=jjfzUpdate',600,480);">
								增&nbsp;&nbsp;加
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2" onclick="showInfo('/xgxt/sjxyDtjsDyxx.do?method=jjfzUpdate','update','600','480')">
								修&nbsp;&nbsp;改
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2" onclick="sumitInfo('/xgxt/sjxyDtjsDyxx.do?method=jjfzManage','del')">
								删&nbsp;&nbsp;除
							</button>
							&nbsp;&nbsp;
