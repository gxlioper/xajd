...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="xyDisabled('xy');">
		...
		<script>
			function dataExport(){
				var url = "dtjs_rdsq_forward.do?method=expDyxgxx";
				var nj = val('nj');
				var pycc = val('pycc');
				url += "&nj=";
				url += nj;
		...
		<html:form action="/dtjs_rdsq_forward" method="post">
								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/dtjs_rdsq_forward.do?method=dyxgsjtjcx');">
											查询
										</button>
									</td>
								</tr>
								...
								<TR>
									<TD>
										<jsp:include flush="true"
											page="/sjcz/turnpage.jsp?form=dtjsForm"></jsp:include>
									</TD>
								</TR>
								<TR>
									<TD height=3></TD>
