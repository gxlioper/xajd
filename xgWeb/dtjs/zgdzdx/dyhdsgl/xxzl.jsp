...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function dyhdsgl_sh(){
			var url ="/xgxt/zgdzdxXxwh.do?method=dyhdsgl_sh&xxk=xxzl&pkValue=";
			var pkValue ="";
		   		if (curr_row == null) {
					alert("请选择要审核的数据！\n（单击相应的行）");
					return false;
	...
	*/
	...
	function querygo(){
		 	document.forms[0].action = "/xgxt/zgdzdxXxwh.do?method=dyhdsgl_Index&xxk=xxzl&go=go";
		 	document.forms[0].submit();
    }
    /*
	全部选中
	...
	*/
      function del(){
        var url = "/xgxt/zgdzdxXxwh.do?method=dyhdsgl_del&xxk=xxzl&czlx=del";
	    var RowsStr="!!#!!";
		...
		var url = "/xgxt/zgdzdxXxwh.do?method=dyhdsgl_save&xxk=xxzl&czlx=view&pkValue=";
		var pkValue ="";
		 if (doType == "view"){
		 pkValue = curr_row.getElementsByTagName("input")[0].value;
		 url += pkValue;
		...
		var url ="/xgxt/zgdzdxXxwh.do?method=dyhdsgl_save&czlx=update&xxk=xxzl&pkValue=";
		var pkValue ="";
		    if (curr_row == null) {
			alert("请选择要修改的数据！\n（单击相应的行）");
			return false;
	...
	<body>
		...
		<html:form action="/zgdzdxXxwh.do" method="post">
			...
			<input type="hidden" id="xxk" name="xxk" value="xxzl" />
				...
				<ul>
					...
					<li onclick="$('go').value='';refreshForm('zgdzdxXxwh.do?method=dyhdsgl_Index&xxk=xxzl')" class="ha">
						<a><span>学习资料</span></a>
					</li>
					<li id="003m" onclick="$('go').value='';refreshForm('zgdzdxXxwh.do?method=dyhdsgl_Index&xxk=zljy')">
						<a><span>资料借阅</span></a>
					</li>
				</ul>
  				</div>
  				...
  				<div class="toolbox">
					...
					<ul>
						...
						<li><a href="#" class="btn_sh" onclick="dyhdsgl_sh();">审核</a></li>
						</logic:equal>
						
						<li><a href="#" class="btn_zj" onclick="showTopWin('zgdzdxXxwh.do?method=dyhdsgl_save&xxk=xxzl&czlx=save',650,450)">增加</a></li>
			...
			<table width="100%" class="" border="0">
					<tbody>
						<tr>
							<th>书、期刊名</th>
							<td><html:text property="sqkm"></html:text></td>
							<th>出版社</th>
							<td><html:text property="cbs"></html:text></td>
							<th>出版时间</th>
							<td><html:text property="cbsj" onclick="return showCalendar('cbsj','y-mm-dd');"></html:text></td>
						</tr>
						<tr>		
						<th>学校审核</th>
						<td><html:select property="xxsh">
