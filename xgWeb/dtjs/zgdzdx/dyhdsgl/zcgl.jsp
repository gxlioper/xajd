...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function dyhdsgl_sh(){
			var url ="/xgxt/zgdzdxXxwh.do?method=dyhdsgl_sh&xxk=zcgl&pkValue=";
			var pkValue ="";
		   		if (curr_row == null) {
					alert("请选择要审核的数据！\n（单击相应的行）");
					return false;
	...
	*/
	...
	function querygo(){
		 	document.forms[0].action = "/xgxt/zgdzdxXxwh.do?method=dyhdsgl_Index&xxk=zcgl&go=go";
		 	document.forms[0].submit();
    }
    /*
	全部选中
	...
	*/
      function del(){
        var url = "/xgxt/zgdzdxXxwh.do?method=dyhdsgl_del&xxk=zcgl&czlx=del";
	    var RowsStr="!!#!!";
		...
		var url = "/xgxt/zgdzdxXxwh.do?method=dyhdsgl_save&xxk=zcgl&czlx=view&pkValue=";
		var pkValue ="";
		 if (doType == "view"){
		 pkValue = curr_row.getElementsByTagName("input")[0].value;
		 url += pkValue;
		...
		var url ="/xgxt/zgdzdxXxwh.do?method=dyhdsgl_save&czlx=update&xxk=zcgl&pkValue=";
		var pkValue ="";
		    if (curr_row == null) {
			alert("请选择要修改的数据！\n（单击相应的行）");
			return false;
	...
	<body>
		...
		<html:form action="/zgdzdxXxwh.do" method="post">
			...
			<input type="hidden" id="xxk" name="xxk" value="zcgl" />
				...
				<div class="buttonbox">
					<ul>
						<logic:equal value="xx" name="usertype">
							<li>
								<a href="#" class="btn_sh" onclick="dyhdsgl_sh();">审核</a>
							</li>
						</logic:equal>

						<li>
							<a href="#" class="btn_zj"
								onclick="showTopWin('zgdzdxXxwh.do?method=dyhdsgl_save&xxk=zcgl&czlx=save',600,400)">增加</a>
						</li>
						<li>
							<a href="#" class="btn_xg" onclick="dyhdsupdate();">修改</a>
						</li>
						<logic:notEqual name="userType" value="xy" scope="session">
							<li>
								<a href="#" class="btn_sc" onclick="del()">删除</a>
							</li>
						</logic:notEqual>
					</ul>
				</div>
				...
				<table width="100%" class="">
					<tbody>
						<tr>
							...
							<td>
								<html:text property="sbmc"></html:text>
							</td>
							<th>
								设备型号
							</th>
							<td>
								<html:text property="sbxh"></html:text>
							</td>
							<th>
								设备负责人
							</th>
							<td>
								<html:text property="sbfzr"></html:text>
							</td>
						</tr>
						<tr>
							<th>
