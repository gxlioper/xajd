			...
			<input type="hidden" id="title" name="title"
				...
				<p class="location">
					...
					<logic:equal value="yes" name="writeAble">
						...
						<div class="buttonbox">
							<ul>
								<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/zgdzdxXxwh.do?method=sxjyhdUpdata',800,600)">增加</a></li>
								<li><a href="#" class="btn_xg" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showTopWin('/xgxt/zgdzdxXxwh.do?method=sxjyhdUpdata&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,800,600)}">修改</a></li>
								<li><a href="#" class="btn_sc" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/zgdzdxXxwh.do?method=sxjyhdDelete&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}">删除</a></li>
						...
						<table width="100%" id="rsTable" class="dateline">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/zgdzdxXxwh.do?method=sxjyhdUpdata&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,800,600)">	
									<td>
