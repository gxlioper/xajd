		...
		<center>
			...
			<div class="tab_cur">
				...
				<ul>
					...
					<li id="004m" onclick="$('go').value='';refreshForm('zgdzdxXxwh.do?method=yjzlManage')">
						<a><span>研究资料</span></a>
					</li>
				</ul>
				</div>
				...
				<logic:equal value="yes" name="writeAble">
						...
						<div class="buttonbox">	
							<ul>
								<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/zgdzdxXxwh.do?method=kyxmUpdata',800,600)">增加</a></li>
								<li><a href="#" class="btn_xg" onclick="if(curr_row == null){alert('请选择要修改的行!');return false;}else{showTopWin('/xgxt/zgdzdxXxwh.do?method=kyxmUpdata&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,800,600)}">修改</a></li>
								<li><a href="#" class="btn_sc" onclick="if(curr_row == null){alert('请选择要删除的行!');return false;}else{refreshForm('/xgxt/zgdzdxXxwh.do?method=kyxmDelete&go=go&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value)}">删除</a></li>
				...
				<div class="searchtab">
					<table width="100%" class="" border="0">
						<tbody>
							<tr>
								<th>部门</th>
								<td><html:select property="bmdm" style="width:180px" styleId="bmdm" >
										<html:option value=""></html:option>
										<html:options collection="bmList" property="bmdm"
											labelProperty="bmmc" />
									</html:select></td>
								<th>科研项目</th>
								<td><html:text property="xmmc" style="width:180px"/></td>
								<th>教职工姓名</th>
								<td><html:text property="xm" style="width:80px"/></td>
							</tr>
								<tr>
								<th>科研项目级别</th>
								<td><html:select property="xmjbdm" style="width:180px" styleId="xmjbdm" >
										<html:option value=""></html:option>
						...
						<table width="100%" id="rsTable" class="dateline">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/zgdzdxXxwh.do?method=kyxmUpdata&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,800,600)">	
									<td align="left">
