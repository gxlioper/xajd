		...
		<html:form action="/czxxDtjsTyxx" method="post">
			...
			<logic:empty name="msg">
				<div class="rightcontent">
						...
						<div class="buttonbox">
							<ul>
								<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/czxxDtjsTyxx.do?method=typxxxUpdate',600,480);">增加</a></li>
								<li><a href="#" class="btn_xg" onclick="showInfo('/xgxt/czxxDtjsTyxx.do?method=typxxxUpdate','update','600','480')">修改</a></li>
								<li><a href="#" class="btn_sc" onclick="sumitInfo('/xgxt/czxxDtjsTyxx.do?method=typxManage','del')">删除</a></li>
