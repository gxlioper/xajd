	...
	<body onload="">
		...
		<input type="hidden" id="url" name="url" value="/xgxt/czxxDtjsTyxx.do?method=typxxxUpdate&doType=add"/>
			...
			<table width="100%"  border="0" class="formlist">
			      ...
			      <tr>
			        <td colspan="4">
			          ...
			          <logic:notEqual name="doType" value="view">
			          		...
			          		onclick="if(checkXnNd('xn','nd')){saveUpdate('/xgxt/czxxDtjsTyxx.do?method=typxxxUpdate&doType=save','xh-pxxmdm-pxsj-xn-nd-xq')}">提 交</button>
			          </logic:notEqual>
				...
				<tr style="height: 23px">
					<th align="right">
						备注<font color="blue"><B>(限输入60字)</B></font>
					</th>
