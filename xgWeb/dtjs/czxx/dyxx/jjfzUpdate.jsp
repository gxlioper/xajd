...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="jd()">
		...
		<logic:equal name="xxdm" value="12317">
			...
			<input type="hidden" id="lx" name="lx" value="申请者"/>
		</logic:equal>
		<!-- 通用 -->
			      ...
			      <tr>
					...
					<logic:equal name="doType" value="add">
			          ...
			          <logic:notEqual name="doType" value="view">
			          	<button type="button" name="提交" onclick="saveUpdate('/xgxt/czxxDtjsDyxx.do?method=jjfzUpdate&doType=save','xh-xn-xq-nd-kssj')">提 交</button>
			          <logic:equal name="doType" value="update">
						<!-- 常州信息 -->
						<logic:equal name="xxdm" value="12317">
							<button type="button" id="buttonZz" onclick="dyzz()">转入发展对象</button>
						</logic:equal>
					  </logic:equal>
