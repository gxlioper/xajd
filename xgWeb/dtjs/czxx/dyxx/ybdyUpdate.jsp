...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function saveZsdy(){
		...
		var url = "/xgxt/czxxDtjsDyxx.do?method=ybdyUpdate&doType=zz";
		showTips('处理数据中，请等待......');
	...
	function getYbdyxx(){
		...
		var xq=$("xq").value;
		if(xh !="" && xn!="" && xq!=""){
			var tableName="view_sjxy_ybdyxx";
			var colList =["xh","xm","xb","xymc","zymc","bjmc","xn","xq","bz","zzzt","kssj","jssj"];
			var pk = "xn||xq||xh";
	...
	<body onload="jd()">
		...
		<input type="hidden" id="url" name="url" value="/xgxt/czxxDtjsDyxx.do?method=ybdyUpdate&doType=add"/>
		<input type="hidden" id="getStuInfo" name="getStuInfo" value="xh-xm-xb-xymc-zymc-bjmc-nj-mzmc"/>
		<!-- 常州信息 -->
		<logic:equal name="xxdm" value="12317">
			<input type="hidden" id="tableName" name="tableName" value="view_fzdxxx"/>
			<input type="hidden" id="lx" name="lx" value="发展对象"/>
		</logic:equal>
		<!-- 通用 -->
		...
		<html:hidden name='rs' property="zzzt" styleId="zzzt"/>
			...
			<table width="100%" border="0" class="formlist">
			      ...
			      <tr>
			        <td colspan="4">
			          ...
			          <logic:notEqual name="doType" value="view">
			          		...
			          		onclick="saveUpdate('/xgxt/czxxDtjsDyxx.do?method=ybdyUpdate&doType=save','xh-xn-xq-nd-kssj')">提 交</button>
				...
				<tr style="height: 23px">
					...
					<td align="left">
						<logic:equal name="doType" value="add">
							<html:select name="rs" property="xn" style="" styleId="xn" onchange="getYbdyxx()">
				...
				<tr style="height: 23px">
					...
					<td align="left">
						<logic:equal name="doType" value="add">
							<html:select name="rs" property="xq" style="" styleId="xq" onchange="getYbdyxx()">
				...
				<tr>
					<th>总支</th>
					<td>
						<html:text property="db" maxlength="30" value="${rs.db }"></html:text>
					</td>
					<th>支部</th>
					<td>
						<html:text property="zb" maxlength="30" value="${rs.zb }"></html:text>
					</td>
				</tr>
