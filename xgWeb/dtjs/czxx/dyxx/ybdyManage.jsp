...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function saveYbdy() {
		...
		var url = "/xgxt/czxxDtjsDyxx.do?method=ybdyManage&doType=zz";
		showTips('处理数据中，请等待......');
		refreshForm(url);
	}
	</script>
	...
	<body onload="choiceDisabled();">
		<html:form action="/czxxDtjsDyxx" method="post">
			...
			<input type="hidden" name="url" id="url" value="/xgxt/czxxDtjsDyxx.do?method=ybdyManage&doType=zhdj" />
			...
			<logic:empty name="msg">
				<div class="rightcontent">
						...
						<div class="buttonbox">
							<ul>
								<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/czxxDtjsDyxx.do?method=ybdyUpdate',600,480);">增加</a></li>
								<li><a href="#" class="btn_xg" onclick="showInfo('/xgxt/czxxDtjsDyxx.do?method=ybdyUpdate','update','600','480')">修改</a></li>
								<li><a href="#" class="btn_sc" onclick="sumitInfo('/xgxt/czxxDtjsDyxx.do?method=ybdyManage','del')">删除</a></li>
									<!-- 常州信息 -->
								<logic:equal name="xxdm" value="12317">
								<li><a href="#" class="btn_zj" onclick="dyzz()">批量转正</a></li>
								</logic:equal>
									<!-- 通用 -->
					...
					<div class="searchtab">
		        		...
		        		<tr>
		            		...
		            		<div class="btn">
		              		...
		              		onclick="allNotEmpThenGo('/xgxt/czxxDtjsDyxx.do?method=ybdyManage');">
		              		查 询
		              		</button>
			    ...
			    <tbody>
			      <logic:iterate name="rs" id="s" indexId="index">
				      <tr onclick="rowOnClick(this);" style="cursor:hand" 
						ondblclick="showInfo('/xgxt/czxxDtjsDyxx.do?method=ybdyUpdate','view','600','480')">
					<td align="center">
