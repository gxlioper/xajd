...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function dyzz(){
		...
		dd_html += "</div>";
		dd_html += "<div id='layerTop' class='tab'>";
		dd_html += "<table width='300' border='0' class='formlist'>";
		dd_html += "<thead>";
	...
	function saveYbdy() {
		...
		var url = "/xgxt/czxxDtjsDyxx.do?method=rdsqManage&doType=zz";
		showTips('处理数据中，请等待......');
		refreshForm(url);
	}
	</script>
	...
	<body onload="choiceDisabled();">
		<html:form action="/czxxDtjsDyxx" method="post">
			...
			<input type="hidden" name="url" id="url" value="/xgxt/czxxDtjsDyxx.do?method=rdsqManage&doType=zhdj" />
			...
			<logic:empty name="msg">
				<div class="rightcontent">
						...
						<div class="buttonbox">
							<ul>
								<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/czxxDtjsDyxx.do?method=rdsqUpdate',600,480);">增加</a></li>
								<li><a href="#" class="btn_xg" onclick="showInfo('/xgxt/czxxDtjsDyxx.do?method=rdsqUpdate','update','600','480')">修改</a></li>
								<li><a href="#" class="btn_sc" onclick="sumitInfo('/xgxt/czxxDtjsDyxx.do?method=rdsqManage','del')">删除</a></li>
									<!-- 常州信息 -->
								<logic:equal name="xxdm" value="12317">
								<li><a href="#" class="btn_zj" onclick="dyzz()">批量转为入党积极分子</a></li>
								</logic:equal>
									<!-- 通用 -->
								<logic:notEqual name="xxdm" value="12317">
								<li><a href="#" class="btn_zj" onclick="djzh('rdsqManage')">转换等级</a></li>
								</logic:notEqual>
					...
					<div class="searchtab">
		        		...
		        		<tr>
		            		...
		            		<div class="btn">
		              		...
		              		onclick="allNotEmpThenGo('/xgxt/czxxDtjsDyxx.do?method=rdsqManage');">
		              		查 询
		              		</button>
		         		...
		         		<tr>
		             		<th>团员推优</th>
							<td><html:select property="sfty" style="width:60px" styleId="sfty">
											<html:option value=""></html:option>
											<html:options collection="sflxList" property="en" labelProperty="cn" />
										</html:select></td>
					    ...
					    <tbody>
					      <logic:iterate name="rs" id="s" indexId="index">
						      <tr onclick="rowOnClick(this);" style="cursor:hand" 
								ondblclick="showInfo('/xgxt/czxxDtjsDyxx.do?method=rdsqUpdate','view','600','480')">
							<td align="center">
