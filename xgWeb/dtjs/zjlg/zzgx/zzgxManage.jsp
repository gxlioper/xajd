...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function delZzgx(){
		...
		if(flag){
			if (confirm("确定要删除所勾选的数据?")) {
				showTips('处理数据中，请等待......');
				var url = "/xgxt/zjlgDtjsZzgx.do?method=zzgxManage&doType=del";
				refreshForm(url);
			}
		}else{
			alert("请勾选要处理的数据");
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/zjlgDtjsZzgx" method="post">
			...
			<logic:empty name="msg">
				<logic:equal value="yes" name="writeAble">
					...
					<div class="buttonbox">	
						<ul>
							<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/zjlgDtjsZzgx.do?method=zzgxUpdate&doType=add',800,600);">增加</a></li>
							<li><a href="#" class="btn_xg" onclick="if(curr_row == null){alert('请选择要修改的数据！');return false;}showTopWin('/xgxt/zjlgDtjsZzgx.do?method=zzgxUpdate&doType=update&pk='+curr_row.getElementsByTagName('input')[0].value,800,600);">修改</a></li>
							<li><a href="#" class="btn_sc" onclick="delZzgx()">删除</a></li>
						...
						<table width="100%" class="" border="0">
							<tbody>
								<tr>
									...
									<th>转接类型</th>
									<td><html:select property="zjlx" style="">
											<html:option value=""></html:option>
							...
							<tfoot>
								<tr>
									...
									<button type="button" id="search_go" onclick="allNotEmpThenGo('/xgxt/zjlgDtjsZzgx.do?method=zzgxManage');">
										查询
									</button>
							...
							<table width="100%" id="rsTable" class="dateline">
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);"
										ondblclick="showTopWin('/xgxt/zjlgDtjsZzgx.do?method=zzgxUpdate&doType=view&pk='+curr_row.getElementsByTagName('input')[0].value,800,600);"
										style="cursor:hand">
										<td align="center">
