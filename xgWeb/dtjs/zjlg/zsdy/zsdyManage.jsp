	...
	<body onload="xyDisabled('xy');">
		<html:form action="/zjlgDtjsZsdy" method="post">
			...
			<logic:equal value="yes" name="writeAble">
				...
				<div class="buttonbox">	
					<ul>
						<li><a href="#" class="btn_zj" onclick="showTopWin('/xgxt/zjlgDtjsZsdy.do?method=zsdyUpdate&doType=add',800,600);">增加</a></li>
						<li><a href="#" class="btn_xg" onclick="if(curr_row == null){alert('请选择要修改的数据！');return false;}showTopWin('/xgxt/zjlgDtjsZsdy.do?method=zsdyUpdate&doType=update&pk='+curr_row.getElementsByTagName('input')[0].value,800,600);">修改</a></li>
						<li><a href="#" class="btn_sc" onclick="delZsdy()">删除</a></li>
						<li><a href="#" class="btn_sx" onclick="zjZsdy()">组织关系转接</a></li>
