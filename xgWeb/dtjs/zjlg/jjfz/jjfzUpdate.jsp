...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function dyzz(){
			...
			dd_html += "<button type='button' onclick='closeAdd1()'>取消</button>";
			dd_html += "</td></tr></tfoot>"
			dd_html += "</table>";
			dd_html += "</div>";
		...
		function saveYbdy(){
			...
			var url = "/xgxt/zjlgDtjsJjfz.do?method=jjfzUpdate&doType=zz";
			showTips('处理数据中，请等待......');
		...
		function saveJjfz(){
			...
			var url = "/xgxt/zjlgDtjsJjfz.do?method=jjfzUpdate&doType=save";
			showTips('处理数据中，请等待......');
			$("buttonSave").disabled=true;
			if($("buttonZz")){
				$("buttonZz").disabled=true;
	...
	<body onload="getZbmc()">
		<html:form action="/zjlgDtjsJjfz">
		<input type="hidden" id="url" name="url" value="/zjlgDtjsJjfz.do?method=jjfzUpdate&doType=add"/>
		...
		<div class="tab">		
			<table class="formlist" id="rsTable">
				...
				<tr style="height: 23px">
					...
					<td align="left">
						<html:text name="rs" property="djsqssj" styleId="djsqssj" readonly="true"
							onblur="dateFormatChg(this)" style="cursor:hand;"
							onclick="return showCalendar('djsqssj','y-mm-dd');"/>	
					</td>
					<th>
						<font color="red">*</font>推优时间
					</th>
					<td align="left">
				...
				<tr style="height: 23px">
					...
					<td align="left" colspan="3">
						<html:textarea name='rs' property="sxhbqk" styleId="sxhbqk" rows="5" style="width: 95%;word-break:break-all;" onblur="chLeng(this,250)"/>
					</td>
				</tr>
				<tr style="height: 23px">
					<th>
				...
				<tfoot>
			      <tr>
			        <td colspan="4"><div class="bz">"<span class="red">*</span>"为必填项</div>
			          <div class="btn">
						  <logic:notEqual name="doType" value="view">
							<button type="button" id="buttonSave" onclick="saveJjfz()">
								保存
							</button>
						  </logic:notEqual>
