	...
	<body onload="checkWinType();check_user()">
		...
		<html:form action="/dtjs" method="post">
			...
			<logic:notEmpty name="rs">
				...
				<fieldset>
					<legend>
						<bean:message key="lable.xsgzyxpzxy" />素质教育论坛
					</legend>
					<table width="100%" class="tbstyle">
						...
						<tr align="left">
							...
							<td colspan="3">
								<html:textarea name='rs' property='ltjh' style="width:99%" styleId="ltjh"
									rows='2' />
							</td>
						</tr>
						<tr align="left">
							...
							<td colspan="3">
								<html:textarea name='rs' property='jtkzqk' style="width:99%"
									rows='10' />
							</td>
						</tr>
						<tr align="left">
							...
							<td colspan="3">
								<html:textarea name='rs' property='zj' style="width:99%"
									rows='６' />
							</td>
						</tr>
						<tr align="left">
				...
				<div class="buttontool">
					<button type="button" class="button2"
						onclick="szsxDataDoSave('dtjs.do?method=saveSzjyltOne','xn-nd-ltjh');"
