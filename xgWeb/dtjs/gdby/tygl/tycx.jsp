...
<html>
	...
	<body onload="choiceDisabled('xy','xy');choiceDisabled('stu','xh-xm-xy-zy-bj');">
		<html:form action="/gdby_tygl.do?method=tycx" method="post">
						...
						<tr>
							...
							<td width="10" align="center" valign="middle" rowspan="3">
								...
								<button type="button" class="button2" id="search_go" style="height:20px"
									onclick="allNotEmpThenGo('/xgxt/gdby_tygl.do?method=tycx&go=go')">
									查 询
								</button>
									<br/>
			...
			<div class="buttontool" id="btn"
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<button type="button" class="button2"
						onclick="location='gdby_tygl.do?method=tysq';"
						style="width:80px">
						增加
					</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2"
						onclick="dataBatch('gdby_tygl.do?method=tycx&doType=del&go=go')"
						style="width:80px">
						删 除
					</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<button type="button" class="button2"
					onclick="wjcfDataExport('gdby_tygl.do?method=tyExp',600,400)"
					style="width:80px">
					导出数据
				</button>
			</div>
