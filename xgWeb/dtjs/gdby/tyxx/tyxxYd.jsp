...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body>
		<html:form action="gdbyTyxx" method="post">
			...
			<input type="hidden" name="realTable" id="realTable" value="gdby_dtjs_tyxxydb" />
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：党团建设 - 团员信息 - 团员信息异动				
				</div>
			</div>			
			<fieldset>
				<legend>
					...
					<thead>
						<tr>
							<td>
								...
								&nbsp;&nbsp;学号:
								<html:text property="querylike_xh" styleId="xh" style="width:120px"/>
								&nbsp;&nbsp;姓名:
								<html:text property="querylike_xm" styleId="xm" style="width:120px"/>
								&nbsp;&nbsp;异动状态:
								<html:select property="queryequals_ydzt" style="width:80px"
										styleId="ydzt" >
										<html:option value=""></html:option>
								...
								&nbsp;&nbsp;异动类型:
								<html:select property="queryequals_ydlxmc" style="width:80px"
										styleId="ydlx">
										<html:option value=""></html:option>
										<html:options collection="ydlxList" property="mc"
										labelProperty="mc" />
									</html:select>
							</td>
							<td width="10" align="center" valign="middle" rowspan="3">
								...
								<button type="button" class="button2" id="search_go"
									onclick="allNotEmpThenGo('gdbyTyxx.do?method=tyxxYd&doType=qry')"  style="height: 25px">
											查 询
										</button>
										<br>
										<button type="button" class="button2" style="height:25px" id="cz"
											onclick="czSearchCond('nj-xh-xm-xy-zy-bj-ydlx-ydzt');">
											重 置
								</button>
							</td>
						</tr>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
				<logic:notEqual name="writeAbled" value="no">
					<button type="button" class="button2"
						onclick="showTopWin('gdbyTyxx.do?method=tyxxDgYd&doType=save',700,500)"
						style="width:80px">
						异 动
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('gdbyTyxx.do?method=tyxxYd&doType=del')"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="wjcfDataExport('gdbyTyxx.do?method=expDate&tName=view_gdby_dtjs_tyxxydb')" style="width:80px">
						导出数据
					</button>
					</div>
