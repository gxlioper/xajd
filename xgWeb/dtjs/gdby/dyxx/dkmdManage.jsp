...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function saveZsdy(){
		var url = "/xgxt/gdby_dtjs.do?method=dkmdManage&doType=save";
		showTips('处理数据中，请等待......');
		refreshForm(url);
	}
				...
				<div class="rightcontent">
								...
								<tr>
									...
									<td width="10" rowspan="2" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/gdby_dtjs.do?method=dkmdManage');">
											查询
										</button>
									</td>
								</tr>
							...
							<table width="100%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);" style="cursor:hand" 
										ondblclick="showInfo('/xgxt/gdby_dtjs.do?method=dkmdUpdate','view','600','480')">
										<td align="center">
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2" onclick="saveMd()">
								保&nbsp;&nbsp;&nbsp;&nbsp;存
							</button>
							&nbsp;&nbsp;
