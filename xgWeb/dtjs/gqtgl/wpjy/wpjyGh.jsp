	...
	<body >
		<html:form action="/ntzyWpjy" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
			    <ul>
				  <li> <a href="#" onclick="dataBatch('ntzyWpjy.do?method=wpjyGh&doType=modi&act=gh')" class="btn_gx"> 归还 </a> </li>
			      <li> <a href="#"  onclick="dataBatch('ntzyWpjy.do?method=wpjyGh&doType=modi&act=wgh')" class="btn_qxgx"> 插销归还 </a> </li>
			    </ul>
			 </div>
			 </logic:equal>
