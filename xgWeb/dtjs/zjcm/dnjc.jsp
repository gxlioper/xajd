...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function dnjcDel(){
		...
		showTips('处理数据中，请等待......');
		refreshForm('/xgxt/dtjs_zjcm.do?method=delDnjc&go=go&pk='+temppk)
	}
	function sh(zht){
		if(curr_row == null){
			alert('请选择要审核的行!');
		...
		refreshForm('/xgxt/dtjs_zjcm.do?method=dnjcShhAll&go=go&pk='+temppk +'&zht='+ zht)
	}
	/*
	...
	<body>
		...
		<center>
			...
			<input type="hidden" id="delDnjc" name="delDnjc" value="${delDnjc}"/>
			<input type="hidden" id="updateShh" name="updateShh" value="${updateShh}"/>
			<div class="title">
						...
						<tr>
							...
							<td width="10" rowspan="3" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="searchCheck('/xgxt/dtjs_zjcm.do?method=dnjc')">
									查询
								</button>
						...
						<logic:iterate name="rs" id="s">
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowMore(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/dtjs_zjcm.do?method=dnjcShh&db=db&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
				<div class="buttontool" id="btn"
					style="position: absolute;left:1%;top:100px" width="100%">
						<button type="button" class="button2"
							onclick="showTopWin('/xgxt/dtjs_zjcm.do?method=dnjcShq',600,480)"
							style="width:80px">
							申 请
						</button>
						&nbsp;
				...
				<logic:present name="delDnjc">
				<script>
					alert(''+document.getElementById('delDnjc').value);
				</script>
				</logic:present>
				<logic:present name="updateShh">
				<script>
					alert(''+document.getElementById('updateShh').value);
				</script>
				</logic:present>
				</logic:equal>
			</html:form>
