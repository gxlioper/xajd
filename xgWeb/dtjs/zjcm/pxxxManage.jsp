				...
				<div class="rightcontent">
							...
							<thead>
								<tr>
									<td align="left">
										...
										&nbsp;&nbsp;培训项目：
										<html:select property="pxxmdm" style="" onchange="">
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/zjcmDtjs.do?method=pxxxManage');">
											查询
										</button>
									</td>
								</tr>
							...
							<table width="100%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);" style="cursor:hand" 
										ondblclick="showInfo('/xgxt/zjcmDtjs.do?method=pxxxUpdate','view','600','480')">
										<td align="center">
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2" onclick="showTopWin('/xgxt/zjcmDtjs.do?method=pxxxUpdate',600,480);">
								增&nbsp;&nbsp;加
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2" onclick="showInfo('/xgxt/zjcmDtjs.do?method=pxxxUpdate','update','600','480')">
								修&nbsp;&nbsp;改
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2" onclick="sumitInfo('/xgxt/zjcmDtjs.do?method=pxxxManage','del')">
								删&nbsp;&nbsp;除
							</button>
							&nbsp;&nbsp;
