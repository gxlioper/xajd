...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body>
		<html:form action="zjcmKkcs" method="post">
			<input type="hidden" name="zyV" id="zyV" />
			<input type="hidden" name="bjV" id="bjV" />
			<input type="hidden" name="isFdy" id="isFdy" value="${fdyQx}" />
			<input type="hidden" name="userName" id="userName" value="${userName}" />
			<input type="hidden" name="realTable" id="realTable" value="zjcm_dtjs_kkcs" />
			    		...
			    		<logic:equal name="lx" value="wh">
							<ul>
								<li id="001l"
									class="xxk_on_l"></li>
								<li id="001m"
									onclick="refreshForm('zjcmKkcs.do?method=kkcsWh&lx=wh')" class="xxk_on_m">
									&nbsp;
									旷课次数维护
									&nbsp;
								</li>
							...
							<ul>
								<li id="002l"
									class="xxk_off_l"></li>
								<li id="002m"
									onclick="refreshForm('zjcmKkcs.do?method=kkcsWh&lx=cx')" class="xxk_off_m">
									&nbsp;
									旷课次数查询
								</li> 
								<li id="002r"
							...
							<ul>
								<li id="001l"
									class="xxk_off_l"></li>
								<li id="001m"
									onclick="refreshForm('zjcmKkcs.do?method=kkcsWh&lx=wh')" class="xxk_off_m">
									&nbsp;
									旷课次数维护
									&nbsp;
								</li>
							...
							<ul>
								<li id="002l"
									class="xxk_on_l"></li>
								<li id="002m"
									onclick="refreshForm('zjcmKkcs.do?method=kkcsWh&lx=cx')" class="xxk_on_m">
									&nbsp;
									旷课次数查询
								</li> 
								<li id="002r"
					...
					<thead>
						<tr>
							<td>
								...
								&nbsp;学期:
								<html:select property="queryequals_xq" style="width:100px"
										styleId="xq" >、
								...
								&nbsp;学号：
								<html:text property="querylike_xh" style="width:100px" styleId="xh"/>
								&nbsp;姓名：
								<html:text property="querylike_xm" style="width:100px" styleId="xm"/>
							</td>
							<td width="10" align="center" valign="middle" rowspan="2">
								<button type="button" class="button2" id="search_go"
											onclick="allNotEmpThenGo('zjcmKkcs.do?method=kkcsWh&doType=qry')" style="height: 25px">
											查 询
										</button>
										<br>
										<button type="button" class="button2" style="height:25px" id="cz"
											onclick="czSearchCond('xn-nj-xy-zy-bj-xh-xm');">
											重 置
								</button>
							</td>
						</tr>
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								...
								<logic:iterate id="v" name="s" offset="6" length="1">
									<td nowrap>
										<input type="text" name="kkcs"  style="width:50px" onkeypress="return onlyNum(this,20)" 
					...
					<TR>
						<TD>
							<jsp:include flush="true"
								page="/sjcz/turnpage.jsp?form=zjcmKkcsForm"></jsp:include>
						</TD>
					</TR>
					<TR>
						<TD height=3></TD>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
				<logic:equal name="writeAble" value="yes">
					<logic:equal name="lx" value="wh">
					<button type="button" class="button2" onclick="save('zjcmKkcs.do?method=kkcsWh&doType=save')" style="width:80px">
						保   存
					</button>
					</logic:equal>
					<logic:equal name="lx" value="cx">
