...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function saveSwcl(url,pk){
		...
		if (confirm("该党内奖惩状态要修改为"+zht+"，确认吗？\n点击\"确定\"，保存数据；点击\"取消\"，将放弃更改！")) {
			showTips('处理数据中，请等待......');
			refreshForm(url);
		}
	}
			...
			<fieldset>
				...
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<td align="left">
							<html:text property="sssj" styleId="sssj" readonly="true" name="rs"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="hidden" name="cllxV" value="<bean:write property="cllx" name="rs"/>" />
							<html:select property="cllx" style="width:180px" styleId="cl" name="rs"  disabled="true">
								<html:option value=""></html:option>
				...
				<div class="buttontool">
					...
					<button type="button" class="button2"
						onclick="saveSwcl('dtjs_zjcm.do?method=saveSwclshh',document.getElementById('shlx').value);"
