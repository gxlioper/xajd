						...
						<tr>
							<td align="left" nowrap>
								...
								<button type="button" class="button2" style="height:25px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/xszz_nbcs.do?method=zxdkcx&doType=query')">
									查询
								</button>
								&nbsp;&nbsp;
					...
					<logic:equal value="yes" name="writeAble">
		                <div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
		                	...
		                	<button type="button" class="button2"
								onclick="deletedata('/xgxt/xszz_nbcs.do?method=zxdkcx&doType=delete');"
								style="width:80px">
								删&nbsp;&nbsp;&nbsp;&nbsp;除
							</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="expData('/xgxt/xszz_nbcs.do?method=zxdkcx&doType=expData')"
								style="width:80px">
								导出数据
							</button>
						</div>
