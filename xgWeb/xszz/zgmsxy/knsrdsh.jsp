...
function dataExport2() {
	document.forms[0].action = "/xgxt/zgmsxy_xszz.do?method=knsrdExp";
...
function ndDisabled() {
	...
	<body onload="xyDisabled('xy');ndDisabled();">
		...
		<html:form action="/zgmsxy_xszz.do?method=knsrdsh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					<logic:equal name="isQuery" value="is">
					当前所在位置：困难生 - 申请结果查询 - 困难生
					</logic:equal>
					...
					<thead>
						<tr>
							<td align="left">
								...
								评议结果：
								<html:select name="hs" property="mzpyjg" style="width:80px">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/zgmsxy_xszz.do?method=knsrdsh&go=go')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left" nowrap>
								...
								<bean:message key="lable.xsgzyxpzxy" />：
								<html:select property="xydm" onchange="initZyList();initBjList()" style="width:160px" styleId="xy">
									<html:option value=""></html:option>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zgmsxy_xszz.do?method=knsrdsq')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zgmsxy_xszz.do?method=knsrdshOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="0" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/zgmsxy_xszz.do?method=knsrdsq');"
								style="width:80px">
								增  加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/zgmsxy_xszz.do?method=knsrdsq');"
								style="width:80px">
								修  改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button type="button" class="button2" onclick="plsh('/xgxt/zgmsxy_xszz.do?method=knsrdplsh');"
								style="width:80px">
								批量审核
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button type="button" class="button2" onclick="del('/xgxt/zgmsxy_xszz.do?method=knsrdsh&go=del');"
								style="width:80px">
								删  除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
