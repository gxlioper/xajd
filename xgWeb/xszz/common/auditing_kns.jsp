...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/auditing_kns" method="post">
			<div class="title">
						...
						<logic:equal name="isQuery" value="is">
							<tr>
								<td align="left">
									...
									年级：
									<html:select property="nj" onchange="refreshForm('/xgxt/auditing_kns.do')" 
									styleId="nj" style="width:90px;padding-left:80px">
									</html:select>
									&nbsp;&nbsp;学号：
									<html:text property="xh"  styleId="xh" maxlength="20" style="width:80px"></html:text>
									&nbsp;&nbsp;姓名：
									<html:text property="xm" styleId="xm" maxlength="10" style="width:80px"></html:text>
									<!--云南艺术<bean:message key="lable.xsgzyxpzxy" />-->
									<logic:equal value="10690" name="xxdm">
										&nbsp;&nbsp;困难生等级：
										<html:select property="kncddm">
										<html:option value=""></html:option>
										<html:options collection="knsdjList" property="dm" labelProperty="mc"/>
										</html:select>
									</logic:equal>
									<!--end云南艺术<bean:message key="lable.xsgzyxpzxy" />-->
								</td>
								<td width="10" align="center" valign="middle" rowspan="2">
									<input type="hidden" name="go" value="a" />
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/auditing_kns.do')">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td>
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy" onchange="refreshForm('/xgxt/auditing_kns.do')">
										<html:option value=""></html:option>
									...
									<html:select name="rs1" property="zydm" style="width:180px"
										styleId="zy" onchange="refreshForm('/xgxt/auditing_kns.do')">
										<html:option value=""></html:option>
			...
			<logic:notEmpty name="rs">
				<fieldset>
					<legend>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<font color="blue">提示：双击一行可以查看详细信息<logic:notEqual name="isQuery" value="is">，并可以改变审核状态</logic:notEqual>；单击表头可以排序</font>
					</legend>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/auditing_kns_one.do','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/needer_apply.do','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2" onclick="add('/xgxt/needer_apply.do');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/needer_apply.do');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/auditing_kns_one.do?actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
