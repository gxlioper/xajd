...
function chkAssisOne(url, act) {
	if (curr_row == null) {
		...
		url += "&ndT=";
		url += curr_row.getElementsByTagName("input")[4].value;
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/auditing_wszxj" method="post">
			<div class="title">
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							<td align="left">
								年级：
								<html:select property="nj" onchange="refreshForm('/xgxt/auditing_wszxj.do')">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/auditing_wszxj.do')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left">
								...
								<html:select  property="xydm" style="width:180px"
									styleId="xy" onchange="refreshForm('/xgxt/auditing_wszxj.do')">
									<html:option value=""></html:option>
								...
								<html:select property="zydm" style="width:180px"
									styleId="zy" onchange="refreshForm('/xgxt/auditing_wszxj.do')">
									<html:option value=""></html:option>
						...
						<tr>
							<td colspan="2">
								审核项目：
								<html:select property="shxmdm" style="width:180px">
									<html:option value=""></html:option>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/auditing_wszxj_one.do','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/wszxj.do','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2" onclick="add('/xgxt/wszxj.do');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/wszxj.do');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<logic:notEqual name="isQuery" value="is">
							<button class="button2" onclick="plsh('/xgxt/auditing_wszxj_one.do?actDo=plsh&jg=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="plsh('/xgxt/auditing_wszxj_one.do?actDo=plsh&jg=btg');"
								style="width:80px">
								不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/auditing_wszxj_one.do?actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
