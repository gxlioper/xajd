...
function dataExport2() {
					...
					<thead>
						<tr>
							<td align="left">
								...
								<html:select name="rs1" property="xydm" style="width:150px" styleId="xy"
										onchange="refreshForm('/xgxt/auditing_szfjzxj.do')">
								...
								年级：
								<html:select name="rs1" property="nj" onchange="refreshForm('/xgxt/auditing_szfjzxj.do')">
									<html:option value=""></html:option>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/auditing_szfjzxj.do')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left">
								审核项目：
								<html:select name="rs1" property="shxm" style="width:150px">
								...
								姓名：
								<html:text name="rs1" property="xm" styleId="xm" style="width:50px;inputtext"
								styleClass="inputtext"></html:text>
								性别：
								...
								身份证号：
								<html:text name="rs1" property="sfzh" styleId="sfzh" style="width:130px;inputtext" maxlength="18"
								styleClass="inputtext"></html:text>
							</td>
						</tr>
						<tr>
							<td align="left" colspan="2">
								地址：
								<html:text name="rs1" property="jtzz" styleId="jtzz" style="width:330px;inputtext" maxlength="140"
								styleClass="inputtext"></html:text>
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/auditing_szfjzxj_one.do','view')">
								<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/szfjxjzxj.do','view')">
								<td align="center">
											<logic:iterate id="v" name="s" offset="1" length="1">
												<input type="checkbox" name="pk" value="<bean:write name="v"/>">
											</logic:iterate>
			...
			<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
					<center>
						<div class="buttontool" id="btn"
							...
							<logic:equal name="isQuery" value="is">
							<button class="button2" onclick="add('/xgxt/szfjxjzxj.do');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/szfjxjzxj.do');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<button class="button2" onclick="plsh('/xgxt/auditing_szfjzxj_one.do?actDo=plsh&jg=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="plsh('/xgxt/auditing_szfjzxj_one.do?actDo=plsh&jg=btg');"
								style="width:80px">
								不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button class="button2" onclick="del('/xgxt/auditing_szfjzxj_one.do?actDo=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
