...
function dataExport2() {
					...
					<thead>
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:150px"
										styleId="xy" onchange="refreshForm('/xgxt/auditing_xfbz.do')">
									...
									<html:select name="rs1" property="zydm" style="width:180px"
										styleId="zy" onchange="refreshForm('/xgxt/auditing_xfbz.do')">
										<html:option value=""></html:option>
									...
									年级：
									<html:select name="rs1" property="nj" onchange="refreshForm('/xgxt/auditing_xfbz.do')">
										<html:option value=""></html:option>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/auditing_xfbz.do')">
										查询
									</button>
								</td>
							</tr>
						...
						<logic:notEqual name="isQuery" value="is">
							...
							<tr>
								<td>
									学号：
								<html:text name="rs1" property="xh" styleId="xh" style="width:70px;inputtext"
								styleClass="inputtext"></html:text>
								姓名：
								<html:text name="rs1" property="xm" styleId="xm" style="width:40px;inputtext"
								styleClass="inputtext"></html:text>
								性别：
								<html:select name="rs1" property="xb">
									<html:option value=""></html:option>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/auditing_xfbz_one.do','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/xfbz.do','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2" onclick="add('/xgxt/xfbz.do');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/xfbz.do');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
							<button class="button2" onclick="plsh('/xgxt/auditing_xfbz_one.do?actDo=plsh&jg=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="plsh('/xgxt/auditing_xfbz_one.do?actDo=plsh&jg=btg');"
								style="width:80px">
								不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/auditing_xfbz_one.do?actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
