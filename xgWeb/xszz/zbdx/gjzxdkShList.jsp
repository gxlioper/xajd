...
%>
	...
	<body onload="xyDisabled('xy')">
		...
		<html:form action="zbdx_xszz.do?method=gjzxdkShList" method="post">
			<div class="title">
...
<%--				value="<bean:write name="pk" scope="request"/>" />--%>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:20px" id="search_go"
									onclick="allNotEmpThenGo('zbdx_xszz.do?method=gjzxdkShList')">
									查询
								</button>
							</td>
						</tr>
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="showTopWin('zbdx_xszz.do?method=getGjzxdkOne&pkVal='+curr_row.getElementsByTagName('input')[0].value, 700, 500);">
								<td>
