...
function chkAssisOne(url) {
	if (curr_row == null) {
		...
		showTopWin(url, 720, 250);
		return true;
	}
}

function add(url){
	return showTopWin(url,650,250);
}
...
function dataExport2() {
	document.forms[0].action = "/xgxt/gzdx_xszz.do?method=lsbtExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
	<body onload="xyDisabled('xy');xyDisabled('nj-xh-xm-xb-sfzh-xy-zy-bj');">
		<html:form action="/gzdx_xszz.do?method=lsbtDate" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 数据维护 - 临时补贴信息
				</div>
			</div>
					...
					<thead>
						<tr>
							<td align="left">
								...
								styleClass="inputtext"></html:text>
								补贴时间
								<input type="text" style="cursor:hand;width:90px" maxlength="10"
									onclick="return showCalendar('btsj','y-mm-dd');"
									value="<bean:write name='rs1' property="btsj" />" name="btsj"
									id="btsj" />
							</td>
							<td width="10" rowspan="2" align="center" valign="middle">
								<input type="hidden" name="go" value="a" />
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/gzdx_xszz.do?method=lsbtDate&go=go')">
									查询
								</button>
							</td>
						</tr>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="userType" value="xx">
								<button class="button2" onclick="add('/xgxt/gzdx_xszz.do?method=lsbtEdit');"
									style="width:80px">
									增 加
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="modi('/xgxt/gzdx_xszz.do?method=lsbtEdit&type=modi');"
									style="width:80px">
									修 改
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="del('/xgxt/gzdx_xszz.do?method=lsbtDate&go=del');"
									style="width:80px">
									删 除
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
