...
function dataExport2() {
	document.forms[0].action = "/xgxt/gzdx_xszz.do?method=xsjyxxExp";
	...
	<body onload="xyDisabled('xy');xyDisabled('nj-xh-xm-xb-sfzh-xy-zy-bj');">
		<html:form action="/gzdx_xszz.do?method=xsjyxxDate" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 助学贷款 - 贷款学生就业信息
				</div>
			</div>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/gzdx_xszz.do?method=xsjyxxDate&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/gzdx_xszz.do?method=xsjyxxOne')"
										style="cursor:hand;">
										<td align=center>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="userType" value="xx">
								<button class="button2" onclick="add('/xgxt/gzdx_xszz.do?method=xsjyxxEdit');"
									style="width:80px">
									增 加
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="modi('/xgxt/gzdx_xszz.do?method=xsjyxxEdit&type=modi');"
									style="width:80px">
									修 改
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="del('/xgxt/gzdx_xszz.do?method=xsjyxxDate&go=del');"
									style="width:80px">
									删 除
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
