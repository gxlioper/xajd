  ...
  <body>
  		<html:form action="/xxcj" method="post">
			...
			<input type="hidden" id="getStuInfo" name="getStuInfo" value="xm-xb" />		
  			...
  			<logic:equal value="退回" name="xysh" name="rs">
  				<input type="hidden" name="xysh" value="需重审"/>
  			</logic:equal>
				...
				<table width="100%" border="0" class="formlist">
					<tfoot>
						<tr>
							<td colspan="4">
								...
								<div class="btn">
									<logic:notEqual value="view" property="doType" name="xxcjForm">
										<button type="button" onclick="saveUpdate('xxcj.do?method=xxcjUpdate&doType=save','')">
											保 存
										</button>
									</logic:notEqual>
									
									<logic:equal value="view" name="xxcjForm" property="doType">
										<button type="button" onclick="window.close();return false;">
											关 闭
										</button>
									</logic:equal>
									<logic:notEqual value="view" name="xxcjForm" property="doType">
					...
					<tbody id="myTbody3" style="display:none">
						...
						<tr>
							...
							<th>抚养费其他</th>
							<td>
								<html:radio property="fyfqt" value="1" name="rs" onclick="checkDqfyxx(this)"></html:radio>是
								<html:radio property="fyfqt" value="0" name="rs" onclick="checkDqfyxx(this)"></html:radio>否
							</td>
						</tr>
					</tbody>
					<thead>
					...
					<tbody id="myTbody5" style="display:none">
						...
						<tr>
							...
							<td>
								...
								<html:radio property="mcj" value="0" onclick="setQm(this,'mqstpc','mqstjc')" name="rs"></html:radio>否
							</td>
						</tr>
					</tbody>
					<thead>
					...
					<tbody id="myTbody7" style="display:none">
						<tr>
							<th>赡养老人(个)</th>
							<td>
								<html:text property="sylrs" name="rs" onkeyup="value=value.replace(/[^\d]/g,'')" onblur="isZero(this);" maxlength="2"></html:text>
							</td>
							<th>老人身体良好</th>
							<td>
					...
					<tbody id="myTbody10" style="display:none">
					 ...
					 -->
					<logic:equal value="view" property="doType" name="xxcjForm">
					<thead>
						<tr>
							<th colspan="4">
					...
					<tbody name="xyxx">
						<tr>
							...
							<td>
								<html:text property="y1" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
							<th>
								y2
							</th>
							<td>
								<html:text property="y2" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<html:text property="y3" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
							<th>
								y4
							</th>
							<td>
								<html:text property="y4" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<html:text property="y5" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
							<th>
								y6
							</th>
							<td>
								<html:text property="y6" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<html:text property="y7" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
							<th>
								y8
							</th>
							<td>
								<html:text property="y8" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<html:text property="y9" onblur="checkInputNum(this)" maxlength="10" name="rs"></html:text>
							</td>
							<th>
								z
							</th>
			...
			<logic:equal value="view" name="xxcjForm" property="doType">
				<script>
					jQuery('input',jQuery('tbody[name=xyxx]')).attr('disabled',true);
				</script>
			</logic:equal>
