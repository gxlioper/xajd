...
function chkAssisOne(url) {
	if (curr_row == null) {
		...
		showTopWin(url, 750, 470);
		return true;
	}
}

function add(url){
	return showTopWin(url,750,470);
}
...
function dataExport2() {
	document.forms[0].action = "/xgxt/zjjdzyjsxy_xszz.do?method=fkxx_exp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/zjjdzyjsxy_xszz.do?method=data_fkxx" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 信息维护 - 国家助学贷款放款信息
				</div>
			</div>
					...
					<thead>
						<tr>
							<td align="left">
								...
								&nbsp;&nbsp;合同号：
								<html:text property="hth" styleId="hth" style="width:90px;inputtext"
								styleClass="inputtext"></html:text>
							</td>
							<td width="10" rowspan="2" align="center" valign="middle">
								<input type="hidden" name="go" value="a" />
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/zjjdzyjsxy_xszz.do?method=data_fkxx&go=go')">
									查询
								</button>
							</td>
						</tr>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zjjdzyjsxy_xszz.do?method=fkxx_queryOne')"
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" onclick="add('/xgxt/zjjdzyjsxy_xszz.do?method=fkxx_queryOne');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/zjjdzyjsxy_xszz.do?method=fkxx_queryOne');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="del('/xgxt/zjjdzyjsxy_xszz.do?method=data_fkxx&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
