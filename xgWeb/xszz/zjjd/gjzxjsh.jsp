...
function dataExport2() {
	document.forms[0].action = "/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjExp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/zjjdzyjsxy_xszz.do?method=gjzxjsh" method="post">
			<div class="title">
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsq')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjshOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="0" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsq');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button type="button" class="button2" onclick="tg('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsh&go=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="btg('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsh&go=btg');"
								style="width:80px">
								不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button type="button" class="button2" onclick="del('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjsh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
