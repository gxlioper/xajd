	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			if(xyshyj != null){
			 ...
			 refreshForm('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxjshSave');
		}
		...
		<html:form action="/data_search" method="post">
			...
			<table width="98%" align="center" class="tbstyle">
				...
				<tr>
					...
					<td width="30%">
						<bean:write name='rs' property="zxjdjmc" />
					</td>
					<td width="16%">
						<div align="center">
							助学金金额
				...
				<tr>
					...
					<td>
						<bean:write name="rs" property="jthkrs" />
					</td>
				</tr>
				<tr>
					<td >
