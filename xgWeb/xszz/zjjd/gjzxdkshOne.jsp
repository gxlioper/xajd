...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			if(fdyshyj != null){
	         	if(fdyshyj.replace(/[^\u0000-\u00ff]/g, "**").length > 500){	         
	          		 alert("班主任审核意见不能大于500个字符");
	          		 return false;
	       		 }
	       	}
			if(xyshyj != null){
			 ...
			 refreshForm('/xgxt/zjjdzyjsxy_xszz.do?method=gjzxdkshSave');
		}
		function yzdx(obj,str){
			document.getElementById(str).value = obj.value;
		}
		</script>
		<html:form action="/zjjdzyjsxy_xszz.do?method=gjzxdkshSave" method="post">
			<div class="title">
