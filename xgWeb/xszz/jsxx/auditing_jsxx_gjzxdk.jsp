...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/auditing_jsxx_gjzxdk" method="post">
			<div class="title">
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/auditing_jsxx_gjzxdk.do')">
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/auditing_jsxx_gjzxdk.do')">
										查询
									</button>
								</td>
							</tr>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/auditing_jsxx_gjzxdk_one.do','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/jsxx_gjzxdk.do','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button type="button" class="button2" onclick="add('/xgxt/jsxx_gjzxdk.do');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/jsxx_gjzxdk.do');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button type="button" class="button2"
						onclick="del('/xgxt/auditing_jsxx_gjzxdk_one.do?actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
