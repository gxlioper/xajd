...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="xyDisabled('xy');initPage();initBjList()">
		<html:form action="/whlg_xszz.do?method=jtjjknswh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 数据维护 - 家庭情况调查
				</div>
			</div>
					...
					<thead>
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/whlg_xszz.do?method=jtjjknswh&go=go&doType=search')">
									查询
								</button>
							</td>
						</tr>
						<tr>	
							<td align="left" nowrap>
								&nbsp;&nbsp;学号：
								<html:text name="form" property="xh" styleId="xh" style="width:90px;inputtext"
								styleClass="inputtext"></html:text>
								&nbsp;&nbsp;姓名：
								<html:text  name="form" property="xm" styleId="xm" style="width:90px;inputtext"
								styleClass="inputtext"></html:text>
							</td>
						</tr>
					</thead>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/whlg_xszz.do?method=jtjjknssq&doType=view')">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" onclick="add('/xgxt/whlg_xszz.do?method=jtjjknssq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/whlg_xszz.do?method=jtjjknssq&doType=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="del('/xgxt/whlg_xszz.do?method=jtjjknswh&doType=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<logic:match value="ok" name="ok">
			<script language="javascript">
	   			alert("删除成功！");  
	   			document.getElementById("seacrh_go").click();		
	        </script>
		</logic:match>
