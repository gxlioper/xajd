...
function dataExport2() {
	document.forms[0].action = "/xgxt/whlg_xszz.do?method=jtqkdc_exp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/whlg_xszz.do?method=data_jtqkdc" method="post">
			<div class="title">
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/whlg_xszz.do?method=data_jtqkdc&go=go')">
									查询
								</button>
							</td>
						</tr>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/whlg_xszz.do?method=jtqkdc_queryOne')"
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" onclick="add('/xgxt/whlg_xszz.do?method=jtqkdc_queryOne');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/whlg_xszz.do?method=jtqkdc_queryOne');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="del('/xgxt/whlg_xszz.do?method=data_jtqkdc&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
