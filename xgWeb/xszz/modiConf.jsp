...
<base target="_self"/>
  ...
  <table width="98%" class="tbstyle" align="center" id="rsTable"> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.knssq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr>
      <td align="right" height="25"> <bean:message key="lable.knssq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.gjzxdksq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.gjzxdksq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.gjjxjsq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.gjjxjsq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.gjzxjsq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.gjzxjsq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.szfjxjsq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.szfjxjsq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.szfzxjsq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.szfzxjsq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.zxdkgjzxjsq" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.zxdkgjzxjsq" /><bean:message key="lable.jssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.xndxj" /><bean:message key="lable.kssj" />: </td> 
    ...
    <tr> 
      <td align="right" height="25"> <bean:message key="lable.xndxj" /><bean:message key="lable.jssj" />: </td> 
    ...
    <thead> 
      <tr> 
        <td height="25" colspan="2" align="center"> <button class="button2" onclick="saveConf()"> <bean:message key="lable.save" /> </button></td> 
      </tr> 
    </thead> 
  </table> 
  </fieldset> 
  <logic:present name="ok" scope="request">
    <logic:equal value="ok" name="ok" scope="request">
      <script>alert("保存成功！");window.dialogArguments.location = "/xgxt/assisConf.do";Close();</script>
    </logic:equal>
