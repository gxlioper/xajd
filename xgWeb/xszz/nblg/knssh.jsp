...
function dataExport2() {
	document.forms[0].action = "/xgxt/nblg_xszz.do?method=knsExp";
...
function ndDisabled() {
	...
	<body onload="xyDisabled('xy');ndDisabled();">
		...
		<html:form action="/nblg_xszz.do?method=knssh" method="post">
			<div class="title">
					...
					<thead>
						<tr>
							<td align="left">
								...
								民主评议：
								<html:select property="mzpy" style="width:80px">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/nblg_xszz.do?method=knssh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/nblg_xszz.do?method=knssq')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/nblg_xszz.do?method=knsshOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="0" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/nblg_xszz.do?method=knssq');"
								style="width:80px">
								增  加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/nblg_xszz.do?method=knssq');"
								style="width:80px">
								修  改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button type="button" class="button2" onclick="plsh('/xgxt/nblg_xszz.do?method=knsplsh');"
								style="width:80px">
								批量审核
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button type="button" class="button2" onclick="del('/xgxt/nblg_xszz.do?method=knssh&go=del');"
								style="width:80px">
								删  除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
