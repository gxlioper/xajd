	...
	<body>
		<html:form action="nbtyJtjjkns" method="post">
						...
						<tr>
							...
							<td width="10" align="center" valign="middle" rowspan="3">
								...
								<button type="button" class="button2" id="search_go"
									onclick="allNotEmpThenGo('nbtyJtjjkns.do?method=jtjjknsSh&doType=go')" style="height: 40px">
									查 询
								</button>
							</td>
						</tr>
					...
					<table width="99%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('nbtyJtjjkns.do?method=shOne&doType=view')" style="cursor:hand">
								<td>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
					<button type="button" class="button2" onclick="dataBatch('nbtyJtjjkns.do?method=jtjjknsSh&doType=save&shjg=通过')"
						style="width:80px">
						审核通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('nbtyJtjjkns.do?method=jtjjknsSh&doType=save&shjg=不通过')"
						style="width:80px">
						审核不通过
					</button>
					</div>
