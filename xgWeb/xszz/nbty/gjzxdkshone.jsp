...
<head>
	...
	<script type="text/javascript">
			function yz(){
				var t = checkAllInput('xh!!jzr1!!sfzh1!!sxnpddd!!bjgbxkms!!dkje');
				if(t){
	...
	<html:form action="/nbty_xszz.do?method=gjzxdksq" method="post">
		...
		<table class="tbstyle" width="90%">
			...
			<tr>
				...
				<td>
					<input type="text" id="sxnpddf" maxlength="40" name="sxnpddd"
						style="width:100%;heigh:100%" value="${rs.sxnpddd}"
						readonly="readonly" />
				</td>
				<td>
					<div align="center">
				...
				<td>
					<input type="text" id="bjgbxkms" maxlength="40" readonly="readonly"
						name="bjgbxkms" style="width:100%;heigh:100%"
						value="${rs.bjgbxkms}" />
				</td>
			</tr>
			<tr>
