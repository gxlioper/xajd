...
<html>
	...
	<body onload="onlyXyDisabled('xy');">
		<html:form action="/nbty_xszz.do?method=gjzxdksh" method="post">
						...
						<tr>
							...
							<td width="10" align="center" valign="middle" rowspan="3">
								...
								<button type="button" class="button2" id="search_go" style="height:40px"
									onclick="allNotEmpThenGo('/xgxt/nbty_xszz.do?method=gjzxdksh&go=go')">
									查 询
								</button>
							</td>
						</tr>
			...
			<div class="buttontool" id="btn"
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<button type="button" class="button2"
						onclick="batchData('primarykey_cbv','nbty_xszz.do?method=gjzxdksh&shjg=tg&doType=sh&go=go','sh')"
						style="width:80px">
						通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2"
						onclick="batchData('primarykey_cbv','nbty_xszz.do?method=gjzxdksh&shjg=btg&doType=sh&go=go','sh')"
						style="width:80px">
						不通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2"
						onclick="modi('nbty_xszz.do?method=gjzxdkView&doType=shone')"
						style="width:80px">
						单个审核
					</button>
				</logic:equal>
