...
function plsz(){
	...
	var url = "/xgxt/bjlhdx_xszz.do?method=gjzxdkjePlsz";
	url += "&pkDel=" + RowsStr;
...
function dgsz(){
	var url = "/xgxt/bjlhdx_xszz.do?method=gjzxdkjeEdit";
...
function csh(){
	var url = "/xgxt/bjlhdx_xszz.do?method=gjzxdkjecsh";
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/bjlhdx_xszz.do?method=gjzxdkjesd" method="post">
			<div class="title">
						...
						<thead>
							<tr>
								<td align="left">
									...
									onchange="refreshForm('bjlhdx_xszz.do?method=gjzxdkjesd')">
								...
								<input type="hidden" name="go" value="a"/>
									<button class="button2" id="search_go"
										onclick="refreshForm('bjlhdx_xszz.do?method=gjzxdkjesd&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/bjlhdx_xszz.do?method=gjzxdkjeEdit')">
									<td align="center">
