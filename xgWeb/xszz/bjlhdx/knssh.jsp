...
function dataExport2() {
	document.forms[0].action = "/xgxt/bjlhdx_xszz.do?method=knsshExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/bjlhdx_xszz.do?method=knssh" method="post">
			<div class="title">
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/bjlhdx_xszz.do?method=knssh')">
									...
									<html:select name="rs1" property="zydm" style="width:180px"
										styleId="zy"
										onchange="refreshForm('/xgxt/xgxt/bjlhdx_xszz.do?method=knssh')">
										<html:option value=""></html:option>
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/bjlhdx_xszz.do?method=knssh')">
										查询
									</button>
								</td>
							</tr>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/bjlhdx_xszz.do?method=knsshXxxx','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/bjlhdx_xszz.do?method=knssq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/bjlhdx_xszz.do?method=knssq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
							onclick="modi('/xgxt/bjlhdx_xszz.do?method=knssq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button class="button2"
							onclick="ybkn('/xgxt/bjlhdx_xszz.do?method=knsshXxxx&actDo=ybkn');"
							style="width:80px">
							一般困难
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="tskn('/xgxt/bjlhdx_xszz.do?method=knsshXxxx&actDo=tskn');"
							style="width:80px">
							特殊困难
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="qtkn('/xgxt/bjlhdx_xszz.do?method=knsshXxxx&actDo=qtkn');"
							style="width:80px">
							其他困难
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="bkn('/xgxt/bjlhdx_xszz.do?method=knsshXxxx&actDo=bkn');"
							style="width:80px">
							不困难
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/bjlhdx_xszz.do?method=knsshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
