...
<center> 
  ...
  <table align="center"class="tbstyle" width="100%" height="100%" id="rsTable">
  	<thead>
  	  <tr align="center">
  	    ...
  	    <td colspan="2"><bean:message key="lable.xndxj" /></td>  
  	  </tr>
  	  <tr align="center">
  	...
  	<logic:present name="rs">
  	  ...
  	  <tr onclick="rowOnClick(this)" ondblclick="modiOneConf()" align="center" style="cursor:hand">
  ...
  <div class="buttontool" id="btn"
	...
	<button class="button2" onclick="modiOneConf()">单个设置</button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<button class="button2" onclick="showTopWin('/xgxt/modiConf.do',500,370,'a');">批量设置</button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<logic:notEqual value="xy" name="userType" scope="session">
	<button class="button2" onclick="viewXyConf();">查看详情</button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	</logic:notEqual>
