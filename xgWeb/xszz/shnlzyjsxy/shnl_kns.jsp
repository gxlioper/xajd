...
<head>
	...
	<script language="javascript">
		function yz(titName){
			document.forms[0].action = "/xgxt/shnl_kns.do?doType=add&titName=" + titName;
			document.forms[0].submit();
		}
		
		function toPrintOut(titName){//输出相应的打印页面
			document.forms[0].action = "/xgxt/shnl_knsb.do";
			document.forms[0].submit();
		}
	</script>
</head>
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="shnl_kns.do" method="post">
			<input type="hidden" id="titName" name="titName"
				value="<bean:write name="titName" scope="request" />">
			<input type="hidden" id="url" name="url" value="/shnl_kns.do" />
			...
			<table class="tbstyle" width="90%">
				...
				<tr>
					...
					<td colspan="6">
						<input type="text" id="jtzstfywsj" maxlength="150" name="jtzstfywsj"
							style="width:100%;heigh:100%"
