...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			refreshForm('/xgxt/shgc_xszz.do?method=zzsqXxxx&actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
					...
					<td colspan="8">
						<table width="100%" align="center" class="tbstyle">
							<tr>
								...
								<td width="70%">
									<%
											ArrayList xsYxJxjjlList = (ArrayList) request
							...
							<tr>
								...
								<td width="70%">
									<%
											ArrayList xsZqJxjjlList = (ArrayList) request
							...
							<tr>
								...
								<td width="70%">
									<%
											ArrayList xsQtJxjjlList = (ArrayList) request
