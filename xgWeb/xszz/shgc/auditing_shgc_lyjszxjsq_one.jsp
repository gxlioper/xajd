...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			refreshForm('/xgxt/auditing_shgc_lyjszxjsq_one.do?actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
