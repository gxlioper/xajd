				...
				<td>
					...
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td width="42%">
								<logic:equal name="xysh" value="特别困难">
								&nbsp;A.家庭经济特别困难&nbsp;√
								</logic:equal>
								<logic:notEqual name="xysh" value="特别困难">
								&nbsp;A.家庭经济特别困难&nbsp;□
								</logic:notEqual>
							</td>
							<td width="4%" rowspan="3">
						...
						<tr>
							<td>
								<logic:equal name="xysh" value="一般困难">
								&nbsp;B.家庭经济困难&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;√
								</logic:equal>
								<logic:notEqual name="xysh" value="一般困难">
								&nbsp;B.家庭经济困难&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;□
								</logic:notEqual>
							</td>
						</tr>
						<tr>
							<td>
								<logic:equal name="xysh" value="不通过">
								&nbsp;C.家庭经济不困难&nbsp;&nbsp;&nbsp;√
								</logic:equal>
								<logic:notEqual name="xysh" value="不通过">
								&nbsp;C.家庭经济不困难&nbsp;&nbsp;&nbsp;□
								</logic:notEqual>
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<logic:notEqual name="xysh" value="未审核">
										<br />
										&nbsp;√&nbsp;&nbsp;同意评议小组意见。
										<br />
										&nbsp;□&nbsp;&nbsp;不同意评议小组意见。
							...
							<td>
								...
								<logic:notEqual name="xxsh" value="未审核">
