...
function del(){
	...
	var url = "/xgxt/shgc_xszz.do?method=zzjeDel";
...
function add(){
	var url = "/xgxt/shgc_xszz.do?method=zzjeEdit";
	url += "&act=add";
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/shgc_xszz.do?method=zzjeList" method="post">
			<div class="title">
							...
							<tr>
								...
								<input type="hidden" name="go" value="a"/>
									<button type="button" class="button2" id="search_go"
										onclick="refreshForm('shgc_xszz.do?method=zzjeList&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/shgc_xszz.do?method=zzjeEdit')">
									<td align="center">
