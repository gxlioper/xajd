...
function plsz(){
	...
	var url = "/xgxt/shgc_xszz.do?method=zxdksjPlsz";
	url += "&pkDel=" + RowsStr;
...
function dgsz(){
	var url = "/xgxt/shgc_xszz.do?method=zxdksjEdit";
...
function csh(){
	var url = "/xgxt/shgc_xszz.do?method=zxdksjcsh";
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/shgc_xszz.do?method=zxdksjList" method="post">
			<div class="title">
							...
							<tr>
								...
								<input type="hidden" name="go" value="a"/>
									<button type="button" class="button2" id="search_go"
										onclick="refreshForm('shgc_xszz.do?method=zxdksjList&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/shgc_xszz.do?method=zxdksjEdit')">
									<td align="center">
			...
			<center>
				...
				<div class="buttontool" id="btn"
					...
					<button type="button" class="button2" onclick="csh();">
						初 始 化
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dgsz();">
						单个设置
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
