...
function dataExport2() {
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							<td align="left">
								学号：
								<input type="text" id="xh" name="rs1" property="xh"
									style="width:17%;heigh:100%" 
									onkeyup="value=value.replace(/[\W]/g,'') "
									onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
								&nbsp;&nbsp;身份证号：
								<input type="text" id="sfzh" name="rs1" property="sfzh"
									style="width:17%;heigh:100%" >
								&nbsp;&nbsp;合同号：
								<input type="text" id="hth" name="rs1" property="hth"
									style="width:17%;heigh:100%" >
								&nbsp;&nbsp;审核状态：
								<html:select name="rs1" property="shzt" style="width:100px">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/auditing_shgc_hkxy.do')">
									查询
								</button>
							</td>
						</tr>
							...
							<td align="left" nowrap>
								<bean:message key="lable.xsgzyxpzxy" />：
									<html:select name="rs1" property="xydm" style="width:180px" styleId="xy"
										onchange="refreshForm('/xgxt/auditing_shgc_hkxy.do')">
										<html:option value=""></html:option>
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/auditing_shgc_hkxy_one.do','view')">
								<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/hkxy.do','view')">
								<td align="center">
											<logic:iterate id="v" name="s" offset="1" length="1">
												<input type="checkbox" name="pk" value="<bean:write name="v"/>">
											</logic:iterate>
			...
			<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
					<center>
						<div class="buttontool" id="btn"
							...
							<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/hkxy.do');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/hkxy.do');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<button type="button" class="button2" onclick="tg('/xgxt/auditing_shgc_hkxy_one.do?actDo=tg');"
								style="width:80px">
								批量通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="btg('/xgxt/auditing_shgc_hkxy_one.do?actDo=btg');"
								style="width:80px">
								批量不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button type="button" class="button2" onclick="del('/xgxt/auditing_shgc_hkxy_one.do?actDo=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
