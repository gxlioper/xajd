...
function plsz(){
	...
	var url = "/xgxt/shgc_xszz.do?method=zzsjPlsz";
	url += "&pkDel=" + RowsStr;
...
function dgsz(){
	var url = "/xgxt/shgc_xszz.do?method=zzsjEdit";
...
function csh(){
	var url = "/xgxt/shgc_xszz.do?method=zzsjcsh";
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/shgc_xszz.do?method=zzsjList" method="post">
							...
							<tr>
								...
								<input type="hidden" name="go" value="a"/>
									<button type="button" class="button2" id="search_go"
										onclick="refreshForm('shgc_xszz.do?method=zzsjList&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/shgc_xszz.do?method=zzsjEdit')">
									<td align="center">
