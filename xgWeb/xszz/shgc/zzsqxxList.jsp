...
function dataExport2() {
	document.forms[0].action = "/xgxt/shgc_xszz.do?method=zzsqExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/shgc_xszz.do?method=zzsqxxList" method="post">
			<div class="title">
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/shgc_xszz.do?method=zzsqxxList')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/shgc_xszz.do?method=zzsqxxList')">
										查询
									</button>
								</td>
							</tr>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/shgc_xszz.do?method=zzsqXxxx','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/shgc_xszz.do?method=zzsq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button type="button" class="button2"
							onclick="add('/xgxt/shgc_xszz.do?method=zzsq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
							onclick="modi('/xgxt/shgc_xszz.do?method=zzsq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button type="button" class="button2"
							onclick="pass('/xgxt/shgc_xszz.do?method=zzsqXxxx&actDo=pass');"
							style="width:80px">
							通 过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2"
							onclick="notPass('/xgxt/shgc_xszz.do?method=zzsqXxxx&actDo=notPass');"
							style="width:80px">
							不通过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button type="button" class="button2"
						onclick="del('/xgxt/shgc_xszz.do?method=zzsqXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
