...
function dataExport2() {
	document.forms[0].action = "/xgxt/shgc_xszz.do?method=xszzjehzExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/shgc_xszz.do?method=xszzjehz" method="post">
			<div class="title">
					...
					<thead>
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="nj" style="width:55px"
										onchange="refreshForm('/xgxt/shgc_xszz.do?method=xszzjehz')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/shgc_xszz.do?method=xszzjehz')">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td>
									...
									&nbsp;资助项目：
									<html:select name="rs1" property="bbdm" style="width:150px">
										<html:option value=""></html:option>
