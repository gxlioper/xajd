...
function dataExport2() {
	document.forms[0].action = "/xgxt/zgkydx_xszz.do?method=tsrqExp";
					...
					<thead>
						<tr>
							<td align="left">
								...
								困难程度：
								<html:select property="knpd" style="width:80px">
									<html:option value=""></html:option>
									<html:options collection="knpdList" property="en"
										labelProperty="cn" />
								</html:select>
								特殊人群：
								<html:select property="tsrqdm" style="width:80px">
									<html:option value=""></html:option>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/zgkydx_xszz.do?method=tsrqcx&go=go')">
									查询
								</button>
							</td>
						</tr>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
						<div class="buttontool" align="center" id="btn"
							...
							<button type="button" class="button2"
								onclick="del('/xgxt/zgkydx_xszz.do?method=tsrqcx&go=del');"
								style="width:80px">
								删  除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="query('/xgxt/zgkydx_xszz.do?method=knscx');"
								style="width:100px">
								设置特殊人群
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
