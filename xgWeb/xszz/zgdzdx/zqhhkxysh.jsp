...
function dataExport2() {
	document.forms[0].action = "/xgxt/zgdzdx_xszz.do?method=zqhhkxyExp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/zgdzdx_xszz.do?method=zqhhkxysh" method="post">
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>助学贷款 - 审核 - 展期后还款协议</a>
				</p>
			</div>
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
			    <ul>
				<li> <a href="#" onclick="tg('/xgxt/zgdzdx_xszz.do?method=zqhhkxysh&go=pass');"" class="btn_zj"> 通过 </a> </li>
			    <li> <a href="#" onclick="btg('/xgxt/zgdzdx_xszz.do?method=zqhhkxysh&go=notPass');" class="btn_xg"> 不通过 </a> </li>
				<li> <a href="#" onclick="del('/xgxt/zgdzdx_xszz.do?method=zqhhkxysh&go=del');" class="btn_sc"> 删除 </a> </li>
		          ...
		          <td colspan="6">
		            <div class="btn">	
		              ...
		              <button type="button" class="btn_cx" id="search_go" 
		              	onclick="allNotEmpThenGo('/xgxt/zgdzdx_xszz.do?method=zqhhkxysh&go=go')">
		              	查 询
		              </button>
		              &nbsp;&nbsp;&nbsp;&nbsp;
