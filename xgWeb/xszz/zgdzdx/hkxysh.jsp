		...
		<html:form action="/zgdzdx_xszz.do?method=hkxysh" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
			    ...
			    <ul>
				<li> <a href="#" onclick="tg('/xgxt/zgdzdx_xszz.do?method=hkxysh&go=pass');" class="btn_zj"> 通过 </a> </li>
			    <li> <a href="#" onclick="btg('/xgxt/zgdzdx_xszz.do?method=hkxysh&go=notPass');" class="btn_xg"> 不通过 </a> </li>
				<li> <a href="#" onclick="del('/xgxt/zgdzdx_xszz.do?method=hkxysh&go=del');" class="btn_sc"> 删除 </a> </li>
