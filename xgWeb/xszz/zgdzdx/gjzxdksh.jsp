		...
		<html:form action="/zgdzdx_xszz.do?method=gjzxdksh" method="post">
			...
			<div class="toolbox">
				 ...
				 <div class="buttonbox">
					...
					<li> <a href="#" onclick="refreshForm('/xgxt/zgdzdx_xszz.do?method=gjzxdksq');" class="btn_zj"> 增加 </a> </li>
				    <li> <a href="#" onclick="modi('/xgxt/zgdzdx_xszz.do?method=gjzxdksq');" class="btn_xg"> 修改 </a> </li>
				    </logic:equal>
					<li> <a href="#" onclick="del('/xgxt/zgdzdx_xszz.do?method=gjzxdksh&go=del');" class="btn_sc"> 删除 </a> </li>
			    ...
			    <span>
			    	...
			    	<logic:empty name="rs">
			 		 ...
			 		 <logic:notEmpty name="rs">
						...
						${rsNum}
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<font color="blue">提示：双击一行可以查看并审核一条记录；单击表头可以排序</font>
			 		 </logic:notEmpty>
			    </span>
			    </h3>
