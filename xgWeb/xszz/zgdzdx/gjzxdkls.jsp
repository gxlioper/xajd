...
function dataExport2() {
	document.forms[0].action = "/xgxt/zgdzdx_xszz.do?method=gjzxdklsExp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/zgdzdx_xszz.do?method=gjzxdkls" method="post">
			<div class="tab_cur">
				<p class="location">
				          ...
				          <td colspan="6">
				            <div class="btn">
				              ...
				              <button type="button" class="btn_cx" id="search_go" 
				              	onclick="allNotEmpThenGo('/xgxt/zgdzdx_xszz.do?method=gjzxdkls&go=go')">
				              	查 询
				              </button>
				              &nbsp;&nbsp;&nbsp;&nbsp;
							...
							<table summary="" class="dateline" align="" width="100%">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/zgdzdx_xszz.do?method=gjzxdklsOne')"
