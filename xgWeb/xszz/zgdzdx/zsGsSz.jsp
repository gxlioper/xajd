	...
	<body id="noticeprint">
		<script type="text/javascript">
			...
			<html:form action="/zgdzdx_xszz.do" method="post">
				...
				<div class="dayin">
					<div class="xingming1"
						style="position: absolute;top:200px;left:70px;" id="0"
						onclick="clickEven(this);setFont(this.id)">
						{姓名}
					</div>
					<div class="xingming2"
						style="position: absolute;top:300px;left:300px;" id="1"
						onclick="clickEven(this);setFont(this.id)">
						{学年}
					</div>
					<div class="xi1" id="2"
				   ...
				   <div class="xi1" id="4"
						style="position: absolute;top:457px;left:210px;"
						onclick="clickEven(this);setFont(this.id)">
						{年}
					</div>
					<div class="xi1" id="5"
						style="position: absolute;top:457px;left:300px;"
						onclick="clickEven(this);setFont(this.id)">
						{月}
					</div>
					<div class="xi1" id="6"
						style="position: absolute;top:457px;left:350px;"
						onclick="clickEven(this);setFont(this.id)">
						{日}
					</div>					
					<br>
					<center>
						<div class="noPrin noprint"
							style="position:absolute;top:10px;left:100px;font-size: 15px">
							项目：
							<html:select property="xmdm" onchange="refreshForm('/xgxt/zgdzdx_xszz.do?method=zsGsSz&xmdmV='+$('xmdm').value)">
							...
							<input type='button' class='button2' value='保存'
								onclick="getResult();refreshForm('/xgxt/zgdzdx_xszz.do?method=zsGsSz&act=save');this.disabled=true">
						</div>						
					</center>
				</div>
			</html:form>		
