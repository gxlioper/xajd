...
function del(){
	...
	var url = "/xgxt/zgdzdx_xszz.do?method=jzxj_xmjeDel";
...
function add(){
	var url = "/xgxt/zgdzdx_xszz.do?method=jzxj_xmjeEdit";
	url += "&act=add";
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/zgdzdx_xszz.do?method=jzxj_xmjewh" method="post">
		<div class="tab_cur">
				<p class="location">
		          ...
		          <td colspan="6">
		            <div class="btn">
		              <button type="button" class="btn_cx" id="search_go"
										onclick="refreshForm('zgdzdx_xszz.do?method=jzxj_xmjewh&go=go');">
										查询
									</button>
			    ...
			    <tbody>
				 <logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/zgdzdx_xszz.do?method=jzxj_xmjeEdit')">
									<td align="">
