...
function dataExport2() {
	document.forms[0].action = "/xgxt/new_common_xszz.do?method=xszzshExp";
...
function queryOne() {
	...
	var xh = curr_row.getElementsByTagName("input")[3].value;
	var url = "/xgxt/stu_info_details.do?xh="+xh;
	showTopWin(url, 800, 600);
}
		</script>
		<html:form action="/new_common_xszz.do?method=xszzsh" method="post">
			<div class="title">
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/new_common_xszz.do?method=xszzsh')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/new_common_xszz.do?method=xszzsh')">
										查询
									</button>
								</td>
							</tr>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/new_common_xszz.do?method=xszzshXxxx','view')">
									<td align="center">
							...
							<logic:equal name="isQuery" value="is">
								<logic:equal name="xxmc" value="zgkydx">
    ...
    <bean:write name="v"/>
     ...
     "
										ondblclick="chkAssisOne('/xgxt/new_common_xszz.do?method=xszzsq','view')">
										<td align="center">
											<logic:iterate id="v" name="s" offset="1" length="1">
												<input type="checkbox" name="pk"
													value="<bean:write name="v"/>">
										...
										<logic:iterate id="v" name="s" offset="6" length="1">
											<td align=center>
												<a href="#" onclick="queryOne()"> <bean:write name="v" />
													<input type="hidden" value="<bean:write name="v"/>" /> </a>
											</td>
										</logic:iterate>
								...
								<logic:notEqual name="xxmc" value="zgkydx">
									<tr onclick="rowOnClick(this)"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="0" length="1">
    <bean:write name="v"/>
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/new_common_xszz.do?method=xszzsq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
							onclick="modi('/xgxt/new_common_xszz.do?method=xszzsq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button class="button2"
							onclick="pass('/xgxt/new_common_xszz.do?method=xszzshXxxx&actDo=pass');"
							style="width:80px">
							通 过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="notPass('/xgxt/new_common_xszz.do?method=xszzshXxxx&actDo=notPass');"
							style="width:80px">
							不通过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/new_common_xszz.do?method=xszzshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
