...
function plsz(){
	...
	var url = "/xgxt/new_common_xszz.do?method=zzsjPlsz";
	url += "&pkDel=" + RowsStr;
...
function dgsz(){
	var url = "/xgxt/new_common_xszz.do?method=zzsjEdit";
...
function csh(){
	var url = "/xgxt/new_common_xszz.do?method=zzsjcsh";
    ...
    document.forms[0].submit();
		...
		<html:form action="/new_common_xszz.do?method=data_zzsj" method="post">
							...
							<tr>
								...
								<input type="hidden" name="go" value="a"/>
									<button class="button2" id="search_go"
										onclick="refreshForm('new_common_xszz.do?method=data_zzsj&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/new_common_xszz.do?method=zzsjEdit')">
									<td align="center">
