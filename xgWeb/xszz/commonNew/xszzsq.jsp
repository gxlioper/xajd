...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			var zycjpm = document.getElementById('zycjpm').value;
			...
			document.forms[0].action = "/xgxt/new_common_xszz.do?method=xszzsq&act=save";
		...
		function chang(){
			document.forms[0].action = "/xgxt/new_common_xszz.do?method=xszzsq";
			document.forms[0].submit();
		}
	</script>
</head>
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="new_common_xszz.do?method=xszzsq" method="post">
			...
			<table class="tbstyle" width="90%">
				...
				<tr>
					<td colspan="2" scope="row">
						<div align="center">
							<font color="red">*</font>专业成绩排名
						</div>
					</td>
					<td colspan="3">
						<input type="text" id="zycjpm" name="zycjpm" style="width:100%;heigh:100%" maxlength="5"
							value="<bean:write name='rs' property="zycjpm" />"
							onkeyup="value=value.replace(/[^\d]/g,'') "
							onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
					</td>
					<td>
					...
					<td colspan="3">
						...
						<input type="hidden" id="zyrs" name="zyrs"
							value="<bean:write name='rs' property="zyrs"/>">
					</td>
				</tr>
				<tr>
					<td colspan="2" scope="row">
						<div align="center">
							<font color="red">*</font>不及格科目数
						</div>
					</td>
					<td colspan="3">
						<input type="text" id="bjgmc" name="bjgmc" style="width:100%;heigh:100%" maxlength="3"
