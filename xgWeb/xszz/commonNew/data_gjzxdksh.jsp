...
function dataExport2() {
	document.forms[0].action = "/xgxt/new_common_xszz.do?method=gjzxdkshExp";
...
function queryOne(xh) {
	...
	showTopWin(url, 800, 600);
		...
		<html:form action="/new_common_xszz.do?method=gjzxdksh" method="post">
			<div class="title">
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/new_common_xszz.do?method=gjzxdksh')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/new_common_xszz.do?method=gjzxdksh')">
										查询
									</button>
								</td>
							</tr>
						...
						<logic:iterate name="rs" id="s">
							<logic:equal name="isQuery" value="no">
								<tr onclick="rowOnClick(this)"
									...
									ondblclick="chkAssisOne('/xgxt/new_common_xszz.do?method=gjzxdkshXxxx','view')">
									<td align="center">
							...
							<logic:equal name="isQuery" value="is">
								...
								<tr onmouseover="rowOver(this);"
									onmouseout="rowOut();"
									onclick="rowOnClick(this)"
									style="cursor:hand;background-color:<logic:iterate id="v" name="s" offset="0" length="1"><bean:write name="v"/></logic:iterate>"
									ondblclick="chkAssisOne('/xgxt/new_common_xszz.do?method=gjzxdksq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/new_common_xszz.do?method=gjzxdksq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
							onclick="modi('/xgxt/new_common_xszz.do?method=gjzxdksq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button class="button2"
							onclick="pass('/xgxt/new_common_xszz.do?method=gjzxdkshXxxx&actDo=pass');"
							style="width:80px">
							通 过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="notPass('/xgxt/new_common_xszz.do?method=gjzxdkshXxxx&actDo=notPass');"
							style="width:80px">
							不通过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/new_common_xszz.do?method=gjzxdkshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
