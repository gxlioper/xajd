...
function del(){
	...
	var url = "/xgxt/new_common_xszz.do?method=zzbbzdyzdDel";
...
function add(){
	var url = "/xgxt/new_common_xszz.do?method=zzbbzdyzdEdit";
	url += "&act=add";
...
function edit(){
	...
	return showTopWin(url,500,300);
		...
		<html:form action="/new_common_xszz.do?method=data_zzbbzdyzd" method="post">
			<div class="title">
							...
							<tr>
								...
								<input type="hidden" name="go" value="a"/>
									<button class="button2" id="search_go"
										onclick="refreshForm('new_common_xszz.do?method=data_zzbbzdyzd&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/new_common_xszz.do?method=zzbbzdyzdEdit')">
									<td align="center">
