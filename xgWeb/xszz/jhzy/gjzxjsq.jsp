...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			document.forms[0].action = "/xgxt/jhzyjsxy_xszz.do?method=gjzxjsqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/jhzyjsxy_xszz.do?method=gjzxjsqb";
			document.forms[0].submit();
		}
		function changeSr(){
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="jhzyjsxy_xszz.do?method=gjzxjsq" method="post">
			<input type="hidden" id="url" name="url" value="/jhzyjsxy_xszz.do?method=gjzxjsq" />
			...
			<table class="tbstyle" width="90%">
				...
				<tr>
					...
					<td>
						<input type="text" id="jtcy1_gx" name="jtcy1_gx" maxlength="25"
							style="width:100%;heigh:100%" 
				...
				<tr>
					...
					<td>
						<input type="text" id="jtcy2_gx" name="jtcy2_gx" maxlength="25"
							style="width:100%;heigh:100%" 
				...
				<tr>
					...
					<td>
						<input type="text" id="jtcy3_gx" name="jtcy3_gx" maxlength="25"
							style="width:100%;heigh:100%" 
				...
				<tr>
					...
					<td>
						<input type="text" id="jtcy4_gx" name="jtcy4_gx" maxlength="25"
							style="width:100%;heigh:100%" 
				...
				<tr>
					...
					<td>
						<input type="text" id="jtcy5_gx" name="jtcy5_gx" maxlength="25"
							style="width:100%;heigh:100%" 
				...
				<div class="buttontool" id="btn" style="position: absolute;width:90%">
					...
					<button type="button" class="button2"
						onClick="toPrintOut();" id="buttonPrint">
						打&nbsp;&nbsp;&nbsp;&nbsp;印
					</button>
				</div>
		</html:form>
