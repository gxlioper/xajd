...
function dataExport2() {
	document.forms[0].action = "/xgxt/jhzyjsxy_xszz.do?method=knsExp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/jhzyjsxy_xszz.do?method=knssh" method="post">
			<div class="title">
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/jhzyjsxy_xszz.do?method=knssh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/jhzyjsxy_xszz.do?method=knssq&type=modi')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/jhzyjsxy_xszz.do?method=knsshOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="1" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
								...
								<TR>
									<TD>
										<jsp:include flush="true"
											page="/sjcz/turnpage.jsp?form=xszzJhzyjsxyActionForm"></jsp:include>
									</TD>
								</TR>
								<TR>
									<TD height=3></TD>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/jhzyjsxy_xszz.do?method=knssq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/jhzyjsxy_xszz.do?method=knssq&type=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button type="button" class="button2" onclick="kn('/xgxt/jhzyjsxy_xszz.do?method=knssh&go=kn');"
								style="width:80px">
								困 难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="tskn('/xgxt/jhzyjsxy_xszz.do?method=knssh&go=tskn');"
								style="width:80px">
								特殊困难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="bkn('/xgxt/jhzyjsxy_xszz.do?method=knssh&go=bkn');"
								style="width:80px">
								不困难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button type="button" class="button2" onclick="del('/xgxt/jhzyjsxy_xszz.do?method=knssh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
