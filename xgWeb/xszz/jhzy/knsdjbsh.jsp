...
function dataExport2() {
	document.forms[0].action = "/xgxt/jhzyjsxy_xszz.do?method=knsdjbExp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/jhzyjsxy_xszz.do?method=knsdjbsh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 结果查询 - 困难生认定
				</div>
			</div>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/jhzyjsxy_xszz.do?method=knsdjbsh&go=go')">
									查询
								</button>
							</td>
						</tr>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/jhzyjsxy_xszz.do?method=knsdjb&type=modi')"
										style="cursor:hand;">
										<td align=center>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" onclick="add('/xgxt/jhzyjsxy_xszz.do?method=knsdjb');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/jhzyjsxy_xszz.do?method=knsdjb&type=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="del('/xgxt/jhzyjsxy_xszz.do?method=knsdjbsh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
