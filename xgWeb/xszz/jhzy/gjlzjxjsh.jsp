...
function dataExport2() {
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/jhzyjsxy_xszz.do?method=gjlzjxjsh" method="post">
			<div class="title">
					...
					<thead>
						<tr>
							<td align="left">
								年度：
								<logic:equal name="isQuery" value="is">
									<html:select property="nd" style="width:60px" styleId="xn">
								...
								<html:text property="xm" styleId="xm"
									style="width:60px;inputtext" styleClass="inputtext"></html:text>
								性别：
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsh&go=go')">
									查询
								</button>
							</td>
						</tr>
								...
								<logic:iterate name="rs" id="s">
									<logic:equal name="isQuery" value="is">
										<tr onclick="rowOnClick(this)"
											ondblclick="chkAssisOne('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsq&type=modi')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
										<tr onclick="rowOnClick(this)"
											ondblclick="chkAssisOne('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjshOne')"
											style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="1" length="1">
    <bean:write name="v"/>
    </logic:iterate>">
						...
						<div class="buttontool" align="center" id="btn"
							...
							<logic:equal name="isQuery" value="is">
								<button type="button" class="button2"
									onclick="add('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsq&type=add');"
									style="width:80px">
									增 加
								</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
									onclick="modi('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsq&type=modi');"
									style="width:80px">
									修 改
								</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
								<button type="button" class="button2"
									onclick="tg('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsh&go=tg');"
									style="width:80px">
									通 过
								</button>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
									onclick="btg('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsh&go=btg');"
									style="width:80px">
									不通过
								</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<button type="button" class="button2"
								onclick="del('/xgxt/jhzyjsxy_xszz.do?method=gjlzjxjsh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
