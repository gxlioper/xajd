	...
	<body onload="xyDisabled('xy');initNdList();initNjList();initOnLoadXyList();">
		<html:form action="/xszz_ynys.do" method="post">
			...
			<input type="hidden" id="isBzr" name="isBzr" value="${isBzr}"/>
				 <!-- 解决<bean:message key="lable.xsgzyxpzxy" />用户disabled 字段不能提交 -->			
							...
							<td align="left">
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/xszz_ynys.do?method=gjlzjxjwh&go=go&doType=search')">
										查询
									</button>
								</td>
							</logic:notEmpty>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)" 
										...
										ondblclick="chkAssisOne('/xgxt/xszz_ynys.do?method=gjlzjxjpre&doType=view')">
										<td align=center>
										<logic:notEmpty name="form" property="sqms">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
						...
						<logic:equal value="true" name="form" property="sqms">
							<button type="button" class="button2" onclick="add('/xgxt/xszz_ynys.do?method=gjlzjxjpre&sqms=true');"
								style="width:80px">
								增 加
							</button>&nbsp;&nbsp;&nbsp;&nbsp;
						</logic:equal>	
							<button type="button" class="button2" onclick="modi('/xgxt/xszz_ynys.do?method=gjlzjxjpre&doType=modi');"
								style="width:80px">
								修 改
							</button>&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="del('/xgxt/xszz_ynys.do?method=gjlzjxjwh&doType=del');"
								style="width:80px">
								删 除
							</button>&nbsp;&nbsp;&nbsp;&nbsp;
