...
function dataExport2() {
	document.forms[0].action = "/xgxt/csmz_xszz.do?method=gjlzjxjshExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/csmz_xszz.do?method=gjlzjxjsh" method="post">
			<div class="title">
						...
						<logic:equal name="isQuery" value="is">
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/csmz_xszz.do?method=gjlzjxjsh')">
									...
									<html:select name="rs1" property="zydm" style="width:180px"
										styleId="zy"
										onchange="refreshForm('/xgxt/xgxt/csmz_xszz.do?method=gjlzjxjsh')">
										<html:option value=""></html:option>
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/csmz_xszz.do?method=gjlzjxjsh')">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学年：
									<html:select name="rs1" property="xn" style="width:160px">
										<html:option value=""></html:option>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/csmz_xszz.do?method=gjlzjxjshXxxx','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/csmz_xszz.do?method=gjlzjxjsq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/csmz_xszz.do?method=gjlzjxjsq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
							onclick="modi('/xgxt/csmz_xszz.do?method=gjlzjxjsq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button class="button2"
							onclick="pass('/xgxt/csmz_xszz.do?method=gjlzjxjshXxxx&actDo=pass');"
							style="width:80px">
							通 过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="notPass('/xgxt/csmz_xszz.do?method=gjlzjxjshXxxx&actDo=notPass');"
							style="width:80px">
							不通过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/csmz_xszz.do?method=gjlzjxjshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
