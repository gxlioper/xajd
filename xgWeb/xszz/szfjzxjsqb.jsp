...
<body>
	<html:form action="szfjzxjsqb.do" method="post">
		<input type="hidden" id="titleName"
			value="<bean:write name="sqlb"  />申请表" />
	...
	<div align=center>
		<input  value="打印"
			onclick="expTab('theTable',document.getElementById('titleName').value);" />
	</div>
</body>
</html:html>
