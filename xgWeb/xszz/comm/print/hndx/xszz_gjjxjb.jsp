...
style='font-size:22.0pt;font-family:宋体;letter-spacing:1.0pt'>国家奖学金申请审批表</span></b></p> 
  ...
  <div align=center><b>&nbsp;&nbsp;&nbsp;学校：</b>海南大学&nbsp;&nbsp;&nbsp; <b>院系：</b>${rs.xymc }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>专业：</b>${rs.zymc }&nbsp;&nbsp;&nbsp;&nbsp;
<b>班级：</b>${rs.bjmc }</div> 
  ...
  <table  class="tbstyle" border="0" align="center" style="width: 90%"> 
    ...
    <tr> 
      ...
      <td colspan="19"> <p>本学年必修课程数<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${rs.bxkms}</u>门，其中，优秀<u>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;${rs.yxkms}</u>门，良好<u>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;${rs.lhkms}</u>门
		<p>成绩排名（专业或年级）：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${rs.xnzypm}<logic:notEmpty name="rs" property="xnzypm">/${rs.zyzrs}</logic:notEmpty> </u>（名次/总人数）</p> 
