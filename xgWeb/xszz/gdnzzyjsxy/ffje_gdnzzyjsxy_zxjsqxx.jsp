...
function dataExport2() {
						...
						<tr>
							<td align="left">
								...
								<html:select name="rs1" property="xydm" style="width:180px" styleId="xy"
										onchange="refreshForm('/xgxt/ffje_gdnzzyjsxy_zxjsqxx.do')">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/ffje_gdnzzyjsxy_zxjsqxx.do')">
									查询
								</button>
							</td>
						</tr>
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/ffje_gdnzzyjsxy_zxjsqxx_one.do','view')">
								<td align="center">
			...
			<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" onclick="del('/xgxt/ffje_gdnzzyjsxy_zxjsqxx_one.do?actDo=more');"
								style="width:80px">
								批量发放
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
