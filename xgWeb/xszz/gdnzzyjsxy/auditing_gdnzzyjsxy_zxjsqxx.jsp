...
function dataExport2() {
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							<td align="left">
								...
								<html:select name="rs1" property="xydm" style="width:180px" styleId="xy"
										onchange="refreshForm('/xgxt/auditing_gdnzzyjsxy_zxjsqxx.do')">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/auditing_gdnzzyjsxy_zxjsqxx.do')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left">
								&nbsp;助学金项目：
								<html:select name="rs1" property="zxjdm1" style="width:180px" styleId="zxjdm1">
										<html:option value=""></html:option>
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/auditing_gdnzzyjsxy_zxjsqxx_one.do','view')">
								<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/gdnzzyjsxy_zxjsqxx.do','view')">
								<td align="center">
											<logic:iterate id="v" name="s" offset="1" length="1">
												<input type="checkbox" name="pk" value="<bean:write name="v"/>">
											</logic:iterate>
			...
			<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
					<center>
						<div class="buttontool" id="btn"
							...
							<logic:equal name="isQuery" value="is">
							<button class="button2" onclick="add('/xgxt/gdnzzyjsxy_zxjsqxx.do');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/gdnzzyjsxy_zxjsqxx.do');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:equal>
							<button class="button2" onclick="del('/xgxt/auditing_gdnzzyjsxy_zxjsqxx_one.do?actDo=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
