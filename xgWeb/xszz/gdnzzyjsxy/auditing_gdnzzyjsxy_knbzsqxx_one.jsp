	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			if(xyshyj != null){
			 ...
			 refreshForm('/xgxt/auditing_gdnzzyjsxy_knbzsqxx_one.do?actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
