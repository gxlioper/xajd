	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			if(xyshyj != null){
			 ...
			 refreshForm('/xgxt/auditing_gdnzzyjsxy_zxjsqxx_one.do?actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
			...
			<table width="98%" align="center" class="tbstyle">
				...
				<tr>
					...
					<td align="left" width="34%">
						<bean:write name="rs" property="zzmc" />
					</td>
					...
					<td width="34%" scope="col">
						<bean:write name="rs" property="zzze" />
					</td>
				</tr>
				<tr>
					<td align="center" width="16%">
					...
					<td align="left" width="34%">
						<bean:write name="rs" property="zzgrje" />
					</td>
					<td width="16%" scope="col">
						<div align="center">
							年度
