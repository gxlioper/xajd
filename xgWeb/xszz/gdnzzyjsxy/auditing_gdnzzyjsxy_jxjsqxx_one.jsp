	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			if(xyshyj != null){
			 ...
			 refreshForm('/xgxt/auditing_gdnzzyjsxy_jxjsqxx_one.do?actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
			...
			<table width="98%" align="center" class="tbstyle">
				...
				<tr>
					...
					<td width="34%" scope="col">
						<bean:write name="rs" property="bjdw" />
					</td>
				</tr>
				<tr>
					<td align="center" width="16%">
				...
				<tr>
					...
					<td align="left" width="34%">
						<bean:write name="rs" property="jlze" />
					</td>
					<td width="16%" scope="col">
						<div align="center">
							年度
