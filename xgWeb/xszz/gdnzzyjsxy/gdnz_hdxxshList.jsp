...
function dataExport2() {
	document.forms[0].action = "/xgxt/gnnzzy_gjzxdk.do?method=hdxxExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/gnnzzy_gjzxdk.do?method=hdxxshList" method="post">
			<div class="title">
						...
						<logic:equal name="isQuery" value="is">
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/gnnzzy_gjzxdk.do?method=hdxxshList')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/gnnzzy_gjzxdk.do?method=hdxxshList')">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td>
									...
									&nbsp;&nbsp;合同号：
									<input type="text" id="hth" name="hth" maxlength="30"
										style="width:100px;heigh:100%"
							...
							<logic:equal name="isQuery" value="no">
								<tr onclick="rowOnClick(this)"
								    ...
								    <bean:write name="v"/>
								     ...
								     "
									ondblclick="chkAssisOne('/xgxt/gnnzzy_gjzxdk.do?method=hdxxshXxxx','view')">
									<td align="center">
							...
							<logic:equal name="isQuery" value="is">
								<tr onclick="rowOnClick(this)"
								    ...
								    <bean:write name="v"/>
								     ...
								     "
									ondblclick="chkAssisOne('/xgxt/gnnzzy_gjzxdk.do?method=hdxxsq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/gnnzzy_gjzxdk.do?method=hdxxsq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
							onclick="modi('/xgxt/gnnzzy_gjzxdk.do?method=hdxxsq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/gnnzzy_gjzxdk.do?method=hdxxshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
