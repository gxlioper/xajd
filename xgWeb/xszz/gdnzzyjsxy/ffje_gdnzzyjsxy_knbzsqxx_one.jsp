...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		<script language="javascript">
		function yz(){
			 refreshForm('/xgxt/ffje_gdnzzyjsxy_knbzsqxx_one.do?actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
