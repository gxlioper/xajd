...
function dataExport2() {
	document.forms[0].action = "/xgxt/gnnzzy_gjzxdk.do?method=zxdkExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/gnnzzy_gjzxdk.do?method=zxdkshList" method="post">
			<div class="title">
						...
						<logic:equal name="isQuery" value="is">
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/gnnzzy_gjzxdk.do?method=zxdkshList')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/gnnzzy_gjzxdk.do?method=zxdkshList')">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td>
									...
									&nbsp;&nbsp;合同编号：
									<input type="text" id="htbh" name="htbh" maxlength="30"
										style="width:100px;heigh:100%"
										value="<bean:write name="rs1" property="htbh"/>"
										onkeyup="value=value.replace(/[\W]/g,'') "
										onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
									&nbsp;&nbsp;审批表编号：
									<input type="text" id="spbbh" name="spbbh" maxlength="30"
										style="width:100px;heigh:100%"
										value="<bean:write name="rs1" property="spbbh"/>">
								</td>
							</tr>
						</logic:equal>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/gnnzzy_gjzxdk.do?method=zxdkshXxxx','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/gnnzzy_gjzxdk.do?method=zxdksq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
				...
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/gnnzzy_gjzxdk.do?method=zxdksq');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
							onclick="modi('/xgxt/gnnzzy_gjzxdk.do?method=zxdksq');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button class="button2"
							onclick="pass('/xgxt/gnnzzy_gjzxdk.do?method=zxdkshXxxx&actDo=pass');"
							style="width:80px">
							通 过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
							onclick="notPass('/xgxt/gnnzzy_gjzxdk.do?method=zxdkshXxxx&actDo=notPass');"
							style="width:80px">
							不通过
						</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/gnnzzy_gjzxdk.do?method=zxdkshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
