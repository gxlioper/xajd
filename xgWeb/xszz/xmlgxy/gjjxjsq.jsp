...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			document.forms[0].action = "/xgxt/xmlgxy_xszz.do?method=gjjxjsqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/xmlgxy_xszz.do?method=gjjxjsqb";
			document.forms[0].submit();
		}
	</script>
</head>
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="xmlgxy_xszz.do?method=gjjxjsq" method="post">
			<input type="hidden" id="url" name="url" value="/xmlgxy_xszz.do?method=gjjxjsq" />
