...
function dataExport2() {
	document.forms[0].action = "/xgxt/xmlgxy_xszz.do?method=gjlzjxjExp";
...
function gsmd(){
	...
	if((xn == null) || (xn == "")){
		alert("请选择需要导出公示名单的学年!");
		return false;
	}
	
	document.forms[0].action = "/xgxt/xmlgxy_xszz.do?method=gjlzjxjgsmd&xn="+xn;
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/xmlgxy_xszz.do?method=gjlzjxjsh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					<logic:equal name="isQuery" value="is">
					当前所在位置：学生资助 - 申请结果查询 - 国家励志奖学金
					</logic:equal>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsq&type=modi')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/xmlgxy_xszz.do?method=gjlzjxjshOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="1" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
								...
								<TR>
									<TD>
										<jsp:include flush="true"
											page="/sjcz/turnpage.jsp?form=xszzXmlgxyActionForm"></jsp:include>
									</TD>
								</TR>
								<TR>
									<TD height=3></TD>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsq&type=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button type="button" class="button2" onclick="tg('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsh&go=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="btg('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsh&go=btg');"
								style="width:80px">
								不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button type="button" class="button2" onclick="del('/xgxt/xmlgxy_xszz.do?method=gjlzjxjsh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="gsmd()" style="width:80px">
								公示名单
							</button>
						</div>
					</logic:equal>
