...
<script language="javascript">
		function back(){
			document.forms[0].action = "/xgxt/xmlgxy_xszz.do?method=gjjxjsq";
				...
				<td scope="col">
					<table width="100%" class="tbstyle">
						...
						<tr>
							...
							<td colspan="19">
								该学年必修课程
								<u>&nbsp; <logic:empty name='rs' property="gxnbxkcs">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="gxnbxkcs">
										<bean:write name='rs' property="gxnbxkcs" />
									</logic:notEmpty> &nbsp;</u>门，其中，优秀
								<u>&nbsp; <logic:empty name='rs' property="yxkcs">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="yxkcs">
										<bean:write name='rs' property="yxkcs" />
									</logic:notEmpty> &nbsp;</u>门,良好
								<u>&nbsp; <logic:empty name='rs' property="lhkcs">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="lhkcs">
										<bean:write name='rs' property="lhkcs" />
									</logic:notEmpty> &nbsp;</u>门
								<br />
								<br />
								成绩排名（专业或年级）：
								<u>&nbsp;&nbsp; <logic:empty name='rs' property="cjpm">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="cjpm">
										<bean:write name='rs' property="cjpm" />
									</logic:notEmpty> &nbsp;&nbsp;</u>（名次/总人数）
								<br />
								<br />
								综合考评成绩
								<u>&nbsp; <logic:empty name='rs' property="zhkpcj">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="zhkpcj">
										<bean:write name='rs' property="zhkpcj" />
									</logic:notEmpty> &nbsp;</u>分，排名（专业、年级）
								<u>&nbsp;&nbsp; <logic:empty name='rs' property="zhkppm">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="zhkppm">
										<bean:write name='rs' property="zhkppm" />
									</logic:notEmpty> &nbsp;&nbsp;</u>（名次/总人数）（如无此项，填写“无”）
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="19">
								...
								<br />
								其中，院级奖励
								<u>&nbsp; <logic:empty name='rs' property="yjjl">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="yjjl">
										<bean:write name='rs' property="yjjl" />
									</logic:notEmpty> &nbsp;</u>项；校级奖励
								<u>&nbsp; <logic:empty name='rs' property="xjjl">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="xjjl">
										<bean:write name='rs' property="xjjl" />
									</logic:notEmpty> &nbsp;</u>项；省级以上奖励
								<u>&nbsp; <logic:empty name='rs' property="sjjl">
									&nbsp;&nbsp;&nbsp;&nbsp;
								</logic:empty> <logic:notEmpty name='rs' property="sjjl">
