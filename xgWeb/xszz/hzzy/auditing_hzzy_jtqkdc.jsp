...
function dataExport2() {
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							<td align="left">
								...
								<html:select name="rs1" property="xydm" style="width:180px" styleId="xy"
										onchange="refreshForm('/xgxt/auditing_hzzy_jtqkdc.do')">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/auditing_hzzy_jtqkdc.do')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left">
								年级：
								<html:select name="rs1" property="nj" onchange="refreshForm('/xgxt/auditing_hzzy_jtqkdc.do')">
									<html:option value=""></html:option>
								...
								styleClass="inputtext"></html:text>
								困难等级：
								<html:select name="rs1" property="kndj">
									<html:option value=""></html:option>
						...
						<tr>
							<td align="left" colspan="2">
								通讯地址：
								<html:text name="rs1" property="xxtxdz" styleId="xxtxdz" style="width:330px;inputtext" maxlength="140"
								styleClass="inputtext"></html:text>
							</td>
						</tr>
					</thead>
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/auditing_hzzy_jtqkdc_one.do','view')">
								<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
								ondblclick="chkAssisOne('/xgxt/hzzy_jtqkdc.do','view')">
								<td align="center">
											<logic:iterate id="v" name="s" offset="1" length="1">
												<input type="checkbox" name="pk" value="<bean:write name="v"/>">
											</logic:iterate>
			...
			<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
					<center>
						<div class="buttontool" id="btn"
							...
							<logic:equal name="isQuery" value="is">
							<button type="button" class="button2" onclick="add('/xgxt/hzzy_jtqkdc.do');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/hzzy_jtqkdc.do');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:equal>
							<button type="button" class="button2" onclick="del('/xgxt/auditing_hzzy_jtqkdc_one.do?actDo=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
