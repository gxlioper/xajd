...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			refreshForm('/xgxt/auditing_hzzy_jqzx_one.do?actDo=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
		...
		<html:form action="/data_search" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 审核 - 开发区慈善总会"金秋助学"救助学生审核 - 单个审核
				</div>
			</div>
