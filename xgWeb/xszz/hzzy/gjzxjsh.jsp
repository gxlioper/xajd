...
function dataExport2() {
	document.forms[0].action = "/xgxt/hzzyjsxy_xszz.do?method=gjzxjExp";
	...
	<body onload="xyDisabled('xy');">
		...
		<html:form action="/hzzyjsxy_xszz.do?method=gjzxjsh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					<logic:equal name="isQuery" value="is">
					当前所在位置：学生资助 - 申请结果查询 - 国家助学金
					</logic:equal>
					<logic:notEqual name="isQuery" value="is">
					当前所在位置：学生资助 - 审核 - 国家助学金
					</logic:notEqual>
				</div>
			</div>
					...
					<thead>
						<tr>
							<td align="left">
								...
								姓名：
								<html:text property="xm" styleId="xm" style="width:60px;inputtext"
								styleClass="inputtext"></html:text>
								性别：
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsh&go=go')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left" nowrap>
								...
								专业：
								<html:select property="zydm" onchange="initBjList()" style="width:170px" styleId="zy">
									<html:option value=""></html:option>
								...
								助学金等级：
								<html:select property="zxjdj">
									<html:option value=""></html:option>
									<html:option value="一等助学金">一等</html:option>
									<html:option value="二等助学金">二等</html:option>
								</html:select>
							</td>
						</tr>
						<tr>
							<td align="left" nowrap colspan="2">
								...
								家庭住址：
								<html:text property="jtzz" styleId="jtzz" style="width:330px;inputtext" maxlength="200"
								styleClass="inputtext"></html:text>
							</td>
						</tr>
					</thead>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsq')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/hzzyjsxy_xszz.do?method=gjzxjshOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="0" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button class="button2" onclick="add('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsq');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button class="button2" onclick="tg('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsh&go=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsh&go=btg');"
								style="width:80px">
								不通过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							</logic:notEqual>
							<button class="button2" onclick="del('/xgxt/hzzyjsxy_xszz.do?method=gjzxjsh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
