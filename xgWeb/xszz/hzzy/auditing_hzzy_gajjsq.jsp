...
function dataExport2() {
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/auditing_hzzy_gajjsq.do')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/auditing_hzzy_gajjsq.do')">
										查询
									</button>
								</td>
							</tr>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/auditing_hzzy_gajjsq_one.do','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/hzzy_gajjsq.do','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button type="button" class="button2" onclick="add('/xgxt/hzzy_gajjsq.do');"
							style="width:80px">
							增 加
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modi('/xgxt/hzzy_gajjsq.do');"
							style="width:80px">
							修 改
						</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button type="button" class="button2"
						onclick="del('/xgxt/auditing_hzzy_gajjsq_one.do?actDo=del');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
