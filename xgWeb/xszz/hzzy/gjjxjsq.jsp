...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			if(xsjbqk != null){
	         	if(xsjbqk.replace(/[^\u0000-\u00ff]/g, "**").length > 2000){	         
	          		 alert("学生基本情况不能大于2000个字符");
	          		 return false;
	       		 }
	       	}
			document.forms[0].action = "/xgxt/hzzyjsxy_xszz.do?method=gjjxjsqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/hzzyjsxy_xszz.do?method=gjjxjsqb";
			document.forms[0].submit();
		}
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="hzzyjsxy_xszz.do?method=gjjxjsq" method="post">
			<input type="hidden" id="url" name="url" value="/hzzyjsxy_xszz.do?method=gjjxjsq" />
