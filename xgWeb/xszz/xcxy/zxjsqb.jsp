	...
	<logic:equal name="sfksq" value="yes">
		<html:form action="xcxyXszz.do?method=getXmsq" method="post" enctype="multipart/form-data">
			...
			<table class="tbstyle" style="width:100%">
					...
					<td colspan="2" align="center">
						<logic:present name="rs" property="hkxz">
							<logic:match value="城镇" name="rs" property="hkxz">
								<input type="radio" name="hkxz" value="城镇" checked>&nbsp;&nbsp;A  城镇
							         	<input type="radio" name="hkxz" value="农村">&nbsp;&nbsp;B 农村
							         </logic:match>
							<logic:match value="农村" name="rs" property="hkxz">
								<input type="radio" name="hkxz" value="城镇">&nbsp;&nbsp;A  城镇
							         	<input type="radio" name="hkxz" value="农村" checked>&nbsp;&nbsp;B 农村
							         </logic:match>
						</logic:present>
				...
				<logic:equal value="国家助学金" name="zzxm" property="xmlc">
					<tr>
				...
				<tr>
					...
					<td colspan="4">
						...
						<logic:notPresent name="rs" property="chjl">
							<textarea name="chjl" rows='6' style="width:100%" id="chjl" type="_moz"><logic:iterate id="map" name="xszzList"><bean:write name="map" property="xn" />学年  获得<bean:write name="map" property="mc" />；</logic:iterate>
							</textarea>
						</logic:notPresent>
					</td>
				</tr>
				<tr>
					...
					<td colspan="4" style="vertical-align: text-top;">
						<logic:iterate id="map" name="xnxszzList">
							<bean:write name="map" property="xn" />学年  获得<bean:write name="map" property="mc" />；
						</logic:iterate>
					</td>
				</tr>
				<tr>
					...
					<td colspan="4" style="vertical-align: text-top;">
						<logic:iterate id="map" name="xnxswjcfList">
							<bean:write name="map" property="xn" />学年  <bean:write name="map" property="cfyymc" />  <bean:write name="map" property="cflbmc" />；
						</logic:iterate>
					</td>
				</tr>
				<tr>
