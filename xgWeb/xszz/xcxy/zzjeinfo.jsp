...
function del(){
	...
	if (!confirm("确定要删除所选资助项目的金额吗？")){
		return false;
	}
	var url = "/xgxt/xcxyXszz.do?method=zzjeDel";
...
function add(){
	var url = "/xgxt/xcxyXszz.do?method=zzjeEdit";
	url += "&doType=add";
	return showTopWin(url,370,260);
}
		...
		<html:form action="/xcxyXszz.do?method=zzxmInfo" method="post">
							...
							<tr>
								...
								<td width="50" rowspan="1" align="center" valign="middle">
									<button type="button" class="button2" id="search_go"
										onclick="refreshForm('xcxyXszz.do?method=zzxmJeInfo&doType=query');">
										查询
									</button>
								</td>
							</tr>
			...
			<center>
				<div class="buttontool" id="btn"
					style="position: absolute;left:1%;top:50px" width="100%">
