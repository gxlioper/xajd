...
function del(){
	...
	if (!confirm("删除资助项目会同时删除资助金额、时间设置,确定要删除所选资助项目以及相关数据？")){
		return false;
	}
	var url = "/xgxt/xcxyXszz.do?method=zzxmDel";
...
function add(){
	var url = "/xgxt/xcxyXszz.do?method=zzxmEdit";
	url += "&doType=add";
							...
							<tr>
								...
								<td width="50" rowspan="1" align="center" valign="middle">
									<button type="button" class="button2" id="search_go"
										onclick="refreshForm('xcxyXszz.do?method=zzxmInfo&doType=query');">
										查询
									</button>
								</td>
							</tr>
