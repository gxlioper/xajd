				...
				<div class="searchcontent">
					...
					<logic:equal value="yes" name="writeAble">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<button class="button2" onclick="dataBatch('n05_xszz.do?method=xfhj3Sh&shjg=通过&type=save')"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="dataBatch('n05_xszz.do?method=xfhj3Sh&shjg=不通过&type=save')"
								style="width:80px">
								不通过
							</button>							
						</div>
