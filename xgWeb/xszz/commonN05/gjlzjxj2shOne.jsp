...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			refreshForm('/xgxt/n05_xszz.do?method=gjlzjxj2shSave');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
		...
		<html:form action="/n05_xszz" method="post">
			...
			<tr>
				...
				<td>
					<bean:write name="rs" property="km1"/>
				</td>
				<td>
					<div align="center">
						成绩
				...
				<td>
					<bean:write name="rs" property="cj1"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<bean:write name="rs" property="km2"/>
				</td>
				<td>
					<div align="center">
						成绩
				...
				<td>
					<bean:write name="rs" property="cj2"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<bean:write name="rs" property="km3"/>
				</td>
				<td>
					<div align="center">
						成绩
				...
				<td>
					<bean:write name="rs" property="cj3"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<bean:write name="rs" property="km4"/>
				</td>
				<td>
					<div align="center">
						成绩
				...
				<td>
					<bean:write name="rs" property="cj4"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<bean:write name="rs" property="km5"/>
				</td>
				<td>
					<div align="center">
						成绩
				...
				<td>
					<bean:write name="rs" property="cj5"/>
				</td>
			</tr>
			<tr>
				<td>
