...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			document.forms[0].action = "/xgxt/n05_xszz.do?method=xfhj1sqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/n05_xszz.do?method=xfhj1sqb";
			document.forms[0].submit();
		}
	</script>
</head>
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="n05_xszz.do?method=xfhj1sq" method="post">
			<input type="hidden" id="url" name="url" value="/n05_xszz.do?method=xfhj1sq" />
			...
			<table class="tbstyle" width="90%">
				...
				<tr>
					...
					<td>
						<input type="text" id="hjje" maxlength="7" name="hjje"
							style="width:100%;heigh:100%"
					...
					<td>
						<input type="text" readonly style="cursor:hand;width:100%"
							...
							value="<bean:write name='rs' property="hjqx" />" name="hjqx"
							id="hjqx" />
					</td>
				</tr>
				<tr>
