	...
	<body>
		<center>
			...
			<html:form action="/n05_xszz" method="post">
				...
				<input type="hidden" id="tableName" name="tableName" value="view_xszz_hjqfmd" />
				<input type="hidden" id="realTable" name="realTable" value="view_xszz_hjqfmd" />
				<logic:empty name="rs">
					<br />
					<br />
					<p align="center">
								...
								<tr align="center" style="cursor:hand">
									<logic:iterate id="tit" name="topTr" offset="0" length="1">
										<td id="<bean:write name="tit" property="en"/>"
											onclick="tableSort(this)" nowrap width="6%">
									...
									<logic:iterate id="tit" name="topTr" offset="3" length="1">
										<td id="<bean:write name="tit" property="en"/>"
											onclick="tableSort(this)" nowrap width="20%">
											<bean:write name="tit" property="cn" />
										</td>
									...
									<logic:iterate id="tit" name="topTr" offset="5" length="1">
										<td id="<bean:write name="tit" property="en"/>"
											onclick="tableSort(this)" nowrap width="14%">
											<bean:write name="tit" property="cn" />
										</td>
									</logic:iterate>
