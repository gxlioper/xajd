	...
	<body>
		<center>
			...
			<html:form action="/n05_xszz" method="post">
				...
				<input type="hidden" id="tableName" name="tableName" value="view_xg_bks_wgqxfmd" />
				<input type="hidden" id="realTable" name="realTable" value="view_xg_bks_wgqxfmd" />
				<input type="hidden" id="qxfqj" name="qxfqj" value="${xn }" />
				<logic:empty name="rs">
					<br />
					<br />
					<p align="center">
