						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=xfhj3&go=go')">
									查询
								</button>
							</td>
						</tr>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="modi('/xgxt/n05_xszz.do?method=xfhj3Modi&type=view')"
					...
					<logic:equal value="yes" name="writeAble">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<button class="button2" onclick="showTopWin('n05_xszz.do?method=xfhj3Add',700,500)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/n05_xszz.do?method=xfhj3Modi')"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="dataBatch('n05_xszz.do?method=xfhj3&type=del')"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="wjcfDataExport('n05_xszz.do?method=xfhj3Exp')" style="width:80px">
								导出数据
							</button>							
						</div>
					</logic:equal>
