...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	*/
	...
	function tjjg(){
		url = "n05_xszz.do?method=knsrd1shDeptModel&go=tjjg";
		//判断是否有未审核的记录
		//判断是否已经提交
		var pk = "bm||dm||zjz||tjxm||tjzt";
		var pkV = 'xy'+val('userDep') + val('xn')+ "knsrd1" + "1";		
		var shjb = val('shjb');
		qgzxgzkh.checkExists('xszz_com_bmshtjb',pk,pkV,function(data){
			if(data){
				...
				xszzCommonN05DWR.jlsfqbsh('knsrd1','xn',pk,pkV,shjb,function(data){
					if(data){
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=knsrd1shdm" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 审核 - 困难生认定
				</div>
			</div>
						...
						<tr>
							...
							<td width="10" rowspan="" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=knsrd1shDeptModel&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=knsrd1shdmOne')"
    ...
    <bean:write name="v"/>
     ...
     ">
										...
										<td>
											<a href="#" onclick="rowOnClick(findParents(this,'TR'));chkAssisOne('/xgxt/n05_xszz.do?method=knsrd1shdmOne&doType=view')"><font color="blue">查看详细</font></a>
										</td>
									</tr>
								</logic:iterate>
							</table>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button class="button2" onclick="tg('/xgxt/n05_xszz.do?method=knsrd1sh&go=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/n05_xszz.do?method=knsrd1sh&go=btg');"
								style="width:80px">
								不通过
							</button>
							<!--学校用户-->
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/n05_xszz.do?method=knsrd1sh&go=th');"
								style="width:80px">
								退回重审
							</button>
							</logic:notEqual>
