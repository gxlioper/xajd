...
function dataExport2() {
	document.forms[0].action = "/xgxt/n05_xszz.do?method=xfhj2Exp";
...
function tj(url){
	...
	url+="&xn="+xn;
	return showOpenWindow(url,750,550);
}
function tj2(url){
	var xn = document.getElementById('xn').value;
	...
	url+="&xn="+xn;
	return showOpenWindow(url,750,600);
}

</script>
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=xfhj2sh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					<logic:equal name="isQuery" value="is">
					当前所在位置：学生资助 - 申请结果查询 - 学费缓交
					</logic:equal>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=xfhj2sh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=xfhj2sq&type=modi')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=xfhj2shOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="1" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button class="button2" onclick="add('/xgxt/n05_xszz.do?method=xfhj2sq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/n05_xszz.do?method=xfhj2sq&type=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="del('/xgxt/n05_xszz.do?method=xfhj2sh&go=del');"
								style="width:80px">
								删 除
							</button>
							...
							<logic:notEqual name="isQuery" value="is">
							<button class="button2" onclick="tg('/xgxt/n05_xszz.do?method=xfhj2sh&go=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/n05_xszz.do?method=xfhj2sh&go=btg');"
								style="width:80px">
								不通过
							</button>							
							</logic:notEqual>
							...
							<logic:equal name="xxdm" value="11078">
								<logic:equal name="isQuery" value="is">
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="showOpenWindow('/xgxt/n05_xszz.do?method=xfhj2xsqfxx',1000,500);"
									style="width:100px">
									学生欠费记录
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="button2" onclick="tj('/xgxt/n05_xszz.do?method=xfhj2wgqfmd');"
									style="width:100px">
									无故欠费名单
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<logic:equal name="userType" value="xx">
									<button class="button2" onclick="tj2('/xgxt/n05_xszz.do?method=xfhj2hjtj');"
										style="width:140px">
										缓缴及欠费统计名单
									</button>
									&nbsp;&nbsp;&nbsp;&nbsp;
