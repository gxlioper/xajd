						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=zsfhj1Sh&go=go')">
									查询
								</button>
							</td>
						</tr>
				...
				<div class="searchcontent">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="modi('/xgxt/n05_xszz.do?method=zsfhj1ShOne&type=view')"
					...
					<logic:equal value="yes" name="writeAble">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<button class="button2" onclick="dataBatch('n05_xszz.do?method=zsfhj1Sh&shjg=通过&type=save')"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="dataBatch('n05_xszz.do?method=zsfhj1Sh&shjg=不通过&type=save')"
								style="width:80px">
								不通过
							</button>							
						</div>
