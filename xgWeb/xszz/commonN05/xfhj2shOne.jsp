...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			refreshForm('/xgxt/n05_xszz.do?method=xfhj2shSave');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
		...
		<html:form action="/n05_xszz" method="post">
			...
			<table width="98%" align="center" class="tbstyle">
				...
				<tr>
					...
					<td>
						<bean:write name="rs" property="hjxzfqx"/>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<bean:write name="rs" property="sfhdgjzxdk"/>
					</td>
					<td>
						<div align="center">
							是否申请国家助学贷款
					...
					<td>
						<bean:write name="rs" property="ywsqgjzxdk"/>
					</td>
				</tr>
				<tr>
					<td>
