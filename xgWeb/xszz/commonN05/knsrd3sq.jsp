	...
	<script language="javascript">
		function yz(){
			...
			if(bxnyhzzqk != null){
	       	...
	       	if( xxdm == "11078"){//广州大学
		       	if(gzdx_yz()){
					document.forms[0].action = "/xgxt/n05_xszz.do?method=knsrd3sqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/n05_xszz.do?method=knsrd3sqb";
			document.forms[0].submit();
		}
		function changeXf(){
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="n05_xszz.do?method=knsrd3sq" method="post" enctype="multipart/form-data">
			<input type="hidden" id="xxdm" name="xxdm" value="${xxdm }" />
			<input type="hidden" id="url" name="url" value="/n05_xszz.do?method=knsrd3sq" />
			...
			<table width="99%"  border="0" class="formlist">
				<thead>
	   				<tr>
	       				<th colspan="10"><span>经济困难生认定</span></th>
	       			</tr>
	  			</thead>
	  			<tbody>
				<tr>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="bxnyhzzqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'bxnyhzzqk')"/>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="jtcszrzhqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'jtcszrzhqk')"/>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="jtcstfywqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'jtcstfywqk')"/>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="jtcyycjnmrndnlrqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'jtcyycjnmrndnlrqk')"/>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="jtcysyqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'jtcysyqk')"/>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="jtqzqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'jtqzqk')"/>
				...
				<tr>
					...
					<td colspan="9">
						<html:textarea name="rs" property="qtqk" rows='3'  style="word-break:break-all;width:98%"  onblur="yzdx(this,'qtqk')"/>
				...
				<tr>
					...
					<logic:notEmpty name="rs" property="scdz">
						...
						<td  colspan="9"> 
							...
							&nbsp;&nbsp;
							<a href="javascript:refreshForm('/xgxt/n05_xszz.do?method=fileDel')" />点击删除</a>
							</logic:notEqual>
						</td>
					</logic:notEmpty>
				</tr>	
