...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			document.forms[0].action = "/xgxt/n05_xszz.do?method=xfjm2sqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/n05_xszz.do?method=xfjm2sqb";
			document.forms[0].submit();
		}
	</script>
</head>
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="n05_xszz.do?method=xfjm2sq" method="post">
			<input type="hidden" id="url" name="url" value="/n05_xszz.do?method=xfjm2sq" />
			...
			<table class="tbstyle" width="90%">
				...
				<tr>
					...
					<td>
						<input type="text" id="xqmc" readonly="readonly" name="xqmc"
							style="width:100%;heigh:100%"
				...
				<tr>
					...
					<td>
						<input type="text" id="hjqk" maxlength="100" name="hjqk"
							style="width:100%;heigh:100%"
							value="<bean:write name="rs" property="hjqk"/>">
					</td>
					<td>
						<div align="center">
							获助情况
					...
					<td>
						<input type="text" id="hzqk" name="hzqk" maxlength="100"
							style="width:100%;heigh:100%"
							value="<bean:write name="rs" property="hzqk"/>">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="qfqk" maxlength="5" name="qfqk"
							style="width:100%;heigh:100%"
							value="<bean:write name="rs" property="qfqk"/>"
							onkeyup="value=value.replace(/[^\d]/g,'')" 
							onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
					</td>
					<td>
					...
					<td>
						<input type="text" id="sqjmje" name="sqjmje" maxlength="5"
							style="width:100%;heigh:100%"
							value="<bean:write name="rs" property="sqjmje"/>"
							onkeyup="value=value.replace(/[^\d]/g,'')" 
							onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
					</td>
				</tr>
