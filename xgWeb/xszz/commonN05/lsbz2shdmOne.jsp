...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script language="javascript" src="js/function.js"></script>
		...
		function yz(){
			...
			refreshForm('/xgxt/n05_xszz.do?method=lsbz2shdmOne&type=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
		...
		function loadElement(){
			var shjg = val('shjg');
			if(shjg == '通过'){
				ele('pzjeTr').style.display='';
			}else{
				setVal('xxpzje','');
				ele('pzjeTr').style.display='none';
			}
		}
		</script>
