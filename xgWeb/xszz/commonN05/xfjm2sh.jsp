...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	//		ShiftStartRow=iRow;
		...
		function dataExport2() {
			document.forms[0].action = "/xgxt/n05_xszz.do?method=xfjm2Exp&doType=sh";
		...
		function commitSh(){
			...
			qgzxgzkh.checkExists('xszz_com_bmshtjb','zjz||dm||bm||tjxm||tjzt',xn+xq+bjdm+'bjxfjm2'+'1',function(data){
				if(data != null && data == true){
					alert('该班级已经提交！');
					return false;
				}else{//提交
					qgzxgzkh.checkExists('view_xszz_com_xfjm2','xn||xq||bjdm||fdysh',xn+xq+bjdm+'未审核',function(data){
						if(data){
							alert('还有数据未审核,暂时不能提交结果！');
							return false;
						}else{
							refreshForm("n05_xszz.do?method=xfjm2sh&go=tjsh&xn=" + xn + "&xq=" + xq + "&tjbjdm=" + bjdm);
						}
					});
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=xfjm2sh" method="post">
			<div class="title">
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=xfjm2sh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=xfjm2sq&type=modi')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=xfjm2shOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="1" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button class="button2" onclick="add('/xgxt/n05_xszz.do?method=xfjm2sq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/n05_xszz.do?method=xfjm2sq&type=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="del('/xgxt/n05_xszz.do?method=xfjm2sh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
