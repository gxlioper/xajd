...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<script language="javascript" src="js/function.js"></script>
		...
		function yz(){
			...
			refreshForm('/xgxt/n05_xszz.do?method=xfjm2shdmOne&type=save');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
		...
		function loadElement(){
			var shjg = val('shjg');
			if(shjg == '通过'){
				ele('pzjmjeTr').style.display='';
			}else{
				setVal('xxpzjmje','');
				ele('pzjmjeTr').style.display='none';
			}
		}
		</script>
