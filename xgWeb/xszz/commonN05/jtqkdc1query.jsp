...
function dataExport2() {
	document.forms[0].action = "/xgxt/n05_xszz.do?method=jtqkdc1Exp";
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=jtqkdc1sh" method="post">
			<div class="tab_cur">
				<p class="location">
				<em>您的当前位置：</em><a>
			...
			<div class="toolbox">
			 <logic:equal value="yes" name="writeAble" scope="request">	
					 <div class="buttonbox">
						 <ul>
						<li> <a href="#" onclick="add('/xgxt/n05_xszz.do?method=jtqkdc1sq');" class="btn_zj"> 增加 </a> </li>
					    <li> <a href="#" onclick="modi('/xgxt/n05_xszz.do?method=jtqkdc1sq&type=modi');" class="btn_xg"> 修改 </a> </li>
						<li> <a href="#" onclick="del('/xgxt/n05_xszz.do?method=jtqkdc1query&go=del');" class="btn_sc"> 删除 </a> </li>
				 		...
				 		<td colspan="6" >
							...
							<div class="btn">
								...
								<button class="btn_cx"   id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=jtqkdc1query&go=go')">
									查 询
								</button>
		                         &nbsp;&nbsp;&nbsp;&nbsp;
						...
						<table summary="" id="rsTable" class="dateline" width="100%">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=jtqkdc1queryOne')">
										<td align=center>
