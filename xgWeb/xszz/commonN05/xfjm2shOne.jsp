...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		function yz(){
			...
			refreshForm('/xgxt/n05_xszz.do?method=xfjm2shSave');Close();window.dialogArguments.document.getElementById('search_go').click();
		}
		...
		<html:form action="/n05_xszz" method="post">
			...
			<table width="98%" align="center" class="tbstyle">
				...
				<tr>
					...
					<td>
						<bean:write name="rs" property="sqjmje"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<logic:notEqual name="userType" value="xx">
						...
						<td>
							<logic:present name="shmodel">
								<input type="text" id="pzjmje" name="pzjmje" maxlength="5"
								style="width:100%;heigh:100%"
								value="<bean:write name="rs" property="pzjmje"/>"
								onkeyup="value=value.replace(/[^\d]/g,'')" 
								onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
							</logic:present>
							<logic:notPresent name="shmodel">
								<bean:write name="rs" property="pzjmje"/>
							</logic:notPresent>
