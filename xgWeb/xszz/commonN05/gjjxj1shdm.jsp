	...
	*/
	...
	function chkAssisOne(url, act) {
		if (curr_row == null) {
			...
			url += "&shjg=";
			url += curr_row.cells[10].innerText;
			showTopWin(url, 750, 550);
			return true;
		}
	}	
	function tjjg(){
		url = "n05_xszz.do?method=gjjxj1shDeptModel&go=tjjg";
		//判断结果是否已经提交
		var pkV = 'xy'+val('userDep')+val('xn')+'gjjxj1'+'1';
		qgzxgzkh.checkExists('xszz_com_bmshtjb','bm||dm||zjz||tjxm||tjzt',pkV,function(data){
			if(data){
				alert('已经提交，暂时不能再次提交！');
				return false;
			}else{
				var pk = "xn||xydm";
				pkV = val('xn')+val('userDep');				
				xszzCommonN05DWR.jlsfqbsh('gjjxj1','xn',pk,pkV,val('shjb'),function(data){
					if(data){
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=gjjxj1shdm" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：学生资助 - 审核 - 国家奖学金
				</div>
			</div>
						...
						<tr>
							...
							<td width="10" rowspan="" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=gjjxj1shDeptModel&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=gjjxj1shdmOne')"
    ...
    <bean:write name="v"/>
     ...
     ">
										...
										<td>
											<a href="#" onclick="rowOnClick(findParents(this,'TR'));chkAssisOne('/xgxt/n05_xszz.do?method=gjjxj1shdmOne&doType=view')"><font color="blue">查看详细</font></a>
										</td>
									</tr>
								</logic:iterate>
							</table>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button class="button2" onclick="tg('/xgxt/n05_xszz.do?method=gjjxj1sh&go=tg');"
								style="width:80px">
								通 过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/n05_xszz.do?method=gjjxj1sh&go=btg');"
								style="width:80px">
								不通过
							</button>
							<!--学校用户-->
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/n05_xszz.do?method=gjjxj1sh&go=th');"
								style="width:80px">
								退回重审
							</button>
							</logic:notEqual>
