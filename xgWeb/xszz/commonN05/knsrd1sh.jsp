...
function dataExport2() {
	document.forms[0].action = "/xgxt/n05_xszz.do?method=knsrd1Exp";
	...
	document.forms[0].target = "_self";
		...
		function commitSh(){
			...
			qgzxgzkh.checkExists('xszz_com_bmshtjb','zjz||dm||bm||tjxm||tjzt',xn+bjdm+'bjknsrd1'+'1',function(data){
				if(data != null && data == true){
					alert('该班级已经提交！');
					return false;
				}else{//提交
					//判断是否存在未审核的数据
					qgzxgzkh.checkExists('view_xszz_com_knsrdb1','xn||bjdm||fdysh',xn+bjdm+'未审核',function(data){
						if(data){
							alert('还有数据未审核,暂时不能提交结果！');
							return false;
						}else{
							refreshForm("n05_xszz.do?method=knsrd1sh&go=tjsh&xn=" + xn + "&tjbjdm=" + bjdm);
						}
					});
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=knsrd1sh" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					<logic:equal name="isQuery" value="is">
					当前所在位置：学生资助 - 申请结果查询 - 经济困难生认定
					</logic:equal>
					<logic:notEqual name="isQuery" value="is">
					当前所在位置：学生资助 - 审核 - 经济困难生认定
					</logic:notEqual>
				</div>
			</div>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=knsrd1sh&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=knsrd1sq&type=modi')"
    ...
    <bean:write name="v"/>
     ...
     ">
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=knsrd1shOne')"
										style="cursor:hand;background-color:
    <logic:iterate id="v" name="s" offset="1" length="1">
    <bean:write name="v"/>
    </logic:iterate>
     ">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
	                		<logic:equal name="isQuery" value="is">
							<button class="button2" onclick="add('/xgxt/n05_xszz.do?method=knsrd1sq');"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="modi('/xgxt/n05_xszz.do?method=knsrd1sq&type=modi');"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="del('/xgxt/n05_xszz.do?method=knsrd1sh&go=del');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<logic:notEqual name="isQuery" value="is">
							<button class="button2" onclick="ybkn('/xgxt/n05_xszz.do?method=knsrd1sh&go=ybkn');"
								style="width:80px">
								一般困难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="kn('/xgxt/n05_xszz.do?method=knsrd1sh&go=kn');"
								style="width:80px">
								困 难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="tskn('/xgxt/n05_xszz.do?method=knsrd1sh&go=tskn');"
								style="width:80px">
								特殊困难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="bkn('/xgxt/n05_xszz.do?method=knsrd1sh&go=bkn');"
								style="width:80px">
								不困难
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
