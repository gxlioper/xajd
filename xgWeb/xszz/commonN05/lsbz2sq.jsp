...
<head>
	...
	<script language="javascript">
		function yz(){
			...
			if(sqly != null){
	         	if(sqly.replace(/[^\u0000-\u00ff]/g, "**").length > 4000){	         
	          		 alert("申请理由不能大于4000个字符");
	          		 return false;
	       		 }
	       	}
			document.forms[0].action = "/xgxt/n05_xszz.do?method=lsbz2sqSave";
		...
		function toPrintOut(){//输出相应的打印页面
			document.forms[0].action = "/xgxt/n05_xszz.do?method=lsbz2sqb";
			document.forms[0].submit();
		}
	</script>
</head>
...
<body>
	...
	<logic:equal name="sfksq" value="-1">
		...
		<html:form action="n05_xszz.do?method=lsbz2sq" method="post">
			<input type="hidden" id="url" name="url" value="/n05_xszz.do?method=lsbz2sq" />
