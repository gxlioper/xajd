...
function dataExport2() {
	document.forms[0].action = "/xgxt/n05_xszz.do?method=gjjxj1Exp";
	...
	document.forms[0].target = "_self";
		...
		function commitSh(){
			...
			qgzxgzkh.checkExists('xszz_com_bmshtjb','zjz||dm||bm||tjxm||tjzt',xn+bjdm+'bjgjjxj1'+'1',function(data){
				if(data != null && data == true){
					alert('该班级已经提交！');
					return false;
				}else{//提交
					qgzxgzkh.checkExists('view_xszz_com_gjjxj1','xn||bjdm||fdysh',xn+bjdm+'未审核',function(data){
						if(data){
							alert('还有数据未审核,暂时不能提交结果！');
							return false;
						}else{
							refreshForm("n05_xszz.do?method=gjjxj1sh&go=tjsh&xn=" + xn + "&tjbjdm=" + bjdm);
						}
					});
...
function gjzxj1Print(url){
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=gjjxj1sh" method="post">
			<div class="tab_cur">
				<p class="location">
				<em>您的当前位置：</em><a>
			...
			<div class="toolbox">
			 <logic:equal value="yes" name="writeAble" scope="request">
					 <div class="buttonbox">
						<ul>
						<logic:equal name="isQuery" value="is">
						<li> <a href="#" onclick="add('/xgxt/n05_xszz.do?method=gjjxj1sq');" class="btn_zj"> 增加 </a> </li>
					    <li> <a href="#" onclick="modi('/xgxt/n05_xszz.do?method=gjjxj1sq&type=modi');" class="btn_xg"> 修改 </a> </li>
						<li> <a href="#"  onclick="del('/xgxt/n05_xszz.do?method=gjjxj1sh&go=del');" class="btn_sc"> 删除 </a> </li>
						...
						<li> <a href="#" onclick="dataExport2()"  class="btn_dc"> 导出 </a> </li>
							<logic:equal name="xxdm" value="13742">
								<li> <a href="#" onclick="gjzxj1Print('/xgxt/n05_xszz.do?method=gjjxj1Print')"  class="btn_tj"> 报表统计 </a> </li>
								<li> <a href="#" onclick="gjzxj1Print('/xgxt/n05_xszz.do?method=gjjxj1hzPrint')"  class="btn_tj"> 审核名单汇总 </a> </li>
							</logic:equal>
						</logic:equal>
						<logic:notEqual name="isQuery" value="is">
							<li> <a href="#" onclick="tg('/xgxt/n05_xszz.do?method=gjjxj1sh&go=tg');" class="btn_shtg"> 通 过 </a> </li>
							<li> <a href="#" onclick="btg('/xgxt/n05_xszz.do?method=gjjxj1sh&go=btg');" class="btn_shbtg"> 不通过 </a> </li>
				 		...
				 		<td colspan="6" >
							...
							<div class="btn">
								...
								<button class="btn_cx"   id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=gjjxj1sh&go=go')">
									查 询
								</button>
		                         &nbsp;&nbsp;&nbsp;&nbsp;
						...
						<table summary="" id="rsTable" class="dateline" width="100%">
								...
								<logic:iterate name="rs" id="s">
									...
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=gjjxj1sq&type=modi')"
									...
									<logic:notEqual name="isQuery" value="is">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=gjjxj1shOne')"
										style="cursor:hand;background-color:
									    <logic:iterate id="v" name="s" offset="1" length="1">
									    <bean:write name="v"/>
									    </logic:iterate>
