...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	*/
	...
	function tjjg(){
		url = "n05_xszz.do?method=gjzxj3shDeptModel&go=tjjg";
		//判断是否已经提交
		var pk = "bm||dm||zjz||tjxm||tjzt";
		var pkV = 'xy'+val('userDep') + val('xn')+ "gjzxj3" + "1";
		qgzxgzkh.checkExists('xszz_com_bmshtjb',pk,pkV,function(data){
			if(data){
				...
				xszzCommonN05DWR.jlsfqbsh('gjzxj3','xn',pk,pkV,val('shjb'),function(data){
					if(data){
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/n05_xszz.do?method=gjzxj3shdm" method="post">
			<div class="title">
			...
			<input type="hidden" id="shjb" name="shjb" 
				value="${shjb}" />
			<input type="hidden" id="userType" name="userDep" 
						...
						<tr>
							...
							<td width="10" rowspan="" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/n05_xszz.do?method=gjzxj3shDeptModel&go=go')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										ondblclick="chkAssisOne('/xgxt/n05_xszz.do?method=gjzxj3shdmOne')"
    ...
    <bean:write name="v"/>
     ...
     ">
										...
										<td>
											<a href="#" onclick="rowOnClick(findParents(this,'TR'));chkAssisOne('/xgxt/n05_xszz.do?method=gjzxj3shdmOne&doType=view')"><font color="blue">查看详细</font></a>
										</td>
									</tr>
								</logic:iterate>
							</table>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="btg('/xgxt/n05_xszz.do?method=gjzxj3sh&go=th');"
								style="width:80px">
								退回重审
							</button>
							</logic:notEqual>
