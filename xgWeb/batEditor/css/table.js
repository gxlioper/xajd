...
function TableInsert() {
	if (!isTableSelected()) {
		ShowDialog("/xgxt/batEditor/dialog/table.htm", 350, 380, true);
	}
}
...
function TableProp() {
	if (isTableSelected() || isCursorInTableCell()) {
		ShowDialog("/xgxt/batEditor/dialog/table.htm?action=modify", 350, 380, true);
	}
}
...
function TableCellProp() {
	if (isCursorInTableCell()) {
		ShowDialog("/xgxt/batEditor/dialog/tablecell.htm", 350, 280, true);
	}
}
...
function TableCellSplit() {
	if (isCursorInTableCell()) {
		ShowDialog("/xgxt/batEditor/dialog/tablecellsplit.htm", 200, 150, true);
	}
}
...
function TableRowProp() {
	if (isCursorInTableCell()) {
		ShowDialog("/xgxt/batEditor/dialog/tablecell.htm?action=row", 350, 280, true);
	}
}
