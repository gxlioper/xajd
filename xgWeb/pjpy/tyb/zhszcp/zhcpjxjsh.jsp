...
<script type="text/javascript" src="pjpy/xibeierminyuan/js/xbemyJs.js"></script>
		...
		<script type="text/javascript">
			function shOne() {
				...
				showInfo('/xgxt/pjpyTybZhcpjxj.do?method=zhcpjxjView&shjb='+shjb,'sh','900','600');
			}
			...
			function checkSyme() {
				...
				shformdata('/xgxt/pjpyTybZhcpjxj.do?method=jxjsh&shjg=通过&doType=sh');
			}
		</script>
</head>
<html>
	<body onload="xyDisabled('xy');">
		<html:form action="/pjpyTybZhcpjxj.do?method=zhcpjxjSh" method="post">
			...
			<div class="toolbox">
				  ...
				  <div class="buttonbox">
				    <ul>
					  ...
					  <logic:empty name="yhInfo">
						 ...
						 <li> <a href="#" onclick="shformdata('/xgxt/pjpyTybZhcpjxj.do?method=zhcpjxjSh&shjg=通过&doType=sh');" class="btn_shtg">批量通过</a> </li>
						 <li> <a href="#" onclick="shformdata('/xgxt/pjpyTybZhcpjxj.do?method=zhcpjxjSh&shjg=不通过&doType=sh');" class="btn_shbtg">批量不通过</a> </li>
					  </logic:empty>
					</logic:equal>		
					</ul>					
				  </div>
				          ...
				          <td colspan="5">
				            <div class="btn">
								...
								<button type="button" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/pjpyTybZhcpjxj.do?method=zhcpjxjSh&doType=query')">
									查询
								</button>
								<button type="button"
				...
				<!--一级审核-->
				 ...
				 <tr>
					<th>奖学金</th>
					<td>
						<html:select property="queryequals_jxjdm" styleId="jxjdm" onchange="allNotEmpThenGo('/xgxt/pjpyTybZhcpjxj.do?method=zhcpjxjSh')" style="width:160px">
			...
			<div class="formbox">
			    ...
			    <span>
					...
					<logic:notEmpty name="rs">
						...
						<logic:equal value="10657" name="xxdm" scope="session">
							<logic:equal value="xy" name="userType" scope="session">
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">此项奖学金剩余通过名额为：${syme }个</font>
							</logic:equal>
						</logic:equal>
