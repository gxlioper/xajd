...
<body onload="xyDisabled('xy');">
	<html:form action="/pjpynblgwh" method="post">
		<div class="tab_cur">
					<p class="location">
						<em>当前所在位置：</em><a>评奖评优 － 审核 － 荣誉称号审核</a>
					</p>
		</div>
		<logic:equal value="yes" name="writeAble">
					...
					<div class="buttonbox">	
						...
						<ul>
							<li><a href="#" class="btn_shtg" onclick="shandSubmit('pjpy_nblg_rychsh.do','tg')">审核通过</a></li>
							<li><a href="#" class="btn_shbtg" onclick="shandSubmit('pjpy_nblg_rychsh.do','btg')">审核不通过</a></li>
							<li><a href="#" class="btn_dy" onclick="window.open('pjpy_nblg_rychprint.do?xh=')">打印报表</a></li>
			...
			<div class="searchtab">
				<table width="100%" class="" border="0">
					...
					<th align="left">年级</th>
						...
						<td><html:select property="rychdm" styleId="rychdm" style="width:150px" onchange="refreshForm('pjpy_nblg_rychsh.do')">
								<html:option value=""></html:option>
