...
<html:html>
  ...
  <body>
    <html:form action="/pjpynblgwh">
      <div align="center" style="font-size:20px;font:'黑体' "><b>${xxmc }20<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>&nbsp;-&nbsp;20<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>学年<br/>荣誉称号评审表</b></div>
<br/>
<div>
<table width="100%" class="printstyle">
  <tr>
  	<th height="30" colspan="2" width="13%" scope="col">学   &nbsp;&nbsp;&nbsp; 号</th>
    ...
    <th height="30" width="11%" scope="col">出生年月</th>
  ...
  <tr>
    ...
    <th colspan="3"><div align="center">专业班级</div></th>
    <td colspan="5" width="13%" align="center">&nbsp;<bean:write name='rs' property="zymc"/><br/><bean:write name='rs' property="bjmc"/></td>
  </tr>
  <tr>
  	<th height="30" colspan="2" width="14%" scope="col">德育测评<br/>班级排名</th>
    <td height="30" colspan="4" style="width:20%" scope="col" align="center">&nbsp;</td>
    <th height="30" colspan="3" width="14%" scope="col">体育成绩</th>
    <td height="30" colspan="5" style="width:20%" scope="col" align="center">&nbsp;</td>
  </tr>
  <tr>
  	<th height="30" colspan="2" width="14%" scope="col">已申请<br/>奖学金类别</th>
    <td height="30" colspan="4" style="width:20%" scope="col" align="center">&nbsp;</td>
    <th height="30" colspan="3" width="14%" scope="col">学年担任<br/>社会工作情况</th>
    <td height="30" colspan="5" style="width:20%" scope="col" align="center">&nbsp;</td>
  </tr>
  <tr>
    <th colspan="4" align="center">申报荣誉称号类别</th>
