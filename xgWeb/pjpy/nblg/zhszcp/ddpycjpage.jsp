	...
	<html:form action="/pjpynblgzhcpwh" method="post">
		...
		<logic:equal value="yes" name="writeAble">
					...
					<div class="buttonbox">	
						...
						<ul>
							<li><a href="#" class="btn_zj" onclick="dycjAdd()">增加</a></li>
							<li><a href="#" class="btn_xg" onclick="dycjUpdate('update')">修改</a></li>
							<li><a href="#" class="btn_sc" onclick="deldata('pjpy_nblg_ddpycjwh.do?act=delete')">删除</a></li>
						    <li><a href="#" class="btn_dr" onclick="impAndChkData();">导入数据</a></li>
						    <li><a href="#" class="btn_dc"  onclick="dataExport()">数据导出</a></li>
						    <li><a href="xlsDown/dycjb.xls" target="_blank" class="btn_down" >模板下载</a></li>
						</ul>
					</div>
					</div>
		</logic:equal>
