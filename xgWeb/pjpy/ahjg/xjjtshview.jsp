...
%>
	...
	<script type="text/javascript" src="/xgxt/dwr/util.js"></script>
		...
		<html:form action="/pjpyahjgwh.do" method="post">
			...
			<table width="100%" align="center" class="tbstyle">
				...
				<tr style="height:22px">
					...
					<td align="left">
						<html:select property="shxm" styleId="shxm" styleClass="select">
				...
				<tr style="height:22px">
					...
					<td align="left">
						<html:text name="rs" property="bjbkl" readonly="true"></html:text>
					</td>
					<td align="right">
						&nbsp;
					</td>
				...
				<tr style="height:22px">
					...
					<td align="left">
						<html:text name="rs" property="zccql" readonly="true"></html:text>
					</td>
					<td align="right">
						&nbsp;
					</td>
			...
			<div class="buttontool" align="center">
				<button class="button2"
					onclick="refreshForm('shjgbyone.do');"
		...
		<logic:equal value="cb" name="inserted">
			<script>
				alert('提示：审核通过班级数已超限制班级数！');
				window.close();
				window.dialogArguments.document.getElementById('search_go').click();
			</script>
		</logic:equal>
