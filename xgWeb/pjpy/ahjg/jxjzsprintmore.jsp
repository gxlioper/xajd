...
var top= new Array();
	...
	if(cu_R >= window.opener.$("tabPri").rows.length){
		...
		var xm = window.opener.curr_row.cells[3].innerText.trim();
		window.location.href = "jxjzsprintmore.do?xm="+xm+'&hjxn='+document.getElementById('hjxn').value+'&hjxq='+document.getElementById('hjxq').value+'&hjxjdj='+document.getElementById('hjxjdj').value+'&hjny='+document.getElementById('hjny').value;
	}
	}
 ...
 <input type="hidden" name="hjxq" id="hjxq" value="${hjxq }"/>
 <input type="hidden" name="hjxjdj" id="hjxjdj" value="${hjxjdj }"/>
  ...
  <tr> 
    ...
    <ul> 
        <li class="youbianxia"> 
          ...
          <h4><div   style="position: absolute; left: 733px; top: 170px;" title="获奖学期" id="hjxq1" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${hjxq }</div></h4> 
        </li> 
        <li> 
          <h4><div style="position: absolute; left: 489px; top: 215px;" title="获奖学金等级" id="hjxjdj1" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${hjxjdj }</div></h4> 
