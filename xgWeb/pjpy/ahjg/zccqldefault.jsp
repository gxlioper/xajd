						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('zccqlqry.do')">
									查询
								</button>
							</td>
						</tr>
			...
			<logic:notEmpty name="rs">
				<fieldset>
					<legend>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<font color="blue">提示：灰色为早操出勤率低于90%；双击一行可以查看详细信息；单击表头可以排序</font>
					</legend>
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								...
								ondblclick="modidata('zccqlview.do?pkValue=','550','400')"
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_save"
								onclick="showTopWin('zccqladd.do','550','400')"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_modi"
								onclick="modidata('zccqlview.do?pkValue=','550','400')"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_del"
								onclick="delshjxj('zccqldel.do')"
								style="width:80px">
								批量删除
							</button>
							&nbsp;&nbsp;&nbsp;
