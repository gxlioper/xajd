					...
					<thead>
						<tr>
							<td align="left">
								...
								&nbsp;&nbsp;
								年度：
								<html:select property="nd" style="width:80px" styleId="nd" styleClass="select">
									<html:options collection="xnList" property="nd" labelProperty="nd"/>
								</html:select>
								&nbsp;&nbsp;
								学号：
								<html:text property="xh" styleId="xh"
								 style="width:90px" styleClass="inputtext" maxlength="20"></html:text>
								&nbsp;&nbsp;&nbsp;&nbsp;
								姓名：
								<html:text property="xm" styleId="xm" styleClass="inputtext" maxlength="15"></html:text>
							</td>
							<td width="10" rowspan="2" align="center" valign="middle">
								<input type="hidden" name="go" value="a" />
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('xsxxjsqry.do')">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								...
								ondblclick="modidata('xxjsmodi.do?pkValue=','660','480')"
								bgcolor="">
								<td>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_save"
								onclick="showTopWin('xxjsadd.do','660','480')"
								style="width:80px">
								增加
							</button><%--
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_modi"
								onclick="modidata('xxjsmodi.do?pkValue=','660','480')"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
