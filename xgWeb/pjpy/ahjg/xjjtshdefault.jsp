...
%>
	...
	<script type='text/javascript' src='/xgxt/dwr/util.js'></script>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="if (chdatanull()) allNotEmpThenGo('xsjtqry.do');">
									查询
								</button>
							</td>
						</tr>
			...
			<logic:notEmpty name="rs">
				<fieldset>
					<legend>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<font color="blue">提示：双击一行可以查看详细信息并改变审核状态；</font><font color="red">${ bjzs}</font>
					</legend>
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								...
								ondblclick="modidata('xjjtshview.do?pkValue=','650','530')"
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_pass"
								onclick="shandSubmit('xjjtsh.do','tg')"
								style="width:80px">
								审核通过
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_nopass"
								onclick="shandSubmit('xjjtsh.do','btg')"
								style="width:80px">
								审核不通过
							</button>
							&nbsp;&nbsp;&nbsp;
		...
		<logic:present name="inserted">
			<logic:equal value="view" name="inserted">
				<script>
					alert('操作成功！');
