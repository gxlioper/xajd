...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body>
		...
		<html:form action="/pjpyahjgwh" method="post">
			...
			<input type="hidden" id="url" name="url" value="/pjpy_ycsf_addHjmdxx.do" />
			<div class="title">
			...
			<table width="100%" class="tbstyle">
				...
				<tr>
					...
					<td align="left">
						<html:select property="xn" styleId="xn" style="width:90px" styleClass="select">
				...
				<tr>
					...
					<td align="left">
						<html:select property="nd" styleId="nd" style="width:90px" styleClass="select">
				...
				<tr>
					...
					<td align="">
						<html:select property="xxjsdm" styleId="xxjsdm"
				...
				<tr>
					...
					<td align="left">
						<html:text property="hjsj" styleId="hjsj" style="cursor:hand;"
			...
			<div class="buttontool" align="center">
				<button class="button2" onclick="savedata('savexxjsxx.do')"
