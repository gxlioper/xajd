		...
		if (checkTextAreaLength('jlqk-sqly','奖励情况-申请理由',1000)) 
		{
			getStuDtiaInfo.checkStuRychsq(xh,xn,rychdm,function (data) {
			  if (data[0]=="false") {
				...
				saveinfo('xmlgpjpy.do?method=modiRychsqxx&operType=save','');	
			  }
		   });
		}
	}
		...
		<table class="tbstyle" width="100%">
			...
			<tr>
				...
				<td align="left" colspan="3">
					<html:textarea name="rs" property="jlqk" styleId="jlqk" rows="5"
			...
			<tr>
				...
				<td align="left" colspan="3">
					<html:textarea  name="rs" property="sqly" styleId="sqly" rows="5"
						style="width:650px"></html:textarea>
				</td>
			</tr>
		</table>
