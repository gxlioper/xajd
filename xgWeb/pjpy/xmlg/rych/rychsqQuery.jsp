					...
					<tr>
						...
						<td width="10" rowspan="2" align="center" valign="middle">
							<button type="button" class="button2" style="height:40px" id="search_go"
								onclick="refreshForm('pjpy_xmlg_rychsqQuery.do?operType=query');">
								查询
							</button>
						</td>
					</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)" style="cursor:hand;"
								align="center" ondblclick="modiAndDel('pjpy_xmlg_modiRychsqxx.do?operType=view&pkValue=','modi',780,650)">
								<td>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2" id="btn_add"
								onclick="refreshForm('pjpy_xmlg_rychsqDefault.do')"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_xg"
								onclick="modiAndDel('pjpy_xmlg_modiRychsqxx.do?pkValue=','modi',780,650)"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_sc"
								onclick="deldata('xmlgpjpy.do?method=rychsqDelete')"
								style="width:80px">
								删除
							</button>
							&nbsp;&nbsp;
