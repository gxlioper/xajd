	...
	function savedata() {
		...
		if (checkTextAreaLength('jlqk-sqly','奖励情况-申请理由',1000)) 
		{
			if ($("pt")) {
				...
				saveinfo('pjpy_xmlg_modiJxjsqxx.do?operType=save','');	
		}
	}
	//通过DWR来更改奖学金列表
	function changeJxjdm(obj) {
		getStuDtiaInfo.getJxjListByajax(obj.value,function (data) {
				DWRUtil.removeAllOptions('jxjdm');			
				var o = [{id:'',labelText:''}];
				DWRUtil.addOptions('jxjdm',o,'id','labelText');
				for(var i=0;i<data.length;i++){
						o = [{id:data[i].dm,labelText:data[i].mc}];
						DWRUtil.addOptions('jxjdm',o,'id','labelText');
					}
		});
	}
	...
	<html:form action="/xmlgpjpy" method="post">
		...
		<table class="tbstyle" width="100%">
			...
			<tr style="height:23px">
				...
				<td align="left">
					<html:select property="lbdm" styleId="lbdm" onchange="changeJxjdm(this)">
