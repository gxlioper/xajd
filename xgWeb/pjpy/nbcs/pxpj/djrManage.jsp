							...
							<thead>
								<tr>
									<td align="left">
										...
										&nbsp;&nbsp;学年：
										<html:select property="queryequals_xn" style="width:120px" styleId="xn" onchange="">
									...
									<td width="10" rowspan="2" align="center" valign="middle">
										...
										<button type="button" class="button2" style="height:25px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/nbcsPxpj.do?method=djrManage');">
											查询
										</button>
										<br>
					...
					<div class="buttontool" id="btn"
						...
						<logic:equal name="writeAble" value="yes">
							<button type="button" class="button2"
								onclick="showTopWin('/xgxt/nbcsPxpj.do?method=djrUpdate','800','450')"
								style="width:80px">
								分&nbsp;&nbsp;配
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="showTopWin('/xgxt/nbcsPxpj.do?method=djrBlsz','420','280')"
								style="width:80px">
								比例设置
							</button>
							&nbsp;&nbsp;
							<button type="button" class="button2"
								onclick="sumitInfo('/xgxt/nbcsPxpj.do?method=djrManage','del')"
								style="width:80px">
								删&nbsp;&nbsp;除
							</button>	
							&nbsp;&nbsp;	
							...
							&nbsp;&nbsp;
							<button type="button" class="button2" onclick="wjcfDataExport('nbcsPxpj.do?method=djrManage&doType=exp')"
								style="width:80px">
								导出数据
							</button>
						</logic:equal>
