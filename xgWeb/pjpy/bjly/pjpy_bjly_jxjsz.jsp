						...
						<tr>
							...
							<td width="10" rowspan="1" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('pjpy_jxjsz.do')">
									查询
								</button>
							</td>
						</tr>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">	
									<tr onclick="rowOnClick(this);" style="cursor:hand"
										ondblclick="pjpyszbjly('pjpy_jxjsz_one.do');">
				...
				<logic:equal value="yes" name="writeAble" scope="request">
					<center>
						<div class="buttontool" id="btn"
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="pjpyszbjly('pjpy_jxjsz_one.do');"
									style="width:80px">
								修 改
							</button>							
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2" onclick="pjpybjlyDelete('pjpy_jxjsz_delComman.do');"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
