...
<body onload="xyDisabled('xy');">
	<html:form action="/pjpyzjjjwh" method="post">
		<div class="title">
       		<div class="title_img" id="title_m">
         		当前所在位置：评奖评优 - 信息维护 - 学生德育成绩维护
       		</div>
    	</div>
					...
					<thead>
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="dataQryChk('pjpy_zjjj_dycjwh.do');">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td align="left" nowrap>
								...
								考核等级:
								<html:select property="dycj" styleId="dycj" styleClass="selecttext">
									<html:option value=""></html:option>
									<html:options collection="dycjList" property="en" labelProperty="cn"/>
								</html:select>
							</td>
						</tr>
					</thead>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" id="btn_add" style="width:80px"
								onclick="showTopWin('zjjd_zhszcpadd.do','620','480')">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_modi" style="width:80px"
								onclick="modiAndDel('zjjd_zhszcpview.do?pkValue=','modi','620','480')">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
