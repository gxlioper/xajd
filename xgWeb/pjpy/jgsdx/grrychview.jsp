	...
	<body onload="checkWinType();document.all('buttonClose').focus()">
		...
		<html:form action="/pjpyjgsdxwh.do" method="post">
			...
			<input type="hidden" name="pkValue" id="pkValue"
				value="${pkValue }" />
			<input type="hidden" name="rychdm" id="rychdm" value="${rychdm }"/>
			<table width="100%" align="center" class="tbstyle">
				...
				<tr>
					...
					<td colspan="3">
						<html:textarea name="rs" property="shyj" rows="5" styleId="shyj" style="width:98%"></html:textarea>
					</td>
				</tr>
			</table>
			<div class="buttontool" align="center">
				<button class="button2"
					onclick="refreshForm('grrychmodi.do');"
