					...
					<thead>
						<tr>
							<td align="left">
								...
								&nbsp;&nbsp;
								学期：
								<html:select property="xq" styleId="xq" styleClass="xq" style="width:90px">
									<html:option value=""></html:option>
									<html:options collection="xqList" property="xqdm" labelProperty="xqmc"/>
								</html:select>
								&nbsp;&nbsp;
								学号：
								<html:text property="xh" styleId="xh" style="width:85px" styleClass="inputtext"></html:text>
							</td>
							<td width="10" rowspan="2" align="center" valign="middle">
								<input type="hidden" name="go" value="a" />
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('grrychsjqry.do');">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								style="cursor:hand;" align="center" bgcolor="" ondblclick="modidata2('grrychmodiview.do?type=view&pkValue=','600','450')">
								<td>
									...
									<input type="hidden" value="<logic:iterate id="v" name="s" offset="7" length="3"><bean:write name="v"/></logic:iterate>"/>
								</td>							
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_add"
								onclick="refreshForm('credit_apply.do?stab=stab')"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_edit"
								onclick="modidata2('grrychmodiview.do?type=modi&pkValue=','600','450')"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_delete"
								onclick="delshjxj('grrychsqdel.do')"
								style="width:80px">
								批量删除
							</button>
							&nbsp;&nbsp;&nbsp;
