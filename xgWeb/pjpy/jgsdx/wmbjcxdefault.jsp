...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	<head>
		...
		<script type="text/javascript">
			function wmbjprint(url){
				if (curr_row==null || curr_row==''){
					if (confirm('您没有选择数据，确定要打印吗？')==true){
						window.open(url);
						return;
					}
					else {
					...
					<thead>
						<tr>
							<td align="left">
								...
								&nbsp;&nbsp;
								学期：
								<html:select property="xq" styleId="xq" styleClass="xq" style="width:110px">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('wmbjcxjg.do');">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								style="cursor:hand;" align="center" bgcolor="" ondblclick="modidata1('xjbjmodiview.do?pkValue=','550','400')">
								<td>
									...
									<input type="hidden" value="<logic:iterate id="v" name="s" offset="10" length="3"><bean:write name="v"/></logic:iterate>"/>
								</td>							
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_add"
								onclick="refreshForm('pjpy_jgsdx_wmbjsq.do')"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_edit"
								onclick="modidata1('xjbjmodiview.do?pkValue=','550','400')"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_delete"
								onclick="delshjxj('wmbjsqdel.do')"
								style="width:80px">
								批量删除
							</button>
							&nbsp;&nbsp;&nbsp;
							...
							<button class="button2" id="btn_print"
								onclick="wmbjprint('wmbjprint.do?pkValue=')"
								style="width:80px">
								打印/预览
							</button>
						</div>
