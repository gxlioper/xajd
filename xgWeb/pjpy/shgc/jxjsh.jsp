...
function dataExport2() {
	document.forms[0].action = "/xgxt/shgc_pjpy.do?method=jxjshExp";
	document.forms[0].target = "_blank";
	document.forms[0].submit();
	document.forms[0].target = "_self";
}
		</script>
		<html:form action="/shgc_pjpy.do?method=jxjsh" method="post">
			<div class="title">
						...
						<logic:equal name="isQuery" value="is">
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xydm" style="width:180px"
										styleId="xy"
										onchange="refreshForm('/xgxt/shgc_pjpy.do?method=jxjsh')">
								...
								<td width="10" align="center" valign="middle" rowspan="2">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/shgc_pjpy.do?method=jxjsh')">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td>
									...
									&nbsp;&nbsp;&nbsp;奖学金项目：
									<html:select name="rs1" property="bbdm" style="width:160px">
										<html:option value=""></html:option>
							...
							<tr>
								<td>
									...
									<input type="text" id="xh" name="xh" maxlength="20"
										...
										value="<bean:write name="rs1" property="xh"/>">
									&nbsp;&nbsp;审核状态：
									<html:select name="rs1" property="shzt">
										<html:option value=""></html:option>
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/shgc_pjpy.do?method=jxjshXxxx','view')">
									<td align="center">
    ...
    <bean:write name="v"/>
     ...
     "
									ondblclick="chkAssisOne('/xgxt/shgc_pjpy.do?method=jxjsq','view')">
									<td align="center">
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="checkbox" name="pk"
												value="<bean:write name="v"/>">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<logic:equal name="isQuery" value="is">
						<button class="button2"
							onclick="add('/xgxt/shgc_pjpy.do?method=jxjsq');"
							style="width:80px">
							增 加
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2"
							onclick="modi('/xgxt/shgc_pjpy.do?method=jxjsq');"
							style="width:80px">
							修 改
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEqual name="isQuery" value="is">
						<button class="button2"
							onclick="pass('/xgxt/shgc_pjpy.do?method=jxjshXxxx&actDo=pass');"
							style="width:80px">
							通 过
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="button2"
							onclick="notPass('/xgxt/shgc_pjpy.do?method=jxjshXxxx&actDo=notPass');"
							style="width:80px">
							不通过
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="button2"
						onclick="del('/xgxt/shgc_pjpy.do?method=jxjshXxxx&actDo=del');"
						style="width:80px">
						删 除
					</button>
