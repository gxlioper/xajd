...
<head>
	...
	<script language="javascript">
		function yz(){
			document.forms[0].action = "/xgxt/shgc_pjpy.do?method=zqjxjJeff&act=save";
		...
		<table class="tbstyle" width="90%">
			<tr>
				...
				<td align="center" width="50%">
					<input type="text" id="je" maxlength="10" name="je"
							style="width:100%;heigh:100%"
							value="<bean:write name="rs" property="je"/>"
