...
function plsz(){
	...
	var url = "/xgxt/shgc_pjpy.do?method=ptjxjdrsjPlsz";
	url += "&pkDel=" + RowsStr;
...
function dgsz(){
	var url = "/xgxt/shgc_pjpy.do?method=ptjxjdrsjEdit";
...
function csh(){
	var url = "/xgxt/shgc_pjpy.do?method=ptjxjdrsjcsh";
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/shgc_pjpy.do?method=ptjxjdrsjList" method="post">
			<div class="title">
							...
							<tr>
								<td align="left">
									...
									<html:select name="rs1" property="xmmc" style="width:180px">
										...
										<html:options collection="jxjxmList" property="xmmc"
											labelProperty="xmmc" />
									</html:select>
								...
								<input type="hidden" name="go" value="a"/>
									<button class="button2" id="search_go"
										onclick="refreshForm('shgc_pjpy.do?method=ptjxjdrsjList&go=go');">
										查询
									</button>
								</td>
							</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this)"
									ondblclick="chkAssisOne('/xgxt/shgc_pjpy.do?method=ptjxjdrsjEdit')">
									<td align="center">
