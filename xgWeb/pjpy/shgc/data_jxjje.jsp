...
function del(){
	...
	var url = "/xgxt/shgc_pjpy.do?method=jxjjeDel";
...
function add(){
	var url = "/xgxt/shgc_pjpy.do?method=jxjjeEdit";
	url += "&act=add";
	return showTopWin(url,400,250);
}
...
function dataExport2() {
	...
	document.forms[0].target = "_self";
		...
		<html:form action="/shgc_pjpy.do?method=jxjjeList" method="post">
			<div class="title">
						...
						<tr>
							...
							<td width="50" rowspan="1" align="center" valign="middle">
								...
								<button class="button2" id="search_go"
									onclick="refreshForm('shgc_pjpy.do?method=jxjjeList&go=go');">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								ondblclick="chkAssisOne('/xgxt/shgc_pjpy.do?method=jxjjeEdit')">
								<td align="center">
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<!--
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							-->
					<button class="button2" onclick="del();" style="width:80px">
						删 除
					</button>
				</div>
			</center>
