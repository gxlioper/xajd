...
function jeff(){
	...
	url = "/xgxt/shgc_pjpy.do?method=zqjxjJeff";
	url += "&pkDel=" + RowsStr;
...
function dataExport2() {
	document.forms[0].action = "/xgxt/shgc_pjpy.do?method=zqjxjExp";
...
function fprsxx(url){
	return showTopWin(url,750,550);
		...
		<html:form action="/shgc_pjpy.do?method=zqjxjList" method="post">
			<div class="title">
				...
				<table width="100%" class="tbstyle">
					<thead>
						<tr>
							<td align="left">
								...
								<html:select name="rs1" property="nj" style="width:60px"
									onchange="refreshForm('/xgxt/shgc_pjpy.do?method=zqjxjList')">
							...
							<td width="10" align="center" valign="middle" rowspan="2">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/shgc_pjpy.do?method=zqjxjList')">
									查询
								</button>
							</td>
						</tr>
						<tr>
							<td>
								年度：
								<html:select name="rs1" property="nd" style="width:70px" styleId="nd">
									<html:option value=""></html:option>
									<html:options collection="ndList" property="nd"
										labelProperty="nd" />
								</html:select>
								学期：
								<html:select name="rs1" property="xqmc" style="width:50px" styleId="xq">
									<html:option value=""></html:option>
									<html:options collection="xqList" property="xqmc"
										labelProperty="xqmc" />
								</html:select>
								本专科：
								<html:select name="rs1" property="bzk" style="width:70px">
									<html:option value=""></html:option>
								...
								奖学金等级：
								<html:select name="rs1" property="jxjdj" style="width:70px">
									<html:option value=""></html:option>
									<html:options collection="zqJxjdjList" property="jxjdj"
										labelProperty="jxjdj" />
								</html:select>
								是否困难生：
								<html:select name="rs1" property="sfkns" style="width:50px">
									<html:option value=""></html:option>
									<html:options collection="sfknsList" property="sfkns"
										labelProperty="sfkns" />
								</html:select>
							</td>
						</tr>
			...
			<center>
				<div class="buttontool" id="btn"
					...
					<button class="button2"
						onclick="jeff('/xgxt/shgc_pjpy.do?method=zqjxjJeff');"
						style="width:80px">
						发放金额
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="button2"
						onclick="del('/xgxt/shgc_pjpy.do?method=zqjxjDel');"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
