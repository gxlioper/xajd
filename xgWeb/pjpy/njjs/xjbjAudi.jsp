				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							...
							<li>
								<a href="#" id="btn_shtg"
									onclick="if(isChecked('primarykey_cbv') && confirm('您确定要取消审核所勾选的记录吗？')){refreshForm('njjsXjbj.do?method=xjbjAudi&doType=qxsh')}"
						...
						<tfoot>
							<tr>
								<td colspan="2">
									...
									<div class="btn">
										<button name="保存" onclick="searchGo()">
											保 存
										</button>
						...
						<tfoot>
							<tr>
								<td colspan="2">
									...
									<div class="btn">
										<button name="保存" onclick="refreshForm('njjsXjbj.do?method=xjbjAudi&doType=plsh&shjg='+$('shjg').value)">
											保 存
										</button>
										<button name="取消" onclick="closeWindown();return false;">
											取 消
