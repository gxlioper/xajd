...
<script type="text/javascript">
	...
	function checkSyme() {
		...
		shformdata('/xgxt/typj.do?method=rychsh&shjg=通过&doType=sh');
	}
</script>
</head>
				  ...
				  <div class="buttonbox">
				    <ul>
					  ...
					  <logic:empty name="yhInfo">
							...
							<li> <a href="#" onclick="shformdata('/xgxt/typj.do?method=rychsh&shjg=通过&doType=sh');" class="btn_shtg">批量通过</a> </li>
							</logic:notEqual>
							<li> <a href="#" onclick="shformdata('/xgxt/typj.do?method=rychsh&shjg=不通过&doType=sh');" class="btn_shbtg">批量不通过</a> </li>
					  </logic:empty>	
					  </logic:equal>
					</ul>					
				  </div>
						...
						<!--end操作开关提示-->
				          ...
				          <td colspan="5">
				            <div class="btn">
								...
								<button id="search_go"
										onclick="if(''==$('rychdm').value){alert('请选择荣誉称号!');return false;}   allNotEmpThenGo('/xgxt/typj.do?method=rychsh&doType=query')">
									查询
								</button>
								<button
