...
<script type="text/javascript">
	function print() {
		...
		var url = '/xgxt/typj.do?method=jxjPrint&jxjmc='+text;
		if (null != curr_row) {
			var pkValue = curr_row.getElementsByTagName('input')[0].value;
			url+='&pkValue='+pkValue;
		} else {
			if (!confirm('没有选择要打印的数据,继续打印将只显示模板.')) {
				return false;
			}
		}
		window.open(url);
				  ...
				  <div class="buttonbox">
				    <ul>
					  ...
					  <logic:equal value="yes" name="writeAble">
							...
							<li> <a href="#" onclick="showTopWin('/xgxt/typj_jxjsq.do?lx=gb',750,600);" class="btn_zj">增 加</a> </li>
							<li> <a href="#" onclick="var shjb = $('shjb').value;showInfo('/xgxt/typj.do?method=jxjView&shjb='+shjb,'update','900','600');" class="btn_xg">修改</a> </li>
							</logic:notEqual>
							<!--end非南通职业大学-->
							<li> <a href="#" onclick="deletedata('/xgxt/typj.do?method=jxjcx&doType=del');" class="btn_sc">删除</a> </li>
							<li> <a href="#" onclick="impAndChkData();" class="btn_dr">导入数据</a> </li>
							<li> <a href="#" onclick="expData('/xgxt/typj.do?method=jxjcx&doType=expData');" class="btn_dc">导出数据</a> </li>
				        ...
				        <tr>						  
				          <td colspan="6">
				            <div class="btn">
								...
								<button id="search_go"
									onclick="allNotEmpThenGo('/xgxt/typj.do?method=jxjcx&doType=query')">
									查询
								</button>
