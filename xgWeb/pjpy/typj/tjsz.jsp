				  ...
				  <div class="buttonbox">
				    <ul>
					  ...
					  <logic:equal value="yes" name="writeAble">
						<li> <a href="#" onclick="saveAll('/xgxt/typj.do?method=tjsz&doType=save');" class="btn_ccg">保存</a> </li>
						<li> <a href="#" onclick="showShjbList();" class="btn_sz">批量设置</a> </li>
					 </logic:equal>		
						<li> <a href="#" onclick="expData('/xgxt/typj.do?method=tjsz&doType=expData');" class="btn_dc">导出数据</a> </li>
					</ul>					
				  </div>
				  <div class="searchtab">
