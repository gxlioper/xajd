...
function Print() {
  ...
  document.all.eprint.InitPrint();
  document.all.eprint.SetMarginMeasure(1);//1mm是default, 2 inch
	 document.all.eprint.portrait=false; 
  document.all.eprint.header = "";
  document.all.eprint.footer = "";
}
	...
	var zd = ["xm","hjqsxn","hjjsxn","zhi","hjxjmc","fzxn","fzy","fzr"];
	...
	function drag_dropie(obj){
		...
		getPagePara.savePagePara(topStri,leftStri,'zzdxzs',function(){});
		return false;
		}
  ...
  <tr> 
    ...
    <ul> 
        <li class="youbianxia"> 
          <h4><div  style="position: absolute; left: 488px; top: 168px;" title="评奖起始学年度" id="hjqsxn" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${hjqsxn }</div></h4> 
          <h4 class="yueri"><div   style="position: absolute; left: 623px; top: 171px;" title="评奖结束学年度" id="hjjsxn" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${hjjsxn }</div></h4> 
        ...
        <h4 class="yueri"><div style="position: absolute; left: 620px; top: 217px;" title="学年度连接线" id="zhi" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${zhi }</div></h4>  
          ...
          <h4><div  style="position: absolute; left: 737px; top: 217px;" title="发证月份" id="fzy" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${fzy }</div></h4> 
        	<h4><div style="position: absolute; left: 733px; top: 170px;" title="评奖名称" id="hjxjmc" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()" nowrap>${hjxjmc }</div></h4> 
        	<h4><div style="position: absolute; left: 733px; top: 170px;" title="发证日" id="fzr" onMouseDown="initializedragie(this)" onMouseMove="drag_dropie(this)" onmouseup="savePosition()">${fzr }</div></h4> 
        </li> 
     </ul></td> 
  </tr> 
</table> 
