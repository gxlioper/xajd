...
var top= new Array();
	var left = new Array();
    var x,y;
    var zd = ["xm","hjqsxn","hjjsxn","zhi","hjxjmc1","fzxn","fzy","fzr"];
	...
	if(cu_R >= window.opener.$("tabPri").rows.length){
		...
		window.location.href = "zzdxzsprintmore.do?xm="+xm+'&hjxn='+document.getElementById('hjxn').value+'&hjxjmc='+document.getElementById('hjxjmc').value+'&hjny='+document.getElementById('hjny').value;
	}
	}
