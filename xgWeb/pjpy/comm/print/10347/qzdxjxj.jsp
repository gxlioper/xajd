...
<html>
	<head>
		...
		<title>湖州师范学院求真学院单项奖学金申请表</title>
	...
	<body>
		<center>
			<p>
				<span style="font-size: 26px; font-family: 宋体">湖州师范学院求真学院单项奖学金申请表</span>
			</p>
		</center>
			<table border="0" width="652px" class="printtab">
				...
				<tr>
        			...
        			<td width=489 colspan=10>
        				<p><b>
        					<span>
        						<logic:equal value="求真学习特别奖" name="xmmc">
        						...
        						<logic:equal value="求真技能奖" name="xmmc">
        						...
        						<logic:equal value="求真科技奖" name="xmmc">
        							<input type="checkbox" disabled="disabled"/>学习特别奖
        							<input type="checkbox" disabled="disabled"/>技能奖
        						...
        						<logic:equal value="求真创新奖" name="xmmc">
        							<input type="checkbox" disabled="disabled"/>学习特别奖
        							<input type="checkbox" disabled="disabled"/>技能奖
	        						<input type="checkbox" disabled="disabled"/>科技奖
        						...
        						<logic:equal value="求真文体活动奖" name="xmmc">
        							<input type="checkbox" disabled="disabled"/>学习特别奖
        							<input type="checkbox" disabled="disabled"/>技能奖
	        						<input type="checkbox" disabled="disabled"/>科技奖
	        						<input type="checkbox" disabled="disabled"/>创新奖
