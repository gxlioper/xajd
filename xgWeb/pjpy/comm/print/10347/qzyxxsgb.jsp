...
<html>
	<head>
		...
		<title>湖州师范学院求真学院优秀学生干部申请表</title>
	...
	<body>
		<center>
			<p>
				<span style="font-size: 26px; font-family: 宋体">湖州师范学院求真学院优秀学生干部申请表</span>
			</p>
		</center>
			<table border="0" width="652px" class="printtab">
				...
				<tr>
					<td colspan=11 valign=top>
						...
						<br/>${rs.sqly }<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
						<p align="right">
							<b><span>签名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></b>
						</p>
						<br/>
