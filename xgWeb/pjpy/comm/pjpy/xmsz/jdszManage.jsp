...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<html:form action="/pjpy_ty_jdsz" method="post">
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>评奖评优-评奖综合设置-兼得设置</a>
				</p>
	...
	<!-- 提示信息 end-->
		<div class="prompt" id="div_help" style="display: none">
			...
			<p>
				1.本模块用于设置评奖项目之间的兼得情况，例如：设置"项目A"与"项目B"不可兼得，如果当前评奖周期学生获得了评奖"项目A"就不能再获得"项目B"。注:该限制条件在最后一级审核时起作用。
			</p>
		...
		<!-- 快捷方式 end-->
				...
				<!-- 按钮 -->
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" class="btn_sz"
									onclick="showTopWin('pjpy_ty_jdsz.do?method=xzxm',500,300)"
									id="btn_dr">设置</a>
							</li>
							<li>
								<a href="#" class="btn_xg"
									onclick="showUpdateWindow('primarykey_cbv','pjpy_ty_jdsz.do?method=jdsz&doType=update',500,400);"
									id="btn_qx">修改</a>
							</li>
							<li>
								<a href="#" class="btn_sc"
									onclick="batchData('primarykey_cbv','pjpy_ty_jdsz.do?method=jdszManage&doType=del','del')"
									id="btn_qx">删除</a>
							</li>
						</ul>
					</div>
								...
								<td colspan="6">
									<div class="btn">
										<button type="button" class="btn_cx" id="search_go"
											onclick="allNotEmpThenGo('pjpy_ty_jdsz.do?method=jdszManage&doType=query')">
											查 询
										</button>
			...
			<div class="formbox">
				...
				<jsp:include flush="true"
					page="/sjcz/turnpage.jsp?form=pjpyJdszForm"></jsp:include>
			</div>
			<!-- 提示信息 -->
