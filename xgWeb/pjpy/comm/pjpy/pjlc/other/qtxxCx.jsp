	...
	<head>
		...
		function deleteQtxx(){
			...
			if(n>0){
				...
				if(blog){
					confirmInfo("该操作将会删除您所勾选的记录，是否确定继续操作？",function(tag){
				...
				<div class="buttonbox">
					<ul>
						...
						<logic:equal name="writeAble" value="yes">
							<li>
								<a href="#" onclick="showTopWin('pjpyQtxx.do?method=qtxxZj',600,600);return false;" class="btn_zj">增加</a>
							</li>
							<li>
								<a href="#" onclick="showModi();return false;" class="btn_xg">修改</a>
							</li>
							<li>
								<a href="#" onclick="deleteQtxx();return false;" class="btn_sc">删除</a>
							</li>
