	...
	<html:form action="/pjpyynyswh" method="post">
		<div class="title">
       		<div class="title_img" id="title_m">
         		<bean:message bundle="pjpyynys" key="pjpy_ynys_yxbyssqqry" />
       		</div>
    	</div>
						...
						<td align="left">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="refreshForm('ynys_yxbyssqqryres.do');document.getElementById('search_go').disabled=true;">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										style="cursor:hand;" ondblclick="modiAndDel('ynys_yxbysmodi.do?act=view&pkValue=','modi','620','520');">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" id="btn_add" style="width:80px"
								onclick="refreshForm('pjpy_yxbyssq.do')">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_modi" style="width:80px"
								onclick="modiAndDel('ynys_yxbysmodi.do?pkValue=','modi','620','520');">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_del" style="width:80px"
								onclick="deldata('ynys_yxbysdel.do')">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;
							...
							<button type="button" class="button2" onclick="dataExport()" style="width:80px">
								...
								&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" id="btn_print" onclick="bbPrint('ynys_yxbysprint.do?pkValue=')" style="width:80px">
						打印报表
					</button>
								&nbsp;&nbsp;&nbsp;
								<a href="xlsDown/ynys_yxbysb.xls"
