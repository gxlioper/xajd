...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
       function toChk(str){ 
           ...
           var url = "/xgxt/pjpyszyqwh.do?method=szyc_shsjViewAndChk&doType=save&check="+str; 
		   var RowsStr="";		  		  	   
		   ...
		   if (confirm("确定要\""+xyshDone+"\"所选记录？")){
		        if(str=="yes"){
		             getSzPjpyDAO.getPointLimit("shsj",pkVArray,pkValue,function(data){
		                if(data==""){
		                      refreshForm(url);
			                  if($("buttonYes")){
	...
	<body>
		<html:form action="/pjpyszyqwh">
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>评奖评优 － 学生综合素质养成课 - 社会实践 - 审核</a>
				</p>
			</div>
