...
function dataExportXthd() {
	...
	<body>
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置:</em><a>综合素质-学生综合素质养成课-IVT论坛查询</a>
			</p>
		</div>
		...
		<html:form action="/pjpyszyqwh" method="post">
			...
			<div class="comp_title">
				<ul>
					<li class="ha">
						<a
							href="javascript:refreshForm('pjpyszyqwh.do?method=szyc_xthdManage&xxk=ivlt');"><span>查询</span>
						</a>
					</li>
					<li>
						<a
							href="javascript:refreshForm('pjpyszyqwh.do?method=szyc_xthdBzrAdd&tbName=szyq_ivtltb');"><span>增加</span>
						</a>
					</li>
				</ul>
			</div>
				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" class="btn_xg"
									onclick="modiTab('pjpyszyqwh.do?method=szyc_dshdUpdate&xxk=ivlt&pkValue=','800','500');return false;"
									id="btn_xg">修改</a>
							</li>
							<li>
								<a href="#" class="btn_tj"
								...
								<td colspan="6">
									<div class="btn">
										...
										<button type="button" class="btn_cx" id="search_go"
											onclick="refreshForm('pjpyszyqwh.do?method=szyc_xthdManage&xxk=ivlt&go=go');">
											查 询
										</button>
								...
								<tbody>
									<logic:iterate name="rs" id="s">
										<tr onclick="rowOnClick(this)" style="cursor: hand;"
											ondblclick="modiTab('pjpyszyqwh.do?method=szyc_dshdUpdate&xxk=ivlt&pkValue=','800','500')">
											<td>
