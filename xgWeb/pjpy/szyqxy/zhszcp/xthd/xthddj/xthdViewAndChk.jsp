...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
       function toChk(str){         
           ...
           var url = "/xgxt/pjpyszyqwh.do?method=szyc_xthdViewAndChk&xxk=wthd&doType=save&check="+str; 
		   var RowsStr="";		  		  	   
		   ...
		   if (confirm("确定要\""+xyshDone+"\"所选记录？")){
			   if(str=="yes"){
		             getSzPjpyDAO.getPointLimitXthd("wthd",pkVArray,pkValue,function(data){
		                if(data==""){
		                      refreshForm(url);
			                  if($("buttonYes")){
