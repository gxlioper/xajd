...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function bzrSave(){
			...
			if (confirm("确认所录入的数据？")) {
				showTips('处理数据中，请等待......');
				refreshForm("/xgxt/pjpyszyqwh.do?method=szyc_xthdBzrAdd&doType=save&tbName=szyq_xthddjb");
								...
								<td colspan="6">
									<div class="btn">
										...
										<button type="button" class="btn_cx" id="search_go"
											onclick="refreshForm('pjpyszyqwh.do?method=szyc_xthdBzrAdd&tbName=szyq_xthddjb');">
											查 询
										</button>
							...
							<tbody>
								<logic:iterate name="rsList" id="s" indexId="index">
									<tr>
										...
										<td>
											<textarea name="hdnr" style="width:80px" rows="3"
										...
										<td>
											<input type="text" name="jldj" maxlength="20"
												style="width:80px" />
										</td>
										<td align="center">
