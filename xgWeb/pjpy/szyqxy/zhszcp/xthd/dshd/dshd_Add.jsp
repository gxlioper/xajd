        ...
        for(var i=1;i<=rowLen;i++){
        	   if($("dsmc"+i)){
      			...
      			if($("dsxd"+i)){
           			...
           			if($("dsxd"+i).value.length>300){
           				alert("第"+i+"行,读书心得字数最多只能是300个，请确定");
           				return false;
           			}
       			}
        }
        refreshForm('/xgxt/pjpyszyqwh.do?method=szyc_dshdAdd&xxk=dshd&doType=save');
...
jQuery(function(){
	...
	<body >
		<html:form action="/pjpyszyqwh">
			<input id="url" name="url" type="hidden" value="/pjpy/szyqxy/zhszcp/xthd/dshd/dshd_Add.jsp"/>
			<input id="getStuInfo" name="getStuInfo" type="hidden" value="xh"/>
			<div class="title">
				<div class="title_img" id="title_m">
					当前位置：综合素质-学生综合素质养成课-读书活动录入
				</div>
			</div>
							...
							<table align="center" style="width: 100%" id="rsT" class="tbstyle">
								...
								<thead style="height: 23px">
									<tr>
										...
										<td nowrap="nowrap">
											读书心得<font color="red">(限300字内)</font>
										</td>
										<td nowrap="nowrap">
											是否获奖
										</td>
