				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" class="btn_xg"
									onclick="modiTab('pjpyszyqwh.do?method=szyc_dshdUpdate&xxk=dshd&pkValue=','800','500');return false;"
									id="btn_xg">修改</a>
							</li>
								...
								<td colspan="6">
									<div class="btn">
										...
										<button type="button" class="btn_cx" id="search_go"
											onclick="refreshForm('pjpyszyqwh.do?method=szyc_xthdManage&xxk=dshd&go=go');">
											查 询
										</button>
								...
								<tbody>
									<logic:iterate name="rs" id="s">
										<tr onclick="rowOnClick(this)"
											ondblclick="modiTab('pjpyszyqwh.do?method=szyc_dshdUpdate&xxk=dshd&pkValue=','800','500')">
											<logic:iterate id="v" name="s" offset="1">
												<td>
													<input type=hidden id="pk" name="ok"
														value="<logic:iterate id="x" name="s" offset="0" length="1"><bean:write name="x"/></logic:iterate>" />
													<logic:iterate id="y" name="s" offset="1" length="1">
														<input type="hidden" name="xsxh"
															value="<bean:write name='y'/>" />
													</logic:iterate>
