...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function bzrSave(){
			...
			if (confirm("确认所录入的数据？")) {
				showTips('处理数据中，请等待......');
				refreshForm("/xgxt/pjpyszyqwh.do?method=szyc_xthdBzrAdd&doType=save&tbName=szyq_dshdjzb");
...
<body >
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置:</em><a>综合素质-学生综合素质养成课-读书活动查询</a>
			</p>
		</div>
	<html:form action="/pjpyszyqwh" method="post">
    	...
    	<div class="comp_title">
			<ul>
				<li>
					<a href="javascript:refreshForm('szyc_xthdManage.do');"><span>查询</span>
					</a>
				</li>
				<li class="ha">
					<a
						href="javascript:refreshForm('pjpyszyqwh.do?method=szyc_xthdBzrAdd&tbName=szyq_dshdjzb');"><span>增加</span>
					</a>
				</li>
			</ul>
		</div>
					...
					<table width="100%" border="0" id="searchTab">
								...
								<td colspan="6">
									<div class="btn">
										...
										<button type="button" class="btn_cx" id="search_go"
											onclick="refreshForm('pjpyszyqwh.do?method=szyc_xthdBzrAdd&tbName=szyq_dshdjzb&go=go');">
											查 询
										</button>
    					...
    					<tbody>
							<tr>
								...
								<td>
									<html:select property="xn" style="width:90px" styleClass="select" disabled="true"
									styleId="xn">
								...
								<td>
									<html:select property="xq" style="width:90px" styleClass="select" disabled="true"
									styleId="xq">
									<html:option value=""></html:option>
							...
							<table summary="" class="dateline tablenowrap" width="100%">
								<thead>
									<tr>
										...
										<td>
											读书心得<font color="red">(限150字)</font>
										</td>
										<td>
											是否获奖
										</td>
								...
								<tbody>
									<logic:iterate name="rsList" id="s" indexId="index">
										<tr>
											...
											<td><input type="text" name="dsmc" style="width:80px" maxlength="40"/></td>
											<td><input type='text' style="width:80px" name='dsrq' id="dsrq${index }" maxlength='20' readonly='true' onblur='dateFormatChg(this)' style='cursor:hand;' onclick="return showCalendar('dsrq${index }','y-mm-dd')"/></td>		
											<td><textarea  name="dsxd"  rows="3" onblur="chLeng(this,150)"></textarea></td>
											<td align="center"><select name='sfhj' style=""><option value='是'>是</option><option value='否'>否</option></select></td>
											<td align="center"><select name='jjf' style=""><option value='加分'>加分</option><option value='减分'>减分</option></select></td>
											<td><input type="text" name="pf" onkeypress="return sztzNumInputValue(this,5,event)" maxlength="5" style="width:80px"/></td>
										</tr>
									</logic:iterate>
								</tbody>
							</table>
