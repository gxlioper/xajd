				...
				<logic:equal value="yes" name="writeAble">
					<div class="buttonbox">
						<ul>
							<li>
								<a href="#" class="btn_xg"
									onclick="modiTab('pjpyszyqwh.do?method=szyc_dshdUpdate&xxk=yybd&pkValue=','800','500');return false;"
									id="btn_xg">修改</a>
							</li>
							<li>
								<a href="#" class="btn_tj"
								...
								<td colspan="6">
									<div class="btn">
										...
										<button type="button" class="btn_cx" id="search_go"
											onclick="refreshForm('pjpyszyqwh.do?method=szyc_xthdManage&xxk=yybd&go=go');">
											查 询
										</button>
								...
								<tbody>
									<logic:iterate name="rs" id="s">
										<tr onclick="rowOnClick(this)" style="cursor: hand;"
											ondblclick="modiTab('pjpyszyqwh.do?method=szyc_dshdUpdate&xxk=yybd&pkValue=','800','500')">
											<td align=center>
