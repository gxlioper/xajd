...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
		function viewChk(){
		     var url = "/xgxt/pjpyszyqwh.do?method=szyc_xthdViewAndChk&xxk=yybd";
		     
		     url+="&xh="+curr_row.cells[3].innerHTML;
		     url+="&xn="+$("xn").value;
		     url+="&xq="+$("xq").value;
		...
		function dataExportXthd() {
			var url = "/xgxt/pjpyszyqwh.do?method=szyc_xthdBbhz&xxk=yybd";
			var xymc ="";
		    if($("xydm").value!=""){ 
...
<body onload="xyDisabled('xy');">
	<html:form action="/pjpyszyqwh" method="post">
		<div class="tab_cur">
			<p class="location">
				<em>您的当前位置:</em><a>综合素质-学生综合素质养成课-语言表达录入 - 审核</a>
			</p>
			<p class="help">
		...
		<div class="comp_title">
	      <ul>
	        ...
	        <li class="ha"><a href="javascript:$('go').value='';refreshForm('pjpyszyqwh.do?method=szyc_XthdChk&xxk=yybd');"><span>语言表达</span></a></li>
	        <li><a href="javascript:$('go').value='';refreshForm('pjpyszyqwh.do?method=szyc_XthdChk&xxk=ivlt');"><span>IVT论坛</span></a></li>
	        <li><a href="javascript:$('go').value='';refreshForm('pjpyszyqwh.do?method=szyc_XthdChk&xxk=wthd');"><span>文体活动</span></a></li>
	      </ul>
	    </div>
	    ...
	    <div class="toolbox">
			<div class="buttonbox">	
				<ul>
					<li><a href="#" class="btn_shtg" onclick="sh5s('pjpyszyqwh.do?method=szyc_XthdChk&xxk=yybd&doType=save','通过');return false;">审核通过</a></li>
					<li><a href="#" class="btn_shbtg" onclick="sh5s('pjpyszyqwh.do?method=szyc_XthdChk&xxk=yybd&doType=save','不通过');return false;">审核不通过</a></li>
					<li><a href="#" class="btn_sc" onclick="del5s('pjpyszyqwh.do?method=szyc_dshdDel&xxk=yybd&doType=del');return false">删除</a></li>
			...
			<table width="100%">
				<tfoot>
					<tr>
						...
						<button type="button" id="search_go" onclick="refreshForm('/xgxt/pjpyszyqwh.do?method=szyc_XthdChk&xxk=yybd&go=go');this.disabled=true;">
							查询
						</button>
