...
<body onload="xyDisabled('xy');">
	<html:form action="/pjpyszyqwh" method="post">
    	<div class="tab_cur">
			<p class="location">
				<em>您的当前位置:</em><a>综合素质-学生综合素质养成课-社会实践 - 审核</a>
			</p>
			<p class="help">
    	...
    	<div class="toolbox">
			<div class="buttonbox">	
				<ul>
					<li><a href="#" class="btn_shtg" onclick="sh5s('pjpyszyqwh.do?method=szyc_shsjChk&doType=save','通过');return false;">审核通过</a></li>
					<li><a href="#" class="btn_xg" onclick="sh5s('pjpyszyqwh.do?method=szyc_shsjChk&doType=save','不通过');return false;">审核不通过</a></li>
					<li><a href="#" class="btn_sc" onclick="del5s('/xgxt/pjpyszyqwh.do?method=serv_shsjDel&go=go');return false;">删除</a></li>
					<li><a href="#" class="btn_tj" onclick="shsjHzb();return false;">汇总</a></li>
				</ul>
			</div>
		</div>
