...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function rychOne(url){
		if(curr_row == null){
			alert('请选择要修改的学生!');
			return false;
		}
		//var pk = curr_row.cells[1].innerText+curr_row.cells[2].innerText;
		var pk = curr_row.cells[0].getElementsByTagName("input")[0].value
	...
	function rychDel(){
		...
		showTips('处理数据中，请等待......');
		refreshForm('/xgxt/pjpyhxxywh.do?method=rychDel&go=go&pk='+temppk)
	}
	</script>
	<body>
		<%
		...
		<center>
			...
			<input type="hidden" id="tableName" name="tableName"
				value="${tableName }" scope="request" />
			<input type="hidden" id="realTable" name="realTable"
				value="${realTable }" scope="request"/>
					...
					<thead>
						<tr>
							<td>
								...
								&nbsp;&nbsp;荣誉称号:
								<html:select name='rs1' property="rychdm" styleId="rychdm">
									<option value=""></option>
							...
							<td width="10" rowspan="3" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="searchCheck('/xgxt/pjpyhxxywh.do?method=rychall')">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
								<tr onclick="rowMore(this)" style="cursor:hand"
									ondblclick="rychOne('/xgxt/pjpyhxxywh.do?method=rychOne&pk=');">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
				<div class="buttontool" id="btn"
					...
					<button class="button2"
						onclick="showTopWin('/xgxt/pjpyhxxywh.do?method=rychSq',600,480);" style="width:80px">
						增 加
					</button>
					&nbsp;
					<button class="button2" style="width:80px"
					onclick="rychOne('/xgxt/pjpyhxxywh.do?method=rychOne&pk=');">
						修 改
					</button>
					&nbsp;
					<button class="button2" style="width:80px"
