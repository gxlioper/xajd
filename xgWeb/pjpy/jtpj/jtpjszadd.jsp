			...
			<div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table width="" border="0" class="formlist">
					...
					<tbody>
						...
						<tr>
							<th width="">
								<span class="red">*</span>集体评奖单位<br/>
								<font color="red">(选定后不能修改)</font>
							</th>
							<td colspan="3">
								<div style="float: left;">
									<html:radio property="jtpjdw" value="xy" styleId="xy"><label style='cursor:pointer' for="xy">以<font color="blue"><bean:message key="lable.xb" /></font>为单位</label></html:radio>
									<html:radio property="jtpjdw" value="bj" styleId="bj"><label style='cursor:pointer' for="bj">以<font color="blue">班级</font>为单位</label></html:radio>
									<logic:equal name="xxdm" value="12309">
									<html:radio property="jtpjdw" value="qs" styleId="qs"><label style='cursor:pointer' for="qs">以<font color="blue">寝室</font>为单位</label></html:radio>
									</logic:equal>
									<logic:equal name="xxdm" value="10466">
									<html:radio property="jtpjdw" value="qs" styleId="qs"><label style='cursor:pointer' for="qs">以<font color="blue">寝室</font>为单位</label></html:radio>
									</logic:equal>
									<html:radio property="jtpjdw" value="qt" styleId="qt"><label style='cursor:pointer' for="qt">其他</label></html:radio>
								</div>
							</td>
						</tr>
					<thead>
					...
					<logic:equal name="iswzdx" value="1" >
						...
						<tr>
							...
							<td colspan="3">
								<div>
								<html:radio property="sfkfsq" value="1" styleId="sfkfsq1"><label style='cursor:pointer' for="sfkfsq1">开启</label></html:radio></lable>
								<html:radio property="sfkfsq" value="0" styleId="sfkfsq0"><label style='cursor:pointer' for="sfkfsq0">关闭</label></html:radio></lable>
								</div>
							</td>
						</tr>
						<tbody id="kqxx">
