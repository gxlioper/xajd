					...
					<thead>
						<tr>
							...
							&nbsp;&nbsp;
								...
								&nbsp;&nbsp;
								年度：
								<html:select property="nd" styleClass="select" style="width:80px" styleId="nd">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="refreshForm('zjjd_zhszcpqry.do');this.disabled=true">
									查询
								</button>
							</td>
						</tr>
