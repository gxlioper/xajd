...
<tr>
	<td width="20%" align=right class="include_tab_r">	
		银行类型：
	</td>
	<td width="30%" class="include_tab_r">
		<input type="text" name="yhmc" id="yhmc" value="" readonly="readonly"
			style="text-align:left;ime-mode:disabled;width:100%;border:0;"/>
	</td>
	<td width="16%" align=right class="include_tab_r">
		卡号：
	</td>
	<td style="border-right:0;">
		<input type="text" name="yhkh" id="yhkh" value="" readonly="readonly"
			style="text-align:left;ime-mode:disabled;width:100%;border:0;"/>
	</td>
</tr>
</table>
