...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="xyDisabled('xy');shResult()">
		...
		<html:form action="/xysbjxj" method="post">
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：
					评奖评优 - 审核结果查询 - 奖学金审核结果查询
				</div>
			</div>
					...
					<thead>
						<tr>
							<td align="left">
								...
								结果：
								通过<html:radio property="jg" value="tg"></html:radio>
								未通过<html:radio property="jg" value="btg"></html:radio>
							</td>
							<td width="10" rowspan="2" align="center" valign="middle">
								<input type="hidden" name="go" value="a" />
								<button class="button2" style="height:40px" id="search_go"
									onclick="if(checkMustNotNull()) allNotEmpThenGo('/xgxt/xyshjxjjgQry.do');">
									查询
								</button>
							</td>
						</tr>
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button class="button2"
								onclick="expTab('rsTable','<bean:message key="lable.xsgzyxpzxy" />奖学金审核结果名单',null,null,null,null)">
								打印/预览
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="button2"
								onclick="pjpySbExport()">
								数据导出
							</button>
						</div>
					</logic:equal>
