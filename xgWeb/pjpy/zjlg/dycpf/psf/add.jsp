	...
	function savePsf(){
		...
		if(num!=0){
			if($("userType").value == "teacher"){
				for(var i=0;i<num;i++){
					if($("zwpyf"+i) && $("bjpyf"+i)){
						if($("zwpyf"+i).value != "" && $("bjpyf"+i).value != ""){
							if($("xyfjf"+i).value != ""){
								cpf += $("xh"+i).value + "!@!"+$("xn"+i).value+"!@!"+$("zwpyf"+i).value+"!@!"+$("bjpyf"+i).value+"!@!"+$("xyfjf"+i).value+"!!@@!!";
							}else{
								cpf += $("xh"+i).value + "!@!"+$("xn"+i).value+"!@!"+$("zwpyf"+i).value+"!@!"+$("bjpyf"+i).value+"!@!"+"noPoint"+"!!@@!!";
							}
						}else{
							alert("第"+(i+1)+"行，自我评议分或者班级评议分为空，请确认！！！");
							return false；
						}
					}
				}
				...
				for(var i=0;i<num;i++){
					if($("zwpyf"+i) && $("bjpyf"+i)){
						if($("zwpyf"+i).value != "" && $("bjpyf"+i).value != ""){
							if($("xyfjf"+i).value != ""){
								cpf += $("xh"+i).value + "!@!"+$("xn"+i).value+"!@!"+$("zwpyf"+i).value+"!@!"+$("bjpyf"+i).value+"!@!"+$("xyfjf"+i).value+"!@!"+$("xyshV"+i).value+"!!@@!!";
							}else{
								cpf += $("xh"+i).value + "!@!"+$("xn"+i).value+"!@!"+$("zwpyf"+i).value+"!@!"+$("bjpyf"+i).value+"!@!"+"noPoint"+"!@!"+$("xyshV"+i).value+"!!@@!!";
							}
						}else{
							alert("第"+(i+1)+"行，自我评议分或者班级评议分为空，请确认！！！");
							return false；
			...
			refreshForm('/xgxt/zjlgPjpy.do?method=dycpfPsf&doType=save');
		}else{
			alert("请填写分数后再保存");
			return false;
		}
							...
							<tr>
								<td colspan="2">
									<input type="radio" name="cjlx" value="0" id="cjlx" 
										onclick="refreshForm('/xgxt/zjlgPjpy.do?method=dycpfPsf');"  checked>
										平时分
									&nbsp; 
							...
							<tr>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/zjlgPjpy.do?method=dycpfPsf')">
										查询
									</button>
								</td>
							</tr>
							...
							<logic:iterate name="rs" id="s" indexId="index">
								<tr onclick="rowOnClick(this);" style="cursor:hand">
									...
									<td align="center">
										...
										<html:text name="s" property="zwpyf" styleId="zwpyf${index}" style="width:85px" 
									...
									<td align="center">
										<logic:notEqual name="userType" value="xy">
										<html:text name="s" property="bjpyf" styleId="bjpyf${index}" style="width:85px" 
											onkeypress="return numInputValue(this,4,event)" maxlength="4" onblur="chFs(this);"/>
										</logic:notEqual>
										<logic:equal name="userType" value="xy">
										<html:text name="s" property="bjpyf" styleId="bjpyf${index}" style="width:85px" 
									...
									<logic:equal name="s" property="xysh" value="已通过">
										<td>
									...
									<logic:notEqual name="s" property="xysh" value="已通过">
										<td>
