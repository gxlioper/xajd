...
<head>
	...
	<script language="javascript">
		function jxjSqSavett(){
			...
			if(xxjl != null){
	         	if(xxjl.length > 800){	         
	          		 alert("本人简历不能大于400个字符！");
	          		 return false;
	       		 }
	       	}
	       	
			document.forms[0].action = "/xgxt/zjlgPjpy.do?method=jxjAdd&doType=save&jxjtype=tcgxjxj&update=update";
