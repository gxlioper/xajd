		...
		function jxjSqSavett(){
			...
			if(lshshyj != null){
	         	if(lshshyj.length > 200){	         
	          		 alert("评审委员会意见不能大于100个字符！");
	          		 return false;
	       		 }
	       	}
			document.forms[0].action = "/xgxt/zjlgPjpy.do?method=jxjAdd&doType=save&jxjtype=hdjxj&update=update";
