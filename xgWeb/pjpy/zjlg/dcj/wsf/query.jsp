...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="xyDisabled('xy');">
		<html:form action="/zjlgPjpydcj" method="post">
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>评奖评优 - 信息维护 - 德育卫生分维护</a>
				</p>
			</div>
			...
			<logic:equal value="yes" name="writeAble">
					...
					<div class="buttonbox">	
						<ul>
							...
							<li><a href="#" class="btn_shtg" onclick="shdata('pjpy_zjlg_wsfwh.do?act=sh&jg=tg')">审核通过</a></li>
							<li><a href="#" class="btn_shbtg" onclick="shdata('pjpy_zjlg_wsfwh.do?act=sh&jg=btg')">审核不通过</a></li>
							</logic:notEqual>
