...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function savePsf() {
		if (confirm('确认要保存当前页所录入的数据吗?')) {
			refreshForm('pjpy_zjlg_kqfwh.do?act=save');
		}
	}
	</script>
	</head>
	<body onload="xyDisabled('xy');">
		<html:form action="/zjlgPjpydcj" method="post">
			...
			<div class="tab_cur">
				<p class="location">
					<em>您的当前位置:</em><a>评奖评优 - 信息维护 - 德育考勤分维护</a>
				</p>
			</div>
					...
					<table width="100%" class="tbstyle">
						...
						<tfoot>
							<tr>
								...
								<button type="button" id="search_go" onclick="allNotEmpThenGo('pjpy_zjlg_kqfwh.do?act=qry')">
									查询
								</button>
						...
						<table width="100%" id="rsTable" class="dateline">
							<thead>
								...
								<td align="center">
									...
									<input type="hidden" id="cbv" name="primarykey_xh" style="height:17.5px"
								...
								<td align="center">
									<input type="text" name="save_kqf" maxlength="4" style="width: 50px;height:17.5px"
									value="<logic:iterate id="v" name="s" offset="6" length="1"><bean:write name="v"/></logic:iterate>" onkeyup="ckinpdata(this)"/>
								</td>
							</tr>
							</logic:iterate>
						</table>
