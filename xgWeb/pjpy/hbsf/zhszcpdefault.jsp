						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('hbsf_zhszcpqry.do');">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								style="cursor:hand;" align="center" bgcolor="" ondblclick="modidata2('hbsf_zhszcpview.do?type=view&pkValue=','800','550')">
								<td>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_add"
								onclick="showTopWin('hbsf_zhszcpadd.do','800','550')"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_edit"
								onclick="modidata2('hbsf_zhszcpview.do?type=modi&pkValue=','800','550')"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_delete"
								onclick="delshjxj('hbsf_zhszcpdel.do')"
								style="width:80px">
								批量删除
							</button>
							&nbsp;&nbsp;&nbsp;
							...
							<button class="button2" id="btn_expdata"
								onclick="zhszcpexp('hbsf_zhszcpexp.do')"
								style="width:80px">
								导出数据
							</button>
							</div>
