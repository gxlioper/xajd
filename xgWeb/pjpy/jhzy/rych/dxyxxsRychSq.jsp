	...
	<script language="javascript">
		function dataSave(){
			...
			if(act=="modi"){
			   ...
			   getSztzData.getInfoEx("jhzy_dxyxxsb","xh||xn",pkV," (fdysh<>'未审核' or xysh<>'未审核' or xxsh<>'未审核')",function(bool){
			       if(bool){
			           alert("该生已申请"+xn+"学年单项优秀学生荣誉称号；\n\n并通过相关部门审核或正在审核中！不能再次申请！ ");
			           return false;
			       }else{
			          refreshForm("/xgxt/jhzy_rych.do?method=dxyxxsRychSq&doType=save");			          
			       }
...
<body>
	...
	<html:form action="/jhzy_rych" method="post">
	    <logic:present name="noPass">
	       <p align="center" style="color: red">该生目前不满足<bean:write name="jhzyPjpyForm" property="xn"/>学年"单项优秀学生"荣誉称号申请条件！</p>
	    </logic:present>
