...
function chkView(){
    var url = "/xgxt/jhzy_rych.do?method=rychChek&xmk=sjyxbys&pkValue=";
    var pk = curr_row.cells[0].getElementsByTagName("input")[0].value;
	url += pk;
    showTopWin(url,"850","450");              		                  
 }
 function check(str){
           var userType = $("userType").value;
           var url = "/xgxt/jhzy_rych.do?method=rychCk&xmk=sjyxbys&go=go&check="+str;
		   var RowsStr="";		  
		   var userType = $("userType").value;		   
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_rych.do?method=bjqszShManageQuery&go=go');">
										查询
									</button>
								</td>
							</tr>
