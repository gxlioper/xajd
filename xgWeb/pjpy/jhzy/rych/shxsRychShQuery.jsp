...
function chkView(){
    var url = "/xgxt/jhzy_rych.do?method=rychChek&xmk=shxs&pkValue=";
 ...
 function check(str){
           var userType = $("userType").value;
           var url = "/xgxt/jhzy_rych.do?method=rychCk&xmk=shxs&go=go&check="+str;
		   var RowsStr="";		  
		   var userType = $("userType").value;		   
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_rych.do?method=shxsRychShQuery&go=go');">
										查询
									</button>
								</td>
							</tr>
