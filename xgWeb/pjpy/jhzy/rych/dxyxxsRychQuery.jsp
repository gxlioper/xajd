...
function rychView(act){  
    ...
    var url = "/xgxt/jhzy_rych.do?method=dxyxxsRychSq&act="+act+"&pkValue=";
...
function del(){          
           var url = "/xgxt/jhzy_rych.do?method=rychDel&xmk=dxyxxs&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
...
<%--				<input type="hidden" id="tableName" name="tableName" value="${tableName}" />--%>
				...
				<div class="title">
					<div class="title_img" id="title_m">
						当前所在位置：评价评优 - 荣誉称号申请 - 申请结果查询 - 单项优秀学生
					</div>
				</div>
				<fieldset>
					<legend>
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_rych.do?method=dxyxxsRychQuery&go=go');">
										查询
									</button>
								</td>
							</tr>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">													
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="showTopWin('/xgxt/jhzy_rych.do?method=dxyxxsRychSq',600,480)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
