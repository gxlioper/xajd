	...
	<html:form action="/jhzy_rych" method="post">
		...
		<table class="tbstyle" width="100%">
			...
			<tr>
				...
				<td colspan="3">
					<bean:write name="rsRych" property="zysj" />
				</td>
			</tr>
			<tr>
				<td>
          ...
          <tr>
			...
			<tr>
				...
				<td colspan="3">
					<html:textarea name="rsRych" property="fdyshyj" rows='5'
						styleId="fdyshyj" style="width:100%" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td colspan="3">
					<html:textarea name="rsRych" property="xyshyj" rows='5'
						styleId="xyshyj" style="width:100%" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td colspan="3">
					<html:textarea name="rsRych" property="xxshyj" rows='5'
