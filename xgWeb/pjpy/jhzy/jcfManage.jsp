...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="xyDisabled('xy')">
		...
		<html:form action="/jhzy_jcf" method="post">
							...
							<tr>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/jhzy_jcf.do?method=jcfManage')">
										查询
									</button>
								</td>
							</tr>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this);" 
									ondblclick="modiTab('jhzy_jcf.do?method=jcfUpdate&doType=view&xn='+curr_row.cells[4].innerText+'&xq='+curr_row.cells[5].innerText+'&pkValue=', '650', '500')"
									style="cursor:hand">
									<td>
										<logic:iterate id="v" name="s" offset="0" length="1">
											<input type="hidden" name="pk" value="<bean:write name="v" />"/>
										</logic:iterate>
										<logic:iterate id="v" name="s" offset="1" length="1">
											<input type="hidden" name="xh" value="<bean:write name="v" />"/>
											<bean:write name="v" />
										</logic:iterate>
									</td>
					...
					<div class="buttontool" id="btn"
						...
						<logic:equal name="writeAble" value="yes">
							<button class="button2"
								onclick="addTab('jhzy_jcf.do?method=jcfUpdate&doType=add', '650', '500')"
								style="width:80px">
								增 加
							</button>
							&nbsp;
							<button class="button2" id="btn_modi" style="width:80px"
								onclick="if(curr_row == null){alert('请选择要修改的数据');return false;}modiTab('jhzy_jcf.do?method=jcfUpdate&doType=update&xn='+curr_row.cells[4].innerText+'&xq='+curr_row.cells[5].innerText+'&pkValue=', '650', '500')">
								修 改
							</button>
							&nbsp;
							<button class="button2" id="btn_modi" style="width:80px"
								onclick="if(curr_row == null){alert('请选择要删除的数据');return false;}showTips('处理数据中，请等待......');refreshForm('/xgxt/jhzy_jcf.do?method=jcfManage&doType=del&pk='+curr_row.getElementsByTagName('input')[0].value, '650', '500')">
								删 除
							</button>
							&nbsp;
