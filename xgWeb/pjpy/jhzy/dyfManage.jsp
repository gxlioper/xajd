...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function saveDyf(){
		refreshForm('/xgxt/jhzy_dyf.do?method=dyfManage&doType=save');
	}
	</script>
							...
							<tr>
								<td colspan="2">
									<input type="radio" name="cjlx" value="0" id="cjlx" 
										onclick="refreshForm('/xgxt/jhzy_dyf.do?method=dyfManage');"  checked>
										德育分
									&nbsp; 
							...
							<tr>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/jhzy_dyf.do?method=dyfManage')">
										查询
									</button>
								</td>
							</tr>
								...
								<tr onclick="rowOnClick(this);" style="cursor:hand">
									...
									<td align="center">
										<logic:iterate id="v" name="s" offset="6" length="1">
											<input type="text" style="width: 50%" name="dyf" maxlength="5"
