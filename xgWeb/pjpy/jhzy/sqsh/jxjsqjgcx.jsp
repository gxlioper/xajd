...
function jxjView(act){  
    if(curr_row==null){
       alert('请选择要操作的记录!\n(单击一行即可)');
       return false;
    } 
    var jxjdm = $('jxjdm').value;
    var url = "/xgxt/jhzy_pjpySqsh.do?method=jxjsq&act="+act+"&jxjdm="+jxjdm+"&pk=";
...
function del(){          
           var url = "/xgxt/jhzy_pjpySqsh.do?method=jxjDel&go=go"; 
		   var RowsStr="";		  		 
		   var pkVArray = "'";
	...
	<body onload="xyDisabled('xy');">
		<center>
			...
			<html:form action="/jhzy_pjpySqsh" method="post">
				...
				<input type="hidden" id="jxjdm" name="jxjdm" value="<bean:write name="jxjdm"/>"/>			
				...
				<div class="title">
					<div class="title_img" id="title_m">
						当前所在位置：评价评优 - 奖学金申请 - 申请结果查询 - <bean:write name ="jxjmc" />
					</div>
				</div>
				<fieldset>
					<legend>
						...
						<thead>
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_pjpySqsh.do?method=jxjQuery&go=go');">
										查询
									</button>
								</td>
							</tr>
							<tr>
								<td align="left" nowrap>									
									...
									<input type="text" name = "xh" value="<bean:write name = "userName" />" readonly="readonly"/>
									</logic:equal>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">													
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="showTopWin('jhzy_pjpySqsh.do?method=jxjsq&jxjdm='+$('jxjdm').value,800,4080)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="jxjView('modi')"
								style="width:80px">
								修 改
							</button>
<%--							<font color="red">(修改过的数据需重新审核)</font>--%>
							&nbsp;&nbsp;&nbsp;&nbsp;
