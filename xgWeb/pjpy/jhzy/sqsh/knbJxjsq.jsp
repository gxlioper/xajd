	...
	<html:form action="/jhzy_pjpySqsh" method="post">
		...
		<table class="tbstyle" width="90%" id="theTable">
			...
			<tr>
				...
				<td>
					<input type="text" id="cjzk" name="cjzk"
						style="width:100%;heigh:100%"
						value="<bean:write name="rsJxj" property="cjzk"/>">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr id= "xxjl">
				...
				<td colspan="3">
					<html:textarea name="rsJxj" property="xxjl" rows='5'
			...
			<tr id= "zysj">
				...
				<td colspan="3">
					<html:textarea name="rsJxj" property="dnshjxj" rows='2'
						style="width:100%" onblur="chLeng(this,50)"/>
				</td>
			</tr>
			<tr id= "zysj">
				<td>
				...
				<td colspan="3">
					<html:textarea name="rsJxj" property="zysj" rows='5'
						style="width:100%" onblur="chLeng(this,800)"/>
				</td>
			</tr>
			<tr id = "sqly">
		...
		<logic:notEqual value="view" name="act">
			<button type="button" class="button2" onClick="dtjsCommonSave('jhzy_pjpySqsh.do?method=jxjsq&doType=save','sqly-bz-zysj','600-300-800','xh-sqly');">
				提交申请
			</button>
		</logic:notEqual>
