...
function chkView(){
    ...
    var url = "/xgxt/jhzy_pjpySqsh.do?method=jxjChek&jxjdm="+jxjdm+"&pkValue=";
 ...
 function check(str){
           var userType = $("userType").value;
           var jxjdm = $("jxjdm").value; 	
           var url = "/xgxt/jhzy_pjpySqsh.do?method=JxjsqshCk&jxjdm="+jxjdm+"&go=go&check="+str;
		   var RowsStr="";		  
		   var userType = $("userType").value;		   
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/jhzy_pjpySqsh.do?method=jxjsh&go=go');">
										查询
									</button>
								</td>
							</tr>
				...
				<center>
					<div class="buttontool" id="btn"
						style="position: absolute;left:1%;top:100px" width="100%">
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="check('yes')" id="checkpass">
								通  过
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="check('no')" id="checknopass"
								>
								不通过
							</button>							
					</div>
