...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	function saveJnf(){
		refreshForm('/xgxt/jhzy_dyf.do?method=jnfManage&doType=save');
	}
	
	function chJnf(obj){
		if(obj.value>4){
			alert("专业技能量值最大为4分，该生已经超过，请确认！！");
			obj.focus();
		}
	}
	</script>
	<body onload="xyDisabled('xy')">
		...
		<html:form action="/jhzy_dyf" method="post">
			<input type="hidden" name="num" id="num" value="${rsNum}"/>
							...
							<tr>
								<td colspan="2">
									...
									<input type="radio" name="cjlx" value="1" id="cjlx" 
										onclick="refreshForm('/xgxt/jhzy_dyf.do?method=tyfManage');" >
									&nbsp; 
										体育分
									<input type="radio" name="cjlx" value="1" id="cjlx" 
										onclick="refreshForm('/xgxt/jhzy_dyf.do?method=jnfManage');" checked>
									&nbsp; 
										技能分
								</td>
							</tr>
							<tr>
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/jhzy_dyf.do?method=jnfManage')">
										查询
									</button>
								</td>
							</tr>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
								<tr onclick="rowOnClick(this);" style="cursor:hand">
									...
									<td align="center">
										<logic:iterate id="v" name="s" offset="6" length="1" indexId="index">
											<input type="text" style="width: 50%" name="jnf" id="fz${index}" maxlength="5"
