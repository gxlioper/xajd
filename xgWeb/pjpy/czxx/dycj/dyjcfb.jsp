						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="refreshForm('pjpy_czxx_dyjcfb.do?act=qry');">
									查询
								</button>
							</td>
						</tr>
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this);" style="cursor:hand;"
								...
								<td align="center">
									...
									<input type="hidden" id="hiddenCbv" name="hiddenCbv"
										value="<logic:iterate id="v" name="s" offset="0" length="1"><bean:write name="v"/></logic:iterate>" />	
								</td>
								...
								<td align="center">
									...
									<input type="text" name="cjArr" maxlength="4" style="width:60px;height:17.5px" onkeyup="ckinpdata(this);checkBox(this);" value="<bean:write name="v" />"/>
									</logic:iterate>
								</td>
							</tr>
						</logic:iterate>
	...
	<center>
		<logic:equal value="yes" name="writeAble">
			<div class="buttontool" id="btn"
				...
				<button type="button" class="button2" onclick="saveinfo('pjpy_czxx_dyjcfb.do?act=save')" style="width:80px">
					保 存
				</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" onclick="deldata('pjpy_czxx_dyjcfb.do?act=del')" style="width:80px">
					删 除
				</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
