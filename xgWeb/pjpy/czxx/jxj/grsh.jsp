...
function tjjg(){
		...
		function commitSh(){
			...
			qgzxgzkh.checkExists('view_czxx_xsjxjb','xn||xq||bjdm',xn+xq+bjdm,function(data){
				if (data != null && data == true) {
					qgzxgzkh.checkExists('pjpy_bmshtjb','zjz||dm||bm||tjzt||tjxm',xn+xq+bjdm+'bj1jxj',function(data){
						if(data != null && data == true){
							alert('该班级奖学金评审结果已经提交！');
							return false;
						}else{//提交
							qgzxgzkh.checkExists('view_czxx_xsjxjb','xn||xq||bjdm||fdysh',xn+xq+bjdm+'未审核',function(data){
								if(data){
									alert('该班级还有部分奖学金数据未审核,暂时不能提交结果！');
									return false;
								}else{
									refreshForm("pjpy_czxx_jxjsh.do?act=tj&tjbjdm=" + bjdm);
								}
							});
						...
						<tr>
							<td align="left">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="refreshForm('pjpy_czxx_jxjsh.do?act=qry');">
									查询
								</button>
							</td>
							</tr>
				...
				<fieldset>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this);" style="cursor:hand;" ondblclick="modiAndDel('pjpy_czxx_jxjDggrsh.do?act=view&pkValue=','modi','750','700')">
								<td align="center">
	...
	<center>
		<logic:equal value="yes" name="writeAble">
			<div class="buttontool" id="btn"
				...
				<button type="button" class="button2" id="btn_dc" onclick="shdata('pjpy_czxx_jxjsh.do?act=save&jg=tg')"
					style="width:80px">
					审核通过
				</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" id="btn_dc" onclick="shdata('pjpy_czxx_jxjsh.do?act=save&jg=btg')"
					style="width:80px">
					审核不通过
				</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" id="btn_dc" onclick="modiAndDel('pjpy_czxx_jxjDggrsh.do?pkValue=','modi','750','700')"
					style="width:80px">
					单个审核
				</button>
				&nbsp;&nbsp;&nbsp;
