...
<script type="text/javascript">	  
	function batchDel(){
           var url = "/xgxt/pjpy_czxx_jxjQuery.do?act=del&go=go"; 
		   var RowsStr="";		  
    ...
    window.open('pjpy_czxx_print.do?table=xsjxjb&pkValue=' + pk);
    }
						...
						<tr>
							<td align="left">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="refreshForm('pjpy_czxx_jxjQuery.do?act=qry');">
									查询
								</button>
							</td>
							</tr>
				...
				<fieldset>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this);" style="cursor:hand;" ondblclick="modiAndDel('pjpy_czxx_jxjModi.do?act=view&pkValue=','modi','700','600')">
								<td align="center">
	...
	<center>
		<logic:equal value="yes" name="writeAble">
			<div class="buttontool" id="btn"
				...
				<button type="button" class="button2" id="btn_dc" onclick="showTopWin('pjpy_czxx_jxjAdd.do',700,570)"
					style="width:80px">
					增加
				</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="button2" id="btn_dc" onclick="modiAndDel('pjpy_czxx_jxjModi.do?pkValue=','modi','700','570')"
					style="width:80px">
					修改
				</button>
				&nbsp;&nbsp;&nbsp;
