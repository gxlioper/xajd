...
<script type="text/javascript">	  
	function tydf(act) {
		if (curr_row == null) {
			...
			showTopWin('pjpy_czxx_addTyfjfxx.do?pkValue=' + curr_row.cells[0].getElementsByTagName("input")[0].value + '&modi='+act, 700,550);
		}
	}
</script>
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="refreshForm('pjpy_czxx_tydlfjfb.do?act=qry');">
									查询
								</button>
							</td>
						</tr>
	...
	<center>
		<logic:equal value="yes" name="writeAble">
			<div class="buttontool" id="btn"
				...
				<button type="button" class="button2" onclick="tydf('add')" style="width:80px">
					评 分
				</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
