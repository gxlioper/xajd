		...
		<html:form action="/mjxyJxj" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
				...
				<li> <a href="#" onclick="modi('/xgxt/mjxyJxj.do?method=jxjShone&doType=view')" class="btn_sh"> 单个审核 </a> </li>
			    <li> <a href="#" onclick="dataBatch('mjxyJxj.do?method=shJxj&doType=save&shjg=通过')" class="btn_shtg"> 审核通过 </a> </li>
				<li> <a href="#" onclick="dataBatch('mjxyJxj.do?method=shJxj&doType=save&shjg=不通过')" class="btn_shbtg"> 审核不通过 </a> </li>
				</logic:notEqual>
			    </ul>
			 </div>
			 <div class="searchtab">
			        ...
			        <tr>
			          <td colspan="8">
			            <div class="btn">
								...
								<button  id="search_go" 
										onclick="refreshForm('/xgxt/mjxyJxj.do?method=shJxj&doType=qry')" >
										查询
								</button>
