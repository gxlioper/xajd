		...
		<html:form action="/mjxyJxj" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
				...
				<li> <a href="#" onclick="showTopWin('mjxyJxj.do?method=jxjSq',700,500)" class="btn_zj"> 增加 </a> </li>
			    <li> <a href="#" onclick="modi('mjxyJxj.do?method=jxjXx&doType=modi')" class="btn_xg"> 修改 </a> </li>
				<li> <a href="#" onclick="dataBatch('mjxyJxj.do?method=resultJxj&doType=del')" class="btn_sc"> 删除 </a> </li>
				<li> <a href="#" onclick="impAndChkData()" class="btn_dr"> 导入 </a> </li>
				</logic:notEqual>
				<li> <a href="#" onclick="wjcfDataExport('mjxyJxj.do?method=expDate')" class="btn_dc"> 导出 </a> </li>
			    </ul>
			 </div>
			 <div class="searchtab">
			 <table width="100%" border="0">
			        ...
			        <tr>
			          <td colspan="8">
			            <div class="btn">
									...
									<button   id="search_go" 
											onclick="refreshForm('/xgxt/mjxyJxj.do?method=resultJxj&doType=qry')"
											>
										查询
									</button>
				...
				<tbody>
						<tr>
							...
							<td>
								...
								<logic:notEqual name="userType"value="xy">
									<html:select property="queryequals_xydm" style="width:140px">
										<html:option value=""></html:option>
										<html:options collection="xyList" property="xydm" labelProperty="xymc" />
									</html:select>
								</logic:notEqual>
							...
							<td>
								<html:select property="queryequals_jxjdm" styleId="jxjdm" style="width:110px">
									<html:option value=""></html:option>
						...
						<tr>
							...
							<td>
								<html:select property="queryequals_xysh" style="width:120px">
									<html:option value=""></html:option>
							...
							<td>
								<html:select property="queryequals_xxsh" style="width:120px">
									<html:option value=""></html:option>
									<html:option value="未审核">未审核</html:option>
									<html:option value="通过">通过</html:option>
									<html:option value="不通过">不通过</html:option>
			...
			<logic:notEmpty name="rs">
					<table summary="" class="dateline" align="" width="100%">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('mjxyJxj.do?method=jxjXx&doType=view')" style="cursor:hand">
								<td>
				...
				<jsp:include flush="true"
								page="/sjcz/turnpage.jsp?form=mjxyJxjForm"></jsp:include>
			</logic:notEmpty>
			</div>
		</html:form>
