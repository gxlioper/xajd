		...
		<html:form action="/mjxyRych" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
				...
				<li> <a href="#" onclick="modi('/xgxt/mjxyRych.do?method=rychShone&doType=view')" class="btn_sh"> 单个审核 </a> </li>
			    <li> <a href="#" onclick="dataBatch('mjxyRych.do?method=shRych&doType=save&shjg=通过')" class="btn_shtg"> 审核通过 </a> </li>
				<li> <a href="#" onclick="dataBatch('mjxyRych.do?method=shRych&doType=save&shjg=不通过')" class="btn_shbtg"> 审核不通过 </a> </li>
				</logic:notEqual>
			    </ul>
			 </div>
			<div class="searchtab">
			          ...
			          <td colspan="8">
			            <div class="btn">
			              <input type="hidden" name="go" value="go" />
							<button  id="search_go" 
									onclick="refreshForm('/xgxt/mjxyRych.do?method=shRych&doType=qry')"
									>
								查 询
							</button>
			              &nbsp;&nbsp;&nbsp;&nbsp;
