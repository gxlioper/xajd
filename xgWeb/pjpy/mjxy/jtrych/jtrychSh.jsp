		...
		<html:form action="/mjxyJtrych" method="post">
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
				<logic:equal name="writeAble" value="yes">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('mjxyJtrych.do?method=jtrychSh&doType=save&shjg=通过')"
						style="width:80px">
						审核通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('mjxyJtrych.do?method=jtrychSh&doType=save&shjg=不通过')"
						style="width:80px">
						审核不通过
					</button>
				</logic:equal>
