					...
					<thead>
						<tr>
							...
							<td width="10" align="center" valign="middle" rowspan="3">
								<button type="button" class="button2" id="search_go"
											onclick="allNotEmpThenGo('mjxyJtrych.do?method=jtrychCx&doType=qry')" style="height: 25px">
											查 询
										</button>
										<br>
						...
						<tr>
							<td>
								...
								<html:select property="bjdm" disabled="true"  style="width:180px" styleId="bj">
									<html:option value=""></html:option>
									<html:options collection="bjList" property="bjdm"
									labelProperty="bjmc" />
								</html:select>
								<html:hidden property="queryequals_bjdm" value="${bjdms}"/>
								</logic:equal>
					...
					<table width="99%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowMoreClick(this,'',event);"
								ondblclick="modi('mjxyJtrych.do?method=jtrychOne&doType=view')" style="cursor:hand">
								<td>
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
				<logic:equal name="writeAble" value="yes">
					<button type="button" class="button2"
						onclick="showTopWin('mjxyJtrych.do?method=jtrychSq&doType=qry',700,500)"
						style="width:80px">
						增 加
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="modi('mjxyJtrych.do?method=jtrychOne&doType=modi')" style="width:80px">
						修 改
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('mjxyJtrych.do?method=jtrychCx&doType=del')"
						style="width:80px">
						删 除
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="wjcfDataExport('mjxyJtrych.do?method=expDate')" style="width:80px">
						导出数据
					</button>
					</div>
