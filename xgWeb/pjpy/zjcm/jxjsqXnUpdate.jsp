			...
			<table class="tbstyle" border="0" id="rsTable" align="center"
				...
				<tr bgcolor="EEF4F9" align="center">
					...
					<logic:notEqual value="theFirst" name="swbj">
						<input  id="up" value="上一条" onclick="showTips('刷新数据中，请稍候...');changerecord('/xgxt/zjcmPjpy.do?method=jxjsqXnUpdate','before');">
					</logic:notEqual>
					&nbsp; &nbsp;
					...
					<logic:notEqual value="theLast" name="swbj">
						<input  id="next" value="下一条" onclick="showTips('刷新数据中，请稍候...');changerecord('/xgxt/zjcmPjpy.do?method=jxjsqXnUpdate','next')">
					</logic:notEqual>
					&nbsp; &nbsp;
