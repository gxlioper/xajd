				...
				<tr style="height:22px">
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea name="rs" property="xyshyj" style="width:100%" rows="3" onblur="chLeng(this,200)"/>
						</td>
					</tr>
					</logic:equal>
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea name="rs" property="xxshyj" style="width:100%" rows="3" onblur="chLeng(this,200)"/>
						</td>
					</tr>
					</logic:notEqual>
