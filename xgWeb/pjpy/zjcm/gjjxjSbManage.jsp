								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button class="button2" style="height:40px" id="search_go"
											onclick="allNotEmpThenGo('/xgxt/zjcmPjpy.do?method=gjjxjSbManage');">
											查询
										</button>
									</td>
								</tr>
					...
					<logic:notEmpty name="rs">
						<fieldset>
							<legend>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<font color="blue">提示：显示结果为已经获得奖学金的学生信息；双击可查看详细信息.</font>
							</legend>
							<table width="100%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);" style="cursor:hand"
										ondblclick="showInfo('/xgxt/zjcmPjpy.do?method=gjjxjSbUpdate','view','800','650')">
										<td align="center">
											<input type="checkbox" id="checkVal${index }" name="checkVal"  style="display:none"
					...
					<div class="buttontool" id="btn"
						...
						<logic:equal name="writeAble" value="yes">
							<button class="button2"
								onclick="showInfo('/xgxt/zjcmPjpy.do?method=gjjxjSbUpdate','sb','800','650')"
								style="width:80px">
								申	报
							</button>
						</logic:equal>
