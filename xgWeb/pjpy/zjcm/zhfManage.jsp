								...
								<tr>
									...
									<td width="10" rowspan="3" align="center" valign="middle">
										...
										<button class="button2" style="height:40px" id="search_go"
											onclick="showTips('处理查询中，请等待......');allNotEmpThenGo('/xgxt/zjcmPjpy.do?method=zhfManage');">
											查询
										</button>
									</td>
								</tr>
						...
						<logic:equal name="writeAble" value="yes">
							...
							<logic:notEqual name="userType" value="stu">
								<logic:notPresent name="nobl">
									&nbsp;
									<button class="button2" 
										onclick="if (confirm('确定要计算本次评奖学年学期的综合分?\n注：计算前请先保存各项分值。')){saveUpdate('/xgxt/zjcmPjpy.do?method=zhfManage&doType=js','')}"
										style="width:80px">
										计算综合分
									</button>
								</logic:notPresent>
