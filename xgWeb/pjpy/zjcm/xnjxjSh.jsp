...
%>
	...
	function jxjDgsh() {
		...
		zjcmJxjDAO.checkJxjshjg(pk,userType,isFdy, function (data){
			if (data == 'false') {
			...
			<fieldset>
				...
				<table width="100%" class="tbstyle" align="center">
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea name="rs" property="fdyyj" style="width:100%" rows="3" onblur="chLeng(this,250)"/>
						</td>
					</tr>
					</logic:equal>
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea name="rs" property="xyyj" style="width:100%" rows="3" onblur="chLeng(this,250)"/>
						</td>
					</tr>
					</logic:equal>
					...
					<tr>
						...
						<td align="left" colspan="3">
							<html:textarea name="rs" property="xxyj" style="width:100%" rows="3" onblur="chLeng(this,250)"/>
						</td>
					</tr>
					</logic:notEqual>
					</logic:notEqual>
