...
<html xmlns="http://www.w3.org/1999/xhtml" lang="gb2312">
	...
	<body onload="stuOnLoadCon();xyDisabled('xy')">
		...
		<html:form action="/gzdxPjpy" method="post">
			...
			<input type="hidden" name="realTable" id="realTable" value="zhszbxfb"/>
			<input type="hidden" name="tableName" id="tableName" value="view_zhszbxf"/>
			<div class="title">
				<div class="title_img" id="title_m">
					当前所在位置：评奖评优 - 综测信息维护 - 综合表现申报查询
				</div>
			</div>
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button class="button2" style="height:40px" id="search_go"
										onclick="refreshForm('/xgxt/gzdxPjpy.do?method=xsZhbxfQuery&go=go');">
										查询
									</button>
								</td>
							</tr>
	...
	<script type="text/javascript">
   function dataAdd(){
       showTopWin("/xgxt/pjpy_gzdx_xsZhbxfsb.do",850,600);
   }
   function dataModi(){
        if (curr_row == null) {
		          alert("请选要修改的记录！\n单击一行记录即可");
	    ...
	    var url = "/xgxt/pjpy_gzdx_xsZhbxfsb.do?act=modi";
	    url +="&pkValue=";
   ...
   function dataView(){
        var url = "/xgxt/pjpy_gzdx_xsZhbxfsb.do?act=view";
	    url +="&pkValue=";
	    url +=(curr_row.cells[0].getElementsByTagName("input"))[0].value;
	    url +="&xh=";
	    url +=curr_row.cells[3].innerText;	
   ...
   function batchDel(){
           var url = "/xgxt/gzdxPjpy.do?method=plDelZhbx&go=go"; 
		   var RowsStr="";		  
		   for (i=0; i<document.getElementsByName("pkV").length; i++){
