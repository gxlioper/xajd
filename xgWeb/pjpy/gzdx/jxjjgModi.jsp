	...
	<script type="text/javascript">
      function dataSave(){
         ...
         if(userType=='xy'){
            ...
            getSztzData.getInfoEx("view_xsjxjb","xh||xn||jxjdm",pkValue,"xxsh='通过'",function(str){
		         if(str){		         	
			        flag = false;
		         }
    	    });
         ...
         refreshForm('/xgxt/gzdxPjpy.do?method=jxjjgModi&doType=save')
      }
    </script>
	<body>
