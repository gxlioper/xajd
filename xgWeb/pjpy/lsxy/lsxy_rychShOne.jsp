...
<script>
	...
	function save(){		
		refreshForm('pjpyLsxy.do?method=rychShOne&act=save');
	}
</script>
<body>
	...
	<input type="hidden" name="xxsh" id="xxsh" value="${rs.xxsh}"/>
		...
		<table class="tbstyle" width="100%">
			...
			<tr style="height:23px">
				...
				<td align="left">
					${rs.rychmc}
					<input type="hidden" name="save_rychdm" id="rychdm" value="${rs.rychdm}">
				</td>
			</tr>
			<tr style="height:23px">
				<td align="right">
			...
			<tr>
				...
				<td align="left" colspan="3">
					<html:textarea property="save_xyyj" rows="5" style="width: 98%" name="rs" onblur="chLeng(this,'1000')"></html:textarea>
				</td>
			</tr>
			<tr >
				<td align="right">
			...
			<tr>
				...
				<td align="left" colspan="3">
					<html:textarea property="save_xxyj" rows="5" style="width: 98%" name="rs" onblur="chLeng(this,'1000')"></html:textarea>
				</td>
			</tr>
			</logic:notEqual>
			<!--end非学院用户-->
