	...
	<body>
		<html:form action="nbty_rych" method="post">
			...
			<div class="buttontool" id="btn" style="position: absolute;left:1%;top:100px" width="100%">	
					<button type="button" class="button2" onclick="dataBatch('nbty_rych.do?method=rychSh&doType=save&shjg=通过')"
						style="width:80px">
						审核通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('nbty_rych.do?method=rychSh&doType=save&shjg=不通过')"
						style="width:80px">
						审核不通过
					</button>
					</div>
