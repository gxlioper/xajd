		...
		<html:form action="/nbtyWmbj" method="post">
							...
							<td align="left">
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go" 
											onclick="refreshForm('/xgxt/nbtyWmbj.do?method=nbtyShWmbj&doType=qry')">
										查询
									</button>
								</td>
							</tr>
			...
			<logic:equal name="writeAbled" value="yes">
				<center>
					...
					<button type="button" class="button2" onclick="dataBatch('nbtyWmbj.do?method=nbtyShWmbj&doType=modi&shjg=通过')"
						style="width:80px">
						审核通过
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="button2" onclick="dataBatch('nbtyWmbj.do?method=nbtyShWmbj&doType=modi&shjg=不通过')"
						style="width:80px">
						审核不通过
					</button>
					</div>
