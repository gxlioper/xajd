			...
			<html:form action="/pjpy_zjsyzy" method="post">
				...
				<div class="title">
					<div class="title_img" id="title_m">
						<bean:message bundle="pjpy" key="pjpy_zjsyzy_pjpyhmd" />
					</div>
				</div>
				<fieldset>
					<legend>
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px"
										onclick="allNotEmpThenGo('pjpy_zjsyzy.do?method=pjpyhmd');">
										查询
									</button>
								</td>
							</tr>
							...
							<thead>
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)" style="cursor:hand"
										ondblclick="modiInfo('pjpy_zjsyzy.do?method=modiPjpyhmd',600,480)">
										<td>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble">
							<button type="button" class="button2" onclick="showTopWin('pjpy_zjsyzy.do?method=addPjpyhmd',600,480)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="modiInfo('pjpy_zjsyzy.do?method=modiPjpyhmd',600,480)"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="batch('pjpy_zjsyzy.do?method=delPjpyhmd','del')"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
