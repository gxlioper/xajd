						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('pjpy_whlgdx.do?method=xjbjSearchInfo');">
									查询
								</button>
							</td>
						</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)"
								style="cursor:hand;" align="center" bgcolor="" ondblclick="modidata2('pjpy_whlgdx.do?method=showXjbjInfo&type=view&pkValue=','500','300')">
								<td>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button class="button2" id="btn_add"
								onclick="showTopWin('pjpy_whlgdx.do?method=xjbjAdd&type=view','500','300')"
								style="width:80px">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_edit"
								onclick="modidata2('pjpy_whlgdx.do?method=showXjbjInfo&type=modi&pkValue=','500','300')"
								style="width:80px">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_delete"
								onclick="delshjxj('pjpy_whlgdx.do?method=xjbjDel')"
								style="width:80px">
								批量删除
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_impdata"
								...
								style="width:80px"><!-- impAndChkData(); -->
								导入数据
							</button>
							&nbsp;&nbsp;&nbsp;
							<button class="button2" id="btn_expdata"
								onclick="xjbjExp('pjpy_whlgdx.do?method=xjbjExp')"
								style="width:80px">
								导出数据
							</button>		
							</div>					
