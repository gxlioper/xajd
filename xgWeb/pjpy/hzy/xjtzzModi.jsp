		...
		<table width="100%" class="tbstyle">
			...
			<tr>
				...
				<td align="left" width="40%">
					<html:text name="rs" property="tzzmc" styleId="tzzmc" maxlength="150"/>
				...
				<td align="left">
					<html:text name="rs" property="tzzsj" styleId="tzzsj" maxlength="25" />
				</td>
			</tr>
			<tr>
				<td scope="col" width="15%">
				...
				<td align="left" width="40%">
					<html:text name="rs" property="tzbs" styleId="tzbs" onkeypress="return onlyNum(this,5)" />
				</td>
				<td align="right" width="10%">
					团员数：
				</td>
				<td align="left">
					<html:text name="rs" property="tys" styleId="tys"  onkeypress="return onlyNum(this,5)"/>
				</td>
			</tr>
  					...
  					<table border="0" id="rsTable" width="100%" class="tbstyle"> 
    					...
    					<logic:iterate id="list" name="rswj"> 
    						<tr onmouseover="rowOnClick(this)"> 
      							<td> <a href="pjpy_hzy_xjbjandwmbj.do?method=DownLoadFile&downType=xjtzz&param=<bean:write name="list" property="pk" />" target=_black>下载   							
      							</a> </td> 
