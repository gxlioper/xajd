...
<body style="font-size:14px" onload="xyDisabled('xy');">
	<html:form action="/pjpy_hzy_xjbjandwmbj" method="post"
		...
		<table width="100%" class="tbstyle">
			...
			<tr>
				...
				<td align="left" width="40%">
					<html:text property="tzbmc" styleId="tzbmc" maxlength="150" />
				</td>
			...
			<tr>
				...
				<td align="left">
					<html:text property="tzbsj" styleId="tzbsj" maxlength="25" />
				</td>
				<td scope="col" width="15%">
					<div align="right">
						团员数：
			...
			<tr>
				...
				<td align="left">
					<html:text property="ftys" styleId="ftys"
						onkeypress="return onlyNum(this,5)" />
				</td>
				<td align="right" width="10%">
			...
			<tr>
				...
				<td align="left" colspan='4'>
					<html:textarea property="tzbzysj" rows="7" cols="100"></html:textarea>
				</td>
			</tr>
			<tr>
				<td align="right">
		...
		<div class="buttontool">
			<button class="button2" id="buttonSave" onclick="xjtzbSave()">
				提交申请
			</button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
