					...
					<thead>
						<tr>
							...
							&nbsp;&nbsp;
								...
								&nbsp;&nbsp;
								年度：
								<html:select property="nd" styleClass="select" style="width:70px" styleId="nd">
									<html:options collection="xnList" property="nd" labelProperty="nd"/>
								</html:select>
								&nbsp;&nbsp;
								学期：
								<html:select property="xq" 
								styleClass="select" style="width:60px;padding-left:50px" styleId="xq">
									<html:option value=""></html:option>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="dataQryChk('hzzy_zhszcpqry.do');">
									查询
								</button>
							</td>
							<td width="10" rowspan="2" align="center" valign="middle">
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										style="cursor:hand;" ondblclick="modiAndDel('hzzy_zhszcpview.do?pkValue=','modi','620','480')">
					...
					<logic:equal value="yes" name="writeAble" scope="request">
	                	<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
							<button type="button" class="button2" id="btn_add" style="width:80px"
								onclick="showTopWin('hzzy_zhszcpadd.do','620','480')">
								增加
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_modi" style="width:80px"
								onclick="modiAndDel('hzzy_zhszcpview.do?pkValue=','modi','620','480')">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_del" style="width:80px"
								onclick="deldata('hzzy_zhszcpdel.do')">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;
							...
							<button type="button" class="button2" onclick="dataExport()" style="width:80px">
								...
								&nbsp;&nbsp;&nbsp;
								<a href="xlsDown/hzzy_zhszcp.xls"
