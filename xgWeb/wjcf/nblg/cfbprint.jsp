...
<table width="100%" class="printstyle">
  ...
  <tr>
  	<th scope="row" colspan="10">
  		...
  		根据《${xxmc }学生违纪处分实施办法》（${xxmc }学[&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号）第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>章第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>条第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>款 ，建议给予该生<logic:empty name="rs" property="cflbmc"><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></logic:empty>
  		<logic:notEmpty name="rs" property="cflbmc">&nbsp;&nbsp;${rs.cflbmc}&nbsp;&nbsp;</logic:notEmpty>
  		处分。
  		 </p>
