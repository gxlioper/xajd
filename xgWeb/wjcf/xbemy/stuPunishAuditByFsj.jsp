...
%>
					...
					<thead>
						<tr>
							<td align="left">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年度：
								<html:select property="nd" style="width:90px" disabled="true" styleId="nd">
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('/xgxt/stuPunishAuditByFsj.do')">
									查询
								</button>
							</td>
						</tr>
    ...
    "
								ondblclick="chkPriseOne('/xgxt/stuPunishAuditOneByFsj.do?act=view&pkVal=',600,420)">
								<td>
