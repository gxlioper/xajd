...
<html:html>
  ...
  <body>
    <html:form action="/wjcfhhgxywh">
      <div align="center" ><font style="font-size:22px;font:'黑体' "><b>${xxmc}学生违纪处分预先告知书</b></font><font style="font-size:17px; ">(<b>存根</b>)</font></div>
      <br/>
      <div align="right">No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;</div>
<br/>
...
<hr>
<br/>
<div align="center" style="font-size:22px;font:'华文楷体' "><b>${xxmc}学生违纪处分预先告知书</b></div>
      <br/>
      <div align="right">No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;</div>
<br/>
...
<table width="95%" class="" align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  	<td height="40px" align="center" class="td"> 
   	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   	 	&nbsp;&nbsp;&nbsp;&nbsp;根据《淮海工<bean:message key="lable.xsgzyxpzxy" />学生违纪处分实施细则》第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>条第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>款的规定，&nbsp;&nbsp;&nbsp;
	</td>
  </tr>
  <tr>
  	<td height="40px" align="center" class="td"> 
  ...
  <tr>
  	<td height="40px" align="center" class="td"> 
   	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如对处理的事实和依据有异议，在接到本通知后三个工作日内可向处
	</td>
  </tr>
  <tr>
  	<td height="40px" align="center" class="td"> 
  ...
  <tr>
  	<td height="40px" align="center" style="font: 楷体_GB2312 ;font-size: 13px">
  	  		<br/>
  		说明：1.当事人签名领取阅读后须将告知书交回其所在<bean:message key="lable.xsgzyxpzxy" />。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  		&nbsp;&nbsp;&nbsp;&nbsp;<br/>
