						...
						<thead>
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/kqxxwh.do')">
										查询
									</button>
								</td>
								<td width="10" rowspan="2" align="center" valign="middle">
							...
							<tr>
								<td align="left" nowrap>
									...
									<html:select property="xydm" style="width:120px" styleId="xy" onchange="refreshForm('/xgxt/kqxxwh.do')">
										<html:option value=""></html:option>
										<html:options collection="xyList" property="xydm" labelProperty="xymc" />
									</html:select>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;专业：
									<html:select property="zydm" style="width:120px" styleId="zy" onchange="refreshForm('/xgxt/kqxxwh.do')">
										<html:option value=""></html:option>
					...
					<fieldset>
						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this);" style="cursor:hand" ondblclick="chkPriseOne('addkqxx.do?pkValue=',550,400)">
										<td>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2"
								onclick="chkPriseOne('addkqxx.do?pkValue=',550,400)"
								style="width:100px">
								增加考勤信息
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="expTabWebPrint('rsTable','',null,null,null,null)" style="width:90px">
								打印/预览
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2"
