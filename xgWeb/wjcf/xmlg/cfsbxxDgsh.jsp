		...
		<table class="tbstyle" width="99%">
			...
			<tr style="height:23px">
				...
				<td align="left" colspan="3">
					<html:textarea rows="4" style="width:500px" 
			...
			<tr style="height:23px">
				...
				<td align="left" colspan="3">
					<html:textarea name="rs" property="xyclyj" rows="4" style="width:500px" disabled="true">
							</html:textarea>
				</td>
			</tr>
			<tr style="height:23px">
				<td align="right">
				审核处理意见：
				<br/><font color="red">(字数在500字以内)</font>
				</td>
				<td align="left" colspan="3">
				
					<html:textarea property="yj" rows="4" style="width:500px" onkeyup="checkLen(this,500)">
							</html:textarea>
				</td>
			</tr>
		</table>
		<div class="buttontool" align="center">
				<logic:notEqual value="view" name="writable">
					<button type="button" class="button2" id="btn_save" 
						onclick="saveinfo('wjcf_xmlg_cfsbxxDgsh.do?operType=save','');"
						style="width:80px">
						保 存
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
