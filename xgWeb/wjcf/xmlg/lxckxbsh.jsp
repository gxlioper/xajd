...
<script type="text/javascript">
	function plsh() {
		...
		if (!flag) {
			...
			showTopWin('wjcf_xmlg_xbplshLxckxx.do?pkString=' + str,500,400);
		}
	}
	function printLxckb() {
		var pkValue = '';
					...
					<tr>
						...
						<td width="10" rowspan="2" align="center" valign="middle">
							<button type="button" class="button2" style="height:40px" id="search_go"
								onclick="refreshForm('wjcf_xmlg_lxckxbsh.do')">
								查询
							</button>
						</td>
					</tr>
					...
					<table width="100%" id="rsTable" class="tbstyle">
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this)" style="cursor:hand;"
								align="center" ondblclick="modiAndDel('wjcf_xmlg_xbLxckxxDgsh.do?pkValue=','modi',760,675)">
								<td>
					...
					<center>
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2" id="btn_add"
								...
								onclick="printLxckb()" style="width:80px">
									打 印
								</button>
						</div>
					</center>
