...
<html:html>
  ...
  <body>
    <html:form action="/wjcfxmlgwh">
      <div align="center" style="font-size:22px;font:'黑体' "><b>${xxmc }学生违纪处分呈报审批表</b></div>
<br/>
<div>
<table width="100%" class="printstyle">
  ...
  <tr>
  	<th scope="row" colspan="10">
  		...
  		<p align="left" style="font-size:16px;"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  		根据《${xxmc }学生违纪处分实施办法》（厦门理工学[&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号）第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>章第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>条第<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>款 ，建议给予该生<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${rs.cflbmc }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>处分。
  		&nbsp;&nbsp;&nbsp;&nbsp;
  		 </p>
  ...
  <tr>
  	<th scope="row" colspan="5">
  		...
  		<p align="left"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:write name="rs" property="xxclyj"/> </p>
  		<p>&nbsp;</p>
  		<p>&nbsp;</p>
  		<p align="center">签名：</p>
		<p align="right"><bean:write name="rs" property="xxshyear"/> 
  	...
  	<th scope="row" colspan="5">
  		...
  		<p align="left"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:write name="rs" property="xndclyj"/> </p>
