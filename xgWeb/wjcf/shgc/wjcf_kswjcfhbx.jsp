		...
		<html:form action="/shgcwjcfwh" method="post">
						...
						<tr>
							...
							<td width="10" rowspan="2" align="center" valign="middle">
								...
								<button type="button" class="button2" style="height:40px" id="search_go"
									onclick="allNotEmpThenGo('wjcf_shgc_kswjcfbxqry.do')">
									查询
								</button>
							</td>
						</tr>
							...
							<table width="99%" id="rsTable" class="tbstyle">
								...
								<logic:iterate name="rs" id="s">
									<tr onclick="rowOnClick(this)"
										style="cursor:hand;" ondblclick="modiAndDel('wjcf_shgc_cfbxmodi.do?act=view&pkValue=','modi','600','480');">
			...
			<div class="buttontool" align="center" id="btn" style="position:absolute;width:95%;top:100px">
				<button type="button" class="button2" id="btn_add" style=""
								onclick="showTopWin('wjcf_shgc_cfbxadd.do',600,480)">
								增加会议记录
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_modi" style="width:80px"
								onclick="modiAndDel('wjcf_shgc_cfbxmodi.do?pkValue=','modi','600','480');">
								修改
							</button>
							&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" id="btn_del" style="width:80px"
								onclick="deldata('wjcf_shgc_cfbxdel.do')">
								删除
							</button>
							&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;
									<button type="button" class="button2"
								onclick="wjcfysbprint('kswjcfbxprint.do?pkValue=')"
								style="width:80px">
								打印预览
							</button>
								&nbsp;&nbsp;&nbsp;
								<a href="xlsDown/shgc_kswjcfbx.xls"
