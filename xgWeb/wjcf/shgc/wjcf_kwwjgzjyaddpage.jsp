			...
			<div class="title">
				...
				<table width="100%" class="tbstyle">
					...
					<tr>
						...
						<td align="left">
							<bean:write name="rs" property="cflbmc" scope="request"/>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td align="left">
							<bean:write name="rs" property="cfyymc" scope="request"/>
						</td>
					</tr>
					<tr>
						<td align="right">
							...
							<div id="child2" style="display:none">
								<logic:equal value="0" name="isSHGC">
									...
									<thead>
										...
										<tr>
											<td>
												<html:textarea property='xsbx1' style="width:99%" rows='3' />
											</td>
										</tr>
								</table>
							</logic:equal>	
								...
								<table width="100%" border="1" align="center" class="tbstyle">
									<thead>
										...
										<tr>
											<td>
												<html:textarea  disabled="true" property='xsbx1' style="width:99%" rows='3' readonly="true"/>
											</td>
										</tr>
								</table>
								<table width="100%" border="1" align="center" class="tbstyle">
									<thead>
										...
										<tr>
											<td>
												<html:textarea property='xsbx2' style="width:99%" rows='3' />
											</td>
										</tr>
								</table>
								</logic:equal>
								...
								<table width="100%" border="1" align="center" class="tbstyle">
									<thead>
										...
										<tr>
											<td>
												<html:textarea disabled="true" property='xsbx2' style="width:99%" rows='3' readonly="true"/>
											</td>
										</tr>
								</table>
									<table width="100%" border="1" align="center" class="tbstyle">
									<thead>
										...
										<tr>
											<td>
												<html:textarea property='xsbx3' style="width:99%" rows='3' />
											</td>
										</tr>
								</table>
								</logic:equal>
								...
								<table width="100%" border="1" align="center" class="tbstyle">
									...
									<thead>
										...
										<tr>
											<td>
												<html:textarea disabled="true" property='xsbx3' style="width:99%" rows='3' readonly="true"/>
											</td>
										</tr>
								</table>
								<table width="100%" border="1" align="center" class="tbstyle">
									<thead>
										...
										<tr>
											<td>
												<html:textarea  property='xsbx4' style="width:99%" rows='3' />
											</td>
										</tr>
								</table>
								</logic:equal>
								...
								<table width="100%" border="1" align="center" class="tbstyle">
									<thead>
										...
										<tr>
											<td>
												<html:textarea disabled="true" property='xsbx4' style="width:99%" rows='3' readonly="true"/>
											</td>
										</tr>
								</table>
								</logic:equal>
					...
					<tr align="left">
						...
						<td colspan="3">
							<html:textarea property='xyclyj' style="width:99%" rows='3' />
						</td>
					</tr>
				</table>
				<div class="buttontool" align="center">
					<logic:notPresent name="act">
						...
						onclick="refreshForm('wjcf_shgc_kswjgzjysave.do');"
