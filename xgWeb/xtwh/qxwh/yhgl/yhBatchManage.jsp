	...
	<body>
		<html:form action="/yhwhManage">
			...
			<div class="toolbox">
			  ...
			  <div class="buttonbox">
			    <ul>
			      <li><a id="add" class="btn_fh" onclick="refreshForm('/xgxt/yhwhManage.do?method=jsBatchManage');return false;">返回</a></li>
			      <li><a id="add" class="btn_zj" onclick="batchData('yhs','yhwhManage.do?method=yhBatchManage&doType=save','');return false;">保存</a></li>
			    </ul>
			  </div>
			  <!-- 按钮 -->
						...
						<logic:iterate name="rs" id="s">
							<tr onclick="rowOnClick(this);" style="cursor:hand">
								...
								<td nowrap="nowrap">
									...
									<input type="checkbox" name="yhs" value="${v }_yy" id="${v }_yy" onclick="checkOne(this);"/>拥有&nbsp;&nbsp;&nbsp;&nbsp;
										<logic:equal value="admin" name="userType">
										<input type="checkbox" name="yhs" value="${v }_gl" id="${v }_gl" onclick="checkOne(this);"/>管理
										</logic:equal>
									</logic:iterate>
								</td>
							</tr>
