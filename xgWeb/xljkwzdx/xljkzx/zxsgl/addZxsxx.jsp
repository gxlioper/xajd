...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
	  ...
	  <script type="text/javascript">
	  	jQuery(function(){
	  		<%
	  		    String zxsxxIsExisttip = (String)request.getAttribute("zxsxxIsExisttip");
	  			if(zxsxxIsExisttip!=null && zxsxxIsExisttip.equals("true")){
	  		%>
	  		showAlertDivLayer("该咨询师信息已存在！");
	  		<%
	  			}
	  		%>
	  	});
			...
			<tbody>
				<tr>
					...
					<td width="32%">
						...
						<button onclick="showDialog('教师选择',680,480,'szdw_fdyjtff.do?method=showFdys&amp;goto=xljk_zxsgl.do?method=addZxsxx');return false;" class="btn_01" id="buttonFindStu">
							选择
						</button>
					</td>
					<th width="18%">
			...
			<tfoot>
				<tr>
					<td colspan="2">
						...
						<div class="btn">
							<button id="submit_button" type="button"  onclick="addZxsxxAction();">
								保 存
							</button>
