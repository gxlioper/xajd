...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" defer="defer">
			...
			function saveAction(type){
				...
				var url = "xlzxnew_ybjg.do?method=saveYbjg";
				ajaxSubFormWithFun("YbjgForm",url,function(data){
	...
	<body>
		<html:form action="/xlzxnew_ybjg" method="post" styleId="YbjgForm">
			...
			--%><div style='tab;width:100%;overflow-x:hidden;overflow-y:auto;'>
				<table width="100%" border="0" class="formlist">
					...
					<tbody>
								...
								<td width="35%">
									<input type="text" name="xymc" style="width:50%" id="xymc"/><button class="btn_01" onclick="addXy()" type="button">选择</button>
