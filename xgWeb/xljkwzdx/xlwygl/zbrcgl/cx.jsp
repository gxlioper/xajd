...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	var gridSetting_1 = {
		...
		colList : [
				...
				{ label : '周次', name : 'zbzc', index : 'zbzc', width : '25%'},
				{ label : '开始日期', name : 'zbksrq', index : 'zbksrq', width : '15%' },
				{ label : '任职结束日期', name : 'zbjsrq', index : 'zbjsrq', width : '15%' },
	 ...
	 */
	function add(){
		showDialog('增加',580,420,'xljk_xlwygl_zbrcglwh.do?method=xz&lx=' + jQuery("#query_type").val());
	}
	...
	function update(){
		...
		if (rows.length != 1){
			...
			showDialog('修改',580,420,'xljk_xlwygl_zbrcglwh.do?method=xg&zbid=' + rows[0]['zbid']);
		}
	}
	// 未/已上报班级
		...
		<html:form action="/xljk_xlwygl_zbrcglwh">
			...
			<logic:equal name="writeAble" value="yes">
				...
				<div class="comp_title" id="comp_title">
			      <ul style="width:90%">
			        <li class="ha"><a href="javascript:void(0);" onclick="selectTab(this,'0');"><span>班级周报日程</span></a></li>
			        <li><a href="javascript:void(0);" onclick="selectTab(this,'1');"><span>公寓周报日程</span></a></li>
			      </ul>
			    </div>
			</div>
		</html:form>
