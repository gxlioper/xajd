...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	var gridSetting = {
		...
		colList : [
				...
				{ label : '关注等级', name : 'gzdj', index : 'gzdj', width : '5%' },
				{ label : '类型', name : 'xlfdlxmc', index : 'xlfdlxmc',  width : '6%'},
				{ label : '时间', name : 'sj', index : 'sj', width : '10%' },
				{ label : '教师', name : 'fdyxm', index : 'fdyxm', width : '10%' }],
	...
	function update(){
		...
		if (rows.length != 1){
			...
			showDialog('修改',680,500,'xljk_xlwjyjgl_xlfdjlglwh.do?method=xg&xh=' + rows[0]['xh'] + '&fdid=' + rows[0]['fdid'] );
		}
	}
	 ...
	 */
	function add(){
		showDialog('新增',680,500,'xljk_xlwjyjgl_xlfdjlglwh.do?method=xz');
	}
	...
	function link(cellValue,rowObject){
		...
		var onclickfn = "onclick=\"" + "showDialog('详细信息' , 780,530 , 'xljk_xlwjyjgl_xlfdjlglwh.do?method=ck&xh=" + rowObject['xh'] + "&fdid=" + rowObject['fdid'] +"')" + "\"";
	...
	var DCCLBH = "xljk_xlwjyjgl_xlfdjlglwh.do";//dcclbh,导出功能编号
	...
	function exportData() {
		...
		var url = "xljk_xlwjyjgl_xlfdjlglwh.do?method=exportData&dcclbh=" + DCCLBH;//dcclbh,导出功能编号
