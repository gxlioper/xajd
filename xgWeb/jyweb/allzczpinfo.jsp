...
<html>
	<head>
		...
		function newpage_zczp(obj)
		{
		    ...
		    obj.href = "viewzczpinfo.do?method=qitainfo&jytype=jyweb&rowid="+pkValue;
		}
	
		
		function delone(obj){
		  var pkValue =  curr_row.getElementsByTagName("input")[0].value;
		  obj.href = "viewallzczpinfo.do?method=allzczpinfo&jytype=jyweb&doType=del&rowid="+pkValue;
		}
		
		function refreshtheweb()
		{
			document.forms[0].action = "viewallzczpinfo.do?method=allzczpinfo&jytype=jyweb";
	...
	<body>
        ...
        <html:form action="/viewallzczpinfo" method="post">
		<div class="mainframe">
			...
			<div class="liebiao">
				...
				<table width="98%" align="center" class="tbborder">
					...
					<logic:iterate name="zczp" id="s2">
						<tr onmouseover="rowOnClick2(this)" height="25">
							...
							<logic:iterate id="v2" name="s2" offset="1" length="1">
								<td class="tubiao">
									<a target="_blank" onclick="newpage_zczp(this)" href=""> <bean:write
											name="v2" /> </a>
								</td>
							</logic:iterate>
							<logic:iterate id="v2" name="s2" offset="2" length="1">
								<td align="center">
									<bean:write name="v2" />
								</td>
							</logic:iterate>
							<logic:iterate id="v2" name="s2" offset="3" length="1">
								<td align="center">
									<bean:write name="v2" />
								</td>
								<logic:equal name="usertype" value="admin" scope="session">
