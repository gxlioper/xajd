...
<html>
	<head>
		...
		function newpage_zcfg(obj)
		{
			var pkValue=  curr_row.getElementsByTagName("input")[0].value;
		    obj.href = "viewzcfginfo.do?method=qitainfo&jytype=jyweb&rowid="+pkValue;
		}
		
		function delone(obj){
		  var pkValue =  curr_row.getElementsByTagName("input")[0].value;
		  obj.href = "viewallzcfginfo.do?method=allzcfginfo&jytype=jyweb&doType=del&rowid="+pkValue;
		}
		
		function refreshtheweb()
		{
			document.forms[0].action = "viewallzcfginfo.do?method=allzcfginfo&jytype=jyweb";
	...
	<body>
        ...
        <html:form action="/viewallzcfginfo" method="post">
		<div class="mainframe">
					...
					<logic:iterate name="zcfg" id="s">
						<tr height="25" onmouseover="rowOnClick2(this)">
							...
							<logic:iterate id="v" name="s" offset="1" length="1">
								<td class="tubiao">
									<a target="_blank" onclick="newpage_zcfg(this)" href=""> <bean:write
											name="v" /> </a>
								</td>
							</logic:iterate>
