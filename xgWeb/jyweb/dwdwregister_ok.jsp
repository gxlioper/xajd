...
<html>
	...
	<body>
		...
		<logic:equal name="xxdm" value="12866" scope="session">
			<div align="center">
			<br>
			<br>
			<br>
			<img src="jyweb/images/dwlogin_ok.gif" border="0" align="absmiddle">
			<br>
			<a href="#" onclick="window.close();return false;">关闭窗口</a>

		</div>
		</logic:equal>
		<logic:notEqual name="xxdm" value="12866" scope="session">
		<div align="center">
			<br>
			<br>
			<br>
