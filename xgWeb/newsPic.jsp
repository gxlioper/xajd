...
<script type="text/javascript"> 
		...
		newsInfoDWR.getNewsInfo('${userName}','${userType}',function(data){
			
			for (var i = 0 ; i < data.length && i<5; i++){
				imgUrl[i+1]= data[i].newscont;
				imgLink[i+1]="/xgxt/newsContent.do?newsId="+data[i].newsid; 
				imgText[i+1] = data[i].newstitle;
			}
		});
