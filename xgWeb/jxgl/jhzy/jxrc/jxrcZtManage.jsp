...
function dataAdd() {
    var url = "/xgxt/jxgl_jhzy.do?method=jxrcZtAdd";		    	
...
function chec(){
 ...
 function dataViewModi(str) {
	...
	if (curr_row == null) {
		...
		var url = "/xgxt/jxgl_jhzy.do?method=jxrcZtUpdate&pkValue=";		    			    
...
function dataDel(){
           var url = "/xgxt/jxgl_jhzy.do?method=jxrcZtDel&go=go"; 
		   var RowsStr="";		  
		   for (i=0; i<document.getElementsByName("pkV").length; i++){
							...
							<tr>
								...
								<td width="10" align="center" valign="middle">
									...
									<button type="button" class="button2"  id="search_go"
										onclick="refreshForm('/xgxt/jxrcZtManage.do?&go=go');this.disabled=true;">
										查询
									</button>
								</td>
							</tr>
				...
				<div id="toolTipLayer" style="position:absolute; visibility: hidden" /></div>
					...
					<div class="buttontool" id="btn"
						style="position: absolute;left:1%;top:100px" width="100%">
							...
							<button type="button" class="button2" onclick="jxztrcsz()" style="width:120px">
								时间范围设置
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
