...
function sendJsgh() {
	...
	var str = "/xgxt/jxglgt.do?method=forwardPage&jsid="+jsid + "&doType=" + doType + "&pkValue=" + pkValue+"&gb="+gb;					
	...
	window.close();	
			...
			<html:form action="/jxgl" method="post">
				...
				<input type="hidden" id="gb" name="gb"  value="<bean:write name="gb"/>" />
							...
							<tr>
								...
								<td width="10" rowspan="2" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px"
										onclick="document.forms[0].go.value='go';refreshForm('/xgxt/jxglgt.do?method=infoSearch');">
										查询
									</button>
								</td>
							</tr>							
