...
-->
	...
	<script language="javascript">	     
     function cqAddSave(){
        ...
        var url= "/xgxt/zgdd_jxgl.do?method=gfscqAdd&doType=save";       
        refreshForm(url);
		if($("buttonSave")){
	...
	<body>
		...
		<html:form action="/zgdd_jxgl" method="post">
			...
			<input type="hidden" id="url" name="url"
				value="/zgdd_jxgl.do?method=gfscqAdd" />
			<table width="99%" id="rsT" class="tbstyle">
				...
				<tr style="height:22px">
					...
					<td align="left">
						<html:text property="xh" styleId="xh" onblur="dctStuXh()"
					...
					<td align="left" style="width: 40%">
						<html:text property="jcsj" styleId="jcsj" onblur="dateFormatChg(this)"
							style="cursor:hand;"
				...
				<tr style="height:22px">
					...
					<td align="left">
						<html:select property="zcqk" styleId="zcqk" style="width:150px">
							<html:option value="">--请选择--</html:option>
				...
				<tr style="height:22px">
					...
					<td colspan="3">
						<html:textarea property='cqqk' style="width:99%" rows='8' />
					</td>
				</tr>
				<tr style="height:22px">
