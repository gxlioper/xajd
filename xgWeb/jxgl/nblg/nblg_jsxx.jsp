					...
					<table width="100%" class="tbstyle">
						<thead>
							<tr>
								<td align="left">
									教师编号：
									<html:text property="zdy" style="width:85px"></html:text>
									&nbsp;&nbsp;&nbsp;姓名：
								...
								<td width="10" rowspan="3" align="center" valign="middle">
									...
									<button type="button" class="button2" style="height:40px" id="search_go"
										onclick="allNotEmpThenGo('/xgxt/jsxxInfo_nblg.do')">
										查询
									</button>
								</td>
							</tr>
				...
				<center>
					<div class="buttontool" id="btn"
						...
						<logic:equal value="yes" name="writeAble" scope="request">
							<button type="button" class="button2" onclick="showDataFrame('viewTeacherInfo.do','add',550,350)"
								style="width:80px">
								增 加
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="showDataFrame('viewTeacherInfo.do','modi',550,350)"
								style="width:80px">
								修 改
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="button2" onclick="showDataFrame('viewTeacherInfo.do','del',550,350)"
								style="width:80px">
								删 除
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
