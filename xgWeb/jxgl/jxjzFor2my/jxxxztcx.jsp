						...
						<table width="100%" id="rsTable" class="tbstyle">
							...
							<logic:equal value="yes" name="writeAble">
								<tr onclick="rowOnClick(this)" style="cursor:hand"
									ondblclick="showTopWin('/xgxt/jxgljz.do?method=jxglxsjzOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)">	
									<td>
			...
			<logic:equal value="yes" name="writeAble">
						<div class="buttontool" id="btn"
							...
							<button type="button" class="button2"
								onclick="showTopWin('/xgxt/jxgljz.do?method=jxglxsjzOne&pk='+curr_row.cells[0].getElementsByTagName('input')[0].value,600,480)"
								style="width:80px">
								查看详细信息
							</button>		
							&nbsp;&nbsp;&nbsp;&nbsp;
