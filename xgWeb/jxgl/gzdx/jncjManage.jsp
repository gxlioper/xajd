	...
	<body onload="xyDisabled('xy');">
		<html:form action="/gzdxJxgl" method="post">
			...
			<div class="toolbox">
			 ...
			 <div class="buttonbox">
			    <ul>
				<li> <a href="#" onclick="saveUpdate('/xgxt/gzdxJxgl.do?method=jncjManage&doType=save','')" class="btn_ccg"> 保存 </a> </li>
			          ...
			          <td colspan="6">
			            <div class="btn">
			              ...
			              <button type="button" class="btn_cx" id="search_go" 
			              	onclick="allNotEmpThenGo('/xgxt/gzdxJxgl.do?method=jncjManage');">
			              	查 询
			              </button>
			              &nbsp;&nbsp;&nbsp;&nbsp;
			               <button type="button" class="btn_cz" id="btn_cz"  	onclick="czSearchCond('xn-nj-xy-zy-bj-xh-xm-xb-sfzh-id');return false;">
			              	重 置
			              </button>
			            </div>
			          </td>
							...
							<tbody>
								<tr>
									...
									<td>
										<html:select property="queryequals_xn" styleId="xn" style="" onchange="">
								...
								<tr>
									...
									<td>
										<html:select property="queryequals_xb" styleId="xb" style="" onchange="">
											<html:option value=""></html:option>
									...
									<td>
										<html:text property="querylike_sfzh" styleId="sfzh" style="" maxlength="20"/>
									</td>
								</tr>
								<tr>
									<th align="left" nowrap>
						 ...
						 <table summary="" class="dateline" align="" width="100%">
								...
								<logic:iterate name="rs" id="s" indexId="index">
									<tr onclick="rowOnClick(this);" style="cursor:hand" ondblclick="">
										...
										<td align="center">
											<input type="text" name="save_cj" 
											style="width: 50px;height:17.5px;ime-mode:disabled"
