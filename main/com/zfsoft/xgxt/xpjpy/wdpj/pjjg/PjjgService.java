...
public class PjjgService extends SuperServiceImpl<PjjgModel, PjjgDao> implements
		Constants {
	 ...
	 * @throws
	 */
	public boolean isExistByPjxmjg(PjjgModel model, String type)
			throws Exception {
	 ...
	 * @throws
	 */
	public String getZsbm(PjjgModel model) {
	...
	public List<HashMap<String, String>> getZjXs(PjjgModel model, User user) throws Exception{
	 ...
	 * @throws
	 */
	public HashMap<String, String> getZcPjfRank(PjjgModel model){
	 ...
	 * @throws Exception 
	 */
	public File createBzmdWord(PjjgModel model) throws Exception{
	 ...
	 * @throws Exception 
	 */
	public boolean isExportBzMd(PjjgModel model) throws Exception{
		List<HashMap<String,String>> bzmdList = dao.getBzmdList(model);
	 ...
	 * @throws
	 */
	public File getJxjhzzhList(PjjgModel model,User user) throws Exception{
...
//		title_cf.setBackground(Colour.YELLOW);	//设置标题背景色
	...
	public String getCwybSum(PjjgModel model, User user) throws Exception {
    ...
    public List<HashMap<String,String>> getPjjgExportList(PjjgModel model, User user) throws Exception {

		return dao.getPjjgExportList(model,user);
    }
}
