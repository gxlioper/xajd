...
public class PjjgDao extends SuperDAOImpl<PjjgModel> {
	...
	public List<HashMap<String, String>> getPageList(PjjgModel t, User user)
		...
		sql.append("select * from (select nvl(x1.sydm,x2.sydm1) sydm,nvl(x1.symc,x2.symc1) symc, f.cpzdm,cp.cpzmc, t2.yhmc yhmc2,t1.xn||' '||t1.xqmc pjzq,case when t11.xh is null then '否' else '是' end sfwtgg ");
...
//	}
    ...
    public List<HashMap<String,String>> getPjjgExportList(PjjgModel t, User user) throws Exception {
		...
		sql.append("select * from (select x1.sydm,x1.symc, f.cpzdm,cp.cpzmc, t2.yhmc yhmc2,t1.xn||' '||t1.xqmc pjzq,case when t11.xh is null then '否' else '是' end sfwtgg ");
