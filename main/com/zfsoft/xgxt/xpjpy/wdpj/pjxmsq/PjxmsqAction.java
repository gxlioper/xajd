...
public class PjxmsqAction extends SuperAction {
	// 是否班级评议.1：是，0：否
	...
	private static final String url = "pj_pjxmsq.do";
	...
	public ActionForward viewPjxmsqList(ActionMapping mapping, ActionForm form,
		...
		PjxmsqModel model = (PjxmsqModel) form;
		PjxmsqService service = new PjxmsqService();
	...
	public ActionForward updateSqb(ActionMapping mapping, ActionForm form,
		...
		PjxmsqModel formModel = (PjxmsqModel) form;
		PjxmsqService service = new PjxmsqService();
		User user = getUser(request);
		CsszService csszService = new CsszService();
		
		PjxmsqModel model = service.getModel(formModel);
	...
	public ActionForward viewLcgz(ActionMapping mapping, ActionForm form,
		...
		PjxmsqModel modelForm = (PjxmsqModel) form;
		PjxmsqService service = new PjxmsqService();
		
		//单个查询
		PjxmsqModel model = service.getModel(modelForm);
	...
	public ActionForward getDjbZip(ActionMapping mapping, ActionForm form,
		...
		PjxmsqService service = new PjxmsqService();
		PjxmsqModel model = null;
		PjxmsqModel modelForm = null;
		
		if (StringUtils.isNotNull(value)){
			String[] values = value.split(",");
			List<File> files = new ArrayList<File>();
			for (int i = 0 , n = values.length ; i < n ; i++){
				modelForm = new PjxmsqModel();
	...
	//填充模版数据生成word文件
	private File getWord(PjxmsqModel pjxmsqModel)
			throws Exception {
		PjjgService servicePjPy = new PjjgService();
		
		Map<String,Object> data = new HashMap<String,Object>();
		PjxmsqModel model = pjxmsqModel;
