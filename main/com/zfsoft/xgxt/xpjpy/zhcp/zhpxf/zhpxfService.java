	 ...
	 */
		...
		try {
			...
			if("null".equals(resultMap.get("result"))){
				...
				resultMap.put("gxts",gxlist.size());//更新条数
	 ...
	 */
		private String uploadErrorExcel(List<String[]> errorlist, String filepath) throws Exception {
			...
			try {
	            ...
	            Label labelxm= new Label(2, 0, "姓名");
	            Label labelzhpxf= new Label(3, 0, "综合品行分");
	            try {
	            	ws.addCell(labelxn);
					ws.addCell(labelxh);
		            ws.addCell(labelxm);
