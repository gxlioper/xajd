 ...
 * @作者： xiaxia[工号:1104]
 * @时间： 2016-02-19 上午08:37:52
 * @版本： V1.0
 * @修改记录: 类修改者-修改日期-修改说明
 */

public class YstRtshForm extends ActionForm {
	private String rtid;
	private String xh;
	 ...
	 * @return the ystids
	 */
	public String[] getYstids() {
		return ystids;
	}

	/**
	 * @param ystids要设置的 ystids
	 */
	public void setYstids(String[] ystids) {
		this.ystids = ystids;
	}
