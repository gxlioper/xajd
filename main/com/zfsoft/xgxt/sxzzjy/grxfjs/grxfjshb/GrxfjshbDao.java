...
public class GrxfjshbDao extends SuperDAOImpl<GrxfjshbForm> {
    ...
    public List<HashMap<String, String>> getPageList(GrxfjshbForm t, User user) throws Exception {
        ...
        sql.append(" select a.* from (select t.*,case t.nzhbcount when 0 then '未汇报' else t.hbshztmc end nzhbshztmc, ");
        ...
        sql.append(" decode(h1.shzt,'0','未提交','1','通过','2','不通过', '3','退回','4','需重审','5','审核中','','无需审核',h1.shzt) hbshztmc,");
        sql.append(" decode(h2.shzt,'0','未提交','1','通过','2','不通过', '3','退回','4','需重审','5','审核中','','无需审核',h2.shzt) zjshztmc,");
