...
public class JgcxDao extends SuperDAOImpl<JgcxForm> {
	...
	protected void setTableInfo() {
		super.setKey("sqid");
		super.setTableName("xg_xszz_new_xszz_bjpyxzpyjg");
	}
	...
	public List<HashMap<String, String>> getPageList(JgcxForm t, User user)
		...
		sql.append(" select t1.guid,t1.xh,t1.shlc,t1.xn,t1.xmdm, ");
		sql.append(xsxxbZd);
...
//		sql.append(" decode(t5.tjzt,'1','已提交','未提交') tjztmc,t5.tjzt, ");
		...
		sql.append(" from ( ");
		sql.append(" select count(1) sumnum,sqr,xn,xq,xmdm,'"+pyyxbl+"' pyyxbl,tjzt  from xg_xszz_new_xszz_bjpyxzpy group by sqr,xn,xq,xmdm,tjzt ");
		sql.append(" ) a ");
		sql.append(" left join ( ");
		sql.append(" select ");
		...
		// =============== 评议结果 < =============
		sql.append(" left join xg_xszz_new_xszz_bjpyxzpyjg t7 on t1.guid=t7.sqid ");
		// =============== 评议结果 > =============
		sql.append(" left join ( ");
		// =============== 评议小组信息 < =============
		sql.append(" select * from ( ");
		...
		sql.append(" from xg_xszz_new_xszz_bjpyxz a ");
	...
	public List<HashMap<String, String>> jgcxView(JgcxForm t, User user) throws Exception {
		...
		if("6".equals(shztbjpy)){ // 未提交
			...
			sql.append(" from xg_xszz_new_xszz_bjpyxz a left join ( ");
			sql.append(" select a.* from xg_xszz_new_xszz_bjpyxzpy a where a.xn=? and a.xq=? and a.sqr=? and a.xmdm=? ");
			...
			sql.append(" b.bjpyr,b.ylzd1,b.ylzd2,b.ylzd3,b.ylzd4,b.ylzd5,b.ylzd6,b.ylzd7,b.ylzd8,b.ylzd9,b.ylzd10,b.tjzt,b.tjsj ");
			sql.append(" from ( ");
			sql.append(" select a.* from xg_xszz_new_xszz_bjpyxzpy a where a.xn=? and a.xq=? and a.sqr=? and xmdm=? ");
			sql.append(" ) b ");
			sql.append(" left join view_xsbfxx c on b.bjpyr=c.xh ");
			sql.append(" left join xg_xszz_new_xszz_bjpyxzpyjg d on b.xn=d.xn and b.xq=d.xq and b.sqr=d.sqr ");
			sql.append(" ) t1 where 1=1 ");
			sql.append(searchTj);
			//sql.append(searchTjByUser);
	...
	public JgcxForm getModel(JgcxForm t) throws Exception {
		...
		sql.append(" from xg_xszz_new_xszz_bjpyxzpyjg t ");
	...
	public boolean tjBjpyxzpy(String xn, String xq, String xmdm, String sqr) throws Exception {
		StringBuilder sql = new StringBuilder();
		sql.append(" update xg_xszz_new_xszz_bjpyxzpy ");
		sql.append(" set ");
