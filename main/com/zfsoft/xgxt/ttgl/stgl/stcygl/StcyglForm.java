...
public class StcyglForm extends ActionForm{
	...
	private String stqc;
	private String tnzw;
	private String sjly;//流程数据或结果数据
	private String ly; //取自结果表或申请表
	private String glzt;//管理状态 页签状态 待审核或已审核
	private String zzly;
	
	/**
	 * @description	： TODO
	 * @author 		： CP（1352）
	 * @date		： 2018-2-5 下午04:30:25 
	 * @return		: the pages
	 */
