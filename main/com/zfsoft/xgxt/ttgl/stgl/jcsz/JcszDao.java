...
public class JcszDao extends SuperDAOImpl<JcszForm>{
	...
	public JcszForm getModel() throws Exception {
		...
		sql.append("and to_date(nvl(sqjssj,'2020-01-01'),'yyyy-mm-dd')+1 then 'true' else 'false' end isopen from xg_ttgl_stgljcszb a ");
