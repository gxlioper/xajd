...
public class TjszService extends SuperServiceImpl<TjszForm,TjszDao> {
	 ...
	 * @throws
	 */
	public boolean saveOrUpdate(String xmdm, List<TjszForm> list) throws Exception {
		return dao.runDeal(xmdm, list);
	}
	
	/*
	 * 获取某个项目的所有条件设置，包含条件关联，-----------供接口调用
	 */
