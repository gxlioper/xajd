 ...
 * @日期：
 */
public class LwAction extends SuperAction<LwForm,LwService> {

    private FdyxxService fdyxxService = new FdyxxService();
//    private KtxmyjqkService ktxmyjqkService = new KtxmyjqkService();

    public ActionForward lwList(ActionMapping mapping, ActionForm form,
                                      HttpServletRequest request, HttpServletResponse response) throws Exception {

        LwForm model = (LwForm) form;
        ...
        request.setAttribute("path","szdw_fdy_lw.do");
        return mapping.findForward("lwList");
    }
...
//        request.setAttribute("jsList",jsList);
    ...
    public ActionForward update(ActionMapping mapping, ActionForm form,
        ...
        LwForm result = getService().getModel(model);
