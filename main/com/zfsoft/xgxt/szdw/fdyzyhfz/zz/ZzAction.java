 ...
 * @日期：
 */
public class ZzAction extends SuperAction<ZzForm,ZzService> {

    private FdyxxService fdyxxService = new FdyxxService();
//    private KtxmyjqkService ktxmyjqkService = new KtxmyjqkService();

    public ActionForward zzList(ActionMapping mapping, ActionForm form,
                                      HttpServletRequest request, HttpServletResponse response) throws Exception {

        ZzForm model = (ZzForm) form;
        ...
        request.setAttribute("path","szdw_fdy_zz.do");
        return mapping.findForward("zzList");
    }
...
//        request.setAttribute("jsList",jsList);
    ...
    public ActionForward update(ActionMapping mapping, ActionForm form,
        ...
        ZzForm result = getService().getModel(model);
