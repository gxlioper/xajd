 ...
 * @日期：
 */
public class KtxmyjqkAction extends SuperAction<KtxmyjqkForm,KtxmyjqkService> {
    private FdyxxService fdyxxService = new FdyxxService();
    public ActionForward ktxmyjqkList(ActionMapping mapping, ActionForm form,
                                       HttpServletRequest request, HttpServletResponse response) throws Exception {

        KtxmyjqkForm model = (KtxmyjqkForm) form;
        ...
        request.setAttribute("path","szdw_fdy_ktxmyjqk.do");
        return mapping.findForward("ktxmyjqkList");
    }
    ...
    public ActionForward add(ActionMapping mapping, ActionForm form,
        ...
        List<HashMap<String,String>> jsList = getService().getJsList();
    ...
    public ActionForward update(ActionMapping mapping, ActionForm form,
        ...
        KtxmyjqkForm result = getService().getModel(model);
