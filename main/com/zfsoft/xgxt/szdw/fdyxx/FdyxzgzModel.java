 ...
 * @系统名称: 学生工作管理系统
 * @模块名称: 思政队伍管理模块
 * @类功能描述: 辅导员信息-辅导员和行政工作
 * @作者： 沈晓波[工号:1123]
 * @时间： 2015-12-18 上午10:45:44 
 * @版本： V1.0
 * @修改记录: 类修改者-修改日期-修改说明
 */

public class FdyxzgzModel implements Serializable{

	private static final long serialVersionUID = -8692278407785586702L;
	
	private String xzgzid;
	private String qzsj;
	private String gzxb;
	private String gznr;
	private String sdbj;
	...
	public String getXzgzid() {
		return xzgzid;
	}
	public void setXzgzid(String xzgzid) {
		this.xzgzid = xzgzid;
	}
	...
	public String getGzxb() {
		return gzxb;
	}
	public void setGzxb(String gzxb) {
		this.gzxb = gzxb;
	}
