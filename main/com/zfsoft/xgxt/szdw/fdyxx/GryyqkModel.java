 ...
 * @作者： xiaxia[工号:1104]
 * @时间： 2018-3-6 下午03:21:13 
 * @版本： V1.0
 * @修改记录: 类修改者-修改日期-修改说明  
 */

public class GryyqkModel {
	private static final long serialVersionUID = -8692278407785586702L;
	private String grhjqkid;
	private String fybm;
	private String bsmc;
	private String hjsj;
	private String zbdw;
	private String hjlb;
	private String hjdj;
	private String gthjr;
	/**
	 * @return the grhjqkid
	 */
	public String getGrhjqkid() {
		return grhjqkid;
	}
	/**
	 * @param grhjqkid要设置的 grhjqkid
	 */
	public void setGrhjqkid(String grhjqkid) {
		this.grhjqkid = grhjqkid;
	}
	/**
	 * @return the fybm
	 */
	 ...
	 * @return the gthjr
	 */
	public String getGthjr() {
		return gthjr;
	}
	/**
	 * @param gthjr要设置的 gthjr
	 */
	public void setGthjr(String gthjr) {
		this.gthjr = gthjr;
	}
}
