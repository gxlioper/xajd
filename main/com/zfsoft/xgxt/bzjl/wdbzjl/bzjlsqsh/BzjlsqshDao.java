...
public class BzjlsqshDao extends SuperDAOImpl<BzjlsqshModel> implements Constants{
	...
	protected void setTableInfo() {
		super.setClass(BzjlsqshModel.class);
	...
	@Override
	public List<HashMap<String, String>> getPageList(BzjlsqshModel t)
			throws Exception {
		return null;
	}
	 ...
	 */
	public List<HashMap<String, String>> getPageList(BzjlsqshModel t, User user)
			throws Exception {
		...
		sql.append("t3.xb,t3.mz,t3.mzmc,t3.xz,t3.zybj,");
		...
		sql.append("from VIEW_NEW_DC_PJPY_JXSQ t left join xg_pjpy_new_pjxmb t2 on t.xmdm = t2.xmdm left join view_xsxxb t3 on t.XH = t3.xh ");
	 ...
	 */
	public List<HashMap<String, String>> getJxsbList(BzjlsqshModel t, User user, String pmfs , List<HashMap<String,String>> zcxmList)
		throws Exception {
	 ...
	 * @throws
	 */
	public List<HashMap<String,String>> getCanOperatData(BzjlsqshModel t, String newXmdms, String bjdms){
		StringBuilder sql = new StringBuilder();
	 ...
	 * @deprecated
	 */
	public List<HashMap<String,String>> getShqkByBj(BzjlsqshModel t , User user) throws Exception{
	 ...
	 * @deprecated
	 */
	public List<HashMap<String,String>> getShqkByCpz(BzjlsqshModel t , User user) throws Exception{
	 ...
	 * @deprecated
	 */
	public List<HashMap<String,String>> getShqkByNjzy(BzjlsqshModel t , User user) throws Exception{
	 ...
	 * @deprecated
	 */
	public List<HashMap<String,String>> getAudingListByBj(BzjlsqshModel t, User user) throws Exception{
	 ...
	 * @deprecated
	 */
	public List<HashMap<String,String>> getAudingListByCpz(BzjlsqshModel t, User user) throws Exception{
	 ...
	 * @throws
	 */
	public List<HashMap<String,String>> getAudingList(BzjlsqshModel t, User user , String pmfs , List<HashMap<String,String>> zcxmList) throws Exception{
	 ...
	 * @throws
	 */
	public List<HashMap<String,String>> getXssqList(BzjlsqshModel t, User user , String pmfs , List<HashMap<String,String>> zcxmList) throws Exception{
	...
	public List<HashMap<String,String>> getAudingListSingle(BzjlsqshModel t, User user , String pmfs , List<HashMap<String,String>> zcxmList) throws Exception{
		...
		sql.append(" select t2.guid shid,t1.sqid,t1.sqly,t2.shsj,t2.gwid,t1.dqxmdm xmdm,pdshztb2.zd3 tzxmmc, ");
		...
		sql.append(" t101.nj,t101.xydm,t101.xymc,t101.zydm,t101.zymc,t101.bjdm zybj,t101.bjmc zybjmc,t10.bjdm,t10.bjmc,t6.yhkh,t8.mc gwmc,");
		...
		if("10704".equals(Base.xxdm)){
			sql.append(" u.realName sqrmc,u.userDepName sqrbmmc, ");
		}
		if("10466".equals(Base.xxdm)){
			sql.append(" k.ldmc||k.qsh qsh,");
		}
		//徐州医药高等专科学校个性化
		...
		if("10874".equals(Base.xxdm)){
			sql.append(" (case when wjcf.xh is null then '否' else '是' end) sfwj,(case when cjhg.xh is null then '是' else '否' end) sfhg, ");
		}
		...
		if("11527".equals(Base.xxdm)){
			/*使用考核总分*/
			sql.append(" (SELECT t.xh,t.xn,t.bjdm,t.zydm,t.xydm,t.zhcpbjxh,t.zf,");
			sql.append("rank() OVER (PARTITION BY t.bjdm ORDER BY t.zf DESC) bjpm,");
			sql.append("rank() OVER (PARTITION BY t.zydm ORDER BY t.zf DESC) zypm,");
			sql.append("rank() OVER (PARTITION BY t.xydm ORDER BY t.zf DESC) xypm ");
			sql.append("FROM (");
			sql.append("SELECT t.*,x.zydm,x.xydm,(t.zpzf * c.zpqz + t.bzzf * c.bzqz + t.bzrzf * c.bzrqz) / 100 zf ");
			sql.append("FROM (SELECT a.xh,a.xmid xn,a.zhcpbjdm bjdm,a.zhcpbjxh,");
			...
			sql.append("GROUP BY a.xh, a.xmid, a.zhcpbjdm, a.zhcpbjxh) t ");
			sql.append("LEFT JOIN VIEW_XSJBXX x ON x.XH = t.XH,xg_khgl_pfqz c) t) ");
			sql.append("t7 on t5.xh=t7.xh and t5.xn=t7.xn ");
			/*使用考核总分：end*/
		}else {
			/*使用综测项目分数*/
			sql.append(" ( select ");
...
//		//理论上对综测需要按学年、学期、学号进行分组，但现在在过滤条件上过滤学年、学期也行
		...
		//重庆邮电大学个性化
		if("13627".equals(Base.xxdm)){
			sql.append(" left join view_xg_fdyxx fdy on t6.bjdm = fdy.bjdm ");
		}
		if("10466".equals(Base.xxdm)){
			sql.append(" left join view_xg_gygl_new_cwxx k on t1.xh=k.xh ");
		}
		//西安科技大学
		if("10704".equals(Base.xxdm)){
			...
			sql.append(" FROM YHB y LEFT JOIN ZXBZ_XXBMDM z ON y.SZBM = z.BMDM)) u  on  t1.sqr = u.userName ");
		}
		
		//南京高等职业技术学校
		if("10874".equals(Base.xxdm)){
			sql.append(" left join (select distinct(xh) from xg_wjcf_wjcfb where 1 = 1");
			if(null != xntj && xntj.length > 0){
				sql.append(" and ( "); 
				for(int i = 1;i <= xntj.length;i++){
					if(i != 1){
						sql.append(" or ");
					}
					sql.append(" xn = ? ");				
			...
			if(null != xqtj && xqtj.length > 0){
				sql.append(" and (");
				for(int i = 1;i <= xqtj.length;i++){
					if(i != 1){
						sql.append(" or ");
					}
					sql.append(" xq = ? )");
			...
			sql.append(" )wjcf on t1.xh = wjcf.xh ");
			sql.append(" left join (select distinct(xh) from cjb where cj < 60 ");
			if(null != xntj && xntj.length > 0){
				sql.append(" and (");				
				for(int i = 1;i <= xntj.length;i++){
					if(i != 1){
			...
			sql.append(" ) cjhg on t1.xh = cjhg.xh");
			inputValue = StringUtils.joinStrArr(xntj,xqtj,xntj,xqtj,inputValue);
		}
	 ...
	 * @deprecated
	 */
	public List<HashMap<String,String>> getAudingListByNjzy(BzjlsqshModel t , User user) throws Exception{
	 ...
	 * boolean 返回类型
	 */
	public boolean updateShxx(BzjlsqshModel t, String id) throws Exception{
	 ...
	 * @throws Exception 
	 */
	public List<HashMap<String,String>> getStudentsFromShtj(BzjlsqshModel model, User user) throws Exception{
	...
	public BzjlsqshModel getModel(BzjlsqshModel t) throws Exception {
	 ...
	 * @throws 
	 */
	public List<HashMap<String, String>> getViweShmx(BzjlsqshModel t, User user) throws Exception {
	 ...
	 * @throws 
	 */
	public List<HashMap<String, String>> getZdshjgList(BzjlsqshModel t, User user) {
	 ...
	 * @throws 
	 */
	public List<HashMap<String, String>> getHjtjb(BzjlsqshModel t) throws Exception {
	...
	public HashMap<String, String> getPjInfo(String xh,String xn,String xq){
		...
		sql.append("on b.bjdm = c.bjdm left join view_xg_gygl_new_cwxx k on a.xh=k.xh where rownum =1 and a.xh = ? ");
...
//		sql.append("to_number(nvl(v.jd,0)) jd ");
	 ...
	 * @throws 
	 */
	public List<HashMap<String, String>> getFjList(BzjlsqshModel t, User user, String pmfs , List<HashMap<String,String>> zcxmList) throws Exception {
...
//		sql.append(" ) group by xh,xn,xq ) t7 on t5.xh=t7.xh and t5.xn=t7.xn and t5.xq=t7.xq ");
     ...
     */
    public List<HashMap<String,String>> getXsglmdList(BzjlsqshModel t) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    	String searchTj = SearchService.getSearchTj(t.getSearchModel());		
