...
import com.zfsoft.xgxt.bzjl.wdbzjl.bzjlxssq.BzjlxssqModel;
...
public class BzjlxssqDao extends SuperDAOImpl<BzjlxssqModel> {
	...
	@Override
	public List<HashMap<String, String>> getPageList(BzjlxssqModel t)
			throws Exception {
		...
		if(StringUtils.isEqual("wsq", t.getQueryType())){
			...
			sql.append("  on t.lxdm = a.xmlxdm").
					append(" left join (select * from xg_pjpy_new_xmsq b where b.xh = ?) t3 on t.xmdm = t3.xmdm ").
					append("  where not exists").
					append("  (select 1").
					append("           from xg_pjpy_new_xmsq t2").
					append("          where t.xmdm = t2.xmdm").
					append("            and t2.xh = ?  and t2.shzt not in ('0' , '3'))").
					append("    and 1=1").
			...
			retData = getPageList(t, sql.toString(), new String[]{t.getXh(),t.getXh()});
...
//			}
			...
			*/
			retData = getPageList(t, sql.toString(), new String[]{t.getXh()});
		}
	...
	@Override
	public List<HashMap<String, String>> getPageList(BzjlxssqModel t, User user)
			throws Exception {
		// TODO 自动生成方法存根
		return null;
	}
	...
	protected void setTableInfo() {
		super.setClass(BzjlxssqModel.class);
	...
	@Override
	protected BzjlxssqModel getModel(BzjlxssqModel t, String sql, String[] input)
			throws Exception {
		// TODO 自动生成方法存根
	 ...
	 * @throws
	 */
	public List<HashMap<String, String>> getYsqxmAllYsh(BzjlsqshModel model, User user) throws Exception {
	 ...
	 * @throws
	 */
	public List<HashMap<String, String>> getYsqxmAll(BzjlsqshModel model,User user) throws Exception {
