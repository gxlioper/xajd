 ...
 * @类功能描述: 学生信息model
 * @作者： ligl
 * @时间： 2013-11-23 上午10:42:46
 * @版本： V1.0
 * @修改记录:
 */
public class XsxxglModel extends CommForm {
	...
	private String zd1;// 入学前单位（广东经管学院-学警号）
	private String zd2;// 获奖情况（广东经管学院-手机短号）
	private String zd3;// 微信名（广东经管学院-考生类别）
	private String zd4;// 微博名
	private String zd5;// 扩展字段5
	private String zd6;// 附件ID （山西财经大学）
	private String shzt;// 审核状态
	private String sfxyqgzx;//是否需要勤工助学
	private String xgyx;// 相关意向
	private String[] xhs;//学号
	private String sf;//身份 --湖南涉外
	private String sfqnzyz; //是否青年志愿者--湖南涉外
	private String xszw;//学生职务--湖南涉外
	private String zybj;//专业班级（西交大个性化）

	private String zd;//字段(字段查看历史修改信息处用到)
	 ...
	 * @return the sfqnzyz
	 */
	public String getSfqnzyz() {
		return sfqnzyz;
	}

	/**
	 * @param sfqnzyz要设置的 sfqnzyz
	 */
	public void setSfqnzyz(String sfqnzyz) {
		this.sfqnzyz = sfqnzyz;
	}
