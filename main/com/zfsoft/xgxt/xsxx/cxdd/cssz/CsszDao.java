...
public class CsszDao extends SuperDAOImpl<CsszForm> {
	...
	protected void setTableInfo() {
		...
		super.setKey("id");
		super.setTableName("xg_xsxx_cxpy_cssz");
	}
	
	public CsszForm getModel() throws Exception{
		String sql = "select * from xg_xsxx_cxpy_cssz where rownum=1";
	...
	public String getSqKg() throws Exception{
		...
		sql.append(" from xg_xsxx_cxpy_cssz t where 1=1");
