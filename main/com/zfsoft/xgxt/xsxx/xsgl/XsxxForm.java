...
public class XsxxForm extends ActionForm {

	private static final long serialVersionUID = 1L;
	private String xy;// (50) y 学院名称
	private String zymc;// (50) y 专业名称
	private String bjmc;// (50) y 班级名称
	private String bjdm;// (20) y 班级代码
	private String zydm;// (20) y 专业代码
	private String xydm;// (20) y 学院代码
	private String bz;// (1000) y 备注
	private String xm;// (64) y 姓名
	private String xmpy;// (64) y 姓名拼音
	private String nj;// (10) y 年级
	private String syd;// (255) y 生源地
	private String csrq;// (20) y 出生日期
	private String sfzh;// (64) y 身份证号码
	private String xb;// (4) y 性别
	private String mz;// (64) y 民族代码
	private String zzmm;// (20) y 政治面貌代码
	private String lxdh;// (120) y 联系电话
	private String dzyx;// (64) y 电子邮箱
	private String cym;// (30) y 曾用名
	private String sg;// (10) y 身高
	private String tz;// (10) y 体重
	private String tc;// (64) y 特长
	private String kslb;// (64) y 考生类别
	private String rxfs;// (64) y 入学方式
	private String pyfs;// (64) y 培养方式
	private String pycc;// (64) y 培养层次
	private String xjlb;// (64) y 学籍类别
	private String xszp;// (64) y 学生照片
	private String xjztm;// (30) y 学籍状态
	private String xz;// (4) y 学制
	private String whcd;// (20) y 文化程度
	private String rxqdw;// (255) y 原毕业学院
	private String jtdh;// (20) y 家庭电话
	private String jrgqtsj;// (24) y 加入共青团时间
	private String jrgcdsj;// (24) y 加入共产党时间
	private String jtcygc;// (4) y 家庭成员构成
	private String jlcfjl;// (300) y 奖励处分经历
	private String jkzk;// (255) y 有无病史
	private String jtdz;// (255) y 家庭详细地址
	private String jtyb;// (20) y 家庭邮编
	private String jg;// (255) y 籍贯
	private String xx;// (20) y 血型
	private String ah;// (255) y 爱好
	private String sfdk;// (4) y 是否贷款
	private String shgxxm1;// (20) y 社会关系姓名1
	private String shgxgx1;// (64) y 社会关系关系1
	private String shgxgzdw1;// (255) y 社会关系工作单位1
	private String shgxzw1;// (64) y 社会关系职务1
	private String shgxdwdh1;// (20) y 社会关系单位电话1
	private String shgxsjhm1;// (20) y 社会关系手机号码1
	private String shgxxm2;// (20) y 社会关系姓名2
	private String shgxgx2;// (64) y 社会关系关系2
	private String shgxgzdw2;// (255) y 社会关系工作单位2
	private String shgxzw2;// (64) y 社会关系职务2
	private String shgxdwdh2;// (20) y 社会关系单位电话2
	private String shgxsjhm2;// (20) y 社会关系手机号码2
	private String jtqkjj;// (255) y 家庭情况简介
	private String jtjjqk;// (255) y 家庭经济情况
	private String sjhm;// (20) y 手机号码
	private String byxx;// (1000) y 毕业信息
	private String kh;// (20) y 卡号
	private String rxrq;// (20) y 入学日期
	private String fdyxm;// (20) y 辅导员姓名
	private String gkcj;// (10) y 高考成绩
	private String qqhm;// (20) y qq号码
	private String hkxz;// (20) y 户口性质
	private String zyjb;// (20) y 专业级别
	private String hkszd;// (120) y 户口所在地
	private String ssyq;// (64) y 宿舍苑区
	private String ssld;// (64) y 宿舍楼栋
	private String jtdzs;// (64) y 家庭地址省
	private String jtdzx;// (64) y 家庭地址市县
	private String sfzsb;// (20) y 是否专升本
	private String sfzfx;// (10) y 是否在分校
	private String zjdm;// (20) y 宗教代码
	private String sfyby;// (6) y '否' 是否已毕业
	private String byny;// (10) y 毕业年月
	private String sfzx;// (10) y 是否在校
	private String zw;// (64) y 职务
	private String thbs;// (10) y 替换标识
	private String dybj;// (10) y 打印标记
	private String shbj;// (10) y 审核标记
	private String xwzsxlh;// (20) y 学位证书序列号
	private String xwzsbh;// (20) y 学位证书编号
	private String xw;// (32) y 学位
	private String xzxm;// (30) y 校长姓名
	private String zsxlh;// (20) y 证书序列号
	private String zsbh;// (20) y 证书编号
	private String bjyjl;// (20) y 毕结业结论
	private String csd;// (64) y 出生地县
	private String zsjj;// (20) y 招生季节
	private String xxxs;// (32) y 学习形式
	private String bxlx;// (32) y 办学类型
	private String bxxs;// (32) y 办学形式
	private String fxzyfx;// (32) y 辅修专业方向
	private String fxzy;// (32) y 辅修专业
	private String zylb;// (32) y 专业类别
	private String dqszj;// (4) y 当前所在级
	private String pyfx;// (32) y 培养方向
	private String zyfx;// (32) y 专业方向
	private String xxszd;// (64) y 学校所在地
	private String ksh;// (32) y 考生号
	private String xxfx;// (64) y 学习方向
	private String zslb;// (64) y 招生类别
	private String gj;// (100) y 国籍
	private String sfjh;// (4) y 是否结婚
	private String ccqj;// (200) y 乘车区间
	private String byzffztdm;// (20) y 毕业证发放状态代码
	private String xwzsxxdz;// (300) y 校外住宿详细地址
	private String jgs;// (64) y 籍贯省
	private String jgshi;// (64) y 籍贯市
	private String jgx;// (64) y 籍贯县
	private String ssbh;// (20) y 宿舍编号
	private String rxnj;// (4) y 入学年级
	private String nfby;// (8) y 能否毕业
	private String sfzc;// (6) y 是否注册
	private String dasfyl;// (6) y 档案是否遗留
	private String daylyy;// (300) y 档案遗留原因
	private String yxdm;// (10) y 院校代码
	private String sfzz;// (10) y 是否在职
	private String sfsf;// (10) y 是否师范
	private String sfdl;// (10) y 是否独立
	private String dxhwp;// (10) y 定向或委培
	private String bysj;// (10) y 毕业时间
	private String zxwyyzdm;// (10) y 主修外语语种代码
	private String wydj;// (32) y 外语等级
	private String jsjdj;// (32) y 计算机等级
	private String lxdz;// (120) y 联系地址
	private String yzbm;// (20) y 邮政编码
	private String shzw;// (120) y 社会职务
	private String jypx;// (300) y 教育培训
	private String xmsj;// (300) y 项目实践
	private String zgzs;// (300) y 资格证书
	private String jljn;// (300) y 奖励技能
	private String sybz1;// (300) y 生源备注1
	private String sybz2;// (300) y 生源备注2
	private String sybz3;// (300) y 生源备注3
	private String xldm;// (10) y 学历代码
	private String zkzh;// (20) y 准考证号
	private String grjl;// (2000) y 个人简历
	private String sfcj;// (4) y 是否残疾/1是,0否
	private String ssch;// (10) y 宿舍床号
	private String rzrq;// (10) y 住宿日期
	private String zsjzrq;// (10) y 住宿截止日期
	private String qsdh;// (20) y 寝室电话
	private String ykth;// (20) y 一卡通号
	private String yhkh;// (20) y 银行卡号
	private String xslb;// (30) y 学生类别代码
	private String xslx;// (30) y 学生类型代码
	private String sfbys;// (2) y 是否毕业生
	private String yhdm;// (3) y 银行代码
	private String hkshen;// (30) y 户口所在省
	private String hkshi;// (30) y 户口所在市
	private String hkxian;// (30) y 户口所在县
	private String zcsxhm;// (30) y 注册顺序号码
	private String rxqwhcd;// (30) y 入学前文化程度
	private String xsqrxxbz;// (4) y '否' 学生确认信息标志
	private String dah;// (60) y 档案号
	private String ylbxh;// (60) y 医疗保险号
	private String rxqdwdz;// (200) y 原毕业学院通信地址
	private String rxqdwyb;// (6) y 原毕业学院邮编
	private String rxqdwdh;// (20) y 入学前单位电话
	private String gzbx;// (1000) y 高中表现
	private String sfgat;// (4) y 是否港澳台胞
	private String sfssmz;// (4) y 是否少数民簇
	private String sfzd;// (6) y 是否走读
	private String syds;// (65) y 生源地省
	private String sydshi;// (64) y 生源地市
	private String sydx;// (64) y 生源地县
	private String byzh;// (30) y 毕业证号
	private String xjh;// (40) y 学籍号
	private String jrzzmmrq;// (24) y 加入政治面貌日期
	private String sfhq;// (2) y 是否华侨
	private String csds;// (64) y 出生地省
	private String csdshi;// (64) y 出生地市
	private String csdxian;// (64) y 出生地县
	private String zd1;// (1000) y 入学前单位（广东经管学院-学警号）
	private String zd2;// (1000) y 获奖情况（广东经管学院-手机短号）
	private String zd3;// (1000) y 微信名（广东经管学院-考生类别）
	private String zd4;// (1000) y 微博名
	private String zd5;// (1000) y 扩展字段5
	private String zd6;//(1000) y 是否单亲
	...
	private String xjlbdm;// (20) y 学籍类别代码
