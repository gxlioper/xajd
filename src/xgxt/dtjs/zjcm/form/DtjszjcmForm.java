package xgxt.dtjs.zjcm.form;

import org.apache.struts.action.ActionForm;

import xgxt.utils.Pages;

public class DtjszjcmForm extends ActionForm {

	/**
	 * 
	 */
	private static final long serialVersionUID = -604328765396070990L;
	...
	private String zhdmc;

	private String zhdrq;
	...
	private String jsskqk;

	private String xyxsbgsyj;
	...
	private String ktqf1;

	private String ktqf2;

	private String ktqf3;

	private String ktqf4;
	...
	private String lxr1 ;
	private String lxr2 ;
	private String dfjnqk ;
	private String thcs ;
	private String cjzzxxqk ;
	private String sfkyzz ;
	private String kcqk ;
	private String xsccdm ;
	private String ssbx1 ;
	private String ssbx2 ;
	private String ssbx3 ;
	private String ssbx4 ;
	...
	public void setHyrs(String hyrs) {
		this.hyrs = hyrs;
	}
	...
	public String getJsskqk() {
		return jsskqk;
	}

	public void setJsskqk(String jsskqk) {
		this.jsskqk = jsskqk;
	}

	public String getJtkzqk() {
		return jtkzqk;
	}

	public void setJtkzqk(String jtkzqk) {
		this.jtkzqk = jtkzqk;
	}
	...
	public void setKssk(String kssk) {
		this.kssk = kssk;
	}

	public String getKtqf() {
		return ktqf;
	}

	public void setKtqf(String ktqf) {
		this.ktqf = ktqf;
	}

	public String getKtqf1() {
		return ktqf1;
	}

	public void setKtqf1(String ktqf1) {
		this.ktqf1 = ktqf1;
	}

	public String getKtqf2() {
		return ktqf2;
	}

	public void setKtqf2(String ktqf2) {
		this.ktqf2 = ktqf2;
	}

	public String getKtqf3() {
		return ktqf3;
	}

	public void setKtqf3(String ktqf3) {
		this.ktqf3 = ktqf3;
	}

	public String getKtqf4() {
		return ktqf4;
	}

	public void setKtqf4(String ktqf4) {
		this.ktqf4 = ktqf4;
	}
	...
	public String getLtjh() {
		return ltjh;
	}

	public void setLtjh(String ltjh) {
		this.ltjh = ltjh;
	}
	...
	public String getSklj() {
		return sklj;
	}

	public void setSklj(String sklj) {
		this.sklj = sklj;
	}
	...
	public String getXschb() {
		return xschb;
	}

	public void setXschb(String xschb) {
		this.xschb = xschb;
	}
	...
	public String getXyxsbgsyj() {
		return xyxsbgsyj;
	}

	public void setXyxsbgsyj(String xyxsbgsyj) {
		this.xyxsbgsyj = xyxsbgsyj;
	}
	...
	public String getZhdmc() {
		return zhdmc;
	}

	public void setZhdmc(String zhdmc) {
		this.zhdmc = zhdmc;
	}

	public String getZhdrq() {
		return zhdrq;
	}

	public void setZhdrq(String zhdrq) {
		this.zhdrq = zhdrq;
	}
	...
	public String getGxzw() {
		return gxzw;
	}

	public void setGxzw(String gxzw) {
		this.gxzw = gxzw;
	}
	...
	public String getSsbx1() {
		return ssbx1;
	}

	public void setSsbx1(String ssbx1) {
		this.ssbx1 = ssbx1;
	}

	public String getSsbx2() {
		return ssbx2;
	}

	public void setSsbx2(String ssbx2) {
		this.ssbx2 = ssbx2;
	}

	public String getSsbx3() {
		return ssbx3;
	}

	public void setSsbx3(String ssbx3) {
		this.ssbx3 = ssbx3;
	}

	public String getSsbx4() {
		return ssbx4;
	}

	public void setSsbx4(String ssbx4) {
		this.ssbx4 = ssbx4;
	}
	...
	public void setJcly(String jcly) {
		this.jcly = jcly;
	}
