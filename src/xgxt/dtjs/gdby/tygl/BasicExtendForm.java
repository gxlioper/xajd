...
/**
 * Title: 学生工作管理系统
 * Description:工具用ActionForm,包含通用方法中的判断字段
...
public class BasicExtendForm extends ActionForm{
	...
	private String queryequals_bmdm;        //查询_部门代码
	private String querylike_zgh;           //查询_职工号
	private String queryequals_xxsh;        //查询_学校审核
