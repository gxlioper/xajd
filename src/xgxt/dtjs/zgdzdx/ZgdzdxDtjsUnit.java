...
public class ZgdzdxDtjsUnit {
	public void setFormForXnNdXqNj(ZgdzdxDtjsForm myForm) {
		//评奖评优模块
	...
	public void setNjXyZyBjList(HttpServletRequest request,ZgdzdxDtjsForm myForm) throws IllegalArgumentException,
		SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
