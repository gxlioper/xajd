...
public class WjdcService extends WjdcTyService {

	WjdcDAO dao = new WjdcDAO();
	 ...
	 * @throws Exception
	 */
	public Boolean saveWjInfo(WjdcForm model, String table,
			HttpServletRequest request) throws Exception {

		String[] onezd = new String[] { "xn", "xq", "nd", "mklx", "wjmc",
				"jlsj", "sfkq", "bz", "kyxg", "dawk","jwy" };
		...
		return saveWjdc(saveForm, model, request);
	}
	 ...
	 * @throws Exception
	 */
	public Boolean updateWjInfo(WjdcForm model, String table,
			HttpServletRequest request) throws Exception {

		String[] onezd = new String[] { "wjmc", "sfkq", "bz", "kyxg", "dawk","jwy" };
		...
		return updateWjdc(saveForm, model);
	}
	 ...
	 * @throws Exception
	 */
	public Boolean saveStInfo(WjdcForm model, String table,
			HttpServletRequest request) throws Exception {

		String[] onezd = new String[] { "jlsj", "mklx", "stbh", "stlx", "stmc",
				"stss", "bz" };
	 ...
	 * @throws Exception
	 */
	public Boolean saveDaInfo(WjdcForm model) throws Exception {
		...
		// 问答题参考答案有无
		if ("questions".equalsIgnoreCase(stlx)) {

			if (damc != null && damc.length > 0) {
				bzda = new String[1];
				bzda[0] = Base.isNull(damc[0]) ? "no" : "yes";
			}
		...
		return saveWjdc(saveForm, model);
	}
	 ...
	 * @throws Exception
	 */
	public Boolean delStInfo(WjdcForm model) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Boolean delDaInfo(WjdcForm model) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Boolean saveZjInfo(WjdcForm model,String tableName) throws Exception {

		String[] arrzd = new String[] { "fpbh", "zjsx" };
	 ...
	 * @author luojw
	 */
	public void setWjZjInfo(WjdcForm model, HttpServletRequest request) {
	 ...
	 * @author luojw
	 */
	private void setChooseList(WjdcForm model,
							...
							if (daMap.get("stbh").equalsIgnoreCase(stbh)) {
								...
								for (HashMap<String, String> tjMap : datjList) {
									if (tjMap.get("stbh")
										...
										double bl = Double.valueOf(tjMap.get("num"))/Double.valueOf(tjMap.get("rs"))*100;
										daMap.put("bl", String.valueOf(bl));
									}
								}
	 ...
	 * @throws Exception 
	 */
	public boolean saveSxsjbqk(WjdcForm model,HttpServletRequest request) throws Exception{
		String tableName = "xg_wjdc_xsjbqkb";
		String pk = "xh||wjid";
		String[] onezd = new String[]{"xh","wjid","sxdwmc","gzdd","gzgw","lxfs"};
		
		SaveForm saveForm = new SaveForm();
		saveForm.setTableName(tableName);
		saveForm.setOnezd(onezd);
		saveForm.setPk(pk);
		saveForm.setPkValue(new String[]{model.getXh()+model.getWjid()});
		return saveWjdc(saveForm, model, request);
	}
	 ...
	 * @throws Exception
	 */
	public Boolean saveHdzDa(WjdcForm model, RequestForm rForm)
			throws Exception {
	 ...
	 * @author luojw
	 */
	public List<HashMap<String, String>> setWjHdList(WjdcForm model) {
	 ...
	 * @throws Exception
	 */
	public Boolean delZjxx(WjdcForm model, String pk) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Boolean delHdxx(WjdcForm model, String pk) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void hsqkToExcel(WjdcForm model, OutputStream os) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void jgtjToExcel(WjdcForm model, OutputStream os,HttpServletRequest request) throws Exception {
