 ...
 * 
 * XDoclet definition:
 * @struts.form name="rcgl_rcxw_from"
 */
public class rcgl_rcxw_from extends ActionForm {
	/**
	 * 
	 */
	...
	private String rcgl_rcxw_xnid="";//日常管理日常行为虚拟主键
	
	private String xh="";//学号
	private String rq="";//日期
	private String xwmkdm="";//行为模块代码
	private String jtnr="";//具体记录内容
	...
	public String getRcgl_rcxw_xnid() {
		return rcgl_rcxw_xnid;
	}

	public void setRcgl_rcxw_xnid(String rcgl_rcxw_xnid) {
		this.rcgl_rcxw_xnid = rcgl_rcxw_xnid;
	}
