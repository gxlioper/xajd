...
public class JycxzmService {
	 ...
	 * @throws Exception the exception
	 */
	public ArrayList<String[]> ser_JycczmQuery(JycxzmModel model,
	 ...
	 * @throws Exception the exception
	 */
	public Boolean ser_JycczmAdd(JycxzmModel model, String tableName)
			throws Exception {
		JycxzmDAO dao = new JycxzmDAO();
	 ...
	 * @throws Exception the exception
	 */
	public Boolean ser_JycczmUpdate(JycxzmModel model, String tableName)
	throws Exception {
		JycxzmDAO dao = new JycxzmDAO();
	 ...
	 * @throws Exception the exception
	 */
	public void dao_expData(String tabName,HttpServletResponse response,JycxzmModel model) throws Exception {
		JycxzmDAO dao = new JycxzmDAO();
