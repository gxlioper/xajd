...
public class ZjlgPjpyUnit {
	
	public void setFormForXnNdXqNj(ZjlgPjpyForm myForm) {
		//评奖评优模块
	...
	public void setNjXyZyBjList(HttpServletRequest request,ZjlgPjpyForm myForm) throws IllegalArgumentException,
		SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
	...
	public void setTj(HttpServletRequest request,ZjlgPjpyForm myForm){
		String tj=myForm.getTj();
		if(">".equalsIgnoreCase(tj)){
			myForm.setTj("&gt;");
		}else if(">=".equalsIgnoreCase(tj)){
			myForm.setTj("&gt;=");
		}else if("<".equalsIgnoreCase(tj)){
			myForm.setTj("&lt;");
		}else if("<=".equalsIgnoreCase(tj)){
	...
	public void setZdz(HttpServletRequest request,HashMap<String, String> map){
		
		String psf = map.get("psfbl");
		String wsf = map.get("wsfbl");
		String kqf = map.get("kqfbl");
		
		request.setAttribute("psfMax", psf);
		request.setAttribute("wsfMax", wsf);
		request.setAttribute("kqfMax", kqf);
	}
}
