 ...
 * 
 * XDoclet definition:
 * @struts.form name="mjxyRychForm"
 */
public class MjxyRychForm extends ActionForm {
	...
	public String getZhpfmc() {
		return zhpfmc;
	}
	public void setZhpfmc(String zhpfmc) {
		this.zhpfmc = zhpfmc;
	}
