...
public class PjpyZjkjxyActionForm extends PjpyActionForm {
	...
	private String[] jxjtzrs;//奖学金调整人数
	...
	public String[] getJxjtzrs() {
		return jxjtzrs;
	}

	public void setJxjtzrs(String[] jxjtzrs) {
		this.jxjtzrs = jxjtzrs;
	}
	...
	public String[] getXmdmV() {
		return xmdmV;
	}

	public void setXmdmV(String[] xmdmV) {
		this.xmdmV = xmdmV;
	}
