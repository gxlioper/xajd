...
public class PjpyBcpjInit {
	 ...
	 * 
	 */
	public void initBcpjResult(RequestForm rForm, BasicModel model,
	...
	public List<HashMap<String, String>> getTopTr(String[] colList, String path) {
		...
		if ("pjpy_tjzy_bcpj.do?method=bcpjManage".equalsIgnoreCase(path)) {
			cn= new String[] {"","学号","姓名", "年级",  "班级","项目名称", "项目金额","到款成功","审核结果"}; 
		}
