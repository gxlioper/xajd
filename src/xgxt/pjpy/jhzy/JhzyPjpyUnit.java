...
public class JhzyPjpyUnit {
	public void setFormForXnNdXqNj(JhzyPjpyForm myForm) {
		//评奖评优模块
	...
	public void setNjXyZyBjList(HttpServletRequest request,JhzyPjpyForm myForm) throws IllegalArgumentException,
		SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
