...
public class PjpyZjcmUnit {
	public void setFormForXnNdXqNj(PjpyZjcmActionForm myForm) {
		//评奖评优模块
	...
	public void setNjXyZyBjList(HttpServletRequest request,PjpyZjcmActionForm myForm) throws IllegalArgumentException,
		SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
