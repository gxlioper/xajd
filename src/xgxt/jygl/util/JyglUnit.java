...
public class JyglUnit {
	...
	public static void setNjXyZyBjList(HttpServletRequest request,JhzyForm myForm) throws IllegalArgumentException,
		SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
