...
/**
 * 
 * The Class JycxzmModel.
 */
public class SyxxModel {
	...
	public String getXynx() {
		return xynx;
	}

	public void setXynx(String xynx) {
		this.xynx = xynx;
	}
	...
	public String getSfdlxy() {
		return sfdlxy;
	}

	public void setSfdlxy(String sfdlxy) {
		this.sfdlxy = sfdlxy;
	}
