...
/*		String[] queryList = new String[] { "xydm", "xqdm", "lddm", "cs", "qsh" };
		...
		String[] colList = new String[] { "pk", "xymc", "xqmc", "ldmc", "chmc",
				"qsh", "lddm" };
		
		model.getSearchModel().setSearch_tj_kssj(null);
		...
		model.getSearchModel().setSearch_tj_kssj(new String[]{jcsj});
	    ...
	    sql.append(" from (select ");
		sql.append(" (select y.xydm from xg_gygl_new_gyglryb x,view_xsjbxx y where x.qsh!='#' and x.rzzt='在任' and  x.xh=y.xh" +
				" and x.lddm=a.lddm and x.qsh=a.qsh) xydm, ");
		sql.append(" a.xqdm,a.xqmc,a.yqdm,a.yqmc,a.lddm,a.ldmc,a.ch,a.chmc,a.qsh ");
		//是否打分start
		sql.append(",(case when ");//111111111
		sql.append(" (");
		sql.append(" select count(1) from gygl_wsjc_wsfwhb b ");
		...
		sql.append(" )>0 ");
		sql.append(" then '是' when ");//222222222222222
		sql.append(" (");
		sql.append(" (select count(1) from gygl_wsjc_wsfwhb b ");
		sql.append(" where b.jcld = a.lddm ");
		sql.append(" and b.jcqs = a.qsh");
		...
		sql.append("日".equalsIgnoreCase(jczq) ? " and b.jcsj = '" + jcsj + "'" : "");
		sql.append(" )=0) ");
		sql.append(" then '否' else '' end) sfdf");//333333333333
		//是否打分end
		sql.append(" from view_xg_gygl_new_qsxx a ");
...
/*		if (!Base.isNull(sfdf)) {
		...
		sql.append(" order by xqdm, lddm, ch, qsh ) t");
		...
		ArrayList<String[]> list = commonQueryNotFy(
				"select lddm||qsh pk,t.* from (" + sql.toString(), "",
				inputV, colList, model);
	...
	public ArrayList<String[]> getWsfxxList(GyglTyForm model) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" select jcld || jcqs pk, jcsj,bz,jcbm, ");
		sql.append("(select bmmc from gywsjcbmb where jcbm = bmdm) bmmc, ");
		sql.append(" wsffs, wsfdj,jcry from gygl_wsjc_wsfwhb a ");
...
//		sql.append(")");
		sql.append(" where exists(select 1 from xg_gygl_new_qsxxb b ");
		sql.append(" where a.jcld=b.lddm and a.jcqs=b.qsh ");
		sql.append(Base.isNull(lddm) ? "" : " and b.lddm = '" + lddm + "' ");
		sql.append(Base.isNull(cs) ? "" : " and b.ch = '" + cs + "' ");
		sql.append(Base.isNull(qsh) ? "" : " and b.qsh = '" + qsh + "' ");
		sql.append(")");
	...
	public HashMap<String, String> getQsWsfInfo(GyglTyForm model,
		...
		sql.append(" (select y.xydm from xg_gygl_new_gyglryb x,view_xsjbxx y where x.qsh!='#' and x.rzzt='在任' and  x.xh=y.xh" +
		" and x.lddm=a.lddm and x.qsh=a.qsh) xydm, ");
		sql.append(" jcry,d.jczc,d.jcsj,d.wsffs, ");
//		sql.append(" d.wsfdj,d.bz from (select * from view_ssxx where lddm||cs||qsh = ?) a ");
		sql.append(" d.wsfdj,d.bz from (select * from (select x.*,replace(x.ch,'-','B') cs " +
				"from view_xg_gygl_new_qsxx x) where lddm||qsh = ?) a ");
		...
		String[] outputValue = new String[] { "xqmc", "ldmc", "cs", "qsh",
				"xymc", "jcry", "jczc", "jcsj", "wsffs", "wsfdj", "bz" };
	...
	public ArrayList<String[]> getQsrzInfo(GyglTyForm model) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" select a.xh,b.xm,b.xb,b.xymc,b.zymc,b.bjmc,cwh ");
		sql.append(" from view_xg_gygl_new_cwxx a inner join view_xsjbxx b on a.xh=b.xh ");
	...
	public ArrayList<String[]> getQsWsjcInfoList(GyglTyForm model,GyglWsjcModel wsjcModel)
		...
		String[] colList = new String[] { "pk", "xn", "xq", "nd", "xqmc",
				"ldmc", "chmc", "qsh", "sj", "jcry","wsffs","wsfdj" };
		...
		sql.append(" select lddm||ch||qsh||jcsj||jczc pk, ");
		sql.append(" xn,nd,xqmc,ldmc,ch,chmc,qsh,jczc,jcsj,wsffs,wsfdj, ");
...
//		sql.append(" (select bmmc from gywsjcbmb where bmdm = jcbm) jcbm ");
		sql.append(" jcry ");
		sql.append(" from ( ");
		sql.append(" select a.xn,a.xq,a.nd,b.xqdm,b.xqmc,b.yqdm,b.yqmc,a.jcry, ");
//		sql.append(" b.lddm,b.ldmc,b.cs,b.qsh,a.jczc,a.jcsj,a.wsffs, ");
		sql.append(" b.lddm,b.ldmc,b.ch,b.chmc,b.qsh,a.jczc,a.jcsj,a.wsffs, ");
//		sql.append(" a.wsfdj from gygl_wsjc_wsfwhb a, view_ssxx b ");
//		sql.append(" where a.jcld = b.lddm and a.jccs = b.cs ");
		sql.append("(select y.xydm from xg_gygl_new_gyglryb x,view_xsjbxx y where x.qsh!='#' and x.rzzt='在任' and  x.xh=y.xh "+
		  "and x.lddm=b.lddm and x.qsh=b.qsh) xydm,");
		sql.append("(case when wsffs is null then '否' else '是' end) sfdf,");
		sql.append(" a.wsfdj from gygl_wsjc_wsfwhb a, view_xg_gygl_new_qsxx b ");
		sql.append(" where a.jcld = b.lddm and a.jcqs = b.qsh and ");
		...
		inputList.addAll(Arrays.asList(inputV));
	...
	public ArrayList<String[]> getXsWsjcInfoList(GyglTyForm model,GyglWsjcModel wsjcModel)
		...
		String[] colList = new String[] { "pk", "xh", "xm", "xn", "xq", "nd",
				"xqmc", "ldmc", "chmc", "qsh", "sj", "jcbm", "wsffs", "wsfdj" };
		...
		sql.append(" xh,xm,xn,nd,xqmc,ldmc,ch,chmc,qsh,jczc,jcsj,wsffs,wsfdj, ");
		sql.append("周".equalsIgnoreCase(jczq) ? "'第'||jczc||'周' sj," : "jcsj sj,");
		sql.append(" (select xqmc from xqdzb where xq = xqdm) xq, ");
		sql.append(" (select bmmc from gywsjcbmb where bmdm = jcbm) jcbm ");
		sql.append(" from (select b.xn,b.xq,b.nd,a.xqdm,a.xqmc,a.yqdm,a.yqmc, ");
		sql.append(" a.lddm,a.ldmc,a.ch,a.chmc,a.qsh,a.xh,a.xm,a.nj,a.xymc,a.xydm, ");
...
//		sql.append(" left join view_xszsxx a on a.lddm = b.jcld ");
		sql.append(" left join (select x.*,y.xm,y.zymc from view_xg_gygl_new_cwxx x,view_xsjbxx y where x.xh=y.xh) a on a.lddm = b.jcld ");
		sql.append(" and a.qsh = b.jcqs) a where 1=1 ");
		sql.append(searchTj);
		// 公寓辅导员权限
		sql.append(getGyfdyQuery(model, "a"));
...
//		sql.append(" b.xqmc, b.lddm, b.ldmc, b.cs, b.qsh, ");
		sql.append(" b.xqmc, b.lddm, b.ldmc, b.ch cs, b.qsh, ");
//		sql.append(" b.ssbh, a.jcbm, a.jczc, a.jcsj, a.wsffs, ");
		sql.append(" a.jcry, a.jczc, a.jcsj, a.wsffs, ");
//		sql.append(" a.wsfdj, a.bz from gygl_wsjc_wsfwhb a, view_ssxx b ");
		sql.append(" a.wsfdj, a.bz from gygl_wsjc_wsfwhb a, view_xg_gygl_new_qsxx b ");
//		sql.append(" where a.jcld = b.lddm and a.jccs = b.cs ");
//		sql.append(" and b.lddm||b.cs||b.qsh||a.jcsj||a.jczc = ? ");
//		sql.append(" where a.jcld = b.lddm and a.jccs = b.ch ");
		sql.append(" where a.jcld = b.lddm ");
		sql.append(" and b.lddm||b.ch||b.qsh||a.jcsj||a.jczc = ? ");
		...
		String[] outputValue = new String[] { "xqmc", "lddm", "ldmc", "cs",
				"qsh", "xymc", "jcry", "jczc", "jcsj", "wsffs", "wsfdj", "bz",
				"fssx" };
...
//		sql.append(" from view_xszsxx a where exists (select 1 ");
		sql.append(" from (select x.*,x.ch cs,y.xm,y.zymc,y.xb from view_xg_gygl_new_cwxx x,view_xsjbxx y where x.xh=y.xh) a where exists (select 1 ");
...
//		sql.append(" a.wsfdj from gygl_wsjc_wsfwhb a, view_ssxx b ");
//		sql.append(" where a.jcld = b.lddm and a.jccs = b.cs ");
		sql.append(" b.lddm,b.ldmc,b.ch cs,b.qsh,a.jczc,a.jcsj,a.wsffs, ");
		sql.append(" a.wsfdj from gygl_wsjc_wsfwhb a, view_xg_gygl_new_qsxx b ");
		sql.append(" where a.jcld = b.lddm and a.jccs = b.ch ");
	...
	public ArrayList<String[]> getXsWsjcExpList(GyglTyForm model,
		...
		sql.append(" b.wsffs,b.wsfdj from gygl_wsjc_wsfwhb b ");
//		sql.append(" left join view_xszsxx a on a.lddm = b.jcld ");
		sql.append(" left join (select x.*,x.ch cs,y.xm,y.zymc from view_xg_gygl_new_cwxx x,view_xsjbxx y where x.xh=y.xh) a on a.lddm = b.jcld ");
		sql.append(" and a.cs = b.jccs and a.qsh = b.jcqs) a ");
		sql.append(myQuery.queryStr());
		// 公寓辅导员权限
		sql.append(getGyfdyQuery(model, "a"));
