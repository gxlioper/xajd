 ...
 * </p>
 * <p>
 * Description: 学生资助_困难生认定_金华职业_DAO类
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class KnsrdDAO extends CommDAO {
	 ...
	 */
	public ArrayList<String[]> getKnssqList(KnsrdForm myForm, User user)
		...
		tableSql.append(" order by a.xn,a.xh ) a ");
	 ...
	 * @throws IllegalArgumentException
	 */
	public ArrayList<String[]> getKnsshList(KnsrdForm myForm, User user)
			throws IllegalArgumentException, SecurityException,
			IllegalAccessException, InvocationTargetException,
			NoSuchMethodException {
	 ...
	 * @throws IllegalArgumentException
	 */
	public ArrayList<String[]> getKnsjgList(KnsrdForm myForm, User user)
			throws IllegalArgumentException, SecurityException,
			IllegalAccessException, InvocationTargetException,
			NoSuchMethodException {
	...
	public HashMap<String, String> getKnsrdInfo(String xh, String xn) {
		...
		sql.append("b.sqlb,b.sqly,b.sqsj,b.shzt, ");

		sql.append("b.bzrshsj,b.bzrshyj,b.bzrshr,b.bzrtjdc, ");
		sql
				.append("case when length(b.bzrshyj)>=15 then substr(b.bzrshyj,0,15)||'...' ");
		...
		sql
				.append("case when length(b.fdyshyj)>=15 then substr(b.fdyshyj,0,15)||'...' ");
		...
		sql
				.append("case when length(b.xyshyj)>=15 then substr(b.xyshyj,0,15)||'...' ");
		...
		sql
				.append("case when length(b.xxshyj)>=10 then substr(b.xxshyj,0,10)||'...' ");
		...
		sql.append("select b.xh,b.sqly,b.sqlb,b.sqsj,b.shzt, ");
		...
		sql.append("from xg_xszz_jhzy_knssqb b ");
	...
	public List<HashMap<String, String>> getKnslbList(String[] dm) {
		...
		sql.append("select rownum num,a.* from( ");
		sql.append("select dm,mc from xg_xszz_jhzt_knslbb a ");
		sql.append("where 1=1 ");
		sql.append("and a.dm in(");
		...
		sql.append(")");
		sql.append("order by to_number(a.dm)) a");

		List<HashMap<String, String>> list = dao.getList(sql.toString(), dm,
				new String[] { "dm", "mc", "num" });
	...
	// ==================执行增加操作 begin=============================
	/**
	 * 增加数据（xg_xszz_jhzy_knssqb:困难生申请表）
	 * 
	 * @date 2012-12-04
	 * @author 伟大的骆
	 * @throws Exception
	 */
	public Boolean insertKnssqb(String xh, String xn, String sqlb, String sqly,
			User user) throws Exception {

		// 表名
		String tableName = "xg_xszz_jhzy_knssqb";

		StringBuilder sql = new StringBuilder();
		sql.append("insert into xg_xszz_jhzy_knssqb ");
		sql.append("(");
		sql.append("xh,xn,sqlb,sqly");
		sql.append(")");
		sql.append("values");
		sql.append("(?,?,?,?)");

		List<String[]> params = new ArrayList<String[]>();
		String[] value = new String[] { xh, xn, sqlb, sqly };
		params.add(value);
	...
	// ==================执行修改操作 begin=============================
	/**
	 * 修改数据（xg_xszz_jhzy_knssqb:困难生申请表）
	 * 
	 * @date 2012-12-04
	 * @author 伟大的骆
	 * @throws Exception
	 */
	public Boolean updateKnssqb(String xh, String xn, String sqlb, String sqly,
			User user) throws Exception {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" update xg_xszz_jhzy_knssqb ");
		sql.append(" set sqlb=?,sqly=? ");
		sql.append(" where xn=? and xh=? ");

		List<String[]> params = new ArrayList<String[]>();
		String[] value = new String[] { sqlb, sqly, xn, xh };
		params.add(value);
	 ...
	 * @throws Exception
	 */
	public Boolean updateKnssqb(String xh, String xn, String shzt, String shsj,
	 ...
	 * @throws Exception
	 */
	public Boolean updateKnssqb(String[] pkValue, String shzt, String shsj,
			String shyj, String tjdc, String userStatus, User user)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public Boolean updateKnssqb(String[] pkValue, String shsj, String tjdc,
			User user) throws Exception {
		...
		List<String[]> params = new ArrayList<String[]>();
		for (int i = 0; i < pkValue.length; i++) {
			String[] value = new String[] { tjdc, shsj, user.getUserName(),
					pkValue[i] };
			params.add(value);
		}
	...
	// ==================执行删除操作 begin=============================
	/**
	 * 删除数据（xg_xszz_jhzy_knssqb:困难生申请表）
	 * 
	 * @date 2012-12-04
	 * @author 伟大的骆
	 * @throws Exception
	 */
	public Boolean deleteKnssqb(String[] pkValue, User user) throws Exception {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" delete xg_xszz_jhzy_knssqb ");
