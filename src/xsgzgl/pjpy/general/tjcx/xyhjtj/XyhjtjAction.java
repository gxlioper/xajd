...
public class XyhjtjAction extends BasicAction {
	...
	public ActionForward xyhjtjCx(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// ----------------设置PATH begin-----------------------
		// ----------------显示title，判断读写权----------------
		rForm.setPath("pjpy_tjcx_xyhjtj.do");
		...
		searchModel.setPath("pjpy_tjcx_xyhjtj.do");
		request.setAttribute("searchTj", searchModel);
		String xxdm = Base.xxdm;
		if(xxdm.equals("10279")){
			request.setAttribute("flag", "true");
		}
		// ----------------设置PATH end-----------------------
		service.setRequestValue(rForm, user, request);
		return mapping.findForward("xyhjtjCx");
	}
}